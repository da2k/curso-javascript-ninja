...
text.replace(/Manuel Marques de Sousa/, 'Ricardo Vasconcelos');
console.log(text);
...
text.replace(/brasileiro/,'Alagoano');
console.log(text);
...
text.replace(/O Centauro de Luvas/, function(letra){
...
var regexDate = /(\d\d) de (junho|julho) (\d\d\d\d) /;
