(function() {
  ...
  */
  ...
  console.log(text.replace(/Manuel Marques de Sousa/g, 'Matheus Almeida'));
  ...
  */
  ...
  console.log(text.replace(/brasileiro/g, 'manauara'));
  ...
  */
  ...
  console.log(text.replace(/O Centauro de Luvas/g, function(except) {
    return except.toUpperCase();
  }));
