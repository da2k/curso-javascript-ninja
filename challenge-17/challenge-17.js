(function(){
    ...
    */
    ...
    console.log(text.replace(/Manuel Marques de Sousa/, 'Edson Pedroso'));
    ...
    */
    ...
    console.log(text.replace(/brasileiro/, 'trespontano'));
    ...
    */
    ...
    console.log(text.replace(/a/ig, '4'));
    ...
    */
    ...
    console.log(text.replace(/O Centauro de Luvas/, function(s){
    ...
    */
    ...
    console.log(text.replace(regexDate, function(dataCompleta, dia, mes, ano){
