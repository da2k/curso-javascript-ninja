(function(){
    ...
    */
    ...
    console.log( text.replace(/Manuel Marques de Sousa/g,'Gustavo Martusewicz') );
    ...
    */
    ...
    console.log( text.replace(/brasileiro/, 'de São Bernardo do Campo') );
    ...
    */
    ...
    console.log( text.replace( /(O Centauro de Luvas)/g, function(todaCaptura, frase){
        return frase.toUpperCase();
    }) );
    ...
    */
    ...
    function getMonthNumber(monthName){
        ...
        /*return 'O mês de ' +monthName+ ' é representado pelo número ' + months[monthName];*/
    }
