...
*/
  ...
  console.log(text.replace(/Manuel Marques de Sousa/g, 'Helivelton Gomes Barbosa'));
  // ?
...
*/
  ...
  console.log(text.replace(/brasileiro/g, 'garanhense'));
  // ?
...
*/
  ...
  console.log(text.replace(/O Centauro de Luvas/, function(test) {
...
*/
  ...
  function getMonthNumber(textInput) {
    var months = {
      'janeiro': '01',
      'fevereito': '02',
      'março': '03',
