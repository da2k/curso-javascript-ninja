(function () {
    ...
    */
    ...
    console.log(text.replace(/Manuel Marques de Sousa/, 'Pablo A S D Binotto'))
    ...
    */
    ...
    console.log(text.replace(/brasileiro/, 'Caçapavense'))
    ...
    */
    ...
    // var t1 = 'O Centauro de Luvas'.toUpperCase();
    // console.log(text.replace(/O Centauro de Luvas/g, t1))
