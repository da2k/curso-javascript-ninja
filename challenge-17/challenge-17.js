(function() {
    ...
    */
    ...
    console.log(text.replace(/(Manuel Marques de Sousa)/g, 'Victor Nascimento Silva Barros'));
    ...
    */
    ...
    console.log(text.replace(/(O Centauro de Luvas)/, function(caixaAlta) {
    ...
    */
    ...
    var regextDate = /(\d\d) de (junho|julho) de (\d\d\d\d)/;
    console.log(regextDate);
    /*
    ...
    */
    ...
    console.log(text.replace(regextDate, replaceDate));
}());