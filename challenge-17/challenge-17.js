(function(){
	...
	*/
	...
	"Manuel Marques de Souza, Conde de Porto Alegre (Rio Grande, 13 de junho de 1804 – Rio de Janeiro, 18 de julho de 1875), apelidado de "O Centauro de Luvas", foi um militar, político, abolicionista e monarquista brasileiro."
	*/
	var text = 'Manuel Marques de Souza, Conde de Porto Alegre (Rio Grande, 13 de junho de 1804 – Rio de Janeiro, 18 de julho de 1875), apelidado de "O Centauro de Luvas", foi um militar, político, abolicionista e monarquista brasileiro.';
	...
	*/
	...
	console.log(text.replace(/Manuel Marques de Souza/,'Alberto Veloso'));
	...
	*/
	...
	console.log(text.replace(/brasileiro/g, 'paulista')); //se usarmos o g iria trocar em todos os lugares que aparecer
