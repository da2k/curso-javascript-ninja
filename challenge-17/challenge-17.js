(function(){
  ...
  */
  ...
  console.log( text.replace(/Manuel Marques de Sousa/, 'Isaac Bruno') );
  ...
  */
  ...
  console.log( text.replace( /brasileiro/, 'parnaibano' ) );
  ...
  */
  ...
  function getMonthNumber (monthName) {
    ...
    return months[monthName] ? months[monthName] : -1;
  }
  ...
  */
  console.log( '\nReplace de datas:' );
  var replaceDate = function (capture, day, month, year) {
