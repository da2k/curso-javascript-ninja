(function() {
    ...
    */
    ...
    console.log( text.replace(/Manuel Marques de Sousa/, 'Leandro Fialho') );
    ...
    */
    ...
    console.log( text.replace( /O Centauro de Luvas/g, function(expression) {
    ...
    */
    ...
    // function getMonthNumber( getMonth ) {
    //     var month;
    //     switch ( getMonth ) {
    //         case 'março':
    //             month = '03';
    ...
    //             return 'Mês inválido';
    //     }
    //     return 'O mês de ' + getMonth + ' é representado pelo número ' + month;
    // }
