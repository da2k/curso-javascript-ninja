...
(function() {
    ...
    */
    ...
    console.log( text = text.replace(/Manuel Marques de Sousa/, 'Mellina Yonashiro' ));
    ...
    */
    ...
    console.log( text = text.replace(/brasileiro/, 'paulistana') );
    ...
    */
    ...
    console.log( text.replace(/O Centauro de Luvas/, function(nome){ return nome.toUpperCase(); } ) );
    ...
    */
    ...
    var regexDate = {
        'dia': text.match(/\s\d\d\s/g),
        'mês1': text.match(/junho/g),
        'mês2': text.match(/julho/g),
        'ano': text.match(/\d{4}/g)
    };
