(function (){
    ...
    */
    ...
    console.log(text.replace(/Manuel Marques de Sousa/, 'Julia Stefanoni'));
    /*
    ...
    */
    ...
    console.log(text.replace(/O Centauro de Luvas/g, function(busca){
        return busca.toUpperCase();
    }) );
    ...
    */
    ...
    function getMonthNumber(monthName){
        var monthLowCase = monthName.toLowerCase();
        var months = {
            janeiro: '01',
            fevereiro: '02',
            março: '03',
