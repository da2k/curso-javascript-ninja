(function() {
    ...
    */
    ...
    console.log(text.replace(/Manuel Marques de Sousa/, 'Felipe dos Anjos'));
    ...
    */
    ...
    var upperText = text.replace(/(O Centauro de Luvas)/, function(capture, item) {
    ...
    */
    ...
    function getMonthNumber(mounth) {
        ...
        if(mounths[ mounth ] === undefined) {
            return 'Informe um mês válido';
        }

        return {mounthName: mounth, mounthNumber: mounths[ mounth ]};
    }

    var mounths = {
        choice: getMonthNumber,
        marco: getMonthNumber('março'),
        setembro: getMonthNumber('setembro'),
        dezembro: getMonthNumber('dezembro'),
    };

    console.log('O mês de ' + mounths.marco.mounthName + ' é representado pelo número ' + mounths.marco.mounthNumber + '.')
    console.log('O mês de ' + mounths.setembro.mounthName + ' é representado pelo número ' + mounths.setembro.mounthNumber + '.')
    console.log('O mês de ' + mounths.dezembro.mounthName + ' é representado pelo número ' + mounths.dezembro.mounthNumber + '.')
    ...
    */
    ...
    var regexDate = /([0-3]\d) de (junho|julho) de ([0-2]\d\d\d)/g
    ...
    */
    console.log( '\nReplace de datas:' );
        ...
        function replaceDate(all, day, mounth, year) {
            return day + '/' + mounths.choice(mounth).mounthNumber + '/' + year;
        }

        var newText = text.replace(regexDate, replaceDate);
