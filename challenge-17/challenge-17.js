(function() {
    ...
    */
    ...
    console.log( text.replace(/Manuel Marques de Sousa/, 'Ronaldo Oliveira') );
    ...
    */
    ...
    console.log( text.replace(/O Centauro de Luvas/, function(quote) { 
    ...
    */
    console.log( '\nReplace de datas:' );
    function replaceDate( captured, day, monthName, year ) {
