(() => {
  ...
  console.log(
    text.replace(/Manuel Marques de Sousa/g, "Ricardo Campos de Oliveira")
  );
  ...
  /*
    ...
    "O mês de janeiro é representado pelo número [NÚMERO DO MÊS]."
    */
  ...
  console.log(
    `O mês de fevereiro é representado pelo número ${getMonthNumber(
      "fevereiro"
    )}.`
  );
  console.log(
  ...
  console.log(
    `O mês de abril é representado pelo número ${getMonthNumber("abril")}.`
  );
  console.log(
    `O mês de maio é representado pelo número ${getMonthNumber("maio")}.`
  );
  console.log(
    `O mês de junho é representado pelo número ${getMonthNumber("junho")}.`
  );
  console.log(
    `O mês de julho é representado pelo número ${getMonthNumber("julho")}.`
  );
  console.log(
    `O mês de agosto é representado pelo número ${getMonthNumber("agosto")}.`
  );
  console.log(
  ...
  console.log(
    `O mês de outubro é representado pelo número ${getMonthNumber("outubro")}.`
  );
  console.log(
    `O mês de novembro é representado pelo número ${getMonthNumber(
      "novembro"
    )}.`
  );
  console.log(
