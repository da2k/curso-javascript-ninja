(function () {
  ...
  */
  ...
  var MyName = text.replace(/Manuel Marques de Sousa/, 'Roquelson Ferreira Souza');
  ...
  */
  ...
  var baiano = text.replace(/brasileiro/, 'baiano');
  ...
  */
  ...
  var changeByHifen = text.replace(/[0-9]/g, '-');

  console.log(changeByHifen);
  ...
  */
  ...
  var changeDforH = text.replace(/[D-Za-h]/g, '0');

  console.log(changeDforH);
  ...
  */
  ...
  var changeA = text.replace(/(A|a)/g, '4');
  ...
  */
  ...
  var changeText = text.replace(/O Centauro de Luvas/, function (capturaTotal) {
