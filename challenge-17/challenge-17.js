...
"Manuel Marques de Sousa, Conde de Porto Alegre (Rio Grande, 13 de junho de 1804 –
...
console.log( text.replace(/(Manuel Marques de Sousa)/g, 'Gilmara Barros') );
...
console.log( text.replace(/(brasileiro)/g, 'cearence') );
