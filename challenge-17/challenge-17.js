(function(){
    ...
    */
    ...
    const re = (/Manuel Marques de Sousa/);
    const replaceName = text.replace( re, 'Ramon Francisco da Silva');
    ...
    */
    ...
    const replaceCity = text.replace( /brasileiro/g, 'paulista');
    ...
    */
    ...
    const replaceNumber = text.replace( /\d/g, '-');
    ...
    */
    ...
    const replaceGhto0 = text.replace(/[D-Za-h]/g, '0')
    console.log( replaceGhto0 );
    ...
    */
    ...
    const replaceAora = text.replace(/a/gi, '4');
    console.log(replaceAora);
    ...
    */
    ...
    const matchPhrase = (/O Centauro de Luvas/);
    const phrase = text.replace(matchPhrase, function(acumulator){
        return acumulator.toUpperCase();
    });
    console.log(phrase);
    ...
    */
    ...
    const regexDate = (/(\d\d) de (junho|julho) de (\d\d\d\d)/gi);
    ...
    */
    ...
    function replaceDate( match ){
        ...
        return text.replace( match, function(result, day, month, year){
