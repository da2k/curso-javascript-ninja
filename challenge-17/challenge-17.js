...
var newText = text.replace(/Manuel Marques de Sousa/, 'Mateus Jabour Barbosa Pereira');
console.log(newText);
/*
...
newText = newText.replace(/brasileiro/, 'pessoense');
console.log(newText);
...
console.log(newText.replace(/\d/g, '-'));
...
console.log(newText.replace(/[D-Za-h]/g, '0'));
...
console.log(newText.replace(/a/gi, '4'));
...
console.log(newText.replace(/O Centauro de Luvas/, function (total) {
...
function getMonthNumber (monthName) {
	...
	var monthNumber = arrMonth.indexOf(monthName) + 1;
	if (monthNumber < 10) {
...
function replaceDate () {
	newText = newText.replace(regexDate, function (total, day, month, year) {
