(function(){
  ...
  */
  ...
  var newText = text.replace(/Manuel Marques de Sousa/, 'Felipe Abbud');
  console.log( newText );

  /*
  Agora, substitua a palavra "brasileiro" por sua cidade natal e mostre no5
  console.
  Ex: Se você for da São Paulo, substitua por "paulista".
  */
  console.log( '\nTrocando naturalidade:' );
  newText = newText.replace(/brasileiro/, 'gaúcho');
  console.log( newText );
  /*
  ...
  */
  ...
  var regexDate = /(\d\d) de ([A-Za-z]+) de (\d\d\d\d)/g;
