(function(){
	...
	*/
	...
	console.log( text.replace( /Manuel Marques de Sousa/g, 'Diogo Rodrigues' ) );
	...
	*/
	...
	console.log( text.replace( /brasileiro/g, 'rio pretense' ) );
	...
	*/
	...
	console.log( text.replace( /(O Centauro de Luvas)/g, function( fulltext, text1 ){
