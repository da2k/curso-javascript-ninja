...
*/
	var regular = 'Manuel Marques de Sousa, Conde de Porto Alegre (Rio Grande, 13 de junho de 1804 – Rio de Janeiro, 18 de julho de 1875), apelidado de "O Centauro de Luvas", foi um militar, político, abolicionista e monarquista brasileiro.';
...
*/
	...
	console.log( regular.replace( /Manuel Marques de Sousa/, 'Gustavo Henrique de Araujo Rodrigues' ) );
...
*/
	...
	console.log( regular.replace( /brasileiro/, 'Pernambuco' ) );
...
*/
	...
	console.log( regular.replace( /\d/g, '-' ) );
...
*/
	...
	console.log( regular.replace( /[D-Hd-h]/g, 0 ));
...
*/
	...
	console.log( regular.replace( /[A]/,'4' ));
...
*/
	...
	console.log( regular.replace( /O Centauro de Luvas/g, function(frase) {
...
*/
	function getMonthNumber(monthNome) {
		var months = {
			janeiro: '01',
			fevereiro: '02',			
			março: '03',
		...
		return months[ monthNome ];
	}
	console.log( 'O mês de março é representado pelo número ' + getMonthNumber( 'agosto' ) + '.' );
...
*/
	...
	function replaceDate(regex, day, month, year) {
		return day + '/' + getMonthNumber( months ) + '/' + year;
	}
	console.log( regular.replace( regexDate, replaceDate ) );
