(function(){
    ...
    */
    ...
    //
    let newText = text.replace('Manuel Marques de Sousa','Alexandre C. Pinheiro');
    console.log(newText);
    ...
    */
    ...
    //
    let newText2 = newText.replace('brasileiro','carioca');
    ...
    */
    ...
    //
    let newText5 = newText4.replace(/[aA]/g,'4');
    ...
    */
    ...
    //
    let string = 'O Centauro de Luvas';
    let newTextFinal = text.replace(string,string.toUpperCase());
    console.log(newTextFinal);
