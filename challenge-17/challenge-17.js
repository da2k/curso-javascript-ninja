(function(){
  ...
  */
  ...
  console.log(text.replace(/Manuel Marques de Sousa/, 'Adriano Avelino'));
  ...
  */
  ...
  console.log(text.replace(/brasileiro/,'Registrense'));
  ...
  */
  ...
  console.log(text.replace(/(O Centauro de Luvas)/g, function upper(captura, d) {
  ...
  */
  console.log( '\nReplace de datas:' );
  function replaceDate (data, dia, mes, ano) {
