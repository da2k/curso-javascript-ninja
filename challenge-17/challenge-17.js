(function (){
    ...
    */
    ...
    console.log(text.replace(/Manuel Marques de Sousa/, 'Victor Costa de Carli'))
    ...
    */
    ...
    console.log(text.replace(/brasileiro/g, 'araraquarense'))
    ...
    */
    ...
    console.log(text.replace(/[D-Hd-h]/gi, '0'))
    ...
    */
    ...
    console.log(text.replace(/O Centauro de Luvas/g, function(f) {
