(function(){
	...
	*/
	...
	console.log(text.replace(/Manuel Marques de Sousa/g,'Thiago Miranda'));
	...
	*/
	...
	console.log(text.replace(/brasileiro/g,'anchietense'));
	...
	*/
	...
	function getMonthNumber(monthsName){
