(function(){
	...
	*/
	...
	console.log(text.replace(/Manuel Marques de Sousa/, 'João Paulo Moraes'));
	...
	*/
	...
	console.log("O Centauro de Luvas".replace(/\w/g, function(letra){
	...
	*/
	console.log( '\nReplace de datas:' );
	function replaceDate(express, dia, mes, ano){
