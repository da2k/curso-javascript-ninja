(function(){
    ...
    */
    ...
    console.log(text.replace(/Manuel Marques de Sousa/, 'Luísa'))
    ...
    */
    ...
    console.log(text.replace(/brasileiro/, 'alagoana'))
    ...
    */
    ...
    console.log('O mês de março é representado por ' + getMonthNumber('março'))
    console.log('O mês de setembro é representado por ' + getMonthNumber('setembro'))
    console.log('O mês de dezembro é representado por ' + getMonthNumber('dezembro'))
    ...
    */
    ...
    var regexDate = /(\d{2})\sde\s(junho|julho)\sde\s(\d{4})/gi
    ...
    */
    ...
    function replaceDate(capturaTotal, date, month, year) {
