(function () {
    ...
    */
    ...
    console.log(texto.replace('Manuel Marques de Sousa', 'Jhonatan Henrique Sychochi'));
    ...
    */
    ...
    console.log(texto.replace('brasileiro', 'curitibano'));
    ...
    */
    ...
    console.log(texto.replace(/[D-h]/g, '0'));
    ...
    */
    ...
    console.log(texto.replace(/A|a/g, '4'));
    ...
    */
    ...
    console.log(texto.replace(/(O Centauro de Luvas)/g, function (text, result) {
    ...
    */
    ...
    var regexDate = /(\w\w) de (\w\w\w\w\w) de (\w\w\w\w)/g;
    console.log(texto.match(regexDate));
    ...
    */
    console.log('\nReplace de datas:');
    function replaceDate(match, dia, mes, ano) {
