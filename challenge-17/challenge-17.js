(function(){
    ...
    */
    ...
    console.log(text.replace(/Manuel Marques de Sousa/, 'Diego Dmitry'))
    ...
    */
    ...
    //OU
    console.log(text.replace(/O Centauro de Luvas/g, function(sent){
