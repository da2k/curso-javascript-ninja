(function(){
  ...
  */
  ...
  console.log( text.replace(/Manuel Marques de Sousa/, 'Kevin Oliveira') );
  ...
  */
  ...
  console.log( text.replace(/brasileiro/, 'andreense') );
  ...
  */
  ...
  console.log( text.replace(/(O Centauro de Luvas)/, function(apelido) {
