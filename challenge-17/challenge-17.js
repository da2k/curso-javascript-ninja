...
console.log(text.replace(/Manuel Marques de Sousa/, 'Marcel Souza Zanatta'));
...
console.log(text.replace(/brasileiro/g, 'Sao Carlense'));
...
*/
console.log( '\nReplace de datas:' );
function replaceDate(capTotal2, cap1, cap2,cap3){
