...
console.log( text.replace( /Manuel Marques de Sousa/g, 'Wellington Fernando da Silva' ) );
...
console.log( text.replace(/(O Centauro de Luvas)/g, function( all, captura ) {
...
function replaceDate( all, dia, mes, ano ) {
