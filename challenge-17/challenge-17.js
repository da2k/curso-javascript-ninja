...
console.log(text.replace(/Manuel Marques de Sousa/, 'Michael de Souza Nogueira'));
...
console.log(text.replace(/brasileiro/, 'candango'));
...
var nomeMes = 'marco';
console.log('O mês de', nomeMes, ' é representado pelo número ', getMonthNumber(nomeMes), '.');
nomeMes = 'setembro';
console.log('O mês de', nomeMes, ' é representado pelo número ', getMonthNumber(nomeMes), '.');
nomeMes = 'dezembro';
console.log('O mês de', nomeMes, ' é representado pelo número ', getMonthNumber(nomeMes), '.');

//console.log(text.replace(/(julho)/g, getMonthNumber(nomeMes)));
