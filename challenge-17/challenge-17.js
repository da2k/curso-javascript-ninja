(function() {
    ...
    */
    ...
    console.log(text.replace(/Manuel Marques de Sousa/g, 'Ingrid Rauany Dias Soares'));
    ...
    */
    ...
    console.log(text.replace(/brasileiro/, 'mineira'));
    ...
    */
    ...
    console.log("O mês de janeiro é representado pelo número " + getMonthNumber('fevereiro') + ".");
    console.log("O mês de janeiro é representado pelo número " + getMonthNumber('março') + ".");
    console.log("O mês de janeiro é representado pelo número " + getMonthNumber('abril') + ".");
    console.log("O mês de janeiro é representado pelo número " + getMonthNumber('maio') + ".");
    console.log("O mês de janeiro é representado pelo número " + getMonthNumber('junho') + ".");
    console.log("O mês de janeiro é representado pelo número " + getMonthNumber('agosto') + ".");
    console.log("O mês de janeiro é representado pelo número " + getMonthNumber('setembro') + ".");
    console.log("O mês de janeiro é representado pelo número " + getMonthNumber('outubro') + ".");
    console.log("O mês de janeiro é representado pelo número " + getMonthNumber('novembro') + ".");
    console.log("O mês de janeiro é representado pelo número " + getMonthNumber('dezembro') + ".");
