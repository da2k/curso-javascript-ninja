(function(){
  ...
  */
  ...
  no console:
  */
  var newText = text.replace( /Manuel Marques de Sousa/g, 'Anderson Nascimento' );
  ...
  */
  var newNationality = newText.replace( /brasileiro/g, 'carioca' );
  ...
  */
  var numbers = newNationality.replace( /\d/g, '-' );
  ...
  */
  var letters = newNationality.replace( /[D-Za-h]/g, 0 );
  ...
  */
  var lettersA = newNationality.replace( /[Aa]/g, 4 );
  ...
  */
  var phrase = 'O Centauro de Luvas';

  var newPhrase = phrase.replace( /O Centauro de Luvas/g, function( capturaTotal ){
  ...
  */
  function getMonthNumber( month ){
    //return month.replace(/março/g, '03');
    switch( month ) {
      case 'janeiro':
      return '01';
      break;
  ...
  */
  ...
  var replaceDates = newNationality.replace(regexDate, replaceDate);
