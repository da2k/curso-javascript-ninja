...
console.log(text.replace(/Manuel Marques de Sousa/, 'Leandro Souza'));
...
console.log(text.replace(/O Centauro de Luvas/g, function (regTotal) {
    return regTotal.toUpperCase();
}));
