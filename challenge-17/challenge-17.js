(function(){
  ...
  */
  ...
  console.log( text.replace(/Manuel Marques de Souza/g, 'Rafael Bernardo') );
  ...
  */
  ...
  console.log( text.replace(/brasileiro/, 'osasquense') );
  ...
  */
  ...
  function getMonthNumber( month ) {
    if ( month.match(/junho/) ) {
      return '05';
    }
    if ( month.match(/julho/) ) {
      return '06';
    }
    if ( month.match(/março/) ) {
      return '03';
    }
    if ( month.match(/setembro/) ) {
      return '09';
    }
    if ( month.match(/dezembro/) ) {
      return '12';
    }
  }
  ...
  */
  ...
  //  13 de junho de 1804
  var regexDate = /(\w\w)( de )(junho|julho)( de )(\w\w\w\w)/g;
  ...
  */
  ...
  function replaceDate() {
    return text.replace( regexDate, function( total, p1, p2, p3, p4, p5 ) {
      return p1 + "/" + getMonthNumber( p3 ) + "/" + p5;
    });
  }
