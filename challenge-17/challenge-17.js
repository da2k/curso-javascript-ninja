(function() {
  ...
  Conde de Porto Alegre (Rio Grande, 13 de junho de 1804 – Rio de Janeiro, 18 de julho de 1875),
  apelidado de "O Centauro de Luvas",
  ...
  */
  ...
  console.log(text.replace('Manuel Marques de Sousa', 'Herton Mota'));
  // ?
  ...
  */
  ...
  console.log(text.replace('brasileiro', 'alegretense'));
  // ?
  ...
  */
  ...
  console.log(text.replace('O Centauro de Luvas', function(item) {
