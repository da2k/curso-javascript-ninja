;(function() {
    ...
    */
    ...
    console.log( text.replace( /Manuel Marques de Sousa/g,'Eduardo Raphael Cintra Maia' ) );
    ...
    */
    ...
    console.log( text.replace( /brasileiro/g, 'uberabensse' ) );
    ...
    */
    ...
    var regexDate = /([0|1][0-9]) de (junho|julho) de (\w\w\w\w)/g;
    ...
    */
    ...
    function replaceDate(regx, dia, mes, ano){
