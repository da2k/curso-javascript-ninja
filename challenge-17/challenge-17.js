(function () {
  ...
  */
  ...
  var text1 = text.replace( /Manuel Marques de Sousa/g, 'Evelyn Schmitz' );
  console.log( text1 );
  ...
  */
  ...
  var text2 = text.replace( /brasileiro/g, 'joinvilense' );
  console.log( text2 );
  ...
  */
  ...
  var text4 = text.replace( /[D-Hd-h]/g, '0' );
  console.log( text4 );
  ...
  */
  ...
  "13/06/1804".
  A primeira coisa a fazer é criar uma função chamada
  ...
  */
  ...
  function getMonthNumber( monthName ) {
    var monthName = monthName.toLowerCase();
