(function() {
  ...
  */
  ...
  console.log( text.replace( /(Manuel Marques de Sousa)/g, 'Maria Nathyelle Monteiro Maciel' ) );
  ...
  */
  ...
  console.log( text.replace( /(brasileiro)/g, 'Umariense' ) );
  /*
  ...
  */
  ...
  // 'O Centauro de Luvas'.replace( /\w/g, function( capturaTotal, letra ) {
