...
console.log(text = text.replace(/Manuel Marques de Sousa/, 'Herick Allaín Soares Cunha'));
/*
...
console.log(text = text.replace(/brasileiro/, 'paraibano'));
/*
...
console.log(text.replace(/(O Centauro de Luvas)/g, function(capturaTotal, first) {
