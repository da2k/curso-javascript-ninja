...
no console:
*/
console.log( 'Adicionando seu nome no texto:', text.replace(/Manuel Marques de Sousa/, 'Renan Oliveira') );
...
*/
console.log( '\nTrocando naturalidade:', text.replace(/brasileiro/g, 'pessoense') );
// ?
...
*/
console.log( '\nTrocando "A" e "a" por "4":', text.replace(/[A-a]/g, '4') );
// ?
...
*/
console.log( '\n"O Centauro de Luvas" em caixa alta:', text.replace(/O Centauro de Luvas/, function(capTotal) {
    return capTotal.toUpperCase();
}) );
// ?
...
console.log( '\nRegex que vai fazer o match com as datas do texto:', text.match(regexDate) );
// ?
...
console o resultado.
*/
console.log( '\nReplace de datas:', text.replace(regexDate, function (all, day, month, year) {
