(function () {
  ...
  */
  ...
  console.log(text.replace(/Manuel Marques de Sousa/g, 'Monica Craveiro de Menezes'));
...
//   console.log(text.replace(/a/gi, 4));
  ...
  */
  ...
  console.log(text.replace(/O Centauro de Luvas/g, function (total) { return total.toUpperCase(); }));
  ...
  */
  ...
  function getMonthNumber(mes) {
    ...
    var numberMonth = month.indexOf(mes) + 1;
    return numberMonth < 10 ? ('0' + numberMonth) : numberMonth;
  }
  var mes = 'março';
