(function(){
    ...
    */
    ...
    var novoText1 = text.replace(/Manuel Marques de Sousa/g, 'Emmanuel Tavares')
    console.log(novoText1);
    ...
    */ 
    ...
    var novoText2 = novoText1.replace(/brasileiro/g, 'paulista');
    ...
    */
    ...
    var novoText3 = novoText2.replace(/\d/g, '-');
    console.log(novoText3);
    ...
    */
    ...
    var novoText4 = novoText3.replace(/[D-Za-h]/g, '0');
    console.log(novoText4);
    ...
    */
    ...
    console.log('O mês de feveiro é representado pelo número ' + getMonthNumber('fevereiro') +'.');
