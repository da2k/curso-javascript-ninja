...
*/
var text = `Manuel Marques de Sousa, Conde de Porto Alegre (Rio Grande, 13 de junho de 1804 – 
    Rio de Janeiro, 18 de julho de 1875), apelidado de "O Centauro de Luvas", foi um militar, 
    político, abolicionista e monarquista brasileiro.`
...
console.log(text.replace(/Manuel Marques de Sousa/, 'Maicon Pereira de Souza'))
...
console.log(text.replace(/O Centauro de Luvas/gi, function(texto){
...
function getMonthNumber (month){
    var monthArray = ['janeiro', 'fevereiro', 'março', 'abril', 'maio', 'junho', 
    'julho', 'agosto', 'setembro', 'outubro', 'novembro', 'dezembro']
    
    var number = (monthArray.indexOf(month) + 1).toString()
