(function(){
	...
	*/
	...
	console.log(text.replace(/Manuel Marques de Sousa/, 'Jhones da Silva Goncalves'));
	...
	*/
	...
	console.log(text.replace(/(O Centauro de Luvas)/, function(capturaTotal, texto){
	...
	*/
	...
	function replaceDate(regexAll, day, month, year) {
