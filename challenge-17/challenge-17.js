(function() {
    ...
    */
    ...
    console.log(text.replace(/Manuel Marques de Sousa/g, 'Roger Waters Alves de Melo'));

    /*
    Agora, substitua a palavra "brasileiro" por sua cidade natal e mostre no
    console.
    Ex: Se você for de São Paulo, substitua por "paulista".
    */
    console.log( '\nTrocando naturalidade:' );

    console.log(text.replace(/brasileiro/g, 'goiano'));
    ...
    */
    ...
    console.log("O mês de " + monthName + " é representado pelo número " + getMonthNumber(monthName) + ".");
