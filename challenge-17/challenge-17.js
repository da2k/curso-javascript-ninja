(function() {
  ...
  */
  ...
  console.log(text.replace(/Manuel Marques de Sousa/, "Vitor Lopes de Souza"));
  ...
  */
  ...
  console.log(
    text.replace(/(O Centauro de Luvas)/, function(capturaTotal) {
  ...
  */
  ...
  unction getMonthNumber(monthName) {
  var month = [
    "janeiro",
    "fevereiro",
    "março",
  ...
  var monthNumber = String(month.indexOf(monthName) + 1);
  ...
  */
  ...
  function replaceDate(capituraTotal, day, month, year) {
