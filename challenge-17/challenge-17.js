(function(){
    ...
    */
    ...
    console.log(text.replace(/Manuel Marques de Sousa/, 'Artur Freire dos Santos'));
    ...
    */
    ...
    console.log(text.replace(/brasileiro/, 'santista'));
    ...
    */
    ...
    console.log(text.replace(/O Centauro de Luvas/, function(value){
    ...
    */
    ...
    //a função 'replaceDate' entraria como o segundo parâmetro no 'replace', por esta razão, não há por que invocar o seu retorno.
