(function(){
    ...
    */
    ...
    "Manuel Marques de Sousa, Conde de Porto Alegre (Rio Grande, 13 de junho de 1804 – Rio de Janeiro, 
    18 de julho de 1875), apelidado de "O Centauro de Luvas", foi um militar, político, abolicionista e 
    ...
    */
    ...
    var newText = text.replace(/Manuel Marques de Sousa/, 'Milena Silva');
    console.log( newText );
    ...
    */
    ...
    console.log( text.replace(/brasileiro/, 'recifence')  );
    ...
    */
    ...
    var centaurao = text.replace(/O Centauro de Luvas/, function(frase){ 
        return frase.toUpperCase();
    })
    console.log( centaurao );
   ...
   console.log( 'O mês de dezembro é representado pelo número ' + getMonthNumber( 'dezembro' ) + '.' ); 
    ...
    regular que fará o match com as datas. Crie grupos de captura para o
