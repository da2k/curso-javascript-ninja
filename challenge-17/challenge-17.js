(function(){
    ...
    */
    ...
    console.log(text.replace(/(Manuel Marques de Sousa)/g, "Jorge de Andrade Neto"));
    ...
    */
    ...
    console.log(
        text.replace(/(O Centauro de Luvas)/g, function(captura){
            return captura.toLocaleUpperCase();
        })
    );
