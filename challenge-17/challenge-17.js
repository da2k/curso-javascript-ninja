...
console.log(text.replace(/Manuel Marques de Sousa/g, 'Alison Gustavo de Lima'));
...
console.log(text.replace(/brasileiro/g, 'taquaritinguense'));
...
function replaceDate(){
  return text.replace(regexDate, function(capturaTotal, dia, mes, ano){
    return mes;
  });
}
