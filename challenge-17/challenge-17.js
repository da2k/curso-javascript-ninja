(function () {
  ...
  */
  ...
  console.log(text.replace(/Manuel Marques de Sousa/, 'Otávio Landim'));
  ...
  */
  ...
  console.log(text.replace(/brasileiro/, 'cearense'));
  ...
  */
  ...
  console.log(text.replace(/A|a/gi, 4));
  ...
  */
  ...
  console.log(text.replace(/O Centauro de Luvas/g, function (textoP) {
    return textoP.toUpperCase();
  }));
