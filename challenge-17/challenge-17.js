(function(){
	...
	*/
	...
	var newNameText = text.replace(/Manuel Marques de Sousa/g, 'Lucas Maia e Silva' );
	...
	*/
	...
	var newBornText = text.replace(/brasileiro/g, 'mineiro');
	console.log(newBornText);
	...
	*/
	...
	var removedNumbersText = text.replace(/\d/g, '-');
	console.log(removedNumbersText);
	...
	*/
	...
	var changeCharsText = text.replace(/[D-h]/g, '0');
	console.log(changeCharsText);
	...
	*/
	...
	var changeAText = text.replace(/[Aa]/g, '4');
	console.log(changeAText);
	...
	*/
	...
	var upperPhrase = text.replace(/O Centauro de Luvas/g, function(stringBusca){
		// console.log(arguments);
		return stringBusca.toUpperCase();
	});
