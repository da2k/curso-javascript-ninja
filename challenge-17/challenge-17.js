...
(function () {
    ...
    */
    ...
    console.log(text.replace(/Manuel Marques de Sousa/, 'Mario Salles'));
    /*
    ...
    */
    ...
    console.log(text.replace(/(O Centauro de Luvas)/gi, function (w) { return w.toUpperCase(); }));
    ...
    */
    ...
    var regexDate = /(\d{2}) de (junho|julho) de \d{4}/gi;
