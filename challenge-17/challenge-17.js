(function() {
  ...
  */
  var text = 'Manuel Marques de Sousa, Conde de Porto Alegre (Rio Grande, 13 de ' +
             'junho de 1804 – Rio de Janeiro, 18 de julho de 1875), apelidado de ' +
             '"O Centauro de Luvas", foi um militar, político, abolicionista e ' +
  ...
  */
  ...
  var changeName = text.replace( /Manuel Marques de Sousa/, 'Maurício Júnior' );
  ...
  */
  ...
  var changeNationality = text.replace( /brasileiro/g, 'campineiro' );
  console.log( changeNationality );
  ...
  */
  ...
  var changeNumberToHiphen = text.replace( /\d/g, '-' );
  console.log( changeNumberToHiphen );
  ...
  */
  ...
  var changeLetterToZero = text.replace( /[D-Hd-h]/g, '0' );
  console.log( changeLetterToZero );
  ...
  */
  ...
  var changeLetterToFour = text.replace( /[aA]/g, '4' );
  console.log( changeLetterToFour );
  ...
  */
  ...
  var changeToUpperCase = text.replace( /O Centauro de Luvas/g, function( total ) {
  ...
  */
  ...
  function getMonthNumber( month ) {
    ...
    var index = months.indexOf( month ) + 1 < 10 ? '0' + ( months.indexOf( month ) + 1 ) : months.indexOf( month ) + 1;
    return index;
  }
  ...
  */
  ...
  function replaceDate() {
    return text.replace( regexDate, function( total, day, month, year ) {
