...
console.log( text.replace( /(Manuel Marques de Sousa)/g , 'Caio Myra Pereira' )  )
...
console.log( text.replace( /(O Centauro de Luvas)/, function(capturarTotal){
             
            return capturarTotal.toUpperCase();
} )  )
...
var regexDate = /([0-9][0-9]) de (junho|julho) de ([0-9][0-9][0-9][0-9])/gi;
...
var replaceDate = function(capturarTotal,dias,meses,anos){
	
	 return dias + '/' + getMonthNumber( meses ) + '/' + anos;
