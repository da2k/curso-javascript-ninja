(function() {
    ...
    */
    ...
    console.log(text.replace(/Manuel Marques de Sousa/, 'Valentina Sophia'));
    ...
    */
    ...
    console.log(text.replace(/brasileiro/, 'baiano'));
    ...
    */
    ...
    console.log(text.replace(/O Centauro de Luvas/, toUpperCase));
