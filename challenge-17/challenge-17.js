(function() {
    ...
    */
    ...
    console.log( text.replace( /Manuel Marques de Sousa/g, "Maxwell Oliveira") );
    ...
    */
    ...
    console.log( text.replace(/O Centauro de Luvas/g, function(todos) {
        return todos.toUpperCase();
    }) );
