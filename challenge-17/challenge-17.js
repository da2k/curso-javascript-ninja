(function(){
  ...
  */
  ...
  console.log(text.replace(/(Manuel Marques de Sousa)/g, 'Jefferson Torá'));
  ...
  */
  ...
  console.log(text.replace(/(O Centauro de Luvas)/g, function(capturaTotal, primeiraCapt){
    return primeiraCapt.toUpperCase();
  }));
  ...
  */
  ...
  var regexDate = /([0-9][0-9]) de (junho|julho) de (\d\d\d\d)/g ;
  ...
  */
  console.log( '\nReplace de datas:' );
  function replaceDate(all, day, month, year){
