(function() {
    ...
    */
    ...
    console.log(text.replace(/Manuel Marques de Sousa/g, 'Lorran Thierry David'));
    ...
    */
    ...
    console.log(text.replace(/brasileiro/g, 'jundiaiense'));
    ...
    */
    console.log( '\nReplace de datas:' );
    var replaceDate = function replaceDate(regex, $1, $2, $3) {
