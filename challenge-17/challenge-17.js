(function(){
  ...
  */
  ...
  Troque o nome "Manuel Marques de Sousa" pelo seu nome, e mostre o resultado no console:
  */
  console.log( 'Adicionando seu nome no texto:' );
  var nameFull = 'John Charles Mello'
  var nameReplace = /Manuel Marques de Sousa/g
  console.log( text.replace(nameReplace, nameFull) )

  /*
  Agora, substitua a palavra "brasileiro" por sua cidade natal e mostre no console.
  ...
  */
  ...
  /*
  Substitua todos os números por um traço `-`. Cada caractere de número deve ser um traço. Mostre o resultado no console:
  */
  console.log( '\nTrocando números por -:' );
  console.log( text.replace(/\d/g, '-' ) )

  /*
  Substitua todas as letras (somente letras) de "D" maiúsculo até "h" minúsculo por "0" (número zero). Mostre o resultado no console:
  */
  ...
  */
  ...
  //console.log( text.replace(/[A-a]/g, '4') ) não funciona nesse exercício, passa por todos os caracteres desde o 'A' até o 'a'
  console.log( text.replace(/a/gi, '4') )
  console.log( text.replace(/A|a/g, '4') )
  console.log( text.replace(/[Aa]/g, '4') )

  /*
  Substitua a frase "O Centauro de Luvas", deixando-a em caixa alta, usando o método `toUpperCase()`. Mostre o resultado no console:
  */
  console.log( '\n"O Centauro de Luvas" em caixa alta:' );
  console.log( text.replace( /O Centauro de Luvas/g, function(sentence){
  ...
  */
  ...
  comsole.log("O mês de março é representado pelo número " + getMonthNumber('março') + ".")
  comsole.log("O mês de setembro é representado pelo número " + getMonthNumber('setembro') + ".")
  comsole.log("O mês de dezembro é representado pelo número " + getMonthNumber('dezembro') + ".")
  /*
