(function() {
    ...
    */
    ...
    console.log(text.replace(/Manuel Marques de Sousa/, 'Ana Paula de Sousa'));
    ...
    */
    ...
    console.log(text.replace(/brasileiro/g, 'osasquence'));
    ...
    */
    ...
    //onsole.log(text.replace(/[Aa]/g, 4));
    ...
    */
    ...
    console.log('O mês de setembro é representado pelo número ' + getMonthNumber('fevereiro') + '.')
    console.log('O mês de dezembro é representado pelo número ' + getMonthNumber('outubro')+ '.');
