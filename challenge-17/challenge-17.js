(function(){
    ...
    */
    ...
    console.log(text.replace(/Manuel Marques de Souza/, 'Marcelo Herique de Souza e Silva'));
    /*
    ...
    */
    ...
    console.log(text.replace(/brasileiro/g, 'apiaense'));
    /*
    ...
    */
    ...
    console.log( text.replace( /O Centauro de Luvas/g, function(pharse){
