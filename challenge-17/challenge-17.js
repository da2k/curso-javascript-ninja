(function () {
  ...
  */
  ...
  console.log(text.replace(/Manuel Marques de Sousa/g, 'Camila Soares'));
  ...
  */
  ...
  console.log(text.replace(/brasileiro/g, 'meritiense'));
  ...
  */
  ...
  //primeiro parametro: todo o match, regex, segundo parametro apenas oq eu quero ex CENTAURO
  ...
  */
  ...
  console.log('O mês de march é representado pelo número ' + getMonthNumber('march') + '.');
  console.log('O mês de september é representado pelo número ' + getMonthNumber('september') + '.');
  console.log('O mês de december é representado pelo número ' + getMonthNumber('december') + '.');
