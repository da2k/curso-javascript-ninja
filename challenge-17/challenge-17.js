(function() {
  ...
  */
  ...
  console.log(
    text.replace(/Manuel Marques de Sousa/, "Leonardo Antonio de Deus")
  );
  ...
  */
  ...
  function getMonthNumber(mes) {
    var monthNumber;
    monthNumber = mes.replace(
      /(janeiro)|(fevereiro)|(março)|(marco)|(abril)|(maio)|(junho)|(julho)|(agosto)|(setembro)|(outrubro)|(novembro)|(dezembro)/gi,
      function(texto) {
  ...
  console.log("\nMeses representados por números: --versão correção--");
  function getMonthNumber(mes) {
    var meses = {
      janeiro: "01",
      fevereiro: "02",
