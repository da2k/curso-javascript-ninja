...
'use strict';
    ...
    */
    ...
    console.log(text.replace(/Manuel Marques de Sousa/, 'Matheus Lima Pinheiro' ));
    ...
    */
    ...
    console.log(text.replace(/brasileiro/,'estanciano'));
    ...
    */
    ...
    console.log(text.replace( /[D-H d-h]/g, 0 ));
    ...
    */
    ...
    })); //Se eu passar um grupo (), tenho que passar na função (regex, phrase). Sendo o 
        // primeiro toda a tegex sem o agrupamento. 
    ...
    */
    ...
    function getMonthNumber(months){
        switch(months){
            ...
            case 'dezembro':
                return '12';
            default: return 'Coloque um mês válido';    
        }
        return months;
    }
