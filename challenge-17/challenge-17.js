(function() {
 ...
 console.log(text.replace( /Manuel Marques de Sousa/, 'William de Oliveira Souza'));
  ...
  */
  ...
  console.log(text.replace(/brasileiro/, 'batateiro')); // São Bernardo do Campo ;)
  ...
  */
  ...
  var monthsToReplace = ['março', 'setembro', 'dezembro'];

  monthsToReplace.forEach(function( index ) {
    console.log( 'O mês de ' + index + ' é representado pelo número ' + getMonthNumber(index) + '.' );
  });
