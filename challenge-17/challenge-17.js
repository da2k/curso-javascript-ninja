(function () {
    ...
    */
    ...
    console.log(text.replace(/Manuel Marques de Sousa/, 'Vinicius Barbieri de Meneses'));
    ...
    */
    ...
    console.log(text.replace(/brasileiro/g, 'campineiro'));
    ...
    */
    ...
    console.log(text.replace(/(O Centauro de Luvas)/g, function (total, match) {
