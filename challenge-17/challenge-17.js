(function() {
    ...
    */
    ...
    var editedText= text.replace( /Manuel Marques de Sousa/, 'Charles Darwin' );
    ...
    */
    ...
    editedText = editedText.replace( /brasileiro/g, 'fluminense');
    console.log( editedText );
    /*
    ...
    */
    ...
    editedText = editedText.replace( /\d/g, '-' );
    console.log( editedText );
    /*
    ...
    */
    ...
    editedText = editedText.replace( /[D-Za-h]/g, 0 );
    console.log( editedText );
    /*
    ...
    */
    ...
    editedText = text.replace( /A/gi, 4 );
    console.log( editedText );
    /*
    ...
    */
    ...
    editedText = text.replace( /O Centauro de Luvas/g, function() {
    ...
    */
    console.log( '\nReplace de datas:' );
    editedText = text.replace( regexDate, function replaceDate() {
