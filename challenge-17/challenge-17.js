(function() {
  ...
  */
  ...
  console.log(text.replace( /Manuel Marques de Sousa/g, 'Felipe Rodolfo'));
  ...
  */
  ...
  console.log(text.replace( /brasileiro/g, 'paraibano'));
  ...
  */
  ...
  console.log(text.replace( /O Centauro de Luvas/g, function(item){ return item.toUpperCase()}));
