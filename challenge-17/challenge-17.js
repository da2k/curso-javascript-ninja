(function () {
  ...
  */
  ...
  console.log(text.replace(/Manuel Marques de Sousa/, 'Wellington Silva da Mota'));
  ...
  */
  ...
  console.log(text.replace(/brasileiro/, 'Guarujaense'));
  ...
  */
  ...
  console.log(text.replace(/A|a/g, 4)); // -> /a/gi
  ...
  */
  ...
  text.replace(/O Centauro de Luvas/g, phrase => {
