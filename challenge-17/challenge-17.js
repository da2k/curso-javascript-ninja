(function(){
    ...
    */
    ...
    console.log(text.replace(/Manuel Marques de Sousa/, function(){return 'Calleu Fuzi'}));
    ...
    */
    ...
    console.log(text.replace(/brasileiro/, function(){return 'teresopolitano'}));
    ...
    */
    ...
    console.log(text.replace(/\d/g, function(){return '-'}));
