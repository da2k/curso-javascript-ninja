(function () {
    ...
    */
    ...
    console.log(text.replace(/Manuel Marques de Sousa/g, 'Getúlio Magela Silva'));
    ...
    */
    ...
    console.log(text.replace(/brasileiro/g, 'jandirense'));
    ...
    */
    ...
    console.log('O mês setembro é representado pelo número ' + getMonthNumber('setembro') + '.');
    console.log('O mês dezembro é representado pelo número ' + getMonthNumber('dezembro') + '.');
