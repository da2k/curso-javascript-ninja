...
var replaceName = text.replace(/Manuel Marques de Sousa/, 'Leandro Leandrino');
...
var replaceCity = text.replace(/brasileiro/g, 'paulistano');
...
var replaceLetter = text.replace(/[D-Za-h]/g, '0');
...
var replaceA = text.replace(/a/gi, '4'); // ou /Aa/g
...
var replaceUppercase = text.replace(/O Centauro de Luvas/, function(e) {
...
var replaceDatas = text.replace(regexDate, replaceDate);
