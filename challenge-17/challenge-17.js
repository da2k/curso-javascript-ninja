(function () {
  ...
  */
  ...
  console.log(text.replace(/Manuel Marques de Sousa/gi, 'Natália Luiza da Silva'))
  ...
  */
  ...
  console.log(text.replace(/brasileiro/gi, 'olimpiense'))
  ...
  */
  ...
  // ?
  console.log(text.replace(/[A-Da-h]/g, '0'))
  ...
  */
  ...
  function getMonthNumber(nomeMes) {
    let numeroMes = '';
    switch (nomeMes) {
      case 'janeiro': numeroMes = '01';
        break;
      case 'fevereiro': numeroMes = '02';
        break;
      case 'março': numeroMes = '03'
        break;
      case 'abril': numeroMes = '04'
        break;
      case 'maio': numeroMes = '05'
        break;
      case 'junho': numeroMes = '06'
        break;
      case 'julho': numeroMes = '07'
        break;
      case 'agosto': numeroMes = '08'
        break;
      case 'setembro': numeroMes = '09'
        break;
      case 'outubro': numeroMes = '10'
        break;
      case 'novembro': numeroMes = '11'
        break;
      case 'dezembro': numeroMes = '12'
        break;
    }
    return numeroMes;
  }
