(function(){
  ...
  */
  ...
  console.log(text.replace(/Manuel Marques de Sousa/, "Rafael Aquino De Cerqueira"))
  ...
  */
  ...
  console.log(text.replace(/brasileiro/, "aracajuano"))
  ...
  */
  ...
  function getMonthNumber(namedMonth) {
    var months = {
      'março': '03',
      'junho': '06',
      'julho': '07',
