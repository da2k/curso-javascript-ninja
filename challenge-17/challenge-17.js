...
*/
  ...
  console.log(text.replace(/Manuel Marques de Sousa/g, "Leticia Monteiro"));
...
*/
  ...
  console.log(
    text.replace(/(O Centauro de Luvas)/g, function(regex, phrase) {
...
*/
  ...
  console.log(
    "O mês de marco é representado pelo número" + getMonthNumber("marco")
  );
  console.log(
    "O mês de setembro é representado pelo número" + getMonthNumber("setebrmo")
  );
  console.log(
