(function(){
	...
	*/
	...
	text = text.replace( /Manuel Marques de Sousa/g, 'Clara Verena Battesini' );
	console.log( text );
	...
	*/
	...
	text = text.replace( /brasileiro/g, 'soteropolitana' );
	console.log( text );
	...
	*/
	...
	console.log( text.replace( /(O Centauro de Luvas)/g, function(captura, frase){
	...
	*/
	...
	function getMonthNumber(mes){
		...
		var indice = meses.indexOf(mes) + 1;
		return indice 
	}
	...
	/*
	Agora, declare uma variável chamada `regexDate` que irá receber a expressão	regular que irá fazer o match com as datas. Crie grupos de captura para o dia, o mês e o ano. Para os meses, você pode fazer o match somente com os meses que estão no texto, não precisa adicionar todos. Com o que vimos até agora, você consegue fazer :D
