(function () {
    ...
    */
    ...
    var newText = text.replace(regex,'Lucas Ferreira dos Santos'); 
    console.log(newText);
    /*
    ...
    */
    ...
    // ?
    var regex = /brasileiro/;
    var newText = text.replace(regex,'Ribeirão Pirense');
    console.log(text.replace(regex,'Ribeirão Pirense'));
    /*
