(function() {
  ...
  */
  ...
  console.log(text.replace(/Manuel Marques de Sousa/, 'Matheus Mazeto'));
  ...
  */
  ...
  console.log(text.replace(/O Centauro de Luvas/g, function(caractere) {
  ...
  function getMonthNumber(month) {
    ...
    switch(month) {
      ...
      case 'Dezembro':
        ...
        break;
        default:
        result = 'Insira um mês válido';
    }
    return console.log(`O mês de ${month} é representado pelo número ${result}.`);
  }
  ...
  */
  ...
  let regexDate = /(\d\d) de (Julho|Junho) de (\d\d\d\d)/g;
