(function() {
  ...
  */
  ...
  console.log(text.replace(/Manuel Marques de Sousa/, 'André Rodrigues'));
  ...
  */
  ...
  console.log(text.replace(/brasileiro/, 'poços caldense'));
  ...
  */
  ...
  console.log(text.replace(/Centauro de Luvas/, function(match) {
  ...
  */
  ...
  var regexDate = /(\d\d) (de) (março|junho|julho|setembro|dezembro) (de) (\d\d\d\d)/g;
  ...
  */
  ...
  console.log(text.replace(regexDate, function(total, day, de1, month, de2, year) {
