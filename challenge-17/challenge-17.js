(function(){
    ...
    */
    ...
    console.log('Variavel text Original:', text);
    /*
    ...
    */
    ...
    console.log(text.replace(/Manuel Marques de Sousa/, 'Menandro Dias Evangelista Neto'));
    ...
    */
    ...
    console.log(text.replace(/brasileiro/, 'solteropolitano'));
