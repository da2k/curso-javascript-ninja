(function(){
	...
	*/
	...
	console.log(text.replace(/Manuel Marques de Sousa/g, 'Danilo Mello'));
	...
	*/
	...
	console.log(text.replace(/"O Centauro de Luvas"/g, function(capTotal){
	...
	*/
	...
	console.log('O mês de março é presentado pelo número '+getMonthNumber('março')+'.');
	console.log('O mês de setembro é presentado pelo número '+getMonthNumber('setembro')+'.');
	console.log('O mês de dezembro é presentado pelo número '+getMonthNumber('dezembro')+'.');
