( function(){
	...
	*/
	...
	console.log( text.replace( /Manuel Marques de Sousa/, 'Jorge Ramos') );
	...
	*/
	...
	console.log( text.replace( /[D-Ha-h]/g, 0 ) );
	...
	*/
	...
	console.log( text.replace( /O Centauro de Luvas/g, function( cap ){
