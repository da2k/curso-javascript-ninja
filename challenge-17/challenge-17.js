(function () {
    ...
    */
    ...
    var fabio = texto.replace(/Manuel Marques de Sousa/g, 'Fabio Pimenta');
    console.log(fabio);
    ...
    */
    ...
    console.log(fabio.replace(/brasileiro/g, 'londrinense'));
    ...
    */
    ...
    console.log(texto.replace(/[Aa]/g, '4'));
    ...
    */
    ...
    console.log(texto.replace(/(O Centauro de Luvas)/g, function (tot, match) {
    ...
    */
    ...
    function replaceDate() {
        var res = texto.match(regexDate);
        for (var i = 2; i < res.length; i += 3) {
            texto = texto.replace(res[i - 2] + ' ' + res[i - 1] + ' ' + res[i], res[i - 2].replace(' de', '') + '/' + getMonthNumber(res[i - 1]) + '/' + res[i].replace('de ', ''))
        }
        return texto;
    }
