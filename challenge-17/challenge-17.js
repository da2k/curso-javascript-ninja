(function(){
	...
	*/
	...
	console.log(text.replace(/Manuel Marques de Sousa/g, 'Iglan Cardeal'));
	...
	*/
	...
	console.log(text.replace(/O Centauro de Luvas/g, 'O Centauro de Luvas'.toUpperCase()));
	...
	*/
	...
	function getMonthNumber(letra1){
			return meses.indexOf(letra1) < 10 ? '"0' + meses.indexOf(letra1) + '"': '"' + meses.indexOf(letra1) + '"';
			}
	for(var i = 1; i<13;i++){
		console.log('O mês de ' + meses[i] + ' é representado peo numero ' + getMonthNumber(meses[i]));
	}
	...
	*/
	...
	var regexDate = text.match(/(\d\d\d\d)|(junho)|(julho)|(\d\d)/gi) 
	...
	*/
	console.log( '\nReplace de datas:' );
	console.log(text.match(/(13 de junho de 1804)|(18 de julho de 1875)/g));
	console.log(text.replace(/(13 de junho de 1804)|(18 de julho de 1875)/gi, function(capturaTotal, cap1, cap2){
			 	return '13/06/1804' , '18/07/1875';
	}));
