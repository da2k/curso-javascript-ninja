(function(){
  ...
  */
  ...
  console.log(text.replace(/Manuel Marques de Sousa/, 'Gilvan Ribeiro de Almeida'));
  ...
  */
  console.log( '\nReplace de datas:' );
  function replaceDate(regex, dia, nomeMes, ano) {
			return dia + '/' + getMonthNumber(nomeMes) + '/' + ano;
		}
