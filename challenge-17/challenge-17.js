(function(){
    ...
    */
    ...
    console.log( text.replace(/Manuel Marques de Sousa/, 'Heber Almeida') );
    ...
    */
    ...
    console.log( text.replace(/brasileiro/, 'sul-matogrossense') );
    ...
    */
    ...
    console.log( text.replace(/O Centauro de Luvas/g, function(param){
    ...
    */
    ...
    console.log( 'O mês de março é representado pelo número '.concat(getMonthNumber('março'),'.') );
    console.log( 'O mês de setembro é representado pelo número '.concat(getMonthNumber('setembro'),'.') );
    console.log( 'O mês de dezembro é representado pelo número '.concat(getMonthNumber('dezembro'),'.') );
