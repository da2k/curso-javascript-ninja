(function() {
  ...
  */
  ...
  console.log(
    text.replace(/Manuel Marques de Sousa/, "Ítalo Bruno Rodrigues Teixeira")
  );
  ...
  */
  ...
  console.log(text.replace(/brasileiro/, "redencionista"));
  ...
  */
  ...
  console.log(
    text.replace(/(O Centauro de Luvas)/, function(res1) {
      return res1.toUpperCase();
    })
  );
  ...
  */
  ...
  function replaceDate(str) {
    return str.replace(regexDate, function(fullMatch, match1, match2, match3) {
      return match1 + "/" + getMonthNumber(match2) + "/" + match3;
    });
  }
