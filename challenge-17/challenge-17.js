(function () {
    ...
    */
    ...
    console.log(text.replace(/Manuel Marques de Sousa/, 'Daniel Bastos'));
    /*
    ...
    */
    ...
    console.log(text.replace(/O Centauro de Luvas/, function (match) {
    ...
    */
    ...
    function replaceDate() {
        return text.replace( regexDate, function( match, day, month, year ) {
