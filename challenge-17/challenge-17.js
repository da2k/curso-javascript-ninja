(() => {
  ...
  */
  ...
  text.replace(/Manuel Marques de Sousa/g, "João Victor");
  ...
  */
  ...
  text.replace(/brasileiro/g, "Pindense");
  ...
  */
  ...
  console.log(text.replace(/O Centauro de Luvas/g, (frase) => {
  ...
  */
  ...
  console.log("O mês de março é representado pelo número " + monthName(
    "março"));
  console.log("O mês de setembro é representado pelo número " + monthName(
    "setembro"));
  console.log("O mês de dezembro é representado pelo número " + monthName(
    "dezembro"));
  /*
 ...
 */
  ...
  */
  console.log('\nReplace de datas:');
  var replaceDate = (regex, day, month, year) => {
