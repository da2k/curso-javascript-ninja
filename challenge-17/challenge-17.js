(function(){
	...
	*/
	...
	text = text.replace(/Manuel Marques de Sousa/, 'Heverton Castro');
	console.log(text);
	...
	*/
	...
	text = text.replace(/brasileiro/, 'altinopolense');
	console.log(text);
	...
	*/
	...
	text = text.replace(/(O Centauro de Luvas)/, function(total, match){
	...
	*/
	...
	function replaceDate(str){
		return str.replace(regexDate, function(total, day, month, year){
