(function(){
    ...
    */
    ...
    console.log(text.replace(/Manuel Marques de Sousa/, 'Emerson'));
    ...
    */
    ...
    console.log(text.replace(/[D-Hd-h]/gs, 0));
    ...
    */
    ...
    console.log(`O mês de março é representado pelo número ${getMonthNumber('march')}`);
    console.log(`O mês de setembro é representado pelo número ${getMonthNumber('september')}`);
    console.log(`O mês de dezembro é representado pelo número ${getMonthNumber('december')}`);
