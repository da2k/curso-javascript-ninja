(function() {
  ...
  */
  ...
  console.log(text.replace(/Manuel Marques de Sousa/g, 'Fellipe Capelli'));
  ...
  */
  ...
  console.log(text.replace(/O Centauro de Luvas/g, function(element) {
  ...
  */
  console.log( '\nReplace de datas:' );
  function replaceDate(regex, day, monthName, year) {
    return day + '/' + getMonthNumber(monthName) + '/' + year;
  }
