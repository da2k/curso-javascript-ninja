(function() {
  ...
  */
  ...
  console.log(text.replace(/Manuel Marques de Sousa/, 'Hugo Leonardo Penha de Sousa'));
  ...
  */
  ...
  console.log('O mês de setembo é representado pelo número ' + getMonthNumber('setembro'));
