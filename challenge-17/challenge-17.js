(function() {
  ...
  */
  ...
  console.log(text.replace(/Manuel Marques de Sousa/g, 'Bruno Yuri Jacinto'));
  ...
  */
  ...
  console.log(text.replace(/brasileiro/, 'orleanense'));
  ...
  */
  ...
  function getMonthNumber(nameOfMonth){
    var monthNumber = {
      'janeiro' : '01',
      'fevereiro' : '02',
      'março' : '03',
    ...
    return monthNumber[nameOfMonth];
  };
  ...
  */
  ...
  var regexDate = /(\d\d) de (janeiro|fevereiro|março|abril|maio|junho|julho|agosto|setembro|outubro|novembro|dezembro) de (\d\d\d\d)/g;
  ...
  */
  console.log( '\nReplace de datas:' );
  function replaceDate(dataToReplace){
    return dataToReplace.replace(regexDate, function (selecionados, g1, g2, g3){
      return g1 + '/' + getMonthNumber(g2) + '/' + g3;
    });
  }
