(function () {
  ...
  */
  ...
  console.log(text.replace(/Manuel Marques de Sousa/, 'William Pegler'));
  ...
  */
  ...
  console.log(text.replace(/O Centauro de Luvas/, function upperCase(match) { return match.toUpperCase() }));
  ...
  */
  ...
  var regexDate = /([0-3]\d) de (junho|julho) de ([012]\d\d\d)/gi
  ...
  console o resultado.
  */
  function replaceDate(totalMatches, dia, mes, ano) {
