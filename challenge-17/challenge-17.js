(function () {
  ...
  */
  ...
  console.log(text.replace(/Manuel Marques de Sousa/, 'Samuel Silva'));
  ...
  */
  ...
  console.log(text.replace(/O Centauro de Luvas/, function (result) {
  ...
  */
  ...
  function getMonthNumber(month) {
    if(!month) {
      console.error('É obrigatório passar o mês');
      return;
    }
    var numberMonth;
  ...
  */
  ...
  // 13 de junho de 1804
  var regexDate = /(\d\d) de (janeiro|fevereiro|março|abril|maio|junho|julho|agosto|setembro|outubro|novembro|dezembro) de (\d\d\d\d)/gi;
  ...
  */
  ...
  function replaceDate(text) {
    return text.replace(regexDate, function(result, day, month, year) {
