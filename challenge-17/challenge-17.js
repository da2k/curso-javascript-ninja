(function(){
	...
	*/
	...
	text.replace(/Manuel Marques de Sousa/g, 'Patrick Jung');
	...
	*/
	...
	console.log(text.replace(/brasileiro/g, 'curitibano'));
	...
	*/
	...
	console.log(text.replace(/(O Centauro de Luvas)/g, function(x){
	...
	*/
	...
	var getMonthNumber = function getMonthNumber(nomeMes){
		...
		console.log( 'O mês de ' +nomeMes +' é representado pelo número ' +numeroMes[nomeMes] +'.' );
		
		return numeroMes[nomeMes];
	...
	*/
	console.log( '\nReplace de datas:' );
	var replaceDate = function replaceDate(regex, dia, mes, ano){
