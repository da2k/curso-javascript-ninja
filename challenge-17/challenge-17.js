(function() {
  ...
  */
  ...
  console.log(text.replace(/Manuel Marques de Sousa/, 'Izanderson Florencio'))
  ...
  */
  ...
  console.log(text.replace(/brasileiro/, 'natalense'))
  ...
  */
  ...
  console.log(text.replace(/O Centauro de Luvas/, (param) => param.toUpperCase()))
  ...
  */
  ...
  const regexDate = /(\d\d) de (junho|julho) de (\d\d\d\d)/g
  ...
  */
  console.log( '\nReplace de datas:' );
  console.log(text.replace(regexDate, (phrase, day, month, year) => `${day}/${getMonthNumber(month)}/${year}`))
})();