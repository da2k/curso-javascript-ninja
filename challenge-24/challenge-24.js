(function (win, doc) {
  ...
  */
  ...
  function calculateAllvalues(accumulated, actual) {
    ...
    var lastOperator = getLastOparator(actual)
    return doOpertion(operator, firstValue, lastValue) + lastOperator;
  }

  function getLastOparator(value) {
    return isLastItemAnOperation(value) ? value.split('').pop() : '';
  }

  function doOpertion(operator, firstValue, lastValue,) {
    switch (operator) {
      case '+':
