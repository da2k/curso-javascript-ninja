...
desafio.
*/
var teams = ['Palmeiras', 'Corinthians', 'Santos', 'Sao paulo', 'Guarani'];
...
function showTeamPosition(number){
	...
	if (number < 1 || number > 5){
		return 'Não temos informação para o time nessa posição';
	}
...
*/
showTeamPosition(1);	// "O time que está em 1 lugar é o palmeiras."
showTeamPosition(2);	// "O time que está em 2 lugar é o corinthians."
showTeamPosition(3);	// "O time que está em 3 lugar é o santos."
showTeamPosition(4);	// "O time que está em 4 lugar é o sao paulo."
...
convertToHex('sky');  //"Não temos o equivalente hexadecimal para a cor sky ."
convertToHex('black'); //"Não temos o equivalente hexadecimal para a cor black ."
convertToHex('gray'); //"Não temos o equivalente hexadecimal para a cor gray ."
