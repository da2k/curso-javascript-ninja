...
desafio.
*/
var teams = ['Palmeiras', 'São Paulo', 'Santos', 'Bragantino', 'Corinthians']
...
/*Aqui eu acrescentei uma função para testar um array de cores com a função acima. Então 
foram testadas as 8 cores pedida no exercício 
*/
function testeDeCores (arrayDeCores){
     for (var cont = 0; cont < arrayDeCores.length; cont++){
          console.log(convertToHex(arrayDeCores[cont])) 
     }
      
}

var arrayDeCores = ['Red', 'Orange', 'Black', 'Green', 'Pink', 'Blue', 'Gold', 'Yellow']

testeDeCores(arrayDeCores)