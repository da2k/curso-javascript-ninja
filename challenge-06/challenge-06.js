...
desafio.
*/
var teams = ['Palmeiras', 'São Paulo', 'Corinthians', 'Santos', 'Bragatino'];
...
showTeamPosition(5) // "O time que está em 5º lugar é o Bragatino."
showTeamPosition(2) // "O time que está em 2º lugar é o Sao Paulo."
showTeamPosition(2) // "O time que está em 4º lugar é o Santos."
...
convertToHex('navy'); // Não temos o equivalente hexadecimal para navy.
