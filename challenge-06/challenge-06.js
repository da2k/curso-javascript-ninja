...
*/
var championship = 'Campeonato Pernambucano 2021';
...
desafio.
*/
var teams = ['Náutico', 'Santa Cruz', 'Sport', 'Ibis', 'Retrô']
...
function convertToHex (color) {
    var hex;
    switch (color){
        case 'preto': hexa = '#000000';                      
            break;
        case 'azul': hexa = '#0000FF';          
            break;
        case 'verde': hexa = '#008000';       
            break;
        case 'roxo': hexa = '#A020F0';           
            break;
        case 'rosa': hexa = '#FFC0CB';        
            break;
