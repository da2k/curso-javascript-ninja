...
var teams = ['Palmeiras', 'Santos', 'Corinthians', 'RB Brasil', 'São Paulo']
...
function showTeamPosition(index){// index = n° da posição do time.
...
function convertToHex(color){
    ...
    // Red , Blue, Green, White, Black -> Value in Hexa, exemplo.. #FF0000

    var hexadecimal; // Declarar uma variavel para os valores hexadecimais
