...
desafio.
*/
var teams = ['Corinthians', 'Palmeiras', 'São Paulo', 'Santos', 'Ituano'];
...
*/
showTeamPosition(2); // 'O time que está em 2 º lugar é o Palmeiras'
showTeamPosition(5); // 'O time que está em 5 º lugar é o Ituano'
showTeamPosition(1); // 'O time que está em 1 º lugar é o Corinthians'
showTeamPosition(3); // 'O time que está em 3 º lugar é o São Paulo'
