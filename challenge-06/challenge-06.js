...
desafio.
*/
var teams = ["goias","atletico", "anapolis", "vila nova", "jaragua"];
...
function showTeamPosition (posicao) {
	corrigiPosicao = posicao -1;
	if(corrigiPosicao>= 0 && corrigiPosicao < teams.length){
		return "O time que está em "+posicao+"º lugar é o "+teams[corrigiPosicao]+".";
	}else {
