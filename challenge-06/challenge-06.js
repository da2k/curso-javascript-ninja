...
desafio.
*/
var teams = ['Palmeiras', 'Flamengo', 'São Paulo', 'Fluminense', 'Santos'];
...
function showTeamPosition(pos) {
  if(pos > 5 || pos < 1) return 'Não temos a informação do time que está nessa posição.';
