...
desafio.
*/
var teams = ['São Paulo', 'Palmeiras', 'Corinthians', 'Santos', 'Flamengo']
...
function convertToHex (color) {
    ...
    break;
    case 'purple':
    console.log('O hexadecimal para a cor ' + color + ' é #551a8b.');
    break;
    case 'grey':
    console.log('O hexadecimal para a cor ' + color + ' é #d3d3d3.');
    break;
    default:
