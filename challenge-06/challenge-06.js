...
desafio.
*/
var teams = ['Palmeiras', 'Corinthians', 'São Paulo', 'Santos', 'Novorizontino'];
...
function showTeamPosition(position) {
    var message = 'Não temos a informação do time que está nessa posição.';
    var team = teams[position - 1];

    if(team) {
        message = 'O time que está em ' + position + 'º lugar é o ' + team + '.';
    }
