...
var teams = [ 'Bahia de Feira', 'Atlético (BA)', 'Bahia', 'Conquista', 'EC Vitória' ]
...
var showTeamPosition = function showTeamPosition(position){
    ...
    if(position > teams.length ){
        return `Não temos a informação do time que está nessa ${position}º posição.`;
    }

    return `O time que está em ${position}º lugar é "${teams[position - 1]}".`;
};
