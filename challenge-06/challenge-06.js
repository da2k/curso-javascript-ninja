...
desafio.
*/
var teams = [ 'Palmeiras', 'Santos', 'Flamengo', 'Ponte Preta', 'Vasco' ]
...
convertToHex('azul');     // O hexadecimal para a cor azul é #6495ED
convertToHex('vermelho'); // O hexadecimal para a cor vermelho é #FF0000
convertToHex('verde');    // O hexadecimal para a cor verde é #32CD32
