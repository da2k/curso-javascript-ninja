...
console.log(convertToHex("Tan")); // Não temos o equivalente hexadecimal para Tan
console.log(convertToHex("Chocolate")); // Não temos o equivalente hexadecimal para Chocolate
console.log(convertToHex("Sienna")); // Não temos o equivalente hexadecimal para Sienna
