...
desafio.
*/
let teams = ['INTZ', 'Flamengo', 'Santos', 'KaBuM', 'FURIA'];
...
*/
showTeamPosition(1); // INTZ
showTeamPosition(5); // FURIA
showTeamPosition(3); // Santos
