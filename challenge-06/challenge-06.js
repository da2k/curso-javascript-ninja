...
function convertToHex(cor) {
  switch (cor) {
    case 'white':
      console.log('O hexadecimal para a cor ' + cor + ' #ffffff');
      break;
    case 'silver':
      console.log('O hexadecimal para a cor ' + cor + ' #c0c0c0');
      break;
    case 'gray':
      console.log('O hexadecimal para a cor ' + cor + ' #808080');
      break;
    case 'black':
      console.log('O hexadecimal para a cor ' + cor + ' #000000');
    case 'blue':
      console.log('O hexadecimal para a cor ' + cor + ' #0000ff');
      break;
    case 'red':
      console.log('O hexadecimal para a cor ' + cor + ' #ff0000');
      break;
    case 'green':
      console.log('O hexadecimal para a cor ' + cor + ' #00ff00');
      break;
    case 'yellow':
      console.log('O hexadecimal para a cor ' + cor + ' #ffff00');
      break;
