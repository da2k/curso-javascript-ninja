...
*/
var championship = 'Campeonato Capixaba de 2017';
...
desafio.
*/
var teams = ['Atlético Itapemirim', 'Doze', 'Espírito Santo', 'Tupy', 'São Mateus'];
...
function convertToHex(corText) {
    ...
    switch (corText) {
        ...
        case 'azul':
            ...
            break;
        default:
            return 'Não temos o equivalente hexadecimal para ' + corText + '.';
    }
    return 'O hexadecimal para a cor ' + corText + ' é ' + corHexa + '.';
}
