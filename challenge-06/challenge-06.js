...
desafio.
*/
let teams = ['Bangu', 'Madureira', 'Volta Redonda', 'Resende', 'Macaé'];
...
function convertToHex(color){
  switch (color){
    ...
    case 'red':
      return `O hexadecimal para a cor ${color} é #ff5733.`;
      break;
    case 'green':
      return `O hexadecimal para a cor ${color} é #DAF7A6.`;
      break;
    case 'orange':
      return `O hexadecimal para a cor ${color} é #FFC300.`;
      break;
    case 'black':
