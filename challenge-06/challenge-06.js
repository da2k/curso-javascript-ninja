...
desafio.
*/
var teams = ['Santos', 'Palmeiras', 'Ponte Preta', 'Corinthians', 'São Paulo'];
...
function showTeamPosition(n) {
  return teams[n - 1] ? 'O time que está em ' + n + 'º lugar é o ' + teams[n - 1] + '.' : 'Não temos a informação do time que está nessa posição.';
}
