...
desafio.
*/
var teams = ['Santos', 'Palmeiras', 'São Paulo', 'Cruzeiro', 'Ponte Preta'];
...
function convertToHex( colorName ) {
  ...
  case 'preto':
    ...
    return 'O hexadecimal para a cor ' + colorName + ' é ' + hexadecimal + '.';
...
console.log( convertToHex( 'amarelo-escuro' ) );
