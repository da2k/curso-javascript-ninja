...
*/
var championship = 'campeonato sul matogrossense';
...
desafio.
*/
var teams = ['Bahia', 'Embugacu', 'Grande Campo Grande', 'Itu', 'Jaguare'];
...
function showTeamPosition(posicao) {
    ...
    return 'O time que está em ' + posicao + 'º lugar é o ' + teams[count] + '.';
}
