...
desafio.
*/
var teams = [ 'Flamengo', 'Vasco', 'Botafogo', 'Fluminense', 'Volta Redonda' ];
...
function convertToHex( cor ) {
	...
	switch( cor ) {
		...
		break;
		case 'Preta':
			corHexadecimal = '000000';
		break;
		case 'Rosa':
			corHexadecimal = 'FFC0CB';
		break;
		case 'Verde':
...
console.log( convertToHex( 'Roxa' ) );
console.log( convertToHex( 'Azul' ) );
console.log( convertToHex( 'Rosa' ) );
console.log( convertToHex( 'Castanha' ) );
