...
var teams = ['São Paulo', 'Curitina', 'Santos', 'Parmeira', 'Ponte Preta']
...
//    var hexaFrase = 'O hexadecimal para a cor ';
//    
//    switch(color){
//        case 'red':
//            return hexaFrase + color + ' é #ff0000';
//
//        case 'green':
//            return hexaFrase + color + ' é #00ff00';
//
//        case 'blue':
//            return hexaFrase + color + ' é #0000ff';
//
//        case 'yellow':
//            return hexaFrase + color + ' é #ffff00';
//
//        case 'cyan':
//            return hexaFrase + color + ' é #00ffff';
//
//        default:
...
function convertToHex(color) {
    var hexaPhrase = 'O hexadecimal para a cor ';
    var hexaPhraseDont = 'Não temos o equivalente hexadecimal para ';
    var hexadecimal;
    ...
    switch(color){
        ...
        default:
            return hexaPhraseDont + color + '.';
    }
    
    return hexaPhrase + color + ' é ' + hexadecimal + '.';
}
