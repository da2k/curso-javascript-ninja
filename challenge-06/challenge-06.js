...
desafio.
*/
var teams = ['Flamengo', 'Fluminense', 'Vasco', 'Botafogo', 'America'];
...
*/
showTeamPosition(1); // "O time que está em 2º lugar é o Fluminense."
showTeamPosition(7); // "Não temos a informação do time que está nesta posição."
showTeamPosition(2); // "O time que está em 3º lugar é o Vasco."
