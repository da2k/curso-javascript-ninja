...
console.log( 'Times que estão participando do campeonato:', teams ); // Times que estão participando do campeonato: Array(5) [ "Flamengo", "Vasco", "Fluminense", "Botafogo", "Bangu" ]
...
showTeamPosition(4); // "O time que está em 4º lugar é o Botafogo"
...
Crie uma função chamada `convertToHex`, com as seguintes características:
    ...
    algum hexa escolhido. 
	
	Se for, retorne a frase:
...
function convertToHex(color){
	var hexa;
	var tex = 'O hexadecimal para a cor ';
	switch(color){
		case 'red':
		hexa = '#FF0000';
		console.log(tex + color +  ' é ' + hexa);
		break;
...
convertToHex('blue');    // O hexadecimal para a cor blue é #0033CC 
convertToHex('green');   // O hexadecimal para a cor green é #009933
convertToHex('yellow');  // O hexadecimal para a cor yellow é #FFFF00
convertToHex('pink');    // O hexadecimal para a cor pink é #FF0066
...
convertToHex('magenta'); // Não temos o equivalente hexadecimal para: magenta
