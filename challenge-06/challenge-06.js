...
desafio.
*/
var teams = ['Corinthians', 'Santos', 'Palmeiras', 'São Paulo', 'Ponte Preta'];
...
function convertToHex(cor){
    switch(cor){
        ...
        case 'green': console.log(`O hexadecimal para a cor ${cor} é #008000.`); break;
        case 'black': console.log(`O hexadecimal para a cor ${cor} é #000000.`); break;
        case 'gold' : console.log(`O hexadecimal para a cor ${cor} é #FFD700.`); break;
