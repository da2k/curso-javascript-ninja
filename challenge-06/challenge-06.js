...
desafio.
*/
var teams = [ 'Paraná', 'JMalucelli', 'Coritiba', 'Atlético-PR', 'Londrina' ];
...
function convertToHex(color) {
  var hex;
  switch(color) {
    case 'red':    hex = '#e74c3c'; break;
    case 'green':  hex = '#1abc9c'; break;
    case 'blue':   hex = '#2980b9'; break;
    case 'yellow': hex = '#f1c40f'; break;
    case 'orange': hex = '#e67e22'; break;
    default:
