...
*/
var championship = "Campeonato Mineiro de Futebol Feminino"
...
desafio.
*/
var teams = [ 'Cruzeiro', 'América', 'Atlético Mineiro', 'Minas Boca', 'Ipatinga'];


console.log( 'Times que estão participando do campeonato:', teams ); // Esta virgula antes de teams e necessaria para a impressao do ARRAY;
...
console.log(convertToHex('musgo'))
