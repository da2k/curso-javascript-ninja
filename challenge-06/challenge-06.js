...
var teams = ['São Paulo', 'Flamengo', 'Vasco', 'Palmeira', 'Corithians']
...
function convertToHex(cor){
    var corHex;
    switch(cor){
        case 'Red': corHex = '#FF0000';
        break;
        case 'Yellow': corHex = '#FFFF00';
        break; 
        case 'Green': corHex = '#008000';
        break;
        case 'Blue': corHex = '#0000FF';
        break;
        case 'Gray': corHex = '#A9A9A9';
        break;
        default:
            return console.log('Não temos o equivalente hexadecimal para '+ cor +'.');
    }
    return console.log('O hexadecimal para a cor '+ cor +' é '+ corHex +'.');
}
