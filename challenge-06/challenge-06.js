...
*/
var championship = 'Campeonato carioca 2019'
...
function showTeamPosition(pos){
    ...
    return pos < 4 ? 'O time que está em '+pos+'º lugar é o '+teams[pos - 1]+'.' : 'Não temos a informação do time que está nessa posição.';
};
