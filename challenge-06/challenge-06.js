...
desafio.
*/
teams = ['Paysandu', 'Fluminense', 'Vasco', 'Corinthias', 'BOTA FOGO BOTA FOGO']
...
function showTeamPosition(number){
	...
	return `O time que está em ${number}º é o time ${teams[number - 1]}`
}
/*
...
console.log(convertToHex('lima-green'));
