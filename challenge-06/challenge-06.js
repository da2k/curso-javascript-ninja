...
function showTeamPosition(position){
    ...
    return position <= 0 || position > teams.length ? 'Não temos a informação do time que está nessa posição' :
        'O time que está na posição '+position+'º lugar é o '+teams[position-1]+'.';    
}
