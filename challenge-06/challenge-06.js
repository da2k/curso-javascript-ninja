...
desafio.
*/
var teams = ['Manchester United', 'Barcelona', 'Paris Saint Germain', 'Liverpool', 'Real Madrid'];
...
function convertToHex(color){
    ...
    switch(color){
        ...
        case 'white':
            ...
            break;
        default:
            return "We don't have the hexadecimal equivalent to " + color + ".";
              }
    return "The hexadecimal code to the color " + color + " is " + hexa + "." ;
}
