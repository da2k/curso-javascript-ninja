...
*/
var championship = "Campeonato Cearense De Futebol";
...
desafio.
*/
var teams = [ 'Ceará', 'Fortaleza', 'Icasa', 'Ferroviário', 'Guarani' ];
...
function showTeamPosition(position) {
  ...
  var frase = 'O time que está em ' + position + 'º' + ' é o ' + teams[position-1];
