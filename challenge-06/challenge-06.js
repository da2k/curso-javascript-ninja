...
desafio.
*/
var teams = ['Palmeiras', 'Santos', 'Flamengo', 'Atlético', 'Botafogo'];
...
function showTeamPosition(posicao){
    ...
    if(teams[posicaoArray]){
        return "O time que está em " + posicao + "º lugar é o " + teams[posicaoArray] + ".";
    }
...
function convertToHex(cor){
    ...
    return "O hexadecimal para a " + cor + " é " + hex + ".";
}
...
convertToHex("green"); // "O hexadecimal para a green é 00ff00."
