...
*/
var championship = 'Campeonato Carioca de Futebol';
...
desafio.
*/
var teams = ['América-RJ', 'Bonsucesso', 'Cabofriense', 'Goytacaz', 'Macaé'];
...
function showTeamPosition(position){
	if(position > 5)
	return 'Não temos a informação do time que está no ' + position + 'º lugar'
