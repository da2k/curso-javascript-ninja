...
showTeamPosition(2); // "O time que está em 1º lugar é o Santos." 
showTeamPosition(3); // "O time que está em 1º lugar é o Flamengo'."
...
function convertToHex(cor) {
    var whiteColor = '#FFFF', blackColor = '#000000', greenColor = '#008000', redColor = '#FF0000', blueColor  = '#0000FF';

    switch (cor) {
        case 'white':
            return 'O hexadecimal para a cor ' +cor+ ' é ' +whiteColor+ ' .';
            break;
        case 'black':
            return 'O hexadecimal para a cor ' +cor+ ' é ' +blackColor+ ' .';
            break;
        case 'green':
            return 'O hexadecimal para a cor ' +cor+ ' é ' +greenColor+ ' .';
            break;
        case 'red':
            return 'O hexadecimal para a cor ' +cor+ ' é ' +redColor+ ' .';
            break;
        case 'blue':
            return 'O hexadecimal para a cor ' +cor+ ' é ' +blueColor+ ' .';
            break;
        default:
...
convertToHex('white'); // "O hexadecimal para a cor white é #FFFF ."
