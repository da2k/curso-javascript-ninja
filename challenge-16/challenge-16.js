(function(){
  ...
  */
  var fullName     = 'anderson-nascimento'

  var newFullName = fullName.split('-').map(function( array ) {
  ...
  */
  ...
  var namesReduce = names.reduce(function( acumulado, atual, index ){
  ...
  */
  var name = 'Fernando';
  var subName = name.substring(8, 3);
