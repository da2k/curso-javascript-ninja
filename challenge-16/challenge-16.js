(function(){
	...
	*/
	...
	var fullName = 'isaac-bruno';
	var result = fullName.split('-').map(function(item, index){
	...
	*/
	...
	var phrase = names.reduce(function(acc, cur, index){
  ...
  console.log(phrase);
	...
	*/
	...
	var myName = 'RoBertO';
	var myNewName = myName.split('').map(function(item, index){
