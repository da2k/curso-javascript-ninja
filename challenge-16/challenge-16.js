...
var fullName = 'paulo-victor-da-silva-machado';
...
var friendes = ['Paulo', 'Marcos', 'Ana', 'Pedro', 'Maria'];
var phrase = friendes.reduce(function(acumulado, atual, index){
    var separator = friendes.length -1 === index ? ' e ' : ', ';
...
*/
console.log( '\nParte de uma string:' );
console.log('Fernado'.substring(8,3));
