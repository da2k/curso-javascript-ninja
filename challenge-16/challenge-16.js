(function() {
    ...
    */
    ...
    for(var x = 1; x <= name.length; x++) {
        console.log(name.charAt(x-1) + " é a " + x + "ª letra do meu nome.");
    }
    ...
    */
    console.log( '\nMeus amigos:' );
    var names = ["Marcus", "João", "Maria", "José", "Vinícius"];
    var reduce = names.reduce(function(acumulado, atual, index){
        var letraE = names.length - 1 === index ? " e " : ", ";
        return acumulado + letraE + atual;
