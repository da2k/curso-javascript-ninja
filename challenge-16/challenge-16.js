(function () {
  ...
  */
  ...
  var fullName = 'luan-vinicius-melo'
  ...
  */
  console.log( '\nMeus amigos:' );
  var friendsArray = ['João','Gaspar','Dráuzio','Maria','Mario']
  var frase = friendsArray.reduce(function(acumulado,atual,index){
    var separator = friendsArray.length - 1 === index ? ' e ' : ', ';
