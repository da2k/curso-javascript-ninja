(function() { 
    ...
    */
    console.log( '\nMeus amigos:' );
    var arr = ['Ana', 'Paula', 'Elaine', 'Rosa', 'Ingrid'];

    var reduce = arr.reduce(function(acumulado, atual, index) {
    ...
    */
    ...
    console.log(roberto.substring(0,6) + roberto.charAt(6).replace('o', 'a'));
