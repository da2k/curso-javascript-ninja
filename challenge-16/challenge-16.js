(function() {
  ...
  */
  ...
  var fullName = 'andre-dionisio';

  var arrFullName = fullName.split('-');

  var newFullName = arrFullName.map(function(item, index) {
  ...
  console.log('Nome no formato normal: ' + newFullName);
  ...
  */
  ...
  var friends = ['Felipe', 'Flavio', 'Rafael', 'Andreas', 'Joao'];

  var reducedFriends= friends.reduce(function(previous, current, index, array) {
