(function () {
  ...
  */
  console.log('\nMeus amigos:');
  var friends = ['Seiya', 'Shiryu', 'Ikki', 'Shun', 'Hyoga'];
  ...
  */
  ...
  for (var i = 0, len = myName.length; i < len; i++) {
    var lowerOrUppercase = i % 2 === 0 ? myName.charAt(i).toUpperCase() :
      myName.charAt(i).toLocaleLowerCase();
    myName2 += lowerOrUppercase;
  }
  console.log(myName2)
}());
