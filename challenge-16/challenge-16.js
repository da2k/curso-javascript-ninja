(function(){
	...
	*/
	...
	var fullName = 'wesley-xavier';
	var	fullName2 = fullName.split('-').map (function(item){
  ...
  var newName = name.reduce(function(acumulado, atual, index){
    return acumulado + (name.length-1===index?' e ':', ') + atual;
