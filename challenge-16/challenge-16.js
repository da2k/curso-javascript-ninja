(function() {
  ...
  */
  ...
  curso para fazer isso funciona corretamente :)
  ...
  */
  ...
  function joinFriends(names) {
    if (Array.isArray(names)) {
      var firstPart = names.slice(0, -1).join(', ')
      var lastPart = names.slice(-1);
  ...
  console.log(joinFriends(friends));
  ...
  */
  ...
  console.log(lowerUpperString(myName));
})()
