(function() {
  ...
  */
  ...
  for(var qtd = 0; qtd < name.length; qtd++ ) {
      console.log(name[qtd] + ' é a ' + (qtd + 1) + 'ª letra do meu nome' );
  }
  ...
  */
  ...
  var fullName = 'aduilio-soares-de-melo';
  ...
  */
  ...
  var amigos = arr.reduce(function(acumulado,atual,index) {
      var separator = arr.length - 1 === index ? ' e ' : ', ' ;
      return acumulado + separator + atual
  }).concat(' sao os meus amigos');
