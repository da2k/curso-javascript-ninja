...
(function () {
  ...
  for (var i = 0; i < name.length; i++)  {
    var indice = i + 1;
    console.log(name.charAt(i) + ' é a ' + indice + ' letra do meu nome');
  }
  ...
  var newFullName = arrName.map(function (item, index) {
  ...
  var arrAmigos = ['Sheridan', 'Lia', 'Perla', 'July', 'Roney'];
  ...
  console.log('\nParte de uma string:');
  var nando = 'Fernando';
  var newNando = nando.substring(8,3);

  console.log(newNando);
