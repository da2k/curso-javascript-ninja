(function(){
    ...
    */
    ...
    /*obs - o primeiro instrução do for, é verificado apenas uma vez, 
    por isso estamos declarando duas varíaveis na primeira instrução.
    */
    for (var i = 0, len = name.length; i < len; i++){
        var nameLetra = name.charAt(i)
        var letraPos = name.indexOf(nameLetra);
        console.log( nameLetra+ ' é a '+ (letraPos + 1) +'ª letra do meu nome.');
    }
    ...
    */
    ...
    var fullName = 'gustavo-martusewicz-da-silva';
