...
//     console.log(name.charAt(i) + ' é a ' + (i + 1) + 'ª letra do meu nome.');
  ...
  */
  ...
  var fullName = 'monica-craveiro-de-menezes';
  ...
  */
  console.log( '\nMeus amigos:' );
  var friends = ['Dauto', 'Danillo', 'Pachi', 'Proxy', 'Nathy'];
  var allFriends = friends.reduce(function (ac, item, index) {
    return ac + (friends.length -1 === index ? ' e ' : ', ') + item;
