(function () {
  ...
  */
  ...
  let fullName = "emerson-chaves-morais";
  ...
  */
  ...
  let namesFriends = ["Jose", "Maria", "Joao", "Jandira", "Jurandir"];

  let strFriends = namesFriends
    .reduce((acc, current, index) => {
      let separator = namesFriends.length - 1 === index ? " e " : ", ";
