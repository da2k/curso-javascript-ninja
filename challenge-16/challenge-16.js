(function() {
  ...
  */
  console.log( '\nMeus amigos:' );
  var friends = [ 'José', 'Ana', 'Fernanda', 'Caio', 'Julia' ];
  var friendsString = friends.slice( 0, -1 ).join( ', ' ) + ' e ' + friends[ friends.length - 1 ] + ' são meus amigos.';
  ...
  */
  ...
  var myName = 'Caio';
  console.log( myName.toUpperCase().split( '').map(function(letter, index) {
