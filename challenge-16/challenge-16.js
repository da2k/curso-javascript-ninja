...
(function(){
    ...
    */
    ...
    var name = 'Mellina';
    // var name_obj = new String(name);
    // for (var i = 0; i < name_obj.length; i++) {
    //     console.log( name_obj[i] + ' é a ' + (name_obj.indexOf(name_obj.charAt(i)) + 1) + 'ª letra do meu nome.');
    // }
    ...
    */
    ...
    var fullName = 'mellina-yogui-yonashiro';
    // function transformFullName( name ) {
    //     console.log( 'Formato slug: ' + name );
    //     var name = new String(name);
    //     var newName = name.split('-');
    //     for (var i = 0; i < newName.length; i++ ) {
    //         console.log(newName[i].charAt(0).toUpperCase() + newName[i].slice(1));
    //     }
    // }
    ...
    */
    console.log( '\nMeus amigos:' );
    var amigos = [ 'Maria', 'José', 'Thiago', 'Andressa', 'Caio', 'Joana' ];
