(function(){
    ...
    */
    ...
    arrName.forEach(function(letra, index) {
        index++;
    ...
    */
    ...
    var fullName = 'edson-pedroso';
    function converteNome(name){
        var arrName = name.split('-');
        var caixaAlta = arrName.map(function(value){
            return value[0].toUpperCase() + value.slice(1);
        });
        
        return caixaAlta.join(' ');
    }
    console.log(converteNome(fullName));
    ...
    */
    ...
    var newName = arrMyName.map(function(value, index){
        if(index % 2 === 0){
