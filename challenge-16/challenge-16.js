(function() {
    ...
    */
    ...
    while(count < nome.length){
      console.log(nome.charAt(count++),'é a '+ count +'ª letra do meu nome.');
    }
    ...
    */
    ...
    var fullName = 'bruno-yuri-jacinto';
    function slugToNormal(slug){
        return slug.split('-').map(function (item){
          return item[0].toUpperCase() + item.slice(1);
        }).join(' ');
    };

    console.log(fullName);
    console.log(slugToNormal(fullName));
