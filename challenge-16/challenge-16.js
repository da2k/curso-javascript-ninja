(function() {
  ...
  */
  ...
  for(let i = 0, len = name.length; i < len; i++){
    console.log(`${name.charAt(i)} é a ${i + 1}º do meu nome`)
  }
  ...
  */
  ...
  const fullName = 'natalia-luiza-da-silva'
  ...
  */
  ...
  const phrase = arrayNames.reduce((accumulator, atual, index) =>{
     let separator = friends.length - 1 === index ? ' e ' : ', ';
     return accumulator + separator + atual;
