(function () { 
    ...
    */
    ...
    var fullName = 'romario-de-carvalho-coimbra';
    ...
    */
    console.log( '\nMeus amigos:' );
    var nomes = ['Taco', 'Teco', 'Tico', 'Toco', 'Tuco'];
    var nomesFrase = nomes.reduce( function(acumulado, atual, index) {
        var separator = nomes.length - 1 === index ? ' e ' :', ';
        return acumulado +separator +atual;
    });
    console.log(nomesFrase);
