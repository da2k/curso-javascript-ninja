(function() {
    ...
    */
    ...
    var fullName = 'leonardo-maldonado';
    ...
    */
    ...
    var friends = ['Bruna', 'Ralf', 'Mia', 'Chico', 'Paulo', 'Tuany'];

    var newFriends = friends.reduce((acumulado, atual, index) => {
    ...
    */
    ...
    console.log(myNewName.toString());
