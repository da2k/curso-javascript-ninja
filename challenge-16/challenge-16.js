...
var fullName = 'amanda-almeida-matos';
...
*/
console.log( '\nMeus amigos:' );
var nomes = ['galadriel', 'arwen', 'gandalf', 'bilbo', 'aragorn']
var reduce = nomes.reduce(function(acumulado, atual, index) {
...
var myName = "Amanda";
var nomeDoido = myName.split("").map(function(item, index) {
  return index % 2 === 0 ? item.toUpperCase() : item.toLowerCase();
}).join("");
console.log(nomeDoido);
})()
