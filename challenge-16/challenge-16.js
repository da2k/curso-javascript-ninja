(function() {
    ...
    */
    ...
    for( var i = 0, qtd = name.length; i < qtd; i++ ) {
    ...
    */
    ...
    var names = ['Lele', 'Lala', 'Lili', 'Lolo', 'Lulu'];
    
    var reduce = names.reduce(function ( accumulatedValue, currentValue, index ) {
    ...
    */
    ...
    // console.log ( name2.slice( 'Fernando'.lastIndexOf('nando') ) );

    console.log ( name2.substring( 8, 3 ) );
