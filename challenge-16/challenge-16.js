(function(){
    ...
    */
    ...
    var fullName  = 'marcelo-henrique-de-souza-silva';
    ...
    */
    console.log( '\nMeus amigos:' );
    var myFriends = ['Victor', 'Vinicius', 'Onassis', 'Marcelo', 'Marcio'];
    var pharse = myFriends.reduce(function(acumulado, atual, index){
