(function(){
  ...
  */
  ...
  arrString.forEach( function( item, index ){
    console.log( item.toUpperCase() + ' é a ' + (index + 1) + ' letra do meu nome.' );
  });
  ...
  */
  ...
  var fullName = 'felipe-ricardo-silveira-abbud';
  ...
  */
  console.log( '\nMeus amigos:' );
  var names = ['Felipe', 'Sacha', 'Vando', 'Cluadia', 'Jack'];
  var newNames = names.reduce( function( acumulado, item, index ){
