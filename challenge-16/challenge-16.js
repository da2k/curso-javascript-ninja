(function(){
  ...
  */
  ...
  var fullName = 'diego-rodrigues';

  var name = fullName
    .charAt(0)
    .toUpperCase() + fullName.slice(1, 6)
    .replace('-', ' ')

  var lastname = fullName
    .charAt(6)
    .toUpperCase() + fullName.slice(7)
  ...
  */
  ...
  str = str.substring(0, lastIndex) + ' e' + str.substr(lastIndex + 1) + ' são meus amigos.';
