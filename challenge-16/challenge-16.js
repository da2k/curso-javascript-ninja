(function () {
    ...
    */
    ...
    var fullName = 'otto-freitas';
    var newFullName = fullName.split('-');
    newFullName = newFullName.map(function (item) {
    ...
    */
    console.log('\nMeus amigos:');
    var names = ['João', 'Maria', 'José', 'Judith', 'Glaucio'];
    var result = names.reduce(function (acumulado, atual,index) {
