(function() {
  ...
  */
  console.log( '\nMeus amigos:' );
  var friends = ['Marcos', 'Lucas', 'João', 'Diogo', 'Gabriel'];
  
  var strFriends = friends.reduce(function(accumu, actu, index) {
    var separator = friends.length -1 === index ? ' e ' : ', ';
    
    return accumu + separator + actu;
  ...
  */
  ...
  for(var i = 0, leng = myName.length; i < leng; i++) {
