(function() {
  ...
  */
  ...
  const fullName = 'mauricio-mutte';
  let fullNameNormal = fullName.split('-').map(function(name) {
  ...
  */
  console.log( '\nMeus amigos:' );
  const friends = ['Carol', 'Gabi', 'Julia', 'Dudu', 'Marcos'];
  const phrase = friends.reduce(function(acumulado, item, index) {
    const separator = friends.length - 1 === index ? ' e ' : ', ';
  ...
  */
  ...
  console.log(nando.substring(8,3));
