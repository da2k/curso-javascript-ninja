(function() {
    ...
    */
    ...
    var fullName = 'rafael-bernardo-dos-santos-silva';
    ...
    */
    ...
    friends = friends.map(function( item, index, array ) {
    ...
    */
    console.log( '\nParte de uma string:' );
    console.log( "Fernando".slice( "Fernando".lastIndexOf( 'na' ) ) );
    ...
    */
    ...
    myName = myName.split('').map(function( item, index, array ) {
