(function(){
    ...
    */
    ...
    for (var index = 0; index < nome.length; index++) {
        ...
        console.log(nome[index] + ' é a '+ (index+1) +'ª  letra do meu nome.');
    }
    ...
    */
    console.log( '\nMeus amigos:' );
    var nomes = ['Calleu', 'Iuna', 'Marcelo', 'Pedro', 'Julia'];
    ...
    */
    ...
    for (var index = 0; index < myName.length; index++) {
            newName.push(index % 2 === 0? myName[index].toUpperCase():myName[index].toLowerCase());
    }
