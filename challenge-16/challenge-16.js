(function() {
    ...
    */
    ...
    var fullName = 'lucas-rafael-ricci';
    var newFullName;
    ...
    console.log('Full name in slug format: ', fullName);
    console.log('Full name in upper case and with space: ', newFullName );
    ...
    */
    console.log( '\nMeus amigos:' );
    var friends = ['Lucas', 'Miriã', 'Cacau', 'Caju', 'Sonia'];
    var phrase = friends.reduce(function(acumulado, item, index) {
