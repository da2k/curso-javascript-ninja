(function() {
  ...
  */
  ...
  let fullName = 'raphael-anjos';
  let slugName = fullName.split('-').map((item) => {
  ...
  */
  ...
  let finalResult = friends.reduce((acum, atual, index) => {
    let endpoint = friends.length - 1 === index ? ' e' : ','
    return `${acum}${endpoint} ${atual}`;
