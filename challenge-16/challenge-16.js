(function(){
    ...
    */
    ...
    var fullName = 'victor-costa-de-carli';
    ...
    */
    console.log( '\nMeus amigos:' );
    var arrFriends = ['Maria', 'Jose', 'Marcos', 'Poliane', 'Isabela'];
    var phrase = arrFriends.reduce( function(acomulado, atual, index) {
        var separador = arrFriends.length - 1 === index ? ' e ' : ', ';
