...
'use strict';
/* Envolva todo o conteúdo desse desafio em uma IIFE.
...
var fullName = 'joao-da-silva-santos-menezes-maranhao-macedo-souza-junior';

var newFull = fullName.split('-').map(function (name){
