(function(){
    ...
    */
    ...
    CPFs.forEach(function(value, index, array){
        array[index] = cleanCPF(value);
    ...
    */
    ...
    CPFs.forEach(function(value, index, array){
        array[index] = cleanCPF(value).replace(regexCPF, formatCPF);
        console.log(array[index]);
    })
    ...
    */
    ...
    console.log('<div><ul><li></li><li></li><li><span></span></li></ul></div>'.match(/<\w+>\s*<\/\w+>/g));
    ...
    */
    ...
    var regExHTML = /(<\w+>)([A-Za-zÁãáàÉéÍíÓóÚú\s]+)(<\/\w+>)/g;

    function formatRegEx(regEX, a, b, c){
        return a + 'O texto dentro da tag "' + a.match(/[^<>/]/g).join('') + '" é "' + b + '"'+ c + '\n';
    }
    console.log('<h1>Título da página</h1><p>Este é um parágrafo</p><footer>Rodapé</footer>'.replace(regExHTML, formatRegEx));
})();