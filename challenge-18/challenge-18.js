...
function cleanCPF(cpf){
  ...
  // /\D/g, '' - substitui tudo o que não é número por espaço em branco
}
...
function correctCPF ( cpf ) {
     ...
     // /(\d{3})(\d{3})(\d{3})(\d{2})/ -> mostra o grupo de sequencias de números
     // '$1.$2.$3-$4' -> como será dividido as sequências
    };
