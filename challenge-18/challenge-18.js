(function () {
  ...
  */
  ...
  var arrCpfs = ['049-214 3421-1', '210.458.522-05', '735 500 794 - 22', '0101.123-131x32'];
  arrCpfs.forEach(function (item) {
  ...
  */
  ...
  arrCpfs.forEach(function (arrCpf) {
    console.log(cleanCPF(arrCpf).replace(/(\d{3})(\d{3})(\d{3})(\d{2})/, '$1.$2.$3-$4'));
  });
