(function(){
	...
	*/
	...
	var htmlData = "<div><section><blockquote>Texto <img /></blockquote></section></div>";
	console.log( htmlData.match(/<\w+>/g) );
	...
	*/
	...
	var htmlData2 = "<div><ul><li></li><li></li><li><span></span></li></ul></div>";
	console.log( htmlData2.match(/<\w+><\/\w+>/g) );
	...
	*/
	...
	var htmlData3 = "<h1>Título da página</h1><p>Este é um parágrafo</p><footer>Rodapé</footer>";
	console.log( htmlData3.replace(/<(\w+)>([^<>]+)<\/(\w+)>/g, '<$1>O texto dentro da tag "$1" é "$2"</$3>\n') );
