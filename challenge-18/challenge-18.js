(function() {
    ...
    */
    ...
    for (var j = 0; j < newCpf.length; j++) {
        console.log(newCpf[j].replace(/(\d{3})(\d{3})(\d{3})(\d{2})/, '$1.$2.$3-$4'));
    }
    ...
    */
    ...
    console.log(('\nMatch com as palavras "junho" ou "julho" para a frase "Os meses de janeiro, junho e julho começam com a letra j.":').match(/ju[nl]ho/g));
    ...
    */
    ...
    var tag1 = '<div><ul><li></li><li></li><li><span></span></li></ul></div>';
    console.log(tag1.match(/(<)\w+(>)(<\/)\w+(>)/g));
    ...
    */
    ...
    var allText = '<h1>Título da página</h1><p>Este é um parágrafo</p><footer>Rodapé</footer>';
    console.log(allText.replace(/<(\w+)>([^<]+)<\/\w+>/g), '<$1>O texto dentro da tag "$1" é "$2"<$1>\n');
})();
