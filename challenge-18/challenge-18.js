...
var regexText = /(\<\w+\>)(.+?)(\<\/\w+\>)/g;
console.log(text.replace(regexText, replaceText));

function replaceText(regex, openTag, value, closeTag) {
    return openTag + "O texto dentro da tag '" + openTag + "' é " + value + closeTag + "\n";
}
