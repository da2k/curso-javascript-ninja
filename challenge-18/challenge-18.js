(function(){
	...
	*/
	...
	function creanCPF(CPF){

		return CPF.replace(/\D+/g,'');
	}
	console.log(creanCPF('049-214 3421-1'));
	console.log(creanCPF('210.458.522-05'));
	console.log(creanCPF('735 500 794 - 22'));
	console.log(creanCPF('101.123-131x32'));
	...
	*/
	...
	console.log(creanCPF('049-214 3421-1').replace(/(\d{3})(\d{3})(\d{3})(\d{2})/,'$1.$2.$3-$4'));
	console.log(creanCPF('210.458.522-05').replace(/(\d{3})(\d{3})(\d{3})(\d{2})/,function(regex,value1,value2,value3,value4){
		return value1+'.'+value2+'.'+value3+'-'+value4;
	}));
	console.log(creanCPF('735 500 794 - 22').replace(/(\d{3})(\d{3})(\d{3})(\d{2})/,function(regex,value1,value2,value3,value4){
		return value1+'.'+value2+'.'+value3+'-'+value4;
	}));
	console.log(creanCPF('101.123-131x32').replace(/(\d{3})(\d{3})(\d{3})(\d{2})/,function(regex,value1,value2,value3,value4){
		return value1+'.'+value2+'.'+value3+'-'+value4;
	}));
