...
(function () {
    ...
    */
    ...
    // também é possível utilizando o callback:
    console.log('\n' + cleanCPF("101.123-131x32").replace(/^(\d{3})(\d{3})(\d{3})(\d{2})/,
        function (regex, ...args) {
    ...
    */
    ...
    var iTag = "<div><section><blockquote>Texto <img /></blockquote></section></div>"
    console.log(iTag.match(/<\w+>/g));
    ...
    */
    ...
    // console.log(html.match(/<\w+>[\w\sáéí]+<\/\w+>/g));
    console.log(html.replace(/(<(\w+)>)([^<]+)(<\/\w+>)/g,"$1O texto que está dentro da tag \"$2\" é \"$3\"$4\n"))
