;(function () {
  ...
  */
  ...
  console.log( phrase.match( /j...o/g ) );
  // regex Daciuk: /ju[nl]ho/g
  ...
  */
  ...
  console.log( tag.match( /<\w{1,}>/g ) );
  // Regex Daciuk: console.log(tag.match(/<\w+>/g));
  ...
  */
  ...
  console.log( tags.match( /(<\w{1,}><\/\w{1,}>)/g ) );
  // Regex Daciuk: console.log(tags.match(/<\w+><\/\w+>/g));
  ...
  */
  ...
  console.log(
    ...
    .replace(
      ...
      //ou '<$1>O texto dentro da tag "$1" é "$2"$4\n'
    )
  );
  */
})();
