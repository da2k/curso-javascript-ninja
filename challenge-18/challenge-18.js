...
cpfs.map(function(item){
        var cpf = cleanCPF(item);
            return cpf.replace(/(\d\d\d)(\d\d\d)(\d\d\d)(\d\d)/, '$1.$2.$3-$4')
})
/* ["049.214.342-11", 
    "210.458.522-05", 
    "735.500.794-22", 
...
console.log('Os meses de janeiro, junho e julho começam com a letra j.'.match(/ju(n|l)ho/gi);

// Match com as palavras "junho" ou "julho" para a frase "Os meses de janeiro, junho e julho começam com a letra j.": ["junho", "julho"]
...
var txt = '<div><section><blockquote>Texto <img /></blockquote></section></div>'
text.match(/<\w+>/gi);
//
...
var textHtml = '<div><ul><li></li><li></li><span></span></li></ul></div>';
textHtml.match(/<\w+><\/\w+>/gi);
// ["<li></li>", "<li></li>", "<span></span>"]
