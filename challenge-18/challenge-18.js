(function () {
  ...
  */
  ...
  cpfs.map(function (index, elem) {
    console.log(cleanCPF(index));
  });
  ...
  */
  ...
  cpfs.map(function (index, elem) {
    console.log(cleanCPF(index).replace(/(\d{3})(\d{3})(\d{3})(\d{2})/, '$1.$2.$3-$4'));
  });
  ...
  */
  ...
  console.log(
        '<h1>Título da página</h1><p>Este é um parágrafo</p><footer>Rodapé</footer>'
                .replace(/(<(\w+)>)([\wíé\sá]+)(<\/\w+>)/g, '$1O texto dentro da tag $2 é $3$4\n')
  );
})();
