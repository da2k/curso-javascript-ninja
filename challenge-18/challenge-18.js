(function(){
	...
	*/
	...
	var replaceTags = '<h1>Título da página</h1><p>Este é um parágrafo</p><footer>Rodapé</footer>'.replace(/(<(\w*)>)([\w\sÀ-ú]*)(<\/\w*>)/g, 
		function(acumulado, captura1, captura2, captura3, captura4){

		return captura1 + 'O texto dentro da tag \"' + captura2 + '\" é \"'+ captura3 +'\"' + captura4 + '\n';
	})
