(function(){
  ...
  */
  ...
  - "101.123-131x32"
  */
  var cpfs = ['210.458.522-05', '735 500 794 - 22', '049-214 3421-1', '101.123-131x32'];

  console.log( 'Limpando CPFs:' );
  function cleanCPF(cpf){
    return cpf.replace(/\D/g, '');
  }
  var cpfs_limpos = cpfs.map(function(item){
  ...
  */
  ...
  function formatarCPF(match, g1, g2, g3, g4 ){
    return g1 + '.' + g2 + '.' + g3 + '-' + g4;
  }

  cpfs_limpos.forEach(function (item){
    console.log( cleanCPF( item ).replace(regexCPF, formatarCPF) );
  });
