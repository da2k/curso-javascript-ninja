;(function() {
    ...
    */
    ...
    '<h1>Título da página</h1><p>Este é um parágrafo</p><footer>Rodapé</footer>'.replace(/(<\w+>)([^<]+)(<\/\w+>)/g, function(regex,openTag,value,closeTag) {

        var formatedTag = openTag.replace( /<|>/g, '');
        console.log(openTag + 'O texto dentro da tag "' + formatedTag + '" é "' + value + '"' + closeTag);
    });
