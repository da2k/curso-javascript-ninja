(function() {
  'use strict';
    ...
    */
    ...
    var cleanCPF = (function(item){
       return item.replace(/\D/g, '');
    });

    var resultsCPFs = CPFS.map(cleanCPF).join(' \n');

    console.log(resultsCPFs);
    ...
    */
    ...
    var regexFormated = /(\d{3})(\d{3})(\d{3})(\d{2})/g;

    function formatedCPF(regex,g1,g2,g3,g4){
    	return g1 + '.' + g2 + '.' + g3 + '-' + g4;
    }

    console.log(resultsCPFs.replace(regexFormated, formatedCPF));
