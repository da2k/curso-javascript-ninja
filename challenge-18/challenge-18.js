(function(){
  ...
  */
  ...
  cpfs.forEach( function( cpf, index ){
    newCpfs.push( cleanCPF(cpf) );
    console.log( newCpfs[index].toString() );
  });
  ...
  */
  ...
  var month = 'Os meses de janeiro, junho e julho começam com a letra j.';
  console.log( month.match(regexMonth));
  /*
  ...
  */
  ...
  console.log( tag.match(regexTag) );
  ...
  */
  ...
  console.log( tag2.match(regexTag2) );
