(function(){
    ...
    */
    ...
    console.log(`${CPFs.map(function(cpf){return cleanCPF(cpf).replace(/(\d{3})(\d{3})(\d{3})(\d{2})/g, '$1.$2.$3-$4')})}`);
    ...
    */
    ...
    console.log(frase, frase.match(/ju+\w{3}/g));
    ...
    */
    ...
    var outraTag = "<div><ul><li></li><li></li><li><span></span></li></ul></div>";
    console.log(outraTag.match(/(<\w+>)(<\/\w+>)/g));
    ...
    */
    ...
    var ultimatag = "<h1>Título da página</h1><p>Este é um parágrafo</p><footer>Rodapé</footer>";
    console.log(ultimatag.replace(/<(\w+)>([^<]+)<\/\w+>/g, function(regex, $1, $2){
        return `<${$1}>O texto dentro da tag ${$1} é ${$2}</${$1}>`;
    }));
})();