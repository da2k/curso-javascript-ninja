(function(){
    ...
    */
    ...
    function correctCPF(cleanCPF) {
        var regex = /(\d{3})(\d{3})(\d{3})(\d{2})/g
        return cleanCPF.replace(regex, function(regex, group1, group2, group3, group4) {
    ...
    console.log(correctCPF(cleanCPF("049-214 3421-1")))
    console.log(correctCPF(cleanCPF("210.458.522-05")))
    console.log(correctCPF(cleanCPF("735 500 794 - 22")))
    console.log(correctCPF(cleanCPF("101.123-131x32")))
