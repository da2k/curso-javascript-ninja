...
(function(){
	...
	*/
	...
	var lCpf = ["049-214 3421-1", "210.458.522-05", "735 500 794 - 22", "101.123-131x32"];
	lCpf.forEach(function(cpf){
	...
	*/
	...
	console.log("<h1>Título da página</h1><p>Este é um parágrafo</p><footer>Rodapé</footer>".replace(/<(\w+)>([^<]+)<\/\w+>/g,'<$1>O texto dentro da tag "$1" é "$2" \n'));
}())
