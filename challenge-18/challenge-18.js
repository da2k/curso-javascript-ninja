(function(){
    ...
    */
    ...
    cpfs.forEach(function(cpf){
        console.log(cleanCPF(cpf).replace(/(\d{3})(\d{3})(\d{3})(\d{2})/g,function(regex,cap1,cap2,cap3,cap4){
    ...
    */
    ...
    var regex2 = /<\w+>/g;
    console.log('<div><section><blockquote>Texto <img /></blockquote></section></div>'.match(regex2));
    ...
    */
    ...
    var regex3 = /<\w+><\/\w+>/g;
    console.log('<div><ul><li></li><li></li><li><span></span></li></ul></div>'.match(regex3));
    /*
