(function() {
    ...
    */
    ...
    console.log('<div><section><blockquote>Texto <img /></blockquote_></section></div>'.match(/<\w+>/g))
    ...
    */
    ...
    console.log('<h1>Título da página</h1><p>Este é um parágrafo</p><footer>Rodapé</footer>'.replace(/<(\w+)>([^<>]+)(<\/\w+>)/g, function(total, $1, $2, $3) {
        return '<' + $1 + '>O texto dentro da tag "' + $1 + '" é "'+ $2 +'"' + $3 + '\n';
    }));
})();