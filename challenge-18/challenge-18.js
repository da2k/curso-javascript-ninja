(function(){
  ...
  */
  ...
  function formatCpf( cpf ) {
    return cleanCPF( cpf ).replace( /([\d]{3})([\d]{3})([\d]{3})([\d]{2})/g , function( regex, f1, f2, f3, f4 ) {
      return f1 + '.' + f2 + '.' + f3 + '-' + f4;
    });
  }
  ...
  */
  ...
  var resultMatch = frase.match(/(ju)(\w+)/gi);
  ...
  */
  ...
  var marquee = "<div><section><blockquote>Texto <img /></blockquote></section></div>";
  var resultMatch = marquee.match(/(<\w+>)/g);
  console.log( resultMatch );
  ...
  */
  ...
  var marquee = "<div><ul><li></li><li></li><li><span></span></li></ul></div>";
  var resultMatch = marquee.match(/(<\w+><\/\w+>)/g);
  console.log( resultMatch );
  ...
  */
  ...
  var marquee = "<h1>Título da página</h1><p>Este é um parágrafo</p><footer>Rodapé</footer>";
  var resultMatch = marquee.replace(
    /(<\w+>)([^<]+)(<\/\w+>)/g,
