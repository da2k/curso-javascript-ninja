(function() {
    ...
    */
    ...
    console.log(cpf1.replace(/(\d{3})(\d{3})(\d{3})(\d{2})/, '$1.$2.$3-$4'));
    console.log(cpf2.replace(/(\d{3})(\d{3})(\d{3})(\d{2})/, '$1.$2.$3-$4'));
    console.log(cpf3.replace(/(\d{3})(\d{3})(\d{3})(\d{2})/, '$1.$2.$3-$4'));
    console.log(cpf4.replace(/(\d{3})(\d{3})(\d{3})(\d{2})/, '$1.$2.$3-$4'));
    ...
    */
    ...
    var frase = '<h1>Título da página</h1><p>Este é um parágrafo</p><footer>Rodapé</footer>';
    console.log(frase.replace(/(\<)(\w+)(\>)([^<]+)(\<\/\w+\>)/g, '$1$2$3O texto dentro da tag "$2" é "$4"$5\n'));
})();