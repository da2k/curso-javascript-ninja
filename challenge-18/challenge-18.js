...
console.log('Os meses de janeiro, junho e julho começam com a letra j. ' + texto.match(/ju[ln]ho/g));
...
var texto1 = '<div><section><blockquote>Texto <img /></blockquote></section></div>';
...
var texto2 = '<div><ul><li></li><li></li><li><span></span></li></ul></div>';
...
var texto3 = '<h1>Título da página</h1><p>Este é um parágrafo</p><footer>Rodapé</footer>';





console.log( texto3.replace(/<(\w+)>([^<]+)<\/\w+>/g,function(regex,tag,texto){
	return '<' + tag + '> O texto dentro da tag '+ tag + ' é ' + texto + ' </' + tag + '>\n';
