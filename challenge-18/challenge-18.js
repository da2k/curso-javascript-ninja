(function(){
    ...
    */
    ...
    function formatCPF( cpf ) {
        return cpf.replace(/\d\d\d|\d\d/g, function( regex,cap1, cap2, cap3 ){
            return regex.length === 3 ?  '.' + regex  : '-' + regex;
        }).replace(/./,'');
    };
    ...
    */
    ...
    console.log( tags.replace(/(<\w+>)([\w\u00C0-\u00FF\s]+)(<\/\w+>)/g, function(regex, key, value1, value2){
        return 'O texto dentro da tag "' + key + '" é "' +  value1 + '" ' + value2 + '\n' ;
    }) );
}());