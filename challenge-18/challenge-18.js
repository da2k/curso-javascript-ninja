(function(){
    ...
    */
    ...
    function replaceCpf(regex, parte1, parte2, parte3, parte4){
        return parte1 + '.' + parte2 + '.' + parte3 + '-' + parte4 ;
    }

    console.log( cpf1.replace( regex , replaceCpf ) );
    console.log( cpf2.replace( regex , replaceCpf ) );
    console.log( cpf3.replace( regex , replaceCpf ) );
    console.log( cpf4.replace( regex , replaceCpf ) );
    ...
    */
    ...
    var text = 'Os meses de janeiro, junho e julho começam com a letra j.',
        regexMonths = /(ju\w+)/g,
        itMatches = text.match(regexMonths); 
    console.log( itMatches ? itMatches : null);
    ...
    */
    ...
    var tags = '<div><section><blockquote>Texto <img /></blockquote></section></div>',
        matchTags = /(<\w+>)/g;
    console.log( tags.match(matchTags) );
    ...
    */
    ...
    var otherTags = '<div><ul><li></li><li></li><li><span></span></li></ul></div>';
    var regexTags = /<\w+><\/\w+>/g
    console.log( otherTags.match(regexTags) );
    ...
    */
    ...
    var regexNewTags = /<(\w+)>([^<]+)<\/\w+>/g
    console.log( htmlText.replace(regexNewTags, '<$1>O texto dentro da tag "$1" é "$2"</$1>\n') );
