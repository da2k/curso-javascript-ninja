(function() {
    ...
    */
    ...
    /* minha primeira solução, que não deu muito certo
    function cpfFormat(cpfLimpo){
        var cpfFormatado = cpfLimpo.replace(/(\d{1,3})/g,'$1.');
        return cpfFormatado;
    }
    console.log( cpfFormat('04921434211') );*/
    /* segunda solução
    cpfs.forEach( function(cpf) {
    ...
    */
    ...
    console.log( 'Os meses de janeiro, junho e julho começam com a letra j.'.match(
        /*/junho|julho/g -primeira solução*/
        /ju[n|l]ho/g
        ) );
    ...
    */
    ...
    console.log( '<h1>Título da página</h1><p>Este é um parágrafo</p><footer>Rodapé</footer>'.replace( /(<(\w+)>)([^<]+)(<\/\w+>)/g,'$1O texto dentro da tag "$3" é "$3"$4\n'));
})();
