(function() {
    ...
    */
    ...
    var marc = '<div><ul><li></li><li></li><li><span></span></li></ul></div>';
    console.log( marc.match( /<\w+><\/\w+>/g ) );
    ...
    */
    ...
    var marc = '<h1>Título da página</h1><p>Este é um parágrafo</p><footer>Rodapé</footer>';
    console.log( marc.replace( /<(\w+)>([^<]+)<\/\w+>/g,
