(function() {
    ...
    */
    ...
    var regex2 = /<\w+>/g;
    var markup1 = '<div><section><blockquote>Texto <img /></blockquote></section></div>';
    console.log( markup1.match(regex2) );
    /*
    ...
    */
    ...
    var regex3 = /<\w+><\/\w+>/g;
    var markup2 = '<div><ul><li></li><li></li><li><span></span></li></ul></div>';
    console.log( markup2.match(regex3) );
    /*
    ...
    */
    ...
    console.log( markup3.replace(regex4, '<$1>O texto dentro da tag "$1" é "$2"</$1>\n') );
})();
