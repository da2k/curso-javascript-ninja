(function() {
  ...
  */
  ...
  cpfs.forEach(element => {
    console.log(cleanCPF(element).replace(/(\d{3})(\d{3})(\d{3})(\d{2})/, '$1.$2.$3-$4'));
  });
  ...
  */
  ...
  var htmlPhase = '<div><section><blockquote> Texto <img /></blockquote></section></div>';
  console.log(htmlPhase.match(/<\w+>/g));
  ...
  */
  ...
  var emptyHtmlPhrase = '<div><ul><li></li><li></li><li><span></span></li></ul></div>';
  console.log(emptyHtmlPhrase.match(/<\w+><\/\w+>/g));
  ...
  */
  ...
  console.log(htmlText.replace(
    /(<\w+>)([^<]+)(<\/\w+>)/g, '$1O texto dentro da tag "$1" é "$2"$3\n'
  ));
})()
