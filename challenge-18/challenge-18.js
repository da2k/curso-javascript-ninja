(function () {
  ...
  */
  ...
  var tagsVazia = '<div><ul><li></li><li></li><li><span></span></li></ul></div>';
  console.log(tagsVazia.match(/<\w+><\/\w+>/g));
  ...
  */
  ...
  console.log(texto.replace(/<(\w+)>([^<]+)<\/\w+>/g,'<$1>O texto dentro da tag "$1" é "$2"<\$2> \n'));
})()