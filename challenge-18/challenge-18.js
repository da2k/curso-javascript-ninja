(function(){
  ...
  */
  ...
  function cleanCPF(document){
    return document.replace(/\D/g,'')
  }

  var cpfClear1 = cleanCPF("049-214 3421-1")
  var cpfClear2 = cleanCPF("210.458.522-05")
  var cpfClear3 = cleanCPF("735 500 794 - 22")
  var cpfClear4 = cleanCPF("101.123-131x32")
  console.log(cpfClear1)
  console.log(cpfClear2)
  console.log(cpfClear3)
  console.log(cpfClear4)
  ...
  */
  ...
  var documentRegex = /(\d{3})(\d{3})(\d{3})(\d{2})/;
  var cpf1 = cpfClear1.replace(documentRegex,'$1.$2.$3-$4');
  var cpf2 = cpfClear2.replace(documentRegex,'$1.$2.$3-$4');
  var cpf3 = cpfClear3.replace(documentRegex,'$1.$2.$3-$4');
  var cpf4 = cpfClear4.replace(documentRegex,'$1.$2.$3-$4');
  ...
  */
  ...
  var monthRegex = /ju[nl]ho/g;

  console.log("Os meses de janeiro, junho e julho começam com a letra j.".match(monthRegex));
  /*
  ...
  */
  ...
  var emptyHtmlRegex = /<\w+><\/\w+>/g;
  console.log("<div><ul><li></li><li></li><li><span></span></li></ul></div>".match(emptyHtmlRegex));
