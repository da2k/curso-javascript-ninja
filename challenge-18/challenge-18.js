...
*/
  ...
  var pharse = "Os meses de janeiro, junho e julho começam com a letra j.";

  console.log(pharse.match(/junho|julho/g));
...
*/
  ...
  var texto =
    "<h1>Título da página</h1><p>Este é um parágrafo</p><footer>Rodapé</footer>";
  var textoReplace = 'O texto dentro da tag "$1" é "$2"';
  var regex = /<(\w+)>([^<]+)<\/\w+>/g;

  console.log(texto.replace(regex, textoReplace));
})();
