(function() {
  ...
  */
  ...
  const str1 = 'Os meses de janeiro, junho e julho começam com a letra j.';
  console.log(str1.match(/j\w+ho/g));
  ...
  */
  ...
  const str2 = '<div><section><blockquote>Texto <img /></blockquote></section></div>';
  ...
  */
  ...
  const str3 = '<div><ul><li></li><li></li><li><span></span></li></ul></div>';
  ...
  */
  ...
  const str4 = '<h1>Título da página</h1><p>Este é um parágrafo</p><footer>Rodapé</footer>';
  console.log(str4.replace(/<(\w+)>([^<]+)<\/\w+>/g, '<$1>O texto dentro da tag "$1" é "$2"</$1>\n'));
})();