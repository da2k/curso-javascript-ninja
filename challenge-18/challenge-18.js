(function(){
	...
	*/
	...
	console.log(correctCPF("73550079422"));
	console.log(correctCPF("10112313132"));
	/*
	...
	*/
	...
	function complicar(text){
		text.replace(/(<\w+>)([\w+íáé\s]+)(<\/\w+>)/g, function(regex, abertura, texto, fechamento){
			console.log(abertura + "O texto dentro da tag " + abertura.replace(/[<>]/g, '') + " é " + '"' + texto + '"' + fechamento);
		});
	};
	complicar("<h1>Título da página</h1><p>Este é um parágrafo</p><footer>Rodapé</footer>");
})();