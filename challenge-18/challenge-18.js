(function(){
	...
	*/
	...
	Para garantir que a regex funciona, teste-a usando o método match. 
	
	Se houvero match, o método retorna um array com os matches. 
	...
	*/
	...
	console.log(text.match(/ju[nl]ho/g)); // O match retonra o array com os casamentos encontrados!
	...
	*/
	...
	var text2 = '<h1>Título da página</h1><p>Este é um parágrafo</p><footer>Rodapé</footer>'

	console.log(text2.replace(/(<(\w+)>)([^<]+)(\/w+>)/g, '\n<$1>O texto dentro da tag "$2" é "$3"</$1>\n'));
})();
