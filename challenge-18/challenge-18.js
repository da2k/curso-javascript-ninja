(function () {
  ...
  */
  ...
  function formatCPF(cpf) {
    var _regexCpf = /(\d{3})(\d{3})(\d{3})(\d{2})/g;
    return cpf.replace(_regexCpf, '$1.$2.$3-$4');
  }
  ...
  */
  ...
  var textToMatch = 'Os meses de janeiro, junho e julho começam com a letra j.';
  console.log(textToMatch.match(regexJunhoJulho));
  ...
  */
  ...
  var regexHtmlTagClose = /<\w{1,}><\/\w{1,}>/g;
  var HTMLtext2 = '<div><ul><li></li><li></li><li><span></span></li></ul></div>';
  console.log(HTMLtext2.match(regexHtmlTagClose));
  ...
  */
  ...
  var regexTextInsideHTML = /<(\w{1,})>(.[^<>]*)<\/\w{1,}>/g;
  var textToReplace = '<h1>Título da página</h1><p>Este é um parágrafo</p><footer>Rodapé</footer>';

  console.log(textToReplace.replace(regexTextInsideHTML, function (value, group1, group2) {
