...
cpfs.forEach(  function( item ){
     ...
     console.log( formatarCPF( cleanCPF( item ) )   )
...
console.log( marcacao.match( regextag ) ) 
...
var regextag = /<(\w+)>([\w\sÀ-ú]+)<\/\w+>/g;

console.log( marcacao.replace( regextag ,  
