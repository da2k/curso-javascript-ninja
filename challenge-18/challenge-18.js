(function() {
	...
	*/
	...
	var completeTags = "<div><ul><li></li><li></li><li><span></span></li></ul></div>";
	console.log( completeTags.match(/<\w+><\/\w+>/g) );
	...
	*/
	...
	var tagWithText = "<h1>Título da página</h1><p>Este é um parágrafo</p><footer>Rodapé</footer>";
	console.log( tagWithText.replace(/(<\w+>)([^<]+)(<\/\w+>)/g, '$1O texto dentro da tag "$1" é "$2"$3\n'));
})();
