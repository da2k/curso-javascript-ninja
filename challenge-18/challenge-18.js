...
var regexX = /(\d{3})(\d{3})(\d{3})(\d{2})/g


console.log(cleanCPF('049-214 3421-1').replace(regexX, '$1.$2.$3-$4') )

console.log(cleanCPF('210.458.522-05').replace(regexX, '$1.$2.$3-$4'))

console.log(cleanCPF('735 500 794 - 22').replace(regexX, '$1.$2.$3-$4'))

console.log(cleanCPF('101.123-131x32').replace(regexX, '$1.$2.$3-$4'))
...
var arrayMonth = 'Os meses de janeiro, junho e julho começam com a letra j.'
console.log(arrayMonth.match(/ju[nl]ho/g))
...
var tagAberturaFechamento = '<div><ul><li></li><li></li><li><span></span></li></ul></div>'
console.log(tagAberturaFechamento.match(/(<\w+><\/\w+>)/g))
...
var tagsSite = '<h1>Título da página</h1><p>Este é um parágrafo</p><footer>Rodapé</footer>'

console.log(tagsSite.replace(/<(\w+)>([^<]+)<\/\w+>/g, `<$1>O texto dentro da tag $1 é $2</$1>
`))
