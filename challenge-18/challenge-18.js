...
function cleanCPF( cpf ){
  return cpf.replace(/\D/g, '' ); // substitui tudo o que nao é numero por espaço em branco
}
...
cpfs.forEach(function( cpf ){
  console.log( cleanCPF( cpf ).replace(/(\d\d\d)(\d\d\d)(\d\d\d)(\d\d)/, '$1.$2.$3-$4')) //(\d{3})(\d{3})(\d{3})(\d{2}
})
