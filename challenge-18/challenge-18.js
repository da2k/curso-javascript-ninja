(function(){
  ...
  */
  ...
  console.log("Os meses de janeiro, junho e julho começam com a letra j.".replace(/junho|julho/g  )  );
  ...
  */
  ...
  console.log('<p>O texto dentro da tag "p" é "Este é um parágrafo"</p>'
              .replace( 
                /<(\w+)>([^<]+)<\/\w+>/g, 
