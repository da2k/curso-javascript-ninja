(function() {
    ...
    */
    ...
    var regexMatch = /<(\w+)>([^<]+)<\/\w+>/g;
    console.log("<h1>Título da página</h1><p>Este é um parágrafo</p><footer>Rodapé</footer>".replace(regexMatch, '<$1>O texto dentro da tag "$1" é "$2"<$1>\n'));
}());