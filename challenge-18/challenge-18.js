(function() {
    ...
    */
    ...
    var cpf = {
        cpf_1: '049-214 3421-1',
        cpf_2: '210.458.522-05',
        cpf_3: '735 500 794 - 22',
        cpf_4: '101.123-131x32',
    };
    ...
    */
    ...
    for(var item in cpf) {
        console.log(formatCPF(cleanCPF(cpf[item])));
    }
    ...
    */
    ...
    var mounths = 'Os meses de janeiro, junho e julho começam com a letra j.';
    console.log(mounths.match(/ju\w+/g));
    ...
    */
    ...
    var htmlItems = '<div><section><blockquote>Texto <img /></blockquote></section></div>';

    console.log(htmlItems.match(/<\w+>/g))
    ...
    */
    ...
    var otherHtmlItems = '<div><ul><li></li><li></li><li><span></span></li></ul></div>';

    console.log(otherHtmlItems.match(/<\w+><\/\w+>/g));
