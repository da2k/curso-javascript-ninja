( function() { 
    ...
    */
    ...
    console.log ( "<div><section><blockquote>Texto <img /></blockquote></section></div>".match(/<[a-z]+>/g) );
    ...
    */
    ...
    console.log( "<div><ul><li></li><li></li><li><span></span></li></ul></div>".match( /<[^\/>]+><\/[^>]+>/gi ) );
    ...
    */
    ...
    console.log( "<h1>Título da página</h1><p>Este é um parágrafo</p><footer>Rodapé</footer>".replace( /<([^\/>]+)>([^<]+)<\/[^>]+>/gi, function( all, tag, text ) {
        return '<' + tag + '>' + 'O texto dentro da tag "' + tag + '" é ' + text + '</' + tag + '>\n';
    } ) );

    console.log( "<h1>Título da página</h1><p>Este é um parágrafo</p><footer>Rodapé</footer>".replace( /<([^\/>]+)>([^<]+)<\/"$1"+>/gi, '<$1>O texto dentro da tag "$1" é $2</$1>\n' ) );
