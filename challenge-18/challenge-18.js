( function() {
	...
	*/
	...
	console.log( '<div><section><blockquote>Texto <img /></blockquote></section></div>'.match( regexTags ) );
	...
	*/
	...
	var regexTagsComplete = /\<\w+\>\<\/\w+\>/g;

	console.log( '<div><ul><li></li><li></li><li><span></span></li></ul></div>'.match( regexTagsComplete ) );
