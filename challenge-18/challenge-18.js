(function() {
	...
	*/
	...
	console.log("<h1>Título da página</h1><p>Este é um parágrafo</p><footer>Rodapé</footer>".replace(/(<(\w+)>)([^<]+)(<\/\w+>)/g, function(fullMatch, openingTag, tagName, text, closingTag) {
		return openingTag + 'O texto dentro da tag "' + tagName + '" é "' + text + '"' + closingTag + '\n'; 
	}));
}());