(function () {
  ...
  */
  ...
  console.log( getFullName.call( william ) );
  ...
  */
  ...
  console.log(sum(7, 8, 9 , 10, 11, 12, 13, 14, 15));
  console.log(sum(16, 17, 18, 19, 20));
  ...
  */
  ...
  var onlyNumbers = justNumbers( userEntry );
  ...
  */
  ...
  console.log( sum.apply( sum, onlyNumbers ) );
})();
