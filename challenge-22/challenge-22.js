(function(win, doc){
  ...
  */
  ...
  console.log( getFullName.call( lia ) );
  console.log( getFullName.call( allef ) );
  ...
  */  
  function sum(){    
    ...
    return Array.prototype.reduce.call( arguments, function( acumulado, actual ){
  ...
  */
  ...
  console.log( sum(1, 2, 3, 4, 5, 6, 8, 9, 15, 12) );
