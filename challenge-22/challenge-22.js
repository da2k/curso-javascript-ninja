      ...
      ( function( win, doc ) {
        ...
        */
        ...
        function justNumbers( dataString ) {
            var regex = /\D+/g
            var newString = dataString.replace( regex, ' ');
            var arrResult = newString.split( ' ' );
            return arrResult
        }
        ...
        */
        ...
        /* faltou a ultima, mas a cabeça já nao esta funcionando. amanha eu tento haha */
    })( window, document );
