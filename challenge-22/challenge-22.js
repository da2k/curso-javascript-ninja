( function( win, doc ) {
  ...
  */
  ...
  var person1 = new Person( 'André', 'Vitebo' );
  var person2 = new Person( 'Bruce', 'Wayne' );
  ...
  */
  function sum() {
    ...
    return Array.prototype.reduce.call( arguments, function( total, value ) {
      return ( +total ) + ( +value );
    } );
  }
