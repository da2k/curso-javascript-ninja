(function(){
  ...
  */
  ...
  console.log(getFullName.call(perfil01));
  console.log(getFullName.call(perfil02));
  /*
  ...
  */
  ...
  console.log(sum(10,20,40,50,60,70));
  console.log(sum(15,25,45,55,65,75));
  /*
