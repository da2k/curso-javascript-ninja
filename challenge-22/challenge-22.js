...
/*
  ...
  */
  function Pessoa (name, lastName) {
	...
	var Felipe = new Pessoa('Felipe', 'Britto');
	var Jeane = new Pessoa('Jeane', 'Martine');
  ...
  */
  console.log( 'O nome das pessoas é:' );
	...
	console.log(getFullName.call(Jeane));
  ...
  */
  function sum() {
		...
		var result = Array.prototype
			...
			.reduce( function(acumulated, actual) {
  ...
  */
  ...
  console.log(
		sum(1, '2', 65, 10) + '\n',
		sum('10', 3, 2) + '\n',
		sum('5', '5', '5', '60', '80', 120, 115, 1280, 5, 60, 47)
	);
