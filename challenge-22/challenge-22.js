(function(){
  ...
  */
  ...
  var pessoa1 = new Pessoa('adriano', 'avelino');
  var pessoa2 = new Pessoa('maria', 'nazaré');
  ...
  */
  function sum() {
    ...
    var result = Array.prototype.reduce.call(arguments, function (accumulated, next) {
  ...
  */
  ...
  console.log(sum(5,6,9,2,3));
  console.log(sum(5,-1,8,2,1));
