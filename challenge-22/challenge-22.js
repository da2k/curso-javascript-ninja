  (function( window , document ){
    ...
    */
    console.log( 'O nome das pessoas é:' );
      ...
      console.log( getFullName.call(peopleTwo) );
    ...
    */
    console.log( '\nFunção que limpa entrada do usuário (somente números):' );
      ...
      function justNumbers( userEntryNumbers ) {

       var userEntry = userEntryNumbers.match( /\d+/g ).map( function( item ) {
    ...
    */
    console.log( '\nSomar números entrados pelo usuário:' );
      ...
      console.log( sum.apply( arguments , numbers ) );
