  ...
  'use strict';
    ...
    */
    function sum(){
      ...
      return Array.prototype.reduce.call(arguments, function( acummulated, actualItem){
        return (+ acummulated) + (+ actualItem)
      })
    }
    ...
    */
    var userEntry = prompt('Enrre com alguns números que serão somados:')
    ...
    */
    ...
    var numbers = justNumers(userEntry)
    console.log(numbers)
...
>>>>>>> a43b3799f8daed12787feef84b2e86b91924c743
})(window, document);