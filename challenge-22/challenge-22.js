  (function(){
    ...
    */
     var thales = {name: 'thales',
                   lastName: 'alonso'};

     var yasmin = {name: 'yasmin',
                   lastName: 'da silva'};
    ...
    */
    ...
    function getFullName() {
     ...
     console.log(getFullName.call( thales ));
     console.log(getFullName.call( yasmin ));
    ...
    */
    ...
    console.log(sum(10, 20, 30, 100, 1000));
    console.log(sum(1, 12, 13, 7));
