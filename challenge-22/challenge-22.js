( function( win, doc ) {
  ...
  */
  ...
  function sum() {
    ...
    return Array.prototype.reduce.call( arguments, function( acumulated, current ) {
      return Number(acumulated) + Number(current);
    } );
  }
  ...
  */
  ...
  console.log( sum( 10, 50, 30, 22 ) );
  console.log( sum( 135, 255, 128 ) );
  ...
  */
  ...
  function justNumbers( entry ) {
    var onlyNumbers = entry.match( /\d+/g );
    return onlyNumbers;
  }
