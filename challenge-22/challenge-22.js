  (function() {
      ...
      */
      ...
      console.log(getFullName.call(doug));
      console.log(getFullName.call(merlinda));
      ...
      */
      ...
      function sum() {
          ...
          var results = Array.prototype.reduce.call(arguments, function(prev, curr,index) {
      ...
      */
      ...
      console.log(sum(5,8,10,4));
      console.log(sum(50,80,10));
