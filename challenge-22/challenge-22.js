(function functionName(window) {
  ...
  */
  ...
  var fernando = new Pessoa('Fernando', 'Ramon');
  var bernardo = new Pessoa('Bernardo', 'Ramon');
  ...
  */
  ...
  getFullName.call(fernando);
  getFullName.call(bernardo);
  ...
  */
  function sum() {
    ...
    return Array.prototype.reduce.call(arguments, function(acumulado, item) {
      return Number(acumulado) + Number(item);
    });
  }
  ...
  */
  ...
  console.log(sum.call(sum, 2,2,2,2));
  console.log(sum.call(sum, 5,4));
  ...
  */
  ...
  function justNumbers(paramString) {
    return paramString.match(/\d+/g);
  }
