(function(){
	...
	*/
	...
	console.log( getFullName.call(personMark) );
	console.log( getFullName.call(personCarol) );
	...
	*/
	...
	function justNumbers(promptStr) {
		return promptStr.match(/\d/g).map(function(item){
			return Number(item);
		});
	}
