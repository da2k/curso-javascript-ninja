  ...
  */
  console.log( 'O nome das pessoas é:' );
   ...
   console.log( getfullname.call( vitor )); // grças ao metodo call deu para chamra sem parametro os valores 
  ...
  function sum () {
    console.log( arguments ); 
     return Array.prototype.reduce.call(arguments ,
       ...
       return (+accumulated) + (+actualitem);  // number( acumulated ) + number(acumulaItem))
    }
   ); 
  } 
  ...
  */
  ...
  console.log( justNumbers('10ferdin2oi 3, 8 ')); 
