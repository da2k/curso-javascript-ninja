(function() {
  ...
  */
  ...
  var person1 = new Person('José', 'Silva');
  var person2 = new Person('Maria', 'Alves');
  ...
  */
  ...
  console.log(sum(49,12,3,405,34));
  console.log(sum(12,102,215,78,97,87));
  ...
  */
  ...
  function justNumbers(userEntry) {
    return userEntry.split(' ').filter(function(item) {
      return item.match(/^\d\d+$/gmi);
    });
  }
