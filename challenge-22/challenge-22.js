(function (){
  ...
  */
  ...
  var person1 = {name:'Luan',lastName:'Melo'}
  var person2 = {name:'Renan',lastName:'Melo'}
  ...
  */
  ...
  console.log(sum(2,4,8,9,7,8,10))
  console.log(sum(48,96,47,8,5,1))
  console.log(sum(4,8,4,56,1,0,10))
