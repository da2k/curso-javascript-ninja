(function () {
  ...
  */
  ...
  var edilson = new Pessoa('Edilson', 'Cichon');
  var fernanda = new Pessoa('Fernanda', 'Rodrigues Cichon');
  ...
  */
  function sum() {
  	...
  	return Array.prototype.reduce.call(arguments, function(acumullated, current) {
  		return acumullated + Number(current);
  	}, 0);
  }
