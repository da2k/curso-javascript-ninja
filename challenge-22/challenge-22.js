(function(window) {
  ...
  */
  ...
  var onePerson = new Person('John', 'Doe');
  var anotherPerson = new Person('Joan', 'Doe');
  ...
  */
  ...
  console.log(getFullName.call(onePerson));
  console.log(getFullName.call(anotherPerson));
