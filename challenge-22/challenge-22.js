...
(function(){
  ...
  */
  var obj1 = {name: 'Matheus', lastName: 'Lima'};
  var obj2 = {name: 'Fabiana', lastName: 'Lima'};
  ...
  */
  ...
  var userEntry = prompt( 'Entre com alguns números para serem somados:' );
