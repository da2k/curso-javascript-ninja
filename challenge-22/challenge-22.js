(function (window, document) {
  ...
  */
  var person1 = { name: 'Jonas', lastName: 'Silva' };
  var person2 = { name: 'Winny', lastName: 'Smith' };
  ...
  */
  var userEntry = window.prompt('Entre com alguns valores que serão somados:');
  ...
  */
  ...
  function justNumbers(str) {
    return str.match(/\d+/g).map(function(item) {
      return + item;
    });
  }
