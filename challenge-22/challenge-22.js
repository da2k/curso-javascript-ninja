(function(win, doc){
  ...
  */
  ...
  console.log( getFullName.call(raul) );
  ...
  */
  function sum() {
    ...
    return Array.prototype.reduce.call(arguments, function(itemAnterior, itemAtual){
      return Number(itemAnterior) + Number(itemAtual);
    });
  }
