(function(win, doc){
  ...
  */
  ...
  console.log( 'O nome das pessoas é: '+getFullName.call(mariaEduarda) );
  console.log( 'O nome das pessoas é: '+getFullName.call(anaJulia) );
  ...
  */
  ...
  function justNumbers( ent ){
    return ent.replace(/\D+/g, ',').split(',');
  }
