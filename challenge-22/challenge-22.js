(function(win, doc) {
  ...
  */
  ...
  var obj1 = new Person("Leticia", "Monteiro");
  var obj2 = new Person("Tabada", "Domingues");
  ...
  */
  ...
  console.log(sum(9, 10, 15));
  console.log(sum(50, 1, 3));
  ...
  */
  var userEntry = win.prompt("Entre com alguns numeros que seram somados");
