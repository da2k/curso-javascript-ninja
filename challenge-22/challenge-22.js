(function(window){
  ...
  */
  ...
  console.log(getFullName.call(pessoaA));
  console.log(getFullName.call(pessoaB));
  ...
  */
  function sum(){
    ...
    return Array.prototype.reduce.call(arguments, function(accumulated, currentValue){
