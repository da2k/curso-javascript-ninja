;(function (win, doc) {
  ...
  */
  ...
  console.log(getFullName.call(leandrino))
  console.log(getFullName.call(brenda))
  ...
  */
  ...
  console.log(sum(1, 2))
  console.log(sum(2, 2))
  console.log(sum(-10, 50, 1205, -2000, 4000))
  ...
  */
  ...
  console.log(justNumbers('1eusei2 asadsa 30, 50'))
  /*
