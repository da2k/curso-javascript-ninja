(function () {
  ...
  */
  ...
  var luiz = new Person('Luiz', 'Campedelli', 27);
  console.log(luiz);

  var joao = new Person('Joao', 'Sousa', 28);
  console.log(joao);

  var maria = new Person('Maria', 'Silva', 29);
  console.log(maria);
  ...
  */
  ...
  console.log( luiz.getFullName() + ' agora tem ' + luiz.addAge(3).getAge() + ' anos');
