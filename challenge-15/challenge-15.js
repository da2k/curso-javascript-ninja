(function(){
  ...
  */
  ...
  var allef = new Person('Allef', 'Silva', 22);
  var lia = new Person('Lia', 'Kerciane', 21);
  var lucas = new Person('Lucas', 'Freitas', 17);
  console.log(allef);
  console.log(lia);
  console.log(lucas);
  /*
  ...
  */
  console.log( '\nNomes das pessoas:' );
  console.log(allef.getFullName());
  console.log(lia.getFullName());
  ...
  */
  console.log( '\nIdade das pessoas:' );
  console.log(allef.getAge());
  console.log(lia.getAge());
