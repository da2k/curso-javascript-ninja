(function() {
  ...
  */
  ...
  var kevin = new Person('Kevin', 'Oliveira', 20);
  var joao = new Person('João', 'Silva', 37);
  var maria = new Person('Maria', 'Cristina', 26);
  ...
  */
  console.log( '\nIdade das pessoas:' );
  console.log( kevin.getFullName() + ' tem ' + kevin.getAge() + ' anos.' );
  ...
  */
  ...
  console.log( kevin.getFullName() + ' agora tem ' + kevin.addAge(5) + ' anos.' );
  console.log( joao.getFullName() + ' agora tem ' + joao.addAge(5) + ' anos.' );
