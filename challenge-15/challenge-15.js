...
var joao = new Person('Joao', 'Alves', 40);

var rael = new Person('Rael', 'Nunes', 7);
...
console.log(rael.getFullName()+ ' tem ' + rael.getAge() + ' anos.');
...
rael.addAge(18);
console.log(rael.getFullName() + ' agora tem ' + rael.getAge() + ' anos.')
