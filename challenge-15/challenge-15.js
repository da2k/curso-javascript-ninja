(function () {
  ...
  */
  ...
  var jonathan = new Person('Jonathan', 'Ramos', 25);
  var joao = new Person('João', 'Pereira', 55);
  ...
  */
  console.log('\nNomes das pessoas:');
  console.log(jonathan.getFullName());
  ...
  */
  console.log('\nIdade das pessoas:');
  console.log(jonathan.getFullName() + " tem "+ jonathan.getAge() +" anos.");
  ...
  */
  ...
  console.log(jonathan.getFullName() + ' agora tem '+jonathan.addAge(2).getAge()+' anos.');
