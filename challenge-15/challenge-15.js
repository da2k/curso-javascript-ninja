(function() {
    ...
    */
    ...
    var jorge = new Person( 'jorge', 'ramos', 31 );
    var joao = new Person( 'joão', 'santos', 43 );
    var maria = new Person( 'maria', 'joaquina', 19 );
    console.log( jorge );
    console.log( joao );
    console.log( maria );
    ...
    */
    ...
    console.log( jorge.getFullName() + ' agora tem ' +  jorge.addAge( 12 ).getAge() + ' anos.' );
    console.log( joao.getFullName() + ' agora tem ' + joao.addAge( 3 ).getAge() + ' anos.' );
    console.log( maria.getFullName() + ' agora tem ' + maria.addAge( 21 ).getAge() + ' anos.' );
