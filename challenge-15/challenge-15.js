(function(){
  ...
  */
  ...
  console.log(edson.getFullName() + ' agora tem ' + edson.addAge(7).getAge() + ' anos.');
  console.log(luke.getFullName() + ' agora tem ' + luke.addAge(2).getAge() + ' anos.');
  console.log(marcos.getFullName() + ' agora tem ' + marcos.addAge(12).getAge() + ' anos.');
})();