(function(){
  ...
  */
  ...
  var joao = new Person('João', 'Gomes', 31);
  var maria = new Person('Maria', 'Nogueira', 23);
  var evelin = new Person('Evelin', 'Schimits', 19);
  ...
  */
  ...
  console.log(evelin.getFullName());
  ...
  */
  ...
  console.log(evelin.getFullName() + ' tem ' + evelin.getAge() + ' anos');
  ...
  */
  ...
  console.log(evelin.getFullName() + ' agora tem ' + evelin.getAge() + ' anos.');
})();