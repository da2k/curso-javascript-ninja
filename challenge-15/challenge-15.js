(function() {
  ...
  */
  ...
  var joao = new Person('João Vitor', 'Cavalcante', 19);
  var fernando = new Person('Fernando', 'Daciuk', 30);
  var alguem = new Person('Alguem', 'Silva', 40);
  console.log(joao);
  ...
  */
  ...
  console.log(alguem.getFullName());
  ...
  */
  ...
  console.log( alguem.getFullName() +' tem '+ alguem.getAge() +' anos.');
  ...
  */
  ...
  console.log( alguem.getFullName() +' agora tem '+ alguem.getAge() +' anos.');
