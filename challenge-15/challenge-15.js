(function() {
  ...
  */
  ...
  var carli = new Person('Victor', 'Carli', 24)
  var joao = new Person('Joao', 'Felipe', 23)
  ...
  */
  console.log( '\nIdade das pessoas:' );
  console.log( carli.getFullName() + ' tem ' + carli.getAge() + ' anos' )
  ...
  */
  ...
  console.log( carli.getFullName() + ' agora tem ' + carli.addAge(2).getAge() + ' anos.' )
