;(function() {
    ...
    */
    ...
    var joao = new Person('João', 'Fricks', 37);
    var paulo = new Person('Paulo', 'Silva', 20);
    var fernanda = new Person('Fernanda', 'Soares', 18);
    ...
    */
    ...
    console.log(paulo.getFullName() + ' agora tem ' + paulo.addAge(2).getAge() + ' anos.');
    console.log(fernanda.getFullName() + ' agora tem ' + fernanda.addAge(2).getAge() + ' anos.');
}());
