...
var joao = new Person('João','Felipe',20);
var leonardo = new Person('Leonardo','Carvalho',29);
...
console.log(leonardo.getFullName() + ' agora tem ' + leonardo.addAge(9).getAge() +' anos.');
