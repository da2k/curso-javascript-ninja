(function(){
    ...
    */
    ...
    var Mariana = new Person('Mariana', 'Gibara', 29);
    var Arthur = new Person('Arthur', 'Linhares', 1);
    var JP = new Person('João', 'Paulo', 30);
    ...
    */
    ...
    console.log(JP.getFullName() + ' tem ' + JP.getAge() + ' anos');
    ...
    */
    ...
    JP.addAge(5);
    console.log(JP.getFullName() + ' agora tem ' + JP.getAge() + ' anos');
    Arthur.addAge(3);
    console.log(Arthur.getFullName() + ' agora tem ' + Arthur.getAge() + ' anos');
