(function() {
  ...
  */
  ...
  let person1 = new Person('Matheus', 'Mazeto', 22);
  let person2 = new Person('Maiza', 'Regina', 49);
  let person3 = new Person('Camila', 'Mallea', 22);
  ...
  */
  ...
  console.log(`${person1.getFullName()} agora tem ${person1.addAge(1)} anos`);
  console.log(`${person2.getFullName()} agora tem ${person2.addAge(2)} anos`);
