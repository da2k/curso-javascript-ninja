(function(){
  ...
  */
  ...
  console.log(ale.getFullName(),'agora tem',ale.addAge(1).getAge(),'anos');
  console.log(fabio.getFullName(),'agora tem',fabio.addAge(4).getAge(),'anos');
  console.log(jane.getFullName(),'agora tem',jane.addAge(9).getAge(),'anos');
})();
