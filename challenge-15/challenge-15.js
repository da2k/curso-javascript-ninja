(function() {
	...
	*/
	...
	var Pedro = new Person('Pedro', 'Muraki', 20);
	console.log(Pedro);
	var Sandra = new Person('Sandra', 'Muraki', 50);
	console.log(Sandra);
	var Julia = new Person('Julia', 'Muraki', 15);
	console.log(Julia);
	...
	*/
	console.log( '\nIdade das pessoas:' );
	var personArray = [];
	personArray.push(Pedro, Sandra, Julia);
	personArray.forEach(function(item){
		console.log( item.name + ' tem ' + item.age + ' anos.' );
	});
