(function(){
  ...
  */
  ...
  var wesley = new Person('Wesley','Xavier',28);
  var cristina = new Person('Cristina','Xavier',21);
  var maria = new Person('Maria Isabel','Alves',53);
  ...
  */
  ...
  console.log(wesley.addAge(1));
  console.log(cristina.addAge(2));
  console.log(maria.addAge(3));

  console.log( '\nNova idade das pessoas:' );
  console.log(wesley.getFullName() + ' agora tem ' + wesley.getAge() + ' anos.');
  console.log(cristina.getFullName() + ' agora tem ' + cristina.getAge() + ' anos.');
