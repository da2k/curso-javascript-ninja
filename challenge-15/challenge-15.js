...
let Andre = new Person ( 'Andre', 'Siqueira', 28 );
let Angela = new Person ( 'Angela', 'Bernardes', 47 );
let Lucas = new Person ('Lucas', 'Siqueira', 21);
...
console.log( `${ Andre.getFullName() } agora tem ${ Andre.addAge(2).getAge() } anos.` );
