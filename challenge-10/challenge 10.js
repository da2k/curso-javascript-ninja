...
*/
  function calculator(operador){
    if(isOperatorValid(operador) === true){
      return  function(x,y){
        operacao = typeof x === 'number' && typeof y === 'number' ? operation[operador](x,y) : false;
          return operacao;
      }
    }
    return false;
  ...
  console.log(calculator('*')(3,'a'));
  console.log(calculator('-')(5,32));
...
//console.log(showOperationMessage('-',4,4));
/*
