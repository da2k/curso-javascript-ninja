...
*/
  function isOperatorValid(oprd) {
    return !!operation[oprd];
  }
...
*/
  function calculator(oprd) {
    return isOperatorValid(oprd)
      ? function (x, y) {
          if (typeof x !== "number" || typeof y !== "number") {
            return false;
          }
          return operation[oprd](x, y);
        }
      : false;
  }
...
*/
  function showOperationMessage(oprd, x, y) {
    return "A operação " + x + " " + oprd + " " + y + " = ";
  }
...
*/
  ...
  if (!!invalid) {
    ...
    number2 = 1;
    console.log(showOperationMessage(operationSignal, number1, number2));
    console.log(invalid(number1, number2));
  } else {
    console.log(showErrorMessage(operationSignal));
  }
})();
