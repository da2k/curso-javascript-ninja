...
*/
operationSignal = '$';
var distinta = calculator(operationSignal);

if (distinta ){
    number1 = 5;
    number2 = 3;

    console.log( showOperationMessage( operationSignal, number1, number2), distinta(number1,number2)  );
}
else{
    console.log( showErrorMessage(operationSignal) )
}
