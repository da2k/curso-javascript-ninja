(function(){
    ...
    */
    ...
    //console.log('Esse operador é ' + isOperatorValid('+'));
    /*
    ...
    */
   operationSignal = '^';
   var acentue = calculator(operationSignal);
   if(acentue) {
       number1 = 30;
       number2 = 6;
       console.log( showOperationMessage(number1, operationSignal, number2), acentue(number1, number2));
   }
   else {
       console.log( showErrorMessage( operationSignal) );
   }
