(function() {
  ...
  */
  function calculator(sign) {
    ...
    return function(parameter1, parameter2) {
      ...
      return operation[sign](parameter1, parameter2);
    };
  ...
  */
  function showErrorMessage(invalidSign) {
    return `Operação "${invalidSign}" não permitida!`;
  }
  ...
  */
  operationSignal = '#';
  var hash = calculator(operationSignal);
  
  if(hash) {
    number1 = 100;
    number2 = 50;
    
    console.log(showOperationMessage(operationSignal, number1, number2), hash(number1, number2));
  } else {
     console.log(showErrorMessage(operationSignal));
  }
