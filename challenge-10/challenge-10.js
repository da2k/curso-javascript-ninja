(function() {
    ...
    */
    ...
    sum === false ? console.log( showErrorMessage( operationSignal ) ) : console.log( showOperationMessage( operationSignal, number1, number2), sum( number1, number2 ) );
    ...
    */
    ...
    subtraction === false ? console.log( showErrorMessage( operationSignal ) ) : console.log( showOperationMessage( operationSignal, number1, number2), subtraction( number1, number2 ) );

    operationSignal = '*';
    var multiplication = calculator( operationSignal );

    multiplication === false ? console.log( showErrorMessage( operationSignal ) ) : console.log( showOperationMessage( operationSignal, number1, number2), multiplication( number1, number2 ) );

    operationSignal = '/';
    var division = calculator( operationSignal );

    division === false ? console.log( showErrorMessage( operationSignal ) ) : console.log( showOperationMessage( operationSignal, number1, number2), division( number1, number2 ) );

    operationSignal = '%';
    var mod = calculator( operationSignal );

    mod === false ? console.log( showErrorMessage( operationSignal ) ) : console.log( showOperationMessage( operationSignal, number1, number2), mod( number1, number2 ) );
    ...
    */
    ...
    invalidOperator === false ? console.log( showErrorMessage( operationSignal ) ) : console.log( showOperationMessage( operationSignal, number1, number2), invalidOperator( number1, number2 ) );
})();
