(function(){
    ...
    */
    function calculator(operator){
        return !isOperatorValid(operator) ? false : function( x,y ) {
            var notANumber = (typeof x !== 'number') || (typeof y !== 'number') ;
            return notANumber ? false :  operation[operator](x,y) ;
        };
    }
    ...
    */
    ...
    /*
    Crie uma função chamada "showErrorMessage" que recebe o
    operador como parâmetro quando a operação não for válida.
