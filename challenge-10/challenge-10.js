(function () {
  ...
  */
  ...
  console.log(operation["+"](19, 10)); //29
  console.log(operation["-"](19, 10)); //9
  console.log(operation["*"](19, 10)); //190
  console.log(operation["/"](19, 10)); //1.9
  console.log(operation["%"](19, 10)); //9
  ...
  */
  ...
  function calculator(operator) {
    ...
    return function (value, value2) {
      ...
      return operation[operator](value, value2);
    };
  }
  ...
  */
  ...
  function showOperationMessage(firstNum, operator, secondNun) {
    return `A operação ${firstNum} ${operator} ${secondNun} é =`;
  }
  ...
  */
  function showErrorMessage(calcOperator) {
    return `Operação ${calcOperator} não permitida!`;
  }
 ...
 operationSignal = "8";
 let multiplication2 = calculator(operationSignal);
 ...
 if (multiplication2) {
   ...
   console.log(
     showOperationMessage(number1, operationSignal, number2),
     multiplication2(number1, number2)
   );
 } else {
   console.log(showErrorMessage(operationSignal));
 }

 //Operação 8 não permitida!
