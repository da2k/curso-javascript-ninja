(function () {
    ...
    */
    function showErrorMessage(parametro) {
        return 'Operação "' + parametro + '" não permitida!'
    }
    ...
    */
    ...
    operationSignal = '?';
    var myVar = calculator(operationSignal);

    if (myVar){
        number1 = 10
        number2 = 30
        console.log(showOperationMessage(number1, operationSignal, number2), myVar(number1, number2));
    } else {
        console.log(showErrorMessage(operationSignal))
    }
})()