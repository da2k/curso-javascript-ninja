 ...
 */
 ...
 function calculator(operador){
  ...
  return  !isOperatorValid(operador)  ? false : function(x,y){
            
    return typeof x  === 'number' && typeof y === 'number' ? operation[operador](x,y) : false;    
...
function Message(funct ,x,y){

  if( funct ){

   number1 = x;
   number2 = y;
   console.log( showOperationMessage(operationSignal,number1,number2)+funct(number1,number2) );
 ...
 */
 ...
 Message(subtraction,5,10)


 operationSignal ='*';
 var multiplication = calculator(operationSignal);
 Message(multiplication,10,5)


 operationSignal ='/';
 var division = calculator(operationSignal);
 Message(division,10,2)
 ...
 */
 ...
 operationSignal = '^'
 var power = calculator(operationSignal);
 Message(power,5,2)
