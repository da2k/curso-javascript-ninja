(function() {
	...
	*/
	function isOperatorValid(operatorTest){
		return operation[operatorTest] !== undefined;
	}
	...
	*/
	operationSignal = 'Operador invalido';
	var operatorInvalid = calculator(operationSignal);
	if( operatorInvalid ){
		var number1 = 20;
		var number2 = 2;
		console.log( showOperationMessage( operationSignal, number1, number2 ), operatorInvalid( number1, number2));
	}
	else{
		console.log(showErrorMessage(operationSignal));
	}
