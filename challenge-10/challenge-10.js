(function() {
  ...
  */
  var result = sum ? showOperationMessage( operationSignal, number1, number2 ) + sum( number1, number2 ) : showErrorMessage( operationSignal );
  console.log( result );
  /*
  ...
  */
  ...
  result = subtraction ? showOperationMessage( operationSignal, number1, number2 ) + subtraction( number1, number2 ) : showErrorMessage( operationSignal );
  console.log( result );

  operationSignal = '*';
  var multiplication = calculator( operationSignal );

  result = multiplication ? showOperationMessage( operationSignal, number1, number2 ) + multiplication( number1, number2 ) : showErrorMessage( operationSignal );
  console.log( result );

  operationSignal = '/';
  var division = calculator( operationSignal );

  result = division ? showOperationMessage( operationSignal, number1, number2 ) + division( number1, number2 ) : showErrorMessage( operationSignal );
  console.log( result );

  operationSignal = '%';
  var mod = calculator( operationSignal );

  result = mod ? showOperationMessage( operationSignal, number1, number2 ) + mod( number1, number2 ) : showErrorMessage( operationSignal );
  console.log( result );
  ...
  */
  operationSignal = 'U';
  var union = calculator( operationSignal );

  result = union ? showOperationMessage( operationSignal, number1, number2 ) + union( number1, number2 ) : showErrorMessage( operationSignal );
  console.log( result );
