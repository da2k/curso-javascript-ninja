...
function calculator(operator) {
  ...
  return function(par1, par2) {
    ...
    return operation[operator] (par1, par2);
  };
}
...
*/
operationSignal = 'x';
var times = calculator(operationSignal);
if (times) {
  number1 = 10;
  number2 = 5;
  console.log( showOperationMessage(operationSignal, number1, number2), times(number1, number2) );
} else {
  console.log( showErrorMessage(operationSignal) );
};
