(function(){
	...
	*/
	console.log(showOperationMessage(operationSignal, number1, number2),
		sum(number1, number2) !== false ? sum(number1, number2) : showErrorMessage(operationSignal) );
	...
	*/
	...
	console.log(showOperationMessage(operationSignal, number1, number2),
		subtraction(number1, number2) !== false ? subtraction(number1, number2) : showErrorMessage(operationSignal) );
	
	operationSignal = '*';	
	var multiplication = calculator(operationSignal);
	
	console.log(showOperationMessage(operationSignal, number1, number2),
		multiplication(number1, number2) !== false ? multiplication(number1, number2) : showErrorMessage(operationSignal) );
	...
	console.log(showOperationMessage(operationSignal, number1, number2),
		division(number1, number2) !== false ? division(number1, number2) : showErrorMessage(operationSignal) );
	
	operationSignal = '%';	
	var mod = calculator(operationSignal);
	
	console.log(showOperationMessage(operationSignal, number1, number2),
		mod(number1, number2) !== false ? mod(number1, number2) : showErrorMessage(operationSignal) );
	...
	*/
	operationSignal = 'I';	
	var invalidSignal = calculator(operationSignal);
