(function(){
	...
	*/
	function isOperatorValid(operator){
		return !!operation[operator]; // retorna equivalente booleano (truthy ou falsy)
	};
	...
	*/
	...
	operationSignal = '9';
	var nove = calculator(operationSignal);

	if( nove ){
		number1 = 9;
		number2 = 8;
		console.log( showOperationMessage(operationSignal, number1, number2), nove( number1, number2) );
	}else{
		console.log( showErrorMessage(operationSignal) );
	}
