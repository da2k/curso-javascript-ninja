...
sum ? console.log( showOperationMessage( operationSignal, number1, number2 ), subtraction(number1, number2)) : console.log( showErrorMessage ( operationSignal ));
...
sum ? console.log( showOperationMessage( operationSignal, number1, number2 ), multiplication(number1, number2)) : console.log( showErrorMessage ( operationSignal ));
...
sum ? console.log( showOperationMessage( operationSignal, number1, number2 ), division(number1, number2)) : console.log( showErrorMessage ( operationSignal ));
...
sum ? console.log( showOperationMessage( operationSignal, number1, number2 ), mod(number1, number2)) : console.log( showErrorMessage ( operationSignal ));
