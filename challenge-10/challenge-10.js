...
function showOperationMessage (operador,x,y) {
    return `A operacao ` + x + ` ` + operador + ` ` + y + ` = `;
}
...
function showErrorMessage (operator) {
    return `operacao ` + operator + `nao permitido `; 
}
...
operationSignal = 'p';
var pepe = calculator(operationSignal);

if (pepe) {
    number1 = 10;
    num2 = 12;
    console.log(showOperationMessage (operationSignal, number1, number2 ), pepe (number1,number2) );
} 
