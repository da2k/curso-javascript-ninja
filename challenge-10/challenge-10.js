(function () { /*
  ...
  */
  function calculator (operacao) {
    if(isOperationValid(operacao)) {
      return function (num1, num2) {
        if(typeof (num1) === 'number' && typeof (num2) === 'number') {
          return operation[operacao](num1, num2); 
        } else {
          return false;
        }
      }
  ...
  */
  ...
  if(subtraction) {
    number1 = 5;
    number2 = 25;
    console.log(showOperationMessage(operationSignalSub, number1, number2), subtraction(number1,number2));
  } else {
    console.log(showErrorMessage(operationSignalSub));
  }

  operationSignalMult = '*';
  var multiplication = calculator(operationSignalMult);
  if(multiplication) {
    number1 = 5;
    number2 = 25;
    console.log(showOperationMessage(operationSignalMult, number1, number2), multiplication(number1,number2));
  } else {
    console.log(showErrorMessage(operationSignalMult));
  }
  operationSignalDiv = '/';
  ...
  if(division) {
    number1 = 5;
    number2 = 25;
    console.log(showOperationMessage(operationSignalDiv, number1, number2), division(number1,number2));
  } else {
  ...
  */
 operationSignalInv = '0';
 var invalid = calculator(operationSignalInv);
 if(invalid) {
  number1 = 5;
  number2 = 25;
  console.log(showOperationMessage(operationSignalInv, number1, number2), invalid(number1,number2));
} else {
  console.log(showErrorMessage(operationSignalInv));
}
})();
