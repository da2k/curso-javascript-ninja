(function () {
  ...
  */
  if(sum) {
			numero1 = 10;
			numero2 = 20;
			console.log(showOperationMessage(operationSignal, numero1, numero2), sum(numero1, numero2));
		} else {
  ...
  */
		...
		var mensagemErro = calculator(operationSignal);

		if(mensagemErro) {
			numero1 = 14;
			numero2 = 15;
			console.log(showOperationMessage(operationSignal, numero1, numero2), mensagemErro(numero1, numero2));
		} else {
			console.log(showErrorMessage(operationSignal));
		}
}());
