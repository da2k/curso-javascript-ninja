(function () {
  ...
  */
  function isOperatorValid(op) {
    return !!operation[op]; //convertendo para trusty(function) ou falsy(undefined) - retorna para o equivalente boleano
    //return operation[op] !== 'undefined'; // também daria certo
  }
