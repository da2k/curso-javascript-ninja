(function(){
    ...
    */
    function isOperatorValid(operator){
        return operator === '+' ? true : operator === '-' ? true : operator === '*' ? true : operator === '/' ? true : operator === '%' ? true : false;
    }
    ...
    */
    ...
    console.log(showOperationMessage(operationSignal, number1, number2), isOperatorValid(operationSignal) === true ? sum(number1, number2) : showErrorMessage(operationSignal));
    ...
    */
    ...
    console.log(showOperationMessage(operationSignal, number1, number2), isOperatorValid(operationSignal) === true ? subtraction(number1, number2) : showErrorMessage(operationSignal));

    operationSignal = '*';
    var multiplication = calculator(operationSignal);
    console.log(showOperationMessage(operationSignal, number1, number2), isOperatorValid(operationSignal) === true ? multiplication(number1, number2) : showErrorMessage(operationSignal));

    operationSignal = '/';
    var division = calculator(operationSignal);
    console.log(showOperationMessage(operationSignal, number1, number2), isOperatorValid(operationSignal) === true ? division(number1, number2) : showErrorMessage(operationSignal));

    operationSignal = '%';
    var mod = calculator(operationSignal);
    console.log(showOperationMessage(operationSignal, number1, number2), isOperatorValid(operationSignal) === true ? mod(number1, number2) : showErrorMessage(operationSignal));
    ...
    */
    ...
    console.log(showOperationMessage(operationSignal, number1, number2), isOperatorValid(operationSignal) === true ? error(number1, number2) : showErrorMessage(operationSignal));
}());