(function(){
    ...
    */
    function calculator(operator){
        let isValid = isOperatorValid(operator);
        return !isValid ? false : function(num1,num2){
            let isNumber = typeof num1 === 'number' && typeof num2 === 'number';
            return !isNumber ? false : operation[operator](num1, num2);
        }
    }
    ...
    */
    function showErrorMessage(wrong_operator){
        return 'Operação "' + wrong_operator + '" não permitida!';
    }
