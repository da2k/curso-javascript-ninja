( function() {
    ...
    */
    ...
    console.log( 'Teste True do Operation ', operation[ '+' ]( 10, 5 ) );
    ...
    */
    ...
    console.log( 'Teste True do isOperatorValid ', isOperatorValid( '+' ) );
    console.log( 'Teste False do isOperatorValid ', isOperatorValid( 'x' ) );
    ...
    */
    ...
    console.log( 'Teste True da Função Calculator de soma: ', calculator( '+' )( 10, 5 ) );
    console.log( 'Teste True da Função Calculator de subtração: ', calculator( '-' )( 10, 5 ) );
    console.log( 'Teste True da Função Calculator de Multiplicação: ', calculator( '*' )( 10, 5 ) );
    console.log( 'Teste True da Função Calculator de Divisão: ', calculator( '/' )( 10, 5 ) );
    console.log( 'Teste True da Função Calculator de Modulo: ', calculator( '%' )( 10, 5 ) );
    ...
    */
    function showOperationMessage( operator, valor1, valor2 ) {
        return 'A operação ' + valor1 + ' ' + operator + ' ' + valor2 + ' =';
    }

    console.log( showOperationMessage( '+', 10, 5 ) );
