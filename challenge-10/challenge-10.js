...
(function(){
	...
	*/
	function isOperatorValid(op){
		//gambiarra nº 1:
		/*var aux = '+-/%*';
    	return aux.indexOf(op) !== -1 && op.length === 1;*/      					
		//funciona, mas é pouco prática. Não estava querendo fazer muitos or's então tentei fazer da menor forma possível,
		//mas deu de melhorar
		
		//tentativa nº 2:
		return operation[op] !== undefined;      					
		//acredito que esta forma seja melhor na questão de economizar código. Novamente, não queria usar muitos or's.
	}
	...
	*/
	...
	error = calculator(operationSignal);
