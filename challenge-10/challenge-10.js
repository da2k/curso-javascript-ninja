(function() {
	...
	*/
	function showOperationMessage(number1, number2, operator) {
	...
	*/
	sum ? console.log(showOperationMessage(number1, number2, operationSignal), sum(number1, number2)) : console.log(showErrorMessage(operationSignal));
	...
	*/
	...
	subtraction ? console.log(showOperationMessage(number1, number2, operationSignal), subtraction(number1, number2)) : console.log(showErrorMessage(operationSignal));

	operationSignal = '*';
	var multiplication = calculator(operationSignal);
	multiplication ? console.log(showOperationMessage(number1, number2, operationSignal), multiplication(number1, number2)) : console.log(showErrorMessage(operationSignal));

	operationSignal = '/';
	var division = calculator(operationSignal);
	division ? console.log(showOperationMessage(number1, number2, operationSignal), division(number1, number2)) : console.log(showErrorMessage(operationSignal));

	operationSignal = '%';
	var mod = calculator(operationSignal);
	mod ? console.log(showOperationMessage(number1, number2, operationSignal), mod(number1, number2)) : console.log(showErrorMessage(operationSignal));
	...
	*/
	...
	invalidOperation ? console.log(showOperationMessage(number1, number2, operationSignal), invalidOperation(number1, number2)) : console.log(showErrorMessage(operationSignal));
}());