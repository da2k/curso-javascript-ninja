(function() {
    ...
    */
    function isOperatorValid(operator) {
        return typeof operator === 'string' && operation[operator] !== undefined;
    }
    ...
    */
    ...
    //var calc = calculator('+');
    //console.log('calc: ', ( calc ? 'true' : 'false'));
    /*
    ...
    */
    ...
    function showErrorMessage(operator) {
        return !isOperatorValid(operator) ? 'Operação "' + operator + '" não permitida!' : '';
    }
    ...
    */
    ...
    //console.log('sum: ', ( sum ? 'true' : 'false'));
    /*
    PASSO 3:
    ...
    */
    if (sum) {
        ...
        console.log(showOperationMessage(operationSignal, number2, number2), sum(number1, number2));
    }
    else {
   ...
   console.log(showOperationMessage(operationSignal, number2, number2), subtraction(number1, number2));

   operationSignal = '*';
   var multiplication = calculator(operationSignal);
   console.log(showOperationMessage(operationSignal, number2, number2), multiplication(number1, number2));

   operationSignal = '/';
   var division = calculator(operationSignal);
   console.log(showOperationMessage(operationSignal, number2, number2), division(number1, number2));

   operationSignal = '%';
   var mod = calculator(operationSignal);
   console.log(showOperationMessage(operationSignal, number2, number2), mod(number1, number2));
