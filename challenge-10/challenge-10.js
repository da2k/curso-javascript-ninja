(function () {
  ...
  */
  function isOperatorValid(operador) {
    ...
    // Nesse caso, operation[operator] retorna uma função caso o operador seja valido,
    // logo, uma função retornará true
  };
  ...
  */
  ...
  if (mod) {
    ...
    console.log(showOperationMessage(operationSignal, number1, number2), mod(
      number1, number2));
 ...
 if (invalido) {
   ...
   console.log(showOperationMessage(operationSignal, number1, number2), invalido(
     number1, number2));
