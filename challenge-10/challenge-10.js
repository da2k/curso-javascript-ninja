(function(){
    ...
    */
    function showOperationMessage(operator, a, b){
        return 'A operacao ' + a + ' ' + operator + ' ' +  b + ' = ';
    }
    ...
    */
    number1 = 5;
    number2 = 10;
    console.log(  sum ? showOperationMessage(operationSignal,number1,number2) + sum(number1,number2) : showErrorMessage() );
    ...
    */
    ...
    console.log( invalid ? showOperationMessage(operationSignal,number1,number2) + invalid(number1,number2) : showErrorMessage(operationSignal) );
