...
*/
  function showErrorMessage(calculator) {
    return `Operação "${calculator}" não permitida!`;
  }
...
if ( sum ) {
	number1 = 30;
	number2 = 50;
	console.log( showOperationMessage( operationSignalSum, number1, number2 ), sum( number1, number2 ) );
} else {
...
var operationSignalSubtraction = "-";
var subtraction = calculator(operationSignalSubtraction);
if ( subtraction ) {
	number1 = 30;
	number2 = 50;
	console.log( showOperationMessage( operationSignalSubtraction, number1, number2 ), subtraction( number1, number2 ) );
} else {
	console.log( showErrorMessage( operationSignalSubtraction ) );
}

var operationSignalMultiplication = "*";
var multiplication = calculator(operationSignalMultiplication);
if ( multiplication ) {
	number1 = 30;
	number2 = 50;
	console.log( showOperationMessage( operationSignalMultiplication, number1, number2 ), multiplication( number1, number2 ) );
} else {
	console.log( showErrorMessage( operationSignalMultiplication ) );
}

var operationSignalDivision = "/";
var division = calculator(operationSignalDivision);
if ( division ) {
	number1 = 30;
	number2 = 50;
	console.log( showOperationMessage( operationSignalDivision, number1, number2 ), division( number1, number2 ) );
} else {
	console.log( showErrorMessage( operationSignalDivision ) );
}
...
if ( mod ) {
	number1 = 30;
	number2 = 50;
	console.log( showOperationMessage( operationSignalMod, number1, number2 ), mod( number1, number2 ) );
} else {
...
*/
var operationSignalInvalid = "ola";
var invalid = calculator(operationSignalInvalid);
if ( invalid ) {
	number1 = 30;
	number2 = 50;
	console.log( showOperationMessage( operationSignalInvalid, number1, number2 ), invalid( number1, number2 ) );
} else {
	console.log( showErrorMessage( operationSignalInvalid ) );
}
})();
