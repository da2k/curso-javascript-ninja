(function(){
  ...
  */
  ...
  // Minha solução
  function isOperatorValid(params) {
    return params === '+' ||
      params === '-' ||
      params === '*' ||
      params === '/' ||
  ...
  */
  function calculator(params) {
    if (!isOperatorValid(params)) {
      return false
    }
    function segFunc(num1, num2) {
      if (typeof num1  !== 'number' || typeof num2 !== 'number') {
        return false;
      }
      return operation[params](num1, num2)
    }
  }
  ...
  */
  function showOperationMessage(op, num1, num2){
    return 'A operação ' + num1 + ' ' + op + ' ' + num2 + ' =' + num1 + op + num2;
  }
