  ...
  var operation =  {
    ...
    */
    function calculator (op){
        return (isOperatorValid(op)) ? function(num1,num2){
            return (typeof num1 === 'number' && typeof num2 === 'number') ? operation[op](num1,num2) : false;
        } : false;
    }
    ...
    */
    function showErrorMessage(op){
        return (isOperatorValid(op)) ? true : 'Operação ' + op + ' não permitida! ';
    }
    ...
    */
    if(sum){
        number1 = 3;
        number2 = 4;
        console.log(showOperationMessage(operationSignal,number1,number2),sum(3,4))
    }else{
    ...
    */
   operationSignal = 'a';
   var opErr = calculator(operationSignal);

   if(opErr){
    number1 = 3;
    number2 = 4;
    console.log(showOperationMessage(operationSignal,number1,number2),opErr(number1,number2));
    }else{
    console.log(showErrorMessage(operationSignal));
    }
