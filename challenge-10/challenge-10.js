...
(function() {
  ...
  */
  ...
  function isOperatorValid(operador) {
    return !!operation[operador]; // pegando o equivalente boleano (falsy amd truthy)
    // return operation[operador] !== undefined; //se dentro do operation tiver o valor do operador, ele retorna true
    //return (operator === '+' || operator === '-' || operator === '*' || operator === '/' || operator === '%');  // ou podemos fazer assim, mas caso colocamos outro parâmetro dentro de operation, eu devo colocar aqui.
  }
  ...
  function calculator(operador) {
    ...
    return function(number1, number2) {
      if (typeof number1 !== 'number' || typeof number2 !== 'number') {
        ...
        return operation[operador](number1, number2); //retorna da função '()'
      }
    }
  }
  //calculator('+')(2, 5);
  ...
  */
  function showOperationMessage(param1, param2, param3) {
    return 'A operação ' + param2 + ' ' + param1 + ' ' + param3 + ' ' + '=';
  }
  ...
  */
  ...
  if (subtraction) {    
    number1 = 0;
    number2 = 10;
    console.log(showOperationMessage(operationSignal, number1, number2), sum(
      number1, number2));
  } else {
    console.log(showErrorMessage(operationSignal));
  }
