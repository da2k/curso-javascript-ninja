(function () {
    ...
    */
    ...
    function isOperatorValid(operator) {
        //Outa forma, function booleanamente é true, e undefined false. Logo posso fazer isso:
        return !!operation[operator];

        //melhor prática, pois se alterar algo no meu objeto, não precisarei de alterar na minha função
        //se der um console no operation[''], com valor que não é propriedade, ele retorna undefined, por isso diferente p pegar os que há
        //return operation[operator] !== undefined;
        //return operation[operator] !== undefined;


        //faz a verificação na expressão e retorna boolean
    ...
    //console.log('Teste com operador: ',isOperatorValid('+'));
    ...
    */
    ...
    //console.log('Chamando a função calculator: ',calculator('+')(1,10));
    ...
    */
    if(sum){            //Function tem valor true
        number1= 10;
        number2= 1;
