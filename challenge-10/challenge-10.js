(function () {
    ...
    */
    ...
    var operation = {
        '+': function (primeiroOperador, segundoOperador) {
    ...
    */
    function isOperatorValid(operador) {
        return Boolean(operation[operador]);
    }
    ...
    */
    function calculator(operador) {
        if (isOperatorValid(operador)) {
            return function (primeiroOperador, segundoOperador) {
                if (typeof primeiroOperador !== 'number' || typeof segundoOperador !== 'number') {
                    return false;
                }

                return operation[operador](primeiroOperador, segundoOperador);
            };
        }
    ...
    */
    function showOperationMessage(operador, primeiroOperador, segundoOperador) {
        return 'A operação ' + primeiroOperador + ' ' + operador + ' ' + segundoOperador + ' ';
    }
