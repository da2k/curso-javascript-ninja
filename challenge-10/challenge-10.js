(function() {
    ...
    */
    function isOperatorValid(operador) {       
        while ( typeof operation[operador] === 'function'){
            return true;
        }
        return false;
    }
    ...
    */
    function calculator( operador ) {
        ...
        function caseTrue( a, b ) {
            return bothNumbers( a, b ) ? operation[ operador ]( a, b ) : false;
            
        }

        return isOperatorValid( operador ) ? caseTrue : false;
    }
    ...
    */
    console.log("Sum é verdadeiro ou falso? " + !!sum);
    number1 = 10;
    number2 = 17;
    console.log( showOperationMessage(operationSignal, number1, number2), sum(number1, number2) );

    // Caso sum fosse false
    ...
    */
    ...
    console.log("Subtraction é verdadeiro ou falso? " + !!subtraction);
    number1 = 20;
    number2 = 17;
    ...
    console.log("Multiplication Qual o tipo de multiplication? " + !!multiplication);
    number1 = 17;
    number2 = 17;
    ...
    console.log("Division é verdadeiro ou falso? " + !!division);
    number1 = 34;
    number2 = 17;
    ...
    console.log("Mod é verdadeiro ou falso? " + !!mod);
    number1 = 20;
    number2 = 17;
    ...
    */
    ...
    console.log("É verdadeiro ou falso? " + !!invalid);
    number1 = 10;
    number2 = 20;
