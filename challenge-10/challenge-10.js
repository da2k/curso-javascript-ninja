...
(function() {
    ...
    */
    ...
    if( !sum ) console.log(showErrorMessage(sum));
    else {
        n1 = 10;
        n2 = 10;
    ...
    */
    ...
    if( !subtraction ) console.log(showErrorMessage(operationSignal));
    else {
        n1 = 10;
        n2 = 10;
    ...
    if( !multiplication ) console.log(showErrorMessage(operationSignal));
    else {
        n1 = 10;
        n2 = 10;
    ...
    if( !division ) console.log(showErrorMessage(operationSignal));
    else {
        n1 = 10;
        n2 = 10;
    ...
    if( !mod ) console.log(showErrorMessage(operationSignal));
    else {
        n1 = 10;
        n2 = 10;
    ...
    */
    ...
    if( !invalid ) console.log(showErrorMessage(operationSignal));
    else {
        n1 = 10;
        n2 = 10;
        console.log(showOperationMessage(invalid, n1, n2), invalid(n1,n2));
    }
