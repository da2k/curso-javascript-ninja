(function() {
    ...
    */
    function isOperatorValid( operator ) {
        // Aqui testamos o equivalente booleano direto na propriedade do objeto, como é uma função, o retorno é "true", caso a propriedade não exista, o retorno é "false".
