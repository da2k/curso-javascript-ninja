(function() {
  ...
  */
  function showOperationMessage(oper, number1, number2) {
    return 'A operação ' + number1 + ' ' + oper + ' ' + number2 + ' =';
  }
  ...
  */
  operationSignal = 'casa';
  var casa = calculator(operationSignal);
  if(casa !== false) {
    number1 = 30;
    number2 = 15;
    console.log( showOperationMessage(operationSignal, number1, number2), casa(number1, number2) );
  } else {
    console.log( showErrorMessage(operationSignal) );
  }
})();