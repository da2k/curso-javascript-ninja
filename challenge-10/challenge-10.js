(function() {
    ...
    */
    var operation = {
        "+": function(valUm, valDois) {
            return valUm + valDois;
        },
        "-": function(valUm, valDois) {
            return valUm - valDois;
        },
    ...
    */
    function calculator(operator) {
        ...
        return function(valUm, valDois) {
            if (typeof valUm !== "number" || typeof valDois !== "number") {
                return false;
            }

            return operation[operator](valUm, valDois);
        };
    }
    ...
    */
    function showOperationMessage(operator, valUm, valDois) {
        return "A operação " + valUm + " " + operator + " " + valDois + " =";
    }
