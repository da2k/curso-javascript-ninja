(function() {
	...
	*/
	function showOperationMessage(operador, v1, v2) {
		return 'A operação ' + v1 + ' ' + operador + ' ' + v2 + ' =';
	}
	...
	*/
	function showErrorMessage(operadorErro) {
		return 'Operação "' + operadorErro + '" não permitida!';
	}
	...
	*/
	...
	operationSignal = '#';
	var sharp = calculator(operationSignal);
	if (!!sharp) {
		number1 = 10;
		number2 = 2;
		console.log(showErrorMessage(operationSignal), sharp(number1, number2));
	} else {
		console.log(showErrorMessage(operationSignal));
	}	
