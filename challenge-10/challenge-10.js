...
(function(){ 
    ...
    */
    ...
    var concat = String('10') + String('10'); // também pode ser 10 + String('10');
    ...
    */
    ...
    operationSignal = '-';
    var substract = calculator(operationSignal);
    if( substract ) {
        number1 = 8;
        number2 = 11;
        console.log( showOperationMessage( operationSignal, number1, number2 ), substract( number1, number2 ) );
    } else {
        console.log( showErrorMessage( operationSignal ) );
    }
