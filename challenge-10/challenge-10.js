(function() {
 ...
 if(sum ) {
   ...
   console.log(showErrorMessage(operationSignal, n1, n2), sum(n1, n2));
 }
  ...
  */
  ...
  if(subtraction) {
    ...
    console.log(showErrorMessage(operationSignal, n1, n2), subtraction(n1, n2));
  }
  ...
  if(multiplication) {
   ...
   console.log(showErrorMessage(operationSignal, n1, n2), multiplication(n1, n2));
  }
  ...
  if(division) {
   ...
   console.log(showErrorMessage(operationSignal, n1, n2), division(n1, n2));
  }
  ...
  if(mod) {
   ...
   console.log(showErrorMessage(operationSignal, n1, n2), mod(n1, n2));
  }
 ...
 if(invalid) {
  n1 = 10;
  n2 = 20;
  console.log(showOperationMessage(operationSignal, n1, n2), invalid(n1, n2));
 } else {
  console.log(showErrorMessage(operationSignal, n1, n2), invalid(n1, n2));
 }
})();
