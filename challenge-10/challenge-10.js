(function() { /*
    ...
    */
    operationSignal = '-';
    subtracao = calculator(operationSignal);
    ...
    operationSignal = '*';
    multiplicacao = calculator(operationSignal);
    ...
    operationSignal = '*';
    divisao = calculator(operationSignal);
    ...
    operationSignal = '*';
    resto = calculator(operationSignal);
    ...
    */
    operationSignal = 'testeInvalid';
    testeInvalid = calculator(operationSignal);

    if (testeInvalid) {
        number1 = 10;
        number2 = 5;
        console.log(showOperationMessage(operationSignal, number1, number2), 
                                            testeInvalid(number1, number2));
       } else {
        console.log(showErrorMessage(operationSignal));
    }
}) ();