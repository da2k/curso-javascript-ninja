...
(function() {
  ...
  */
  function isOperatorValid( op ) {
    return typeof operation[op] === 'function';
  }
  ...
  */
  var calculator = function calculator( op ) {
  ...
  */
  var showOperationMessage = function showOperationMessage( op, x, y ) {
  ...
  */
  var showErrorMessage = function showErrorMessage ( op ) {
  ...
  */
  operationSignal = 'foo';
  var bar = calculator( operationSignal );

  if(bar) {
    console.log( showOperationMessage( operationSignal, number1, number2 ), bar( number1, number2 ) );
  } else {
    console.log( showErrorMessage( operationSignal) );
  }
