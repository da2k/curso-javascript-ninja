(function() {
    ...
    */
    function isOperatorValid(operador) {
        ...
        while( operador === String('+') || operador === String('-') || operador === String('*') || operador === String('/') || operador === String('%')  ){
            return true;
        }
        return false;
        */
        /*
        correção do fernando. Se o operador exite no objeto, retorna true, pq possui a função, senão, retorna undefined, assim, podemos verificar se for diferente de undefined.
        */
        //return operation[operador] !== undefined;

        /* podemos fazer o retorno boleano, levando em conta os valores thruthy e falsy.
            valor [function] é thruty e undefined é falsy. Assim, incluido os operadores de Not (pontos de exclamação), retornamos o valor boleano. 
        */
    ...
    */
    function calculator(operador){
        return isOperatorValid(operador)? function( x, y ){
