(function() {
  ...
  */
  function calculator( operator ){
    ...
    return operation[ operator ](numb1, numb2);
    };
  };
  ...
  */
  function showOperationMessage ( operator, numb1, numb2){
    return 'A operação '+ numb1 + ' ' + operator + ' ' + numb2 + ' =';
  }
  ...
  */
  if ( sum ) {
    number1 = 15;
    number2 = 12;
    console.log( showOperationMessage( operationSignal, numb1, numb2), sum(numb1,numb2));
  }
  else {
  ...
  */
  operationSignal = '-'
  var subtaction = calculator (operationSignal);
  if ( subtraction ) {
    number1 = 50;
    number2 = 10;
  ...
  */
  ...
  if ( invalid ) {
    number1 = 50;
    number2 = 10;
    console.log( showOperationMessage( operationSignal(), number1, numb2) , invalid( number1, numb2 )  )
  } 
  else{
    console.log ( showErrorMessage ( operationSignal ) );
  }
