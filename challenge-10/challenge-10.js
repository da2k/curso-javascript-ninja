...
console.log( '"' + concat + '" é uma string? E é igual a "1010"?', typeof concat.valueOf() === 'string' );
...
*/
    function calculator(operador){
        if(!isOperatorValid(operador)){
            console.log('Operador invalido seu animal')
            return false
        }else{
...
*/
 function showOperationMessage(operador, a, b){
     return 'A operacao '+a+' '+operador+' '+b+' = '
 }
...
*/
 function showErrorMessage(operador){
     return 'Operacão '+operador+' não permitida!'
 }
