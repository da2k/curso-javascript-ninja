(function () {
	...
	*/
	...
	function executeCalc(callback, operationSignal, number1, number2) {
		if(callback) {
			console.log(showOperationMessage(operationSignal, number1, number2), callback(number1, number2));
		} else {
			console.log(showErrorMessage(operationSignal));
		}		
	}
	
	executeCalc(sum, operationSignal, number1 = 20, number2 = 30);
	...
	*/
	...
	executeCalc(sub, operationSignal, number1 = 500, number2 = 500);
	

	operationSignal = '*';
	var mult = calculator( operationSignal );
	executeCalc(mult, operationSignal, number1 = 25, number2 = 52);
	

	operationSignal = '/';
	var div = calculator( operationSignal );
	executeCalc(div, operationSignal, number1 = 100, number2 = 10);
	

	operationSignal = '%';
	var mod = calculator( operationSignal );
	executeCalc(mod, operationSignal, number1 = 200, number2 = 20);
	...
	*/
	...
	executeCalc(sum2, operationSignal, number1 = 20, number2 = 30);
