...
(function () {
    ...
    */
    var show = showOperationMessage(operationSignal, number1, number2);
    var calc = sum(number1, number2);
    var error = showErrorMessage(operationSignal);
    sum ? console.log(show, calc) : console.log(error);
    ...
    */
    ...
    var show = showOperationMessage(operationSignal, number1, number2);
    var calc = subtraction(number1, number2);
    var error = showErrorMessage(operationSignal);
    subtraction ? console.log(show, calc) : console.log(error);
    // multiplicação
    operationSignal = "*";
    var multiplication = calculator(operationSignal);
    var show = showOperationMessage(operationSignal, number1, number2);
    var calc = multiplication(number1, number2);
    var error = showErrorMessage(operationSignal);
    multiplication ? console.log(show, calc) : console.log(error);
    // division
    operationSignal = "/";
    var division = calculator(operationSignal);
    var show = showOperationMessage(operationSignal, number1, number2);
    var calc = division(number1, number2);
    var error = showErrorMessage(operationSignal);
    division ? console.log(show, calc) : console.log(error);
    // mod
    operationSignal = "%";
    var mod = calculator(operationSignal);
    var show = showOperationMessage(operationSignal, number1, number2);
    var calc = mod(number1, number2);
    var error = showErrorMessage(operationSignal);
    mod ? console.log(show, calc) : console.log(error);
    ...
    */
    ...
    var show = showOperationMessage(operationSignal, number1, number2);
    var error = showErrorMessage(operationSignal);
    operation ? console.log(show, calc) : console.log(error);
})()
