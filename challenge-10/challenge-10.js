(function(){
  ...
  */
  var five = '5';
  console.log( five + ' é number?', typeof Number(five) === 'number' );
  ...
  */
  ...
  console.log(showOperationMessage(operationSignal, number1, number2), sum(number1, number2) || sum(number1, number2) == 0 ? sum(number1, number2) : showErrorMessage(operationSignal));
  ...
  */
  ...
  console.log(showOperationMessage(operationSignal, number1, number2), subtraction(number1, number2) || subtraction(number1, number2) == 0 ? subtraction(number1, number2) : showErrorMessage(operationSignal));
  
  operationSignal = "*";
  var multiplication = calculator(operationSignal);
  console.log(showOperationMessage(operationSignal, number1, number2), multiplication(number1, number2) || multiplication(number1, number2) == 0 ? multiplication(number1, number2) : showErrorMessage(operationSignal));

  operationSignal = "/";
  var division = calculator(operationSignal);
  console.log(showOperationMessage(operationSignal, number1, number2), division(number1, number2) || division(number1, number2) == 0 ? division(number1, number2) : showErrorMessage(operationSignal));
  
  operationSignal = "%";
  var mod = calculator(operationSignal);
  console.log(showOperationMessage(operationSignal, number1, number2), mod(number1, number2) || mod(number1, number2) == 0 ? mod(number1, number2) : showErrorMessage(operationSignal));
  ...
  */
  operationSignal = "s";
  var mod = calculator(operationSignal);
  console.log(showOperationMessage(operationSignal, number1, number2), (typeof mod == "function") ? mod(number1, number2) : showErrorMessage(operationSignal));
