(function(){
    ...
    */
    var five = Number('5');
    // five === '5' ? five = 5 : five = true;
    console.log( five + ' é número?', typeof five === 'number' );

    var concat = String(10) + String(10);
    // concat === 10 + 10 ? concat = '10' + '10' : concat = true;
    ...
    */
    function isOperatorValid(param){
        // var result = param === '+' ? true : param === '-' ? true : param === '*' ? true : param === '/' ? true : param === '%' ? true : false ;
        // return result;
    ...
    */
    ...
    //A operação 80 / 7 = 11.428571428571429
