...
*/
function showOperationMessage(op,p1,p2){
console.log('A operação '+p1+' '+op+' '+p2+' =');
}
...
function showErrorMessage(op){
  console.log('Operação "'+op+'" não permitida!');
}
...
*/
  if (sum){
      number1 = 14;
      number2 = 19;
      console.log( showshowOperationMessage( operationSignal, number1, number2), sum( number1, number2) );
  }
  else{
...
*/
  operationSignal='-';
  var minus= calculator(operationSignal);
  if (minus){
      number1 = 32;
      number2 = 5;
      console.log( showshowOperationMessage( operationSignal, number1, number2), sum( number1, number2) );
