...
function isOperatorValid( operator ){
    return operationo[operator] !== undefined;
}
/*
...
function calculator ( operator ) {
    ...
    return function ( x, y) {
        ...
        return operationo[ operator] (x, y);
    };
}
/*
...
function showOperationMessage ( operator, number1, number2){
    return 'A operação ' + number1 + ' ' + operator + ' ' number2 + number2 + ' =';
}
/*
...
*/
operationSignal = '+';  
var sum = calculator ( operatinsSinal );
...
if ( sum ) {
    ...
    console.log(showErrorMessage(operatioSignal));
}
