(function(){
	...
	*/
	var five = '5';
	five = new Number(five).valueOf();
	console.log( five + ' é número?', typeof five === 'number' );

	var concat = new String('10' + '10').valueOf();
	...
	*/
	...
	// console.log(isOperatorValid('teste'));
	...
	*/
	function exe (operation) {
		if (operation) {
		console.log(showOperationMessage(operationSignal, number1, number2), calculator(operationSignal)(number1, number2));
		}else {
	...
	*/
	operationSignal = 'hehehe';
	var kkk = calculator(operationSignal);
	exe(kkk);
})();