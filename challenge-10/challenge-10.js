...
console.log( '"' + String(concat) + '" é uma string? E é igual a "1010"?', typeof concat === 'string' );
...
function showOperationMessage(operador, number1, numer2){
...
var operationSignal = 'TesteMensagemErro';
var mod = calculator(operationSignal);
