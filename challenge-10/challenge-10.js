...
if (!!mult !== false) {
   num1 = 10;
   num2 = 12;
   console.log(showOperationMessage(operationSignal, num1, num2), mult(num1, num2))
} else{
   console.log(showErrorMessage(operationSignal));
}
...
if (!!sub !== false) {
  ...
  */
 operationSignal = 'f';
 var errado = calculator(operationSignal);
 if (!!errado !== false) {
    num1 = 10;
    num2 = 12;
    console.log(showOperationMessage(operationSignal, num1, num2), errado(num1, num2))
} else{
    console.log(showErrorMessage(operationSignal));
}
}());
