(function () {
    ...
    */
    var operation = {
        '+': function name(number1, number2) { return number1 + number2; },
        '-': function name(number1, number2) { return number1 - number2; },
        '*': function name(number1, number2) { return number1 * number2; },
        '/': function name(number1, number2) { return number1 / number2; },
        '%': function name(number1, number2) { return number1 % number2; },
    ...
    */
    function imprimir(operacao) {
        if (operacao)
            return showOperationMessage(operationSignal, number1, number2);
        return showErrorMessage(operationSignal);
    }
    number1 = 5;
    number2 = 8;
    console.log(imprimir(sum), sum(number1, number2));
    ...
    */
    ...
    number1 = 10;
    number2 = 2;
    console.log(imprimir(subtraction), subtraction(number1, number2));

    operationSignal = '*';
    var multiplication = calculator(operationSignal);
    number1 = 8;
    number2 = 7;
    console.log(imprimir(multiplication), multiplication(number1, number2));

    operationSignal = '/';
    var division = calculator(operationSignal);
    number1 = 10;
    number2 = 5;
    console.log(imprimir(division), division(number1, number2));

    operationSignal = '%';
    var mod = calculator(operationSignal);
    number1 = 5;
    number2 = 2;
    console.log(imprimir(mod), mod(number1, number2));
