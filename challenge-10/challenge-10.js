(function () {
    ...
    */
    operationSignal = '$';
    var notAllowedOperation = calculator(operationSignal);
    if (notAllowedOperation) {
        number1 = 12;
        number2 = 22;
        console.log(showOperationMessage(operationSignal, number1, number2), notAllowedOperation(number1, number2));
    } else {
        console.log(showErrorMessage(operationSignal));
    }
})();