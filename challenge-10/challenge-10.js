(function() {
	...
	*/
		function isOperatorValid(operator) {
			while(operation[operator] !== undefined) {
				return true;
			}
			return false;
		}
		function isNumber(num1, num2) { return typeof num1 === 'number' && typeof num2 === 'number' ? true : false;	}
	...
	*/
	function calculator(operator) {
		return isOperatorValid(operator) ? function(paramUm, paramDois) {
			return isNumber(paramUm, paramDois) ? operation[operator](paramUm,paramDois) : false;
		} : false;
	}
