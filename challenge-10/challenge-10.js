(function () {
  ...
  */
  ...
  if (subtracao) {
    num1 = 10;
    num2 = 5;
    console.log(showOperationMessage(operationSignal, num1, num2), subtracao(num1,num2));
  } else {
    console.log(showErrorMessage(operationSignal));
  }
  ...
  */
  ...
  if (invalido) {
    num1 = 6;
    num2 = 5;
    console.log(showOperationMessage(operationSignal, num1, num2), invalido(num1,num2));
  } else {
    console.log(showErrorMessage(operationSignal));
  }
