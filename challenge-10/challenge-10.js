(function() {
  ...
  */
  var operation = {
    ...
    '%' : function mod(n1, n2){return n1 % n2;}
  };
  ...
  function calculator(oper) {
    if (!isOperatorValid(oper)) {
      ...
      return function (n1, n2) {        
        return (typeof n1 !== 'number' || typeof n2 !== 'number') ? false : operation[oper](n1, n2);   
      }
  }
  ...
  */
  function showErrorMessage(oper) {
    return !(isOperatorValid(oper)) ? 'Operação ' + oper + ' não permitida!' : '';
  }
 ...
 operationSignal = '-';
  ...
  operationSignal = '/';
  var divis = calculator(operationSignal);
  if (divis) {
    number1 = 8;
    number2 = 3;
    console.log(showOperationMessage(operationSignal, number1, number2), divis(number1, number2));
  } else {
    console.log(showErrorMessage(operationSignal));
  }
  ...
  */
 operationSignal = 'x';
 var operacaoInvalida = calculator(operationSignal);
 if (operacaoInvalida) {
   number1 = 5;
   number2 = 2;
   console.log(showOperationMessage(operationSignal, number1, number2), operacaoInvalida(number1, number2));
 } else {
   console.log(showErrorMessage(operationSignal));
 }
})();