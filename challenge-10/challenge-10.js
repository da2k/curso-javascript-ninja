...
*/
function showOperationMessage(a, b, c) {
    return 'A operação ' +  a + ' ' +  b +  ' ' + c + ' = ';
}
...
if (sub) {
    ...
    if (rest) {
        number1 = 40;
        number2 = 20;
        console.log(showOperationMessage(number1, operationSignal, number2), rest(number1, number2));
    }
    else{
    //console.log(showErrorMessage(sum);
        console.log(showErrorMessage(operationSignal));
...
if (invalid) {
    number1 = 10;
    number2 = 20;
    console.log(showOperationMessage(number1, operationSignal, number2), invalid(number1, number2));
}
else{
    console.log('teste');
    //console.log(showErrorMessage(sum);
