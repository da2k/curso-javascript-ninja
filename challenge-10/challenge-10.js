 (function() { 
    ...
    */
    ...
    "multiplication", "division" e "invalid".
    */
   operationSignal = '-';
   ...
   if( subtraction ) {
    number1 = 5;
    number2 = 2;
    console.log( showOperationMessage( operationSignal, number1, number2 ), subtraction( number1
        , number2 ) );
   ...
   if( multiplication ) {
    number1 = 50;
    number2 = 1;
    console.log( showOperationMessage( operationSignal, number1, number2 ), multiplication( number1
        , number2 ) );
   ...
   if( division ) {
    number1 = 20;
    number2 = 3;
    console.log( showOperationMessage( operationSignal, number1, number2 ), division( number1
        , number2 ) );
   ...
   if( mod ) {
    number1 = 4;
    number2 = 3;
    console.log( showOperationMessage( operationSignal, number1, number2 ), mod( number1
        , number2 ) );
    ...
    */
   operationSignal = 'oioi';
   var invalid = calculator( operationSignal );
   if( invalid ) {
    number1 = 14;
    number2 = 31;
    console.log( showOperationMessage( operationSignal, number1, number2 ), invalid( number1
        , number2 ) );
