((function() {
	...
	*/
	if ( sum ) {
		number1 = 8;
		number2 = 2;
		console.log(showErrorMessage( operationSignal, number1, number ), sum( number1, number2 ));
	}else {
	...
	*/
	...
	var subtraction = calculator(operationSignal);
		...
		number1 = 8;
		number2 = 2;
		console.log(showErrorMessage( operationSignal, number1, number ), subtraction( number1, number2 ));
	}else {
		console.log(showErrorMessage(operationSignal));
	}	
	...
	var multiplication = calculator(operationSignal);
		...
		number1 = 8;
		number2 = 2;
		console.log(showErrorMessage( operationSignal, number1, number ), multiplication( number1, number2 ));
	}else {
		console.log(showErrorMessage(operationSignal));
	}
	...
	var division = calculator(operationSignal);
		...
		number1 = 8;
		number2 = 2;
		console.log(showErrorMessage( operationSignal, number1, number ), division( number1, number2 ));
	}else {
		console.log(showErrorMessage(operationSignal));
	}
	...
	var division = calculator(operationSignal);
		...
		number1 = 8;
		number2 = 2;
		console.log(showErrorMessage( operationSignal, number1, number ), mod( number1, number2 ));
	}else {
		console.log(showErrorMessage(operationSignal));
	}
