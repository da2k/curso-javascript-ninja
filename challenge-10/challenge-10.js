(function () {
  ...
  */
  sum ? console.log(showOperationMessage(number1 = 10, number2 = 90, operationSignal), sum(number1, number2))
  ...
  */
  ...
  subtraction ? console.log(showOperationMessage(number1 = 100, number2 = 87, operationSignal), subtraction(number1, number2))
  : console.log (showErrorMessage(operationSignal))

  operationSignal = '*'
  var multiplication = calculator(operationSignal)
  multiplication ? console.log(showOperationMessage(number1 = 13, number2 = 99, operationSignal), multiplication(number1, number2))
  : console.log (showErrorMessage(operationSignal))

  operationSignal = '/'
  var division = calculator(operationSignal)
  division ? console.log(showOperationMessage(number1 = 1287, number2 = 128, operationSignal), division(number1, number2))
  : console.log (showErrorMessage(operationSignal))
  
  operationSignal = '%'
  var mod = calculator(operationSignal)
  mod ? console.log(showOperationMessage(number1 = 10, number2 = 2, operationSignal), mod(number1, number2))
  : console.log (showErrorMessage(operationSignal))
  ...
  */
  operationSignal = 'NINJA'
  var deuRuim = calculator(operationSignal)
  deuRuim ? console.log(showOperationMessage(number1 = 10, number2 = 90, operationSignal), deuRuim(number1, number2))
  : console.log(showErrorMessage(operationSignal))
})()
