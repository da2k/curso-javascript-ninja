(function(){
    ...
    */
    ...
    tamanhodoArraydeOperacoes = operation.length

    function isOperatorValid(operador, operation, tamanhodoArraydeOperacoes){
        for(let contador = 0; contador < tamanhodoArraydeOperacoes; contador++){
            if(operador == operation[contador]){
                return true;
            }
        }
        return false;    
    ...
    console.log(isOperatorValid("+", operation, tamanhodoArraydeOperacoes))
    ...
    */
    ...
    function fazercalculo(operador){
            if (isOperatorValid(operador, operation, tamanhodoArraydeOperacoes) !== false){
    ...
    */
    ...
    function showOperationMessage(number1, operator, number2){
        console.log('A operação ' + number1 + ' ' + operator + ' ' + number2 + ' =')
    }
    ...
    */
    ...
    sum = fazercalculo(operationSignal)
    ...
    */
    ...
    showOperationMessage(number1, operationSignal,number2)
    sum(number1,number2)
    ...
    */
    ...
    subtraction = fazercalculo(operationSignal)
    multiplication = fazercalculo(operationSignal)
    division = fazercalculo(operationSignal)
    mod = fazercalculo(operationSignal)
