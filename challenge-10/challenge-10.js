...
if (sum) {
    number1 = 10;
    number2 = 12;
    console.log( showOperationMessage(sumSignal, number1, number2), sum(number1, number2) );
}
else {
    console.log(showErrorMessage(sumSignal) );
}
...
var subtractSignal = '-';
var subtraction = calculator(subtractSignal);

var multiplicationSignal = '*';
var multiplication = calculator(multiplicationSignal);

var divisionSignal = '/';
var division = calculator(divisionSignal);

var modSignal = '%';
var mod = calculator(modSignal);

var invalidSignal = '>';
var invalid = calculator(invalidSignal);
...
if (invalid) {
    number1 = 14;
    number2 = 18;
    console.log( showOperationMessage(invalidSignal, number1, number2), invalid(number1, number2) );
}
else {
    console.log(showErrorMessage(invalidSignal) );
}
...
if (multiplication) {
    number1 = 14;
    number2 = 18;
    console.log( showOperationMessage(multiplicationSignal, number1, number2), multiplication(number1, number2) );
}
else {
    console.log(showErrorMessage(multiplicationSignal) );
}

if (division) {
    number1 = 14;
    number2 = 18;
    console.log( showOperationMessage(divisionSignal, number1, number2), division(number1, number2) );
}
else {
    console.log(showErrorMessage(divisionSignal) );
}

if (mod) {
    number1 = 14;
    number2 = 18;
    console.log( showOperationMessage(modSignal, number1, number2), mod(number1, number2) );
}
else {
    console.log(showErrorMessage(modSignal) );
}
