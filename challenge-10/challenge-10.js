    ...
    function calculator(operator){
        ...
        if(!isOperatorValid(operator)){
            ...
            return function(a, b) {
             ...
             return operation[ operator ](a, b); // Utilizando o formato de array, pois, as propriedade do 
             // método é uma string e além disso, não se sabe qual o valor que será usado em 
             // operator.
             // Temos acima, o RETORNO DO OBJETO OPERATOR + OS DOIS VALORES PASSADOS COMO PARÂMETROS!
            };
