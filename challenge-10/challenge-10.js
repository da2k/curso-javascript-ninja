(function() {
  ...
  */
  function isOperatorValid(operator) {
    return typeof operator === "string" ? true : false;
  }
  ...
  */
  function showErrorMessage(invalidParam) {
    return "Operação " + invalidParam + " não permitida";
  }
  ...
  */
  if (sum) {
    ...
    num2 = 1;
    console.log(
      showOperationMessage(operationSignal, num1, num2),
      sum(num1, num2)
    );
  } else {
