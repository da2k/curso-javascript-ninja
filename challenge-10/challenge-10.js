(function(){
    ...
    */
    function showOperationMessage(operator, firstNumber, secondNumber) {
        return 'A operação '+ firstNumber +' ' + operator + ' ' + secondNumber + ' =';
    }
    ...
    */
   operationSignal = 'i'
   var wrongOperation = calculator(operationSignal);
   
   if (wrongOperation) {
       number1 = 2;
       number2 = 1;
       console.log(showOperationMessage(operationSignal, number1, number2), wrongOperation(number1, number2));
   } else {
       console.log(showErrorMessage(operationSignal));
   }
})();
