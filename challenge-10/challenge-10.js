...
function calculator(op){
     return !isOperationValid(op) ? false : function(p1,p2){
         return typeof p1 !== 'Number' && typeof p2 !== 'Number' ? false : operation[op](p1,p2);
    }
};
/*
...
*/
function showOperationMessage(number1,number2,op){
