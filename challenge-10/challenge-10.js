(function () {
    ...
    */
    ...
    console.log( isOperatorValid('sum') );
    ...
    */
      operationSignal = 'subtracion';
      var subtracion = calculator(operationSignal);
     if(subtracion) {
      number1 = 10;
      number2 = 12;
      console.log( showOperationMessage( operationSignal, number1, number2), subtracion(number1, number2));
    }
   else {
     console.log( showErrorMessage( operationSignal ) );
   }
  
   operationSignal = 'multiplication';
  ...
  operationSignal = 'division';
    ...
    */
    ...
    operationSignal = 'not';
      var not = calculator(operationSignal);
     if(not) {
      number1 = 25;
      number2 = 3;
      console.log( showOperationMessage( operationSignal, number1, number2), not(number1, number2));
    }
   else {
     console.log( showErrorMessage( operationSignal ) );
   }
