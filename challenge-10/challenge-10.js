(function() {
	...
	*/
	...
	console.log(isOperatorValid('$')); // false
	...
	*/
	...
	function calculator(operator) {
		...
		return function(n1, n2) {
			...
			if(typeof n1 !== 'number' && typeof n2 !== typeof 'number') return false;
	...
	*/
	...
	operationSignal = 'megazorde';
	var incorrect = calculator(operationSignal);
	if( incorrect ) {
		number1 = 10;
		number2 = 25;
		console.log(showOperationMessage(operationSignal, number1, number2), incorrect(number1, number2));
	} else {
		console.log(showErrorMessage(operationSignal));
	}
