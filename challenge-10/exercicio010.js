...
*/
function isOperatorValid(operator){                                           // o operador que existe em no objeto vai ser testado
...
*/
function showOperationMessage(operador,numberOne, numberTwo){
    return ` a operação ${numberOne} ${operador} ${numberTwo} =`; 
}           
...
var sum = operation(operationSingnal); 
...
*/
  if(sum){
      number1 = 10 ; 
      number2 = 12; 
      console.log( showOperationMessage(operationSingnal,number1,number2 ),sum(number1,number2)); 
  } 
  else {
      console.log(showErrorMessage(operationSingnal)) ;
  }
...
// 
var operationSingnal = '+' ; 
var sum = calculator(operationSingnal);  
if(sum){
    number1 = 8 ; 
    number2 = 11; 
    console.log( showOperationMessage(operationSingnal,number1,number2 ),sum(number1,number2)); 
...
var operationSingnal = '-' ; 
var  subtraction = calculator(operationSingnal);  
if(subtraction){
    number1 = 5 ; 
    number2 = 10; 
    console.log( showOperationMessage(operationSingnal,number1,number2 ),sum(number1,number2)); 
...
var operationSingnal = '/' ; 
var division = calculator(operationSingnal);  
if(division){
    number1 = 5 ; 
    number2 = 10; 
    console.log( showOperationMessage(operationSingnal,number1,number2 ),sum(number1,number2)); 
...
var operationSingnal = '*' ; 
var multiplication = calculator(operationSingnal);  
if(multiplication){
    number1 = 8 ; 
    number2 = 11; 
    console.log( showOperationMessage(operationSingnal,number1,number2 ),sum(number1,number2)); 
...
var operationSingnal = '%' ; 
var mod = calculator(operationSingnal);  
if(mod){
    number1 = 8 ; 
    number2 = 11; 
    console.log( showOperationMessage(operationSingnal,number1,number2 ),sum(number1,number2)); 
...
*/
var operationSingnal = 'lala' ; 
var invalid = calculator(operationSingnal);  
if(invalid){
    number1 = 8 ; 
    number2 = 11; 
    console.log( showOperationMessage(operationSingnal,number1,number2 ),sum(number1,number2)); 
