...
*/
console.log( 'O resultado da soma é:', sum(function(parm1, parm2 ) { return parm1 + parm2; }) );
...
*/
var subtraction = calculator(12, 4);
...
chamada.
*/
console.log( 'O resultado da subtração é:' , subtraction(function(parm1, parm2 ) { return parm1 - parm2; }) );
// ?

console.log( 'O resultado da multiplicação é:' , multiplication(function(parm1, parm2 ) { return parm1 * parm2; }) );
// ?

console.log( 'O resultado da divisão é:', division(function(parm1, parm2 ) { return parm1 / parm2; })  );
// ?

console.log( 'O resto da divisão é:', mod(function(parm1, parm2 ) { return parm1 % parm2; })  );
// ?
