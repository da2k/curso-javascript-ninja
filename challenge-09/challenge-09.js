(function () {
    ...
    */
    function calculator(numero1, numero2) {
        return function calculate(callback) {
    ...
    */
    console.log('O resultado da soma é: ' + sum(function (numero1, numero2) { return numero1 + numero2; }));
    ...
    */
    var subtraction = calculator(5, 7);
    ...
    chamada.
    */
    console.log('O resultado da subtração é: ' + subtraction(function (numero1, numero2) { return numero1 - numero2; }));
    // ?

    console.log('O resultado da multiplicação é: ' + multiplication(function (numero1, numero2) { return numero1 * numero2; }));
    // ?

    console.log('O resultado da divisão é: ' + division(function (numero1, numero2) { return numero1 / numero2; }));
    // ?

    console.log('O resto da divisão é: ' + mod(function (numero1, numero2) { return numero1 % numero2; }));
    // ?
}());