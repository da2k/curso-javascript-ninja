(function() {
  ...
  */
  ...
  console.log( sum(function(numb1, numb2) {
      return numb1 + numb2;
  }) );
  ...
  */
  ...
  console.log( subtraction(function(numb1, numb2) {
      return numb1 - numb2;
  }) );

  console.log( 'O resultado da multiplicação é:' );
  console.log( multiplication(function(numb1, numb2) {
      return numb1 * numb2;
  }) );

  console.log( 'O resultado da divisão é:' );
  console.log( division(function(numb1, numb2) {
      return numb1 / numb2;
  }) );

  console.log( 'O resto da divisão é:' );
  console.log( mod(function(numb1, numb2) {
      return numb1 % numb2;
  }) );
})();[[]]
