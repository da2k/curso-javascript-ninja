...
(function(){
    ...
    */
    ...
    function calculator(valorUm,valorDois){
        return function(callback){
            return callback(valorUm,valorDois);
        };
    }
    ...
    */
    var soma = sum(function(valorUm,valorDois){
    ...
    */
    ...
    var subtraction = calculator(10,15),
        multiplication = calculator(4,5),
        division = calculator(150,3),
        mod = calculator(55,2);
    ...
    chamada.
    */
    var subtracao = subtraction(function(valorUm,valorDois){
        return valorUm-valorDois;
    });
    console.log( 'O resultado da subtração é: ' + subtracao );
    // O resultado da subtração é -5
    
    var multiplicacao = multiplication(function(valorUm,valorDois){
        return valorUm*valorDois;
    });
    console.log( 'O resultado da multiplicação é: ' + multiplicacao );
    // O resultado da multiplicação é 20
    
    var divisao = division(function(valorUm,valorDois){
        return valorUm/valorDois;
    });
    console.log( 'O resultado da divisão é: ' + divisao);
    // O resuldado da divisao é 50
    
    var resto = mod(function(valorUm,valorDois){
        return valorUm%valorDois;
    });
