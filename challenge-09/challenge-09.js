...
*/
    ...
    myFunction3();
// eu deixei a função no final apenas para testar o esquema de hoisting que vc passou.
...
*/
    ...
    console.log( 'O resultado da soma é:', sum(soma) );
// ?
...
*/
 ...
 var multiplication = calculator( 7, 3);
 var division = calculator( 840, 420);
...
*/
    ...
    console.log( 'O resultado da subtração é:', subtraction(sub));
// ?
    var mult = function( x, y ) {
        return x * y;
    };
    console.log( 'O resultado da multiplicação é:', multiplication(mult) );
// ?
    var divi = function( x, y ) {
        return x / y;
    };
    console.log( 'O resultado da divisão é:', division(divi) );
// ?
    var resto = function( x, y ) {
        return x % y;
    };
    console.log( 'O resto da divisão é:', mod(resto) );
// ?
})();
