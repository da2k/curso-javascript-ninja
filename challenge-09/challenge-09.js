(function() {
    ...
    */
    console.log( 'O resultado da soma é: ' + sum(function(valu1, valu2) {return valu1 + valu2}) + '');
    ...
    */
   var subtraction = calculator( 23,10 );
   var multiplication = calculator( 2,4 );
   var division = calculator( 19,4 );
   var mod = calculator( 50,30 );
    ...
    */
    ...
    console.log( subtraction(function( valu1, valu2 ) {
        return valu1 - valu2;
    }) );


    console.log( 'O resultado da multiplicação é:' );
    console.log( multiplication(function( valu1, valu2 ) {
        return valu1 * valu2;
    }) );

    console.log( 'O resultado da divisão é:' );
    console.log( division(function( valu1, valu2 ) {
        return valu1 / valu2;
    }) );

    console.log( 'O resto da divisão é:' );
    console.log( mod(function( valu1, valu2 ) {
        return valu1 % valu2;
    }) );
})();
