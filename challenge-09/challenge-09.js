...
(function(){
    ...
    */
    ...
    var division = calculator(150, 10);
    ...
    */
    ...
    console.log( subtraction( function( n, n2 ){ 
        return n - n2;
    }) );

    console.log( 'O resultado da multiplicação é:' );
    console.log( multiplication( function( n, n2 ){ 
        return n * n2;
    }) );

    console.log( 'O resultado da divisão é:' );
    console.log( division( function( n, n2 ){ 
        return n / n2;
    }) );

    console.log( 'O resto da divisão é:' );
    console.log( mod( function( n, n2 ){ 
        return n % n2;
    }) );
})();