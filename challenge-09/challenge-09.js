(function () {
  ...
  */
  const subtraction = calculator(24, 12);
  const multiplication = calculator(10, 500.4);
  const division = calculator(540, 10);
  const mod = calculator(2, 10);
  ...
  */
  ...
  console.log(subtraction((x, y) => x - y)); // 12

  console.log('O resultado da multiplicação é:');
  console.log(multiplication((x, y) => x * y)); // 5004

  console.log('O resultado da divisão é:');
  console.log(division((x, y) => x / y)); // 54

  console.log('O resto da divisão é:');
  console.log(mod((x, y) => x % y)); // 2
