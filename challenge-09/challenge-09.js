...
(function() {
    ...
    */
    ...
    chamada.
    */
   var subtr = subtraction(function(n1, n2) {
        return n1 - n2;
   });
    console.log( 'O resultado da subtração é: ' + subtr );
    
    
    var mult = multiplication(function(n1, n2) {
        return n1 * n2;
    });
    console.log( 'O resultado da multiplicação é: ' + mult );
    
    
    var div = division(function(n1, n2) {
        return n1 / n2;
    });
    console.log( 'O resultado da divisão é: ' + div);
    
    var rModulo = mod(function(n1, n2) {
        return n1 % n2;
    });
    console.log( 'O resto da divisão é: ' + rModulo );
