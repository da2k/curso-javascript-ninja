(function(){
  ...
  */
  function myFunction() {
    ...
    var number2 = 20;
    console.log('-----------------------------------');
    console.log( 'Na função '+ myFunction.name +', o primeiro número é', number1 );
    console.log( 'Na função '+ myFunction.name +', o segundo número é', number2 );
    console.log('-----------------------------------');
  ...
  */
  function myFunction2() {
    ...
    console.log( 'A soma de '+ number1 +' e '+ number2 +' é igual a', sum ? sum() : undefined );
    console.log('-----------------------------------');
    return sum();
  };
  myFunction2();
  ...
  */
  function myFunction3() {
    ...
    console.log( 'Na função '+ myFunction3.name +', '+number1+' é igual a', number1 );
    console.log('-----------------------------------');
    return sum();
  };
  myFunction3();
  ...
  */
  ...
  console.log( 'O resto da mod é: '+ mod(function(number1, number2){
    return number1 % number2;
  }));
})();
