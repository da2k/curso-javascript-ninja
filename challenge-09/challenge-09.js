(function() {
  ...
  */
  ...
  console.log( sum(function (numero1, numero2){ return numero1 + numero2;  } ) )
  //10
  ...
  */
  ...
  console.log( subtraction(function (numero1, numero2){ return numero1 - numero2;  } ) )
  //0

  console.log( 'O resultado da multiplicação é:' );
  console.log( multiplication(function (numero1, numero2){ return numero1 * numero2;  } ) )
  //36

  console.log( 'O resultado da divisão é:' );
  console.log( division(function (numero1, numero2){ return numero1 / numero2;  } ) )
  //2

  console.log( 'O resto da divisão é:' );
  console.log( mod(function (numero1, numero2){ return numero1 % numero2;  } ) )
  //1
