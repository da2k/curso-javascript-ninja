...
(function () {
    ...
    */
    function calculator(numero_1, numero_2) {
        return function retorno(callback) {
            return callback(numero_1, numero_2);
        }
    }
    ...
    */
    var resultadoSoma = sum(function (numero_1, numero_2) {
