(function() {
    ...
    */
    ...
    console.log( sum( function( numberOne, numberTwo ) {
    ...
    */
    ...
    var multiplication = calculator( 12, 28 );
    var division = calculator( 32, 48 );
    var mod = calculator( 55, 105 );
    ...
    */
    ...
    console.log( subtraction( function( numberOne, numberTwo ) {
                          return numberOne - numberTwo;
                      } ) );

    console.log( 'O resultado da multiplicação é:' );
    console.log( multiplication( function( numberOne, numberTwo ) {
                          return numberOne * numberTwo;
                      } ) );

    console.log( 'O resultado da divisão é:' );
    console.log( division( function( numberOne, numberTwo ) {
                          return numberOne / numberTwo;
                      } ) );

    console.log( 'O resto da divisão é:' );
    console.log( mod( function( numberOne, numberTwo ) {
                          return numberOne % numberTwo;
                      } ) );
})();
