(function(){
    ...
    */
    ...
    var result = sum( function( x, y ){ return x + y; } );
    console.log(result);
    ...
    */
    var subtraction = calculator( 50, 25 ); var multiplication = calculator( 100, 1 );
    var division = calculator( 50, 30 ); var mod = calculator( 50, 30 );
    ...
    */
    ...
    result = subtraction( function(x, y){ return x - y } );
    console.log(result);
    
    console.log( 'O resultado da multiplicação é:' );
    result = multiplication( function(x, y){ return x * y } );
    console.log(result);
    
    console.log( 'O resultado da divisão é:' );
    result = division( function(x, y){ return x / y } );
    console.log(result);
    
    console.log( 'O resto da divisão é:' );
    result = mod( function(x, y){ return x % y } );
    console.log(result);
