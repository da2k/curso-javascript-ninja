...
(function(){
  ...
  */
  ...
  console.log(sum(function(val1, val2){ return val1 + val2 }))
  ...
  */
  var subtraction = calculator(20, 8)
  var multiplication = calculator(20, 10)
  var division = calculator(500, 10)
  ...
  */
  ...
  console.log(subtraction( function(val1, val2) { return val1 - val2;  } ))

  console.log( 'O resultado da multiplicação é:' );
  console.log(multiplication( function(val1, val2) { return val1 * val2;  } ))

  console.log( 'O resultado da divisão é:' );
  console.log(division( function(val1, val2) { return val1 / val2;  } ))

  console.log( 'O resto do modulo é:' );
  console.log(mod( function(val1, val2) { return val1 % val2;  } ))
})();
