...
*/
var subtraction = calculator( 6, 6);
var multiplication = calculator( 7, 7);
var division = calculator( 8, 8);
var modulo = calculator( 9, 9);
...
console.log( 'O resto da divisão é:' + modulo(function(number1, number2){
    return number1 % number2;
})  );
