...
chamada.
*/
console.log( 'O resultado da subtração é:',subtraction(function callback(x,y){
    return x -y;
}) );
// ?

console.log( 'O resultado da multiplicação é:',multiplication(function callback(x,y){
    return x * y;
}) );
// ?

console.log( 'O resultado da divisão é:',division(function callback(x,y){
    return x / y;
}) ); );
// ?

console.log( 'O resto da divisão é:',mod(function callback(x,y){
    return x % y;
}) ); );
// ?
})();