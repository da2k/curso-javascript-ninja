(function(){
    ...
    */
    function calculator(operando1,operando2){
    ...
    */
    var subtraction = calculator(9,4);
    var multiplication = calculator(7,3);
    var division = calculator(15,5);
    var mod = calculator(11,9);
