...
(function () {
    ...
    */
    var subtraction = calculator(200, 150);
    var multiplication = calculator(50, 300);
    var division = calculator(400, 500);
    var mod = calculator(450, 250);
