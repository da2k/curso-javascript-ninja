...
*/
    ...
    console.log( 'O resultado da soma é:' ,sum(function(valor1,valor2){
...
// ?
    ...
    var mod = calculator = calculator(30,8);
...
console.log(subtraction(function(valor1,valor2){
    return  valor1 - valor2;
 }));

console.log( 'O resultado da multiplicação é:');
console.log( multiplication(function(valor1,valor2){
    return  valor1 * valor2;
 }));

console.log( 'O resultado da divisão é:');
console.log(division(function(valor1,valor2){
    return  valor1 / valor2;
 }));

console.log( 'O resto da divisão é:');
console.log(mod(function(valor1,valor2){
    return  valor1 % valor2;
 }));
