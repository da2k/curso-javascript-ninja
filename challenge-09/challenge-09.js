...
(function(){
    ...
    */
    ...
    console.log(sum(function(x1, y2){
        return x1 + y2;
    }));
    /*
    ...
    */
    ...
    console.log(subtraction(function(x1, y2){
        return x1 - y2;
    }));

    console.log( 'O resultado da multiplicação é:' );
    console.log(multiplication(function(x1, y2){
        return x1 * y2;
    }));

    console.log( 'O resultado da divisão é:' );
    console.log(division(function(x1, y2){
        return x1 / y2;
    }));

    console.log( 'O resto da divisão é:' );
    console.log(mod(function(x1, y2){
        return x1 % y2;
    }));
