...
*/
var soma = sum(function( num1,num2 ) { return num1 + num2; });
...
*/
var subtraction = calculator( 100,64 );
var multiplication = calculator( 2,56 );
var division = calculator( 100,5 );
...
chamada.
*/
var subração = subtraction(function( num1,num2 ) { return num1 - num2; });
console.log( 'O resultado da subtração é:', subração );

var multiplicação = multiplication(function( num1,num2 ) { return num1 * num2; });
console.log( 'O resultado da multiplicação é:', multiplicação );

var divisão = division(function( num1,num2 ) { return num1 / num2; });
console.log( 'O resultado da divisão é:', divisão );

var modulo = mod(function( num1,num2 ) { return num1 % num2; });
