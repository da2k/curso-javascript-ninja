(function(){
    ...
    */
    ...
    console.log(sum(function(number_1, number_2){
    ...
    */
   let subtraction = calculator(79, 37);
   let multiplication = calculator(6, 7);
   let division = calculator(210, 5);
   let mod = calculator(42, 4);
    ...
    */
    ...
    console.log(subtraction(function(number_1, number_2){
        return number_1 - number_2;
    }));

    console.log( 'O resultado da multiplicação é:' );
    console.log(multiplication(function(number_1, number_2){
        return number_1 * number_2;
    }));

    console.log( 'O resultado da divisão é:' );
    console.log(division(function(number_1, number_2){
        return number_1 / number_2;
    }));

    console.log( 'O resto da divisão é:' );
    console.log(mod(function(number_1, number_2){
        return number_1 % number_2;
    }));
