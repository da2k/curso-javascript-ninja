...
(function() {
  ...
  */
  ...
  var division = calculator(120, 2);
  var mod = calculator(542, 42);
  ...
  chamada.
  */
  console.log( 'O resultado da subtração é:', substraction(function(x, y) { return x - y }));
