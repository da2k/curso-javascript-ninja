...
( function(){
    ...
    */
    console.log( 'O resultado da soma é:', sum(3,4));
    ...
    */
    ...
    chamada.
    */
    console.log( 'O resultado da subtração é:', subtraction(10,5) );


    console.log( 'O resultado da multiplicação é:', multiplication(2,3) );


    console.log( 'O resultado da divisão é:', division(8,2) );


    console.log( 'O resto da divisão é:', mod(5,2) );
