...
*/
  ...
  var multiplication = calculator( 10, 10 );
...
chamada.
*/
  console.log( 'O resultado da subtração é: ' + sum( function( x, y ) { return x - y; } ) );
  console.log( 'O resultado da multiplicação é: ' + sum( function( x, y ) { return x * y; } ) );
  console.log( 'O resultado da divisão é: ' + sum( function( x, y ) { return x / y; } ) );
  console.log( 'O resto da divisão é: ' + sum( function( x, y ) { return x % y; } )  );
