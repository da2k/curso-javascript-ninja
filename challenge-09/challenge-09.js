(function() {
	...
	*/
	console.log( 'O resultado da soma é:', sum((number1, number2) => number1 + number2));
	...
	*/
	const subtraction = calculator(21, 4);
	const multiplication = calculator(2, 3);
	const division = calculator(10, 2);
	const mod = calculator(10, 3);
	...
	chamada.
	*/
	console.log( 'O resultado da subtração é:', subtraction((number1, number2) => number1 - number2)));
	// ?

	console.log( 'O resultado da multiplicação é:', multiplication((number1, number2) => number1 * number2)));
	// ?

	console.log( 'O resultado da divisão é:', division((number1, number2) => number1 / number2)));
	// ?

	console.log( 'O resto da divisão é:', mod((number1, number2) => number1 % number2)));
	// ?
})();