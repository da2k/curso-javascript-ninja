(function(){
  ...
  */
  ...
  console.log( sum(function( nume1, nume2){
    return nume1 + nume2;       
  }) );
  ...
  */
  ...
  var multiplication = calculator(50, 20);
  var division = calculator(20, 100);
  var mod = calculator( 100, 11);
  ...
  */
  ...
  console.log(subtraction(function(numbe1, numbe2){
      return numbe1 - numbe2;      
   }) );

  console.log( 'O resultado da multiplicação é:' );
  console.log(multiplication(function(numbe1, numbe2){
      return numbe1 * numbe2;      
   }) );

  console.log( 'O resultado da divisão é:' );
  console.log(division(function(numbe1, numbe2){
      return numbe1 / numbe2;      
   }) );

  console.log( 'O resto da divisão é:' );
  console.log(mod(function(numbe1, numbe2){
      return numbe1 % numbe2;      
   }) );
  })();
