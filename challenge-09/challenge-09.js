...
console.log(sum(function calculator(x, y){
  return x + y;
}));
...
var multiplication = calculator(9, 3);
...
console.log(subtraction(function calculator(x, y){
  return x - y;
}));

console.log( 'O resultado da multiplicação é:' );
console.log(multiplication(function calculator(x, y){
  return x * y;
}));

console.log( 'O resultado da divisão é:' );
console.log(division(function calculator(x, y){
  return x / y;
}));

console.log( 'O resto da divisão é:' );
console.log(mod(function calculator(x, y){
  return x % y;
}));
