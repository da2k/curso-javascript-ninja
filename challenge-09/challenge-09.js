(function () {
  ...
  function calculator(value, value2) {
  ...
  console.log(
    sum(function (value, value2) {
      return `O resultado da soma é ${value + value2} `;
    })
  );

  // O ressultado da soma é 59
  /*
  ...
  const subtration = calculator(70, 10);
  const multiplication = calculator(50, 50);
  const divisiom = calculator(70, 70);
  const mod = calculator(15, 10);
...
*/
  ...
  console.log(
    subtration(function (value, value2) {
      return `O resultado da subtração é ${value - value2} `;
    })
  );

  console.log(
    multiplication(function (value, value2) {
      return `O resultado da multiplicação é ${value * value2} `;
    })
  );

  console.log(
    divisiom(function (value, value2) {
      return `O resultado da divisão é ${value / value2} `;
    })
  );

  console.log(
    mod(function (value, value2) {
      return `O resultado do resto da divisão é ${value % value2} `;
    })
  );
})();
