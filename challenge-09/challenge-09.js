(function() {
  ...
  */
  ...
  console.log(sum(function(param1, param2) {
  ...
  */
  const subtraction = calculator(10,2);
  const multiplication = calculator(10,2);
  const division = calculator(10,2);
  const mod = calculator(10,2);
  ...
  */
  ...
  console.log(subtraction(function(param1, param2) {
    return param1 - param2;
  }));

  console.log( 'O resultado da multiplicação é:' );
  console.log(multiplication(function(param1, param2) {
    return param1 * param2;
  }));

  console.log( 'O resultado da divisão é:' );
  console.log(division(function(param1, param2) {
    return param1 / param2;
  }));

  console.log( 'O resto da divisão é:' );
  console.log(mod(function(param1, param2) {
    return param1 % param2;
  }));
})();
