...
console.log(sum(function(value1, value2){return 'O resultado da soma é ' + (value1 + value2);}));
...
var division = calculator(2, 2);
var mod = calculator(4, 8);
...
console.log(subtraction(function (value1, value2) { return 'O resultado da subtração é:' + (value1 - value2);}));

console.log(multiplication(function (value1, value2) { return 'O resultado da multiplicação é: ' +  (value1 * value2);}));

console.log(division(function (value1, value2) { return 'O resultado da divisão é: ' + (value1 / value2);}));

console.log( mod(function ( value1, value2) { return 'O resto da divisão é: ' + (value1 % value2);}));
