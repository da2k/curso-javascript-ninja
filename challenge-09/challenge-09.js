...
sum(function(num1, num2) { console.log(num1 + num2)});
...
subtraction(function(num1, num2) { console.log(num1 - num2)});

console.log( 'O resultado da multiplicação é:' );
multiplication(function(num1, num2) { console.log(num1 * num2)});

console.log( 'O resultado da divisão é:' );
division(function(num1, num2) { console.log(num1 / num2)});

console.log( 'O resto da divisão é:' );
mod(function(num1, num2) { console.log(num1 % num2)});
})();