( function() {
    ...
    */
    ...
    console.log(sum(function(valorUm, valorDois) { 
    ...
    */
    ...
    console.log(subtraction(function(valorUm, valorDois) {
        return valorUm - valorDois;
    }));

    console.log( 'O resultado da multiplicação é:' );
    console.log(multiplication(function(valorUm, valorDois) {
        return valorUm * valorDois;
    }));

    console.log( 'O resultado da divisão é:' );
    console.log(division(function(valorUm, valorDois) {
        return valorUm / valorDois;
    }));

    console.log( 'O resto da divisão é:' );
    console.log(mod(function(valorUm, valorDois) {
        return valorUm % valorDois;
    }));
