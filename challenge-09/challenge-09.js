(function () {
    ...
    */
    console.log('O resultado da soma é:') // 15
    ...
    */
    let subtraction = calculator(50, 20)
    let multiplication = calculator(100, 5)
    let division = calculator(50, 2)
    let mod = calculator(51, 2)
    ...
    chamada.
    */
    console.log('O resultado da subtração é:') // 30
    console.log(subtraction(function (x, y) {
        return x - y
    }))

    console.log('O resultado da multiplicação é:') // 500
    console.log(multiplication(function (x, y) {
        return x * y
    }))

    console.log('O resultado da divisão é:') // 25
    console.log(division(function (x, y) {
        return x / y
    }))

    console.log('O resto da divisão é:') // 1
