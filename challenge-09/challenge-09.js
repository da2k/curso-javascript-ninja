(function () {
  ...
  */
  ...
  var multiplication = calculator(9, 5);
  var division = calculator(32, 4);
  ...
  chamada.
  */
  console.log('O resultado da subtração é:', subtraction(function (numero1,
    numero2) {
    return numero1 - numero2;
  }));
  ...
  console.log('O resultado da divisão é:', division(function (numero1,
    numero2) {
    return numero1 / numero2;
  }));
