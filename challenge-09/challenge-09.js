...
*/
console.log( 'O resultado da soma é: ' + sum(function(z,w) {return z + w;}));
...
console.log( 'O resultado da subtração é: ' + subtraction(function(z,w) {return z - w;}));

console.log( 'O resultado da multiplicação é: ' + multiplication(function(z,w) {return z * w;}));

console.log( 'O resultado da divisão é: ' + division(function(z,w) {return z / w;}));

console.log( 'O resto da divisão é: ' + mod(function(z,w) {return z % w;}));
