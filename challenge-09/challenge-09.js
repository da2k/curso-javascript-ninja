(function() {
      ...
      */
      ...
      console.log(sum(function(num01, num02){
          return (num01 + num02);
      }));
      ...
      */
      ...
      console.log(subtraction(function(num01, num02){
          return (num01 - num02);
      }));

      console.log( 'O resultado da multiplicação é:' );
      console.log(multiplication(function(num01, num02){
          return (num01 * num02);
      }));

      console.log( 'O resultado da divisão é:' );
      console.log(division(function(num01, num02){
          return (num01 / num02);
      }));

      console.log( 'O resto da divisão é:' );
      console.log(mod(function(num01, num02){
          return (num01 % num02);
      }));
})();
