(function() {
    ...
    */
    console.log( 'O resultado da soma é:', sum( function(nb1, nb2) { return nb1 + nb2; } ) );
    ...
    */
    ...
    var division = calculator(5, 7);
    var mod = calculator(5, 7);
    ...
    chamada.
    */
    console.log('O resultado da subtração é:', subtraction( function(nb1, nb2) { return nb1 - nb2; } ) );
    console.log('O resultado da multiplicação é:', multiplication( function(nb1, nb2) { return nb1 * nb2; } ) );
    console.log('O resultado da divisão é:', division( function(nb1, nb2) { return nb1 / nb2; } ) );
    console.log('O resto da divisão é:', mod( function(nb1, nb2) { return nb1 % nb2; } ) );
