(function () {
  ...
  */
  const subtraction = calculator(20, 10);
  const multiplication = calculator(100, 12);
  const division = calculator(100, 10);
  const mod = calculator(20, 2);
  ...
  */
  ...
  console.log(subtraction((x, y) => x - y)); // 10

  console.log('O resultado da multiplicação é:');
  console.log(multiplication((x, y) => x * y)); // 1200

  console.log('O resultado da divisão é:');
  console.log(division((x, y) => x / y)); // 10

  console.log('O resto da divisão é:');
  console.log(mod((x, y) => x % y)); // 0
