(function(){
    ...
    */
    ...
    console.log( sum( function( value1 , value2 ){ return value1 + value2 } ) );
    ...
    */
    ...
    var subtraction = calculator( 100 , 60 );
    var multiplication = calculator( 7 , 8 );
    var division = calculator( 175 , 5 );
    var mod = calculator( 340 , 224 );
    ...
    */
    ...
    console.log( subtraction( function( value1 , value2 ){ return value1 - value2 } ) );

    console.log( 'O resultado da multiplicação é:' );
    console.log( multiplication( function( value1 , value2 ) { return value1 * value2 } ) );

    console.log( 'O resultado da divisão é:' );
    console.log( division( function( value1 , value2 ) { return value1 / value2 } ) );

    console.log( 'O resto da divisão é:' );
    console.log( mod( function( value1 , value2 ) { return value1 % value2 } ) );
