(function () {
    ...
    */
    ...
    chamada.
    */
    console.log('O resultado da subtração é:'); // 40
    console.log(subtraction(function(x, y) {
        return x - y
    }))

    console.log('O resultado da multiplicação é:'); // 100
    console.log(multiplication(function(x, y) {
        return x * y
    }))

    console.log('O resultado da divisão é:'); // 10
