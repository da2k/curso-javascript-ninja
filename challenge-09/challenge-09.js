(function() {
    ...
    */
    ...
    var subtraction = calculator( 4, 6 );
    ...
    chamada.
    */
    console.log( 'O resultado da subtração é:', subtraction(function( v, y ) {
        return v - y;
    }) );
    // ?

    console.log( 'O resultado da multiplicação é:', multiplication(function( v, y ) {
        return v * y;
    }) );
    // ?

    console.log( 'O resultado da divisão é:', division(function( v, y ) {
        return v / y;
    }) );
    // ?

    console.log( 'O resto da divisão é:', mod(function( v, y ) {
        return v % y;
    }) );
    // ?
