(function(){
  ...
  */
  var calculator = function calculator (a, b) {
    return function returnedCalc (callback) {
      return callback(a, b);
    };
  };
  ...
  */
  ...
  var division = calculator(10, 2.5);
  ...
  chamada.
  */
  console.log( 'O resultado da subtração é:', subtraction(function (a, b) { return a
  - b;}) );

  console.log( 'O resultado da multiplicação é:', multiplication(function (a, b) {
    return a * b}) );

  console.log( 'O resultado da divisão é:', division(function (a, b) { return a /
  b; }) );
