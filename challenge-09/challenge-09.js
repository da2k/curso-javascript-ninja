(function() {
    ...
    */
    ...
    function calculator( num1, num2 ) {
        return function( callback ) {      // função de retorno
    ...
    */
    ...
    // A função que recebe um callback é o retorno da variável sum. 
    // Invoca a função calculator com dois parâmetros.
    ...
    */
    ...
    // A construção da função callback é o parâmetro que está sendo passado para a função sum.
    ...
    */
    ...
    var division = calculator( 200, 10 );
