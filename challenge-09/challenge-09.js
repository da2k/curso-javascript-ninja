...
myFunction();
    ...
    */
    ...
    console.log(sum(function(sumNum1, sumNum2){
    ...
    */
    ...
    console.log(subtraction(function(subNum1, subNum2){
        return subNum1 - subNum2;
    }));
    

    console.log( 'O resultado da multiplicação é:' );
    console.log(multiplication(function(multNum1, multNum2){
        return multNum1 * multNum2;
    }));

    console.log( 'O resultado da divisão é:' );
    console.log(division(function(divNum1, divNum2){
        return divNum1 / divNum2;
    }));

    console.log( 'O resto da divisão é:' );
    console.log(mod(function(modNum1, modNum2){
