...
*/
var arr = [1, "Ricardo", true, { a: 1 }, function() {}];
...
*/
var arr2 = [1, "Ricardo", true, { a: 1 }, function() {}];
...
function book(nomeLivro) {
  var livros = {
    "Java Scripto": {
      ...
      autor: "Ricardo",
      editora: "Duffoux Libs"
    },
    "Scrpito Ninja": {
      quantidadePaginas: 159,
      autor: "Matheus",
      editora: "Bolognini Libs"
    },
    "Ninja Java": {
...
*/
console.log("O autor do " + bookName + ` Scripto é ${book(bookName).autor}.`);
...
console.log(
  "O livro " +
    bookName +
    ` foi publicado pela editora ${book(bookName).editora}.`
);
