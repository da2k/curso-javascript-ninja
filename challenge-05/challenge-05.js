...
*/
var arr = ["alexandre", true, 34, undefined, "ramos"];
...
segundo parâmetro.
*/
function arrayFunc(array, number) {
  return array[number];
}
...
*/
var arr2 = ["alexia", 1, null, undefined, new Date()];
...
function book(nameBook) {
  var books = {
    "Harry Potter": {
      ...
      autor: "J.K Rowling",
      editora: "Bloomsbury Plublishing"
    },
    "A Game of Thrones": {
