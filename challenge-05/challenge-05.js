...
*/
console.log('O autor do livro Domain Drive Design é ' + book('Domain Drive Design').autor + '.');
...
*/
console.log('O livro Spring foi publicado pela editora ' + book('Spring em ação').editora + '.');
