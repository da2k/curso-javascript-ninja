...
*/
console.log("O livro ABC tem "+ book('ABC').quantidadePaginas + " páginas!");
...
*/
console.log("O autor do livro 123 é " + book('123').autor + "."); 
...
*/
console.log("O livro ABC123 foi publicado pela editora " + book('ABC123').editora +".");
