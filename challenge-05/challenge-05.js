...
function book (bookNome){
	...
	return book.[livros];
	return !book ? livros : book[livros]
}
...
var bookNome = 'Harry Potter';
console.log('O livro' + bookNome + 'tem' + book('Harry Potter').quantidadePaginas + '' + 'páginas!');
...
*/
// ?
console.log('O autor do livro'+ bookNome + 'é' + book(bookNome).quantidadePaginas.autor);
...
console.log(bookNome + '' + "foi publicado pela editora" + '' + book(bookNome).editora.);