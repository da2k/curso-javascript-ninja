...
*/
console.log('O autor do livro Admirável mundo novo é ' + book('Admirável mundo novo').autor + '.');
...
*/
console.log('O livro Laranja Mecânica foi publicado pela editora ' + book('Laranja Mecânica').editora + '.');
