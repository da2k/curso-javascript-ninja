...
*/
console.log(getArr(arrAleatorio)[1]);
...
segundo parâmetro.
*/
function myFunction(array, indiceRetorno) {
  return array[indiceRetorno];
}
...
var i = 0
while (i < 5) {
  console.log(myFunction(arrTipoDiferente, i));
  i++;
}
...
function book(nomeLivro) {
  var livros = {
    ...
    "Don't Make Me Think": {
      ...
      autor: "Davi Alves",
      editora: "DASS Editora"
    }
  }
  return nomeLivro ? livros[nomeLivro] : livro;
}
