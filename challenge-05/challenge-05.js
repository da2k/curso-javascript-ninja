...
*/
var myArray = [1, "cat", {x: 0}, function() {}, null];
...
*/
var myArray2 = [1, true, [1, 2, 3], function() {}, null];
...
function book(bookName) {
	var library = {
		'Mulheres que correm com os lobos': {
			quantidadePaginas: 643,
			autor: 'Clarrise Pinkola',
			editora: 'Rocco'
		},
		'As veias abertas da America Latina': {
			quantidadePaginas: 253,
...
*/
var name = 'Mulheres que correm com os lobos';
