...
*/
var myvar = ['cabeca', function() {return 'ombro';}, 10, true, 'olhos'];
...
function book(nomeLivro) {
    var livros = {
        'O Vale no Fim do Mundo': {
            quantidadePaginas: 224,
            autor: 'Sandor Lenard',
            editora: 'Cosac'
        },
        'Vá, Coloque Um Vigia': {
            quantidadePaginas: 252,
            autor: 'José Olympio',
            editora: 'José Olympio'
        },
        'A Little Life': {
            quantidadePaginas: 736,
...
*/
var nomeLivro = 'O Vale no Fim do Mundo';
