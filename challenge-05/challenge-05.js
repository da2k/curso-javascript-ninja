...
*/
var myArr = ["Alexandre", 28, true, null, { hobby: "gamer" }];
...
*/
console.log(
  "O autor do livro " + bookName + " é " + book("O segredo").autor + "."
);
