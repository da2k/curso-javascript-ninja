...
*/
console.log(
  "O livro Irmandade da Adaga Negra 3 tem " +
    book("Irmandade da Adaga Negra 3").quantidadePaginas +
    " páginas!"
);
...
*/
console.log(
  "O autor do livro Irmandade da Adaga Negra 2 é " +
    book("Irmandade da Adaga Negra 2").autor
);
...
*/
console.log(
  "O livro Irmandade da Adaga Negra 1 foi publicado pela editora " +
    book("Irmandade da Adaga Negra 1").editora
);
