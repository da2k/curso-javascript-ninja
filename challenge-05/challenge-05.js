...
*/
var myvar = [1, 'Pedro', true, null, undefined];
...
*/
var array = [1, 'Henrique', false, undefined, null];
...
*/
var name = 'livro1';
console.log('O livro ' + name + ' tem ' + book('livro1').quantidadePaginas + ' páginas!');
...
*/
console.log('O autor do livro ' + name + ' é ' + book('livro1').autor + '.');
...
*/
console.log('O livro ' + name + ' foi publicado pela editora ' + book('livro1').editora + '.');