...
function x(a,b,c) { 
	if(a == null || b == null || c == null){ 
		return 'Você precisa preencher todos os valores corretamente'
	} else { 
		return (a * b * c) + 2; 
	} 
}
...
//Você precisa preencher todos os valores corretamente'
...
function y(var1, var2, var3){
	if(var1 && var2 && var3 ){
		return (var1 + var2) / var3;
	} else if(var1 && var2 && var3 == null){
		return var1+var2;
	} else if(var1 && var2 == null && var3 == null){
		return var1;
