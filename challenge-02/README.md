...
// 1 - Função que recebe 3 argumentos
...
function soma3(x, y, z) {
    if (x === undefined && y === undefined && z === undefined) {
        ...
        // 6 - Se nenhuma das condiçoes acima forem atendidas
        return null;
    }
}
...
function soma3(x, y, z) {
    if (x === undefined && y === undefined && z === undefined) {
        ...
        if (y !== undefined) {
            if (z !== undefined) {
                // Se todos os argumentos forem passados
                return (x + y) / z;
            } else {
            ...
            // Se somente um argumento for passado
            return x;
        }
    } else {
        // Se nenhuma das condiçoes acima forem atendidas
        return null;
    }
}
