...
const addValue = () => ( noValue = 23 ) && 'O valor da variável agora é ' + noValue;
...
console.log(checkArgs(  )); // false
console.log(checkArgs( 1 )); // 1
console.log(checkArgs( 1, 2 )); // 3
console.log(checkArgs( 1, 2, 3 )); // 1
console.log(checkArgs( 1, 2, 3, 4 )); // null
