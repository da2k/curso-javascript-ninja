...
function addValue(params) {
    calc = 10 ;
    return ' O valor da variável agora é .' + calc;
}
...
function sumValid(start, mid, end){
    ...
    else if (start !== undefined && mid !== undefined && === undefined){
        return start + mid;
    }
    else if(start !== undefined && mid !== undefined && end !== undefined){
