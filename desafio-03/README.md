...
*/
var pessoa = {nome: "fabio",sobrenome:"santos",sexo: "masculino",idade:27, altura:1.82, peso:78, andando:false, caminhouQuantosMetros:0};
...
return pessoa.caminhouQuantosMetros = pessoa.caminhouQuantosMetros + x;  
pessoa.andando = true;
};
...
*/
pessoa.nomeCompleto() // olá meu nome é fabio santos
...
inline ao lado da instrução para mostrar qual foi a resposta retornada)
*/
pessoa.msotrarPeso() // eu tenho 78Kg
...
pessoa.apresentacao();
//"ola, eu sou o fabio santos tenho 30 anos, 182m, meu peso é 78kg e, só hoje, eu já caminhei 60 metros!"
