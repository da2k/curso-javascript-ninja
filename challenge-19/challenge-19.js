(function() {
  ...
  */
  ...
  function hasClass( markup, cssClass ) {
    var regex = new RegExp( '\\b' + cssClass + '\\b', 'gm' );
    return regex.test( markup );
  }
  
  console.log( 'container', hasClass( markup, 'container' ) );
  console.log( 'text', hasClass( markup, 'text' ) );
  console.log( 'date', hasClass( markup, 'date' ) );
  console.log( 'excerpt', hasClass( markup, 'excerpt' ) );
  console.log( 'main', hasClass( markup, 'main' ) );
