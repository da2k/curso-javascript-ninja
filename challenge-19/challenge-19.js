(function() {
    ...
    */
    ...
    function hasClass( markup, cssClass ) {
        var regexHasClass = new RegExp('class=[\'"](.+)?' + cssClass + '(.+)?[\'"]');
        return !!markup.match(regexHasClass);
    }
    var classList = ['container', 'text', 'date', 'excerpt', 'main'];
    classList.forEach( function(ClassItem) {
        console.log( hasClass(markup, ClassItem) + ' para a classe ' + ClassItem );
    });
