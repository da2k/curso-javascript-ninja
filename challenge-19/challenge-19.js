...
console.log( hasClass( markup,classes[0] ));
console.log( hasClass( markup,classes[1] ));
console.log( hasClass( markup,classes[2] ));
console.log( hasClass( markup,classes[3] ));
console.log( hasClass( markup,classes[4] ));
