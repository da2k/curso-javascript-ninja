(function(){
  ...
  */
  ...
  /*
  Verifique se a regex acima casa com o texto na variável `otherText`, mostrando o resultado no console.
  ...
  */
  ...
  classes.forEach(function( cssClass ){ //ccsClass, aqui são os items do array classes
