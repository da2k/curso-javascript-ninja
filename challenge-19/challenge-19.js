( function( ) {
	...
	*/
	...
	function hasClass( markup, cssClass ) {
		...
		if( markup.search( regex ) >= 0 ) {
			return true
		} else {
			return false
		}
	}
	var testClass = ['container', 'text', 'date', 'excerpt', 'main'];
	testClass.forEach( function( element ) {
		console.log( hasClass( markup, element ) + ' para a classe ' + element ); 
	})
})();
