(function(){
    ...
    */
    ...
    function hasClass(markup, cssClass){
        // var regExpr = new RegExp('class=["\']' + cssClass + '["\']');
        var regExpr = new RegExp('class=["\'](\\w+)?\\s?' + cssClass + '\\s?(\\w+)?["\']');
        //console.log(regExpr);
        return regExpr.test(markup);
    };

    ['container', 'text', 'date', 'excerpt', 'main'].forEach(function(value){
        console.log(hasClass(markup, value) + ' para a classe ' + value);
    });
