(function () {
  ...
  function hasClass(markup, cssClass) {
    var exp = new RegExp('<(\\w+) class=(\'|\")(' + cssClass + ')\\2>', 'gm');
    return exp.test(markup);
  }

  function showResult(markup, cssClass) {
    var result = ' para a classe ' + cssClass;
    return hasClass(markup, cssClass) + result;
  }

  console.log(showResult(markup, 'container'));
  console.log(showResult(markup, 'text'));
  console.log(showResult(markup, 'date'));
  console.log(showResult(markup, 'excerpt'));
  console.log(showResult(markup, 'main'));
