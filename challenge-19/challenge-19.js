(()=>{
    ...
    */
    ...
    //
    let regexNumbersAtStart = new RegExp('^\\d+','gm');
    console.log(regexNumbersAtStart);
    ...
    */
    ...
    // 
    console.log(text.match(regexNumbersAtStart));
    /*
    ...
    */
    ...
    // 
    const regexNumbersAtEnd = new RegExp('\\d+$','gm');
    console.log(regexNumbersAtEnd);
    /*
    ...
    */
    ...
    // 
    console.log(otherText.match(regexNumbersAtEnd));
    ...
    */
    ...
    function hasClass(markup,cssClass){
        const regex = new RegExp('class\\s*\\W+.*'+cssClass+'.*\\W+','gm');
