(function(){
	...
	*/
	...
	function hasClass (markup, cssClass){
		...
		this.test = function teste(){
			var newRegex = new RegExp('class=["\']([\\s\\w]+)?' + this.cssClass + '([\\s\\w]+)?["\']','gm');
			console.log(newRegex);
			return newRegex.test(this.markup);
		}
	...
	classes.forEach(function(item){
		console.log(new hasClass(markup,item).test()+' para a classe '+ item );
	});
