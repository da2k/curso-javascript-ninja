...
- let justNumbersAndLetters = new RegExp( '[\\da-z]', 'gi' );
...
- Atribua essa regex à uma letiável chamada `justNumbersRegex` e mostre-a
no console:
*/
...
/*
Verifique se a regex acima casa com o texto na letiável `text`, mostrando o
...
regex à uma letiável chamada `numbersAtTheEnd`.
...
/*
Verifique se a regex acima casa com o texto na letiável `otherText`,
...
caso contrário;
- A marcação usada para testar deve ser a que está na letiável `markup`
abaixo;
- Não altere a marcação na letiável markup!
