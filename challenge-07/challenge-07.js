...
*/
var myArray = [1, 'dois', 3.5, ['a','b','c'], {prop1: "value1", prop2: "value2"}];
...
for(var cont = 100; cont>=100 && cont <=120; cont++){
	if(cont%2===0) {
		console.log(cont);
	}
}
...
for(var cont = 111; cont>=111 && cont <=125; cont++){
	if(cont%2!==0) {
		console.log(cont);
	}
}