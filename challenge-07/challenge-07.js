...
var array = [
    ...
    {
        Estado_Civil: 'Casado',
        Nacionalidade: 'Basileiro',
        Profissao: 'Desenvovedor Node'
    },
    function x_y_coodinates(x, y) {
        return 'x = ' + ', y = ' + y;
    }
...
for (let par = 100; par < 121; par++) {
    par % 2 === 0 ? console.log(par) :''
}

console.log( 'Números ímpares entre 111 e 125:' );
for (let imp = 111; imp < 126; imp++) {
    imp % 2 === 0 ? console.log(imp) : ''
}