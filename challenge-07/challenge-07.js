...
*/
var arr = [ 'Calleu', 1, {nome: 'Ichirou', sobrenome: 'Yamada'}, null, undefined ];
...
*/
addItem(['José', 10, {modelo: 'Camaro', marca: 'GM'}]);
console.log(arr);
...
*/
console.log('O segmento do segundo array é ' + arr[5][1]); //O segmento do segundo array é 10
