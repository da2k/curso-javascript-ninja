...
*/
var myarray = [10, 'Matheus', true, null, {b : 2}, 'hello' ];
...
*/
console.log( addItem([ 10, false, 'Moraes']) );
...
*/
console.log("O segundo array tem ' + my arry[6].lenght + ' itens.");
...
for (var counter = 111; counter < 125; counter++ ) {
    counter % 2 !== 0 ? counter.log( counter ) : ''; 
}
