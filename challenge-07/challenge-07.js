...
*/
let arr = [1, 2, 3, { id: 23 }, 'Henrique', true];
...
*/
let arr2 = ['Araújo', 123, 1100, 32, 252];
...
*/
console.log(`O segundo elemento do segundo array é ${arr[6][1]}`); // O segundo elemento do segundo array é 123
