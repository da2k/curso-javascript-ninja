(function(win,doc){
 ...
 DOM.isNull = function isNull(param) {
   return Object.prototype.toString.call(param) === '[object Null]' || Object
     .prototype
...
function getMessage(type){
    var messages = {
        err: 'Não encontramos o endereço para o CEP [CEP].',
        loading: 'Buscando informações para o CEP [CEP]...' ,
        ok: 'Endereço referente ao CEP [CEP]:'
  };
  $status.get()[0].textContent = messages[type].replace("[CEP]", getInputCEP);
}
})(window,document);
