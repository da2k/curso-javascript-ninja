      ...
      - Ao submeter esse formulário, deve ser feito um request Ajax para a URL: http://apps.widenet.com.br/busca-cep/api/cep.json
     ...
     (function () {
      ...
      $formCEP.on('submit', handleSumbitFormCEP);

      function handleSumbitFormCEP(event) {
      ...
      function fillCEPFields() {
          ...
          $endereco.get()[0].textContent = data.address;
      ...
      function getMessage(type) {
          var messages = {
              ...
              error: replaceCEP('Preencha o campo CEP.'),
          };
