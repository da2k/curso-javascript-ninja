...
*/
    ...
    let $buttonsCE = document.querySelector( '[data-js="button-ce"]' );
    let $buttonsEqual = document.querySelector( '[data-js="button-equal"]' );
    ...
    $buttonsEqual.addEventListener('click', handleClickEqual, false);
