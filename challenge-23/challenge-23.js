(function(win, doc){
    ...
    */
    ...
    function isLastItemAnOperation(number) {
      ...
      return operations.some(function(operator){ // `some` varre todo array e ve se algum tem aquele valor
    ...
    function removelastItemIfItIsAnOperator(number){
      if(isLastItemAnOperation(number)) {
          return number.slice(0,-1); // retorna tudo excluindo o último
        }
      return number;
    }
