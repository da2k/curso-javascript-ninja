(function(win, doc){
  ...
  */
  ...
  $buttonsOperation = doc.querySelectorAll('[data-js="buttons-operation"]');
  $buttonCE = doc.querySelector('[data-js="button-ce"]');
  $buttonEqual = doc.querySelector('[data-js="button-equal"]');


  // Call event for button numbers
  Array.prototype.forEach.call($buttonsNumbers, function(button){
    button.addEventListener('click', handleClickNumber, false);
  })

  // Call event for button operation
  ...
  // Function checks the last item is an operation
  ...
  // Function remove last item if it's an operator
