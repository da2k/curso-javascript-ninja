(function(window, document) {
  ...
  */
  ...
  console.log($buttonsNumbers, $buttonOperations);
  ...
  function handleClickEqual(event) {
    ...
    $screen.value = allValues.reduce(function(accumulated, current) {
      ...
      var lastOperator = isLastItemAnOperation(current) ? current.split('').pop() : false;
