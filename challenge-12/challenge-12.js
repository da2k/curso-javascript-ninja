(function() {
    ...
    */
    books.push(
        {
            name: 'Desenvolvendo Web Components',
            pages: 270
        },
        {
            name: 'Web Development with Bootstrap and AngularJS',
            pages: 228
        },
        {
            name: 'MEAN Definitivo',
            pages: 584
        }
    );
    console.log( '\nLista de livros:' );
    ...
    */
    ...
    no formato abaixo:
        "[PROPRIEDADE]: [VALOR]"
    */
    console.log( '\nPropriedades e valores de todos os livros:' );
    books.push(
        {
            name: 'MEAN Definitivo',
            pages: 584
