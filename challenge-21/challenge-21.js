...
Você pode usar o nome que achar melhor, desde que ele seja semântico, ou seja, o nome
...
$start.addEventListener('click', stopTimer, false);
$start.addEventListener('click', resetTimer, false);
