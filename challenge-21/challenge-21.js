(function (window, document) {
    ...
    */
    ...
    var $startBtn = document.querySelector('[data-js=startBtn]');
    var $stopBtn = document.querySelector('[data-js=stopBtn]');
    var $resetBtn = document.querySelector('[data-js=resetBtn]');
