...
(function(win, doc){
    ...
    var $inputTimer = doc.querySelector('[data-js="textTimer"]');
    ...
    var idTimeout;
    var counter = $inputTimer.value;
    function startTime(){
        $inputTimer.value = counter;
        counter++;
        idTimeout = setTimeout(startTime, 1000);
    }
    ...
    // console.log($inputTimer, $buttonStart, $buttonStop, $buttonReset);
})(window, document);
