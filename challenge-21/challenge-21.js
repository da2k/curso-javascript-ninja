(function(win, doc) {
	...
	*/
	...
	var cronId;
	var contador = 0;
	var $txtCronometro = doc.querySelector('[data-js="txtCronometro"]');
	...
	function cron() {
		...
		$txtCronometro.value = contador;
		cronId = setTimeout(cron, 1000);
	}
	...
	$btnStart.addEventListener('click', cron, false);
