...
pessoa.apresentacao = function () {
  ...
  return `Olá, eu sou ${sexo} ${pessoa.nomeCompleto()}, tenho ${pessoa.mostrarIdade()} ${idade}, ${pessoa.mostrarAltura()} metros, meu peso é ${pessoa.mostrarPeso()}Kg e, só hoje, eu já caminhei ${
