...
inline ao lado da instrução para mostrar qual foi a resposta retornada)
*/
console.log(pessoa.motrarPeso()); // 92.7
...
pessoa.apresentacao = () => {
  ...
  return `Olá, eu sou ${sexo} ${pessoa.nomeCompleto()}, tenho ${pessoa.mostrarIdade()}
${idade}, ${pessoa.mostrarAltura()}m, meu peso é ${pessoa.motrarPeso()}Kg e, só hoje,
...
/**
 * Olá, eu sou o Henrique Araújo, tenho 30
 * anos, 1.87m, meu peso é 92.7Kg e, só hoje,
 * eu já caminhei 1726 metros!
 */
