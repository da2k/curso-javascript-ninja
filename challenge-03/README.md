...
pessoa.apresentacao = function(){
    if(pessoa.sexo == "feminino" || pessoa.sexo == "fem" || pessoa.sexo == "f" ){ 
    ...
    if(pessoa.sexo == "masculino" || pessoa.sexo == "mas" || pessoa.sexo == "m" ){ 
        if(pessoa.idade > 1 & pessoa.caminhouQuantosMetros > 1){
...
Olá, eu sou a Siri Fr, tenho 10 anos, 42, meu peso é 7.9 e, só hoje, eu já caminhei 10 metros!
