...
if (pessoa.caminhouQuantosMetros === 0) { pessoa.andando = false; 
} else {
pessoa.andando = true;
}
}
...
*/
pessoa.nomeCompleto() // "Olá! Meu nome é Guilherme Mattos!"
...
// Agora, apresente-se ;)
pessoa.apresentacao() // 'Olá, eu sou o Guilherme, tenho 27 anos, 1.82, meu peso é 96 e, só hoje, eu já caminhei 35 metros!'
```
