...
*/
pessoa.nomeCompleto(); // 'Olá! Meu nome é Jason Voorhees!'

/*
Qual a idade da pessoa? (Use a instrução para responder e comentários
inline ao lado da instrução para mostrar qual foi a resposta retornada)
*/
pessoa.mostrarIdade(); // 'Olá, eu tenho 69 anos!'
...
inline ao lado da instrução para mostrar qual foi a resposta retornada)
*/
pessoa.mostrarAltura(); // 'Minha altura é 1.96m'
...
retornada)
*/
pessoa.mostrarIdade(); // 'Olá, eu tenho 72 anos!'
