...
let pessoa = {
    ...
    sexo: 'M',
    idade: Math.floor(
            ((new Date().getTime() - new Date(1985,11,04).getTime())/1000) 
            *(1/60) 
            *(1/60) 
            *(1/24) 
            *(1/365)
...
*/
pessoa.nomeCompleto(); /*Olá! Meu nome é Alexandre Pinheiro*/
...
pessoa.apresentacao = function(){
    let flexaoNumeroIdade = ''; 
    let flexaoNumeroDistancia = '';
    let flexaoGenero = this.sexo==='M' ? 'o' : 'a';

    if(this.idade > 1){
        flexaoNumeroIdade ='s';
    }
    if(this.caminhouQuantosMetros > 1){
        flexaoNumeroDistancia = 's';
    }

    console.log(`Olá, eu sou ${flexaoGenero} ${this.nome} ${this.sobrenome}, tenho ${this.idade} ano${flexaoNumeroIdade}, ${this.altura}, meu peso é ${this.peso} e, só hoje, eu já caminhei ${this.caminhouQuantosMetros} metro${flexaoNumeroDistancia}!`);
}

// Agora, apresente-se ;)
pessoa.apresentacao(); /*Olá, eu sou o Alexandre Pinheiro, tenho 34 anos, 1.67, meu peso é 90 e, só hoje, eu já caminhei 600 metros!*/
```
