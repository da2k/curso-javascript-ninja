...
*/
var pessoa = {nome: 'maykon', sobrenome: 'morais', sexo: 'masculino', idade: 20, altura: 180, peso: 60, andando: false, caminhouQuantosMetros: 0};
...
*/
pessoa.nomeCompleto(); // Olá! Meu nome é maykon morais'
...
// Agora, apresente-se ;)
// olá, eu sou maykon morais, tenho 23 anos, 1.8, meu peso é 60 e,só hoje, eu já caminhei 9 metros!'
```
