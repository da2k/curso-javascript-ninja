...
*/
var pessoa = { nome: 'Vanessa', sobrenome: 'Basílio', sexo: 'feminino', idade: 29, altura: 1.60, peso: 63, andando: false, caminhouQuantosMetros: 0}
...
*/
pessoa.nomeCompleto() // Olá! Meu nome é Vanessa Basílio!
...
inline ao lado da instrução para mostrar qual foi a resposta retornada)
*/
pessoa.mostrarPeso() // Olá, eu tenho 63kg.
