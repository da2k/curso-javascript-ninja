...
*/
var pessoa = { nome: 'Ivan', sobrenome: 'Wilhelm', sexo: 'masculino', 'idade': 36, altura: 1.75, peso: 70, andando: false, caminhouQuantosMetros: 0 };
...
*/
pessoa.nomeCompleto(); //Olá! Meu nome é Ivan Wilhelm!
...
// Agora, apresente-se ;)
pessoa.apresentacao(); //Olá, eu sou o Ivan Wilhelm, tenho 39 anos, 1.75, meu peso é 70 e, só hoje, eu já caminhei 29 metros!
```
