...
*/
pessoa.nomeCompleto(); // 'Olá! Meu nome é Anderson Pires!'
...
// Agora, apresente-se ;)
pessoa.apresentacao(); // 'Olá, eu sou o Anderson Pires, tenho 36 anos, 1.75, meu peso é 90 e, só hoje, eu já caminhei 600 metros!'
```