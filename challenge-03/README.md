...
*/
pessoa.nomeCompleto = () => { return `Olá! Meu nome completo é ${pessoa.nome} ${pessoa.sobrenome}.`};
...
*/
pessoa.nomeCompleto(); // Olá! Meu nome completo é Carlos Oliveira.
...
*/
for (let i = 0; i < 3; i += 1) { pessoa.fazerAniversario() }
...
pessoa.apresentacao = () => {
    ...
    return `Olá, eu sou ${pronome} ${pessoa.nome} ${pessoa.sobrenome}, tenho ${pessoa.idade} ${idade}, ${pessoa.altura}m, meu peso é ${pessoa.peso}Kg e, só hoje, eu já caminhei ${pessoa.caminhouQuantosMetros} ${distancia}!`
}
