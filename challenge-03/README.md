...
*/
var pessoa = {nome: "jelysson",
  sobrenome:"diretor do whatsbook",
  sexo: "Masculino",
  idade: 18,
  altura: 2.0,
  peso: 120,
...
*/
console.log(pessoa.nomeCompleto()); // jellyson diretor do whatsbook
...
inline ao lado da instrução para mostrar qual foi a resposta retornada)
*/
console.log(pessoa.mostrarPeso()); // 120

/*
Qual a altura da pessoa? (Use a instrução para responder e comentários
inline ao lado da instrução para mostrar qual foi a resposta retornada)
*/
console.log(pessoa.mostrarAltura()); //2.0
...
*/
console.log(pessoa.caminhouQuantosMetros); // 3800
