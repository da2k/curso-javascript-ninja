...
*/
var pessoa = {nome: 'Thiago', sobrenome: 'Miranda', sexo: 'Masculino', idade: 25, altura: 1.73, peso: 63, andando: false, caminhouQuantosMetros: 0};
...
*/
pessoa.nomeCompleto();//Olá, Meu nome é Thiago Miranda!
...
pessoa.apresentacao = function(){
  ...
  return 'Olá, eu sou '+valSex+' '+pessoa.nome+', tenho '+pessoa.idade+' '+valIda+', '+pessoa.altura+', meu peso é '+pessoa.peso+' e, só hoje, eu já caminhei '+pessoa.caminhouQuantosMetros+valMet;

// Agora, apresente-se ;)
'Olá, eu sou o Thiago, tenho 29 anos, 1.73, meu peso é 63 e, só hoje eu já caminhei 18metros'
```
