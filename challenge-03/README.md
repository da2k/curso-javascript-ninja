...
pessoa.apresentacao = function(){
    return pessoa.nomeCompleto()+' '+pessoa.mostrarIdade()+' anos, '+pessoa.mostrarAltura()+', meu peso é '+pessoa.mostrarPeso()+' e, só hoje, eu já caminhei '+pessoa.caminhouQuantosMetros+info
}
