...
*/
var pessoa = { nome: 'Max', sobrenome: 'Arouca', sexo: 'masculino', idade:'26', altura: '1,70', peso: '87', andando: false, caminhouQuantosMetros: 0 };
...
*/
pessoa.nomeCompleto(); // 'Olá! Meu nome é Max Arouca!'
...
*/
pessoa.fazerTresaniversario = function () {
