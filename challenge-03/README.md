...
*/
var pessoa = {nome : 'Bruno', sobrenome : 'Yuri', sexo : 'masculino', idade : 23, altura : 1.78, peso : 78, andando : false, caminhouQuantosMetros : 0};
...
*/
pessoa.andar = function(qtdCaminhado) { pessoa.caminhouQuantosMetros += qtdCaminhado; pessoa.andando = true; }
...
*/
pessoa.nomeCompleto(); //Olá! Meu nome é Bruno Yuri!

/*
Qual a idade da pessoa? (Use a instrução para responder e comentários
inline ao lado da instrução para mostrar qual foi a resposta retornada)
*/
pessoa.mostrarIdde(); //Olá, eu tenho 23 anos!
...
pessoa.apresentacao = function() { 
  ...
  return 'Olá, eu sou ' + firstRule + ' ' + pessoa.nome + ' ' + pessoa.sobrenome + ', tenho ' + pessoa.idade + ' ' + secondRule + ', ' + pessoa.altura + ', meu peso é ' + pessoa.peso + ' e, só hoje, eu já caminhei '  + pessoa.caminhouQuantosMetros + ' ' + thirdRule +'!'; 
