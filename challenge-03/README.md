...
*/
pessoa.nomeCompleto(); // 'Olá! Meu nome é Joâo Norberto!'
...
*/
pessoa.caminhouQuantosMetros; // 78
...
validacaoIdade = "anos";
validacaoSexo = "o";
validacaoMetrosCaminhados = "metros";
    ...
    if(pessoa.caminhouQuantosMetros <= 1){
        validacaoMetrosCaminhados = "metro";
    }
