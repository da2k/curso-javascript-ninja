...
*/
pessoa.nomeCompleto(); // 'Olá! Meu nome é Valdir Pereira!'
...
// Agora, apresente-se ;)
pessoa.apresentacao(); // 'Olá, eu sou o Valdir Pereira, tenho 30 anos, 1.75, meu peso é 80Kg e, só hoje, eu já caminhei 140 metros!'
```
