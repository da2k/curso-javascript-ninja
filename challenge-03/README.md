...
*/
pessoa.nomeCompleto(); //'Olá! Meu nome é Petherson Monteiro!'
...
pessoa.apresentacao = function() {
  var sexo = "o", idade = "anos", metros = "metros";
...
pessoa.apresentacao(); //'Olá, eu sou o Petherson Monteiro, tenho 27 anos, 1.74m, meu peso é 75Kg e, só hoje, eu já caminhei 12 metros!'
```
