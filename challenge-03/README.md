...
*/
var pessoa = {nome: 'Jean', sobrenome: 'Santana', sexo: 'Masculino', idade: 25, altura: 1.70, peso: 60, andando: false,caminhouQuantosMetros: 0};
...
*/
pessoa.andar = function(m){ if (m !== undefined){ pessoa.caminhouQuantosMetros += m; pessoa.andando = true;}}; 
...
*/
pessoa.nomeCompleto(); //"Jean Santana"
