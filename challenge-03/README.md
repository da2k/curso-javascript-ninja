...
*/
var pessoa = { nome: 'Gigleydson', sobrenome: 'Dias', sexo: 'Masculino', idade: 34, altura: 1.80, peso: 80, andando: false, caminhouQuantosMetros: 0 };
...
pessoa.andar = function(metros) {
    if( metros !== undefined ) {
        ...
        return "Digite a quantidade de metros andados"
    }
}
...
*/
pessoa.nomeCompleto(); // "Olá, Meu nome é Gigleydson Dias"
...
retornada)
*/
pessoa.mostraIdade(); // "Olá, eu tenho 37 anos!"
...
// Agora, apresente-se ;)
pessoa.apresentacao();
 // "Olá, eu sou o Gigleydson, tenho 37 anos, 1.8, meu peso é 80 e, só hoje, eu já caminhei 30 metros!"
```
