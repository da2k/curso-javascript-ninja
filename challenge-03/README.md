...
*/
pessoa.nomeCompleto(); // Olá! Meu nome completo é Joao Felipe
...
pessoa.apresentacao = function() {
    let sexo = 'o', idade = 'anos', metros = 'metros';
...
// Agora, apresente-se ;)
?
pessoa.apresentacao(); // Olá, eu sou o Joao Felipe, tenho 32 anos, 1.81, meu peso é 84 e, só hoje, eu já caminhei 500 metros!
