...
var pessoa = { nome: 'Emillyn', sobrenome: 'Silva', sexo:'feminino', idade: 21, altura: 1.56, peso: 53, andando: false, caminhouQuantosMetros: 0};
...
*/
pessoa.NomeCompleto() //"Ola! Meu nome é Emillyn Silva."
...
inline ao lado da instrução para mostrar qual foi a resposta retornada)
*/
pessoa.mostrarAltura()//"Minha altura é 1.56m."
...
Olá, eu sou a Emillyn Silva, tenho 24 anos, 1.56, meu peso é 53 e, só hoje, eu ja caminhei 100metros! 
```
