...
*/
pessoa.andar = function(x) { pessoa.caminhouQuantosMetros = pessoa.caminhouQuantosMetros + x; pessoa.andando = true; }
...
*/
pessoa.nomeCompleto(); //'Olá! Meu nome é Leo AD!'
...
inline ao lado da instrução para mostrar qual foi a resposta retornada)
*/
pessoa.mostrarPeso(); //'Eu peso 107Kg.'
...
pessoa.apresentacao = function() {
  ...
  if ( pessoa.idade === 1 ) {
    var palavraIdade = 'ano';
  } else {
    var palavraIdade = 'anos';
  }
  if ( pessoa.caminhouQuantosMetros === 1) {
    var palavraMetros = 'metro';
  } else {
    var palavraMetros = 'metros';
  }
  return 'Olá, eu sou ' + artigo + ' ' + pessoa.nome + 
  ', tenho ' + pessoa.idade + ' ' + palavraIdade + 
  ', ' + pessoa.altura + 'm, meu peso é ' + 
  pessoa.peso + 'kg e, só hoje, eu já caminhei ' +
  pessoa.caminhouQuantosMetros + ' ' + palavraMetros + '!';
}  
