...
*/
pessoa.nomeCompleto(); //"Olá! Meu nome é Débora Suzuki!"
...
// Agora, apresente-se ;)
pessoa.apresentacao(); // "Olá, eu sou a Débora Suzuki, tenho 35 anos, 1.58m, meu peso é 75 e, só hoje, eu já caminhei 60 metros!"
```
