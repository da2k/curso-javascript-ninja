...
*/
pessoa.nomeCompleto(); // 'Olá! Meu nome é Arthur Ramos'
...
// Agora, apresente-se ;)
pessoa.apresentacao(); // 'Olá, eu sou o Arthur Ramos, tenho 32 anos, 1.7 de altura, meu peso é 85kg e, só hoje, eu já caminhei 15 metros!'
```
