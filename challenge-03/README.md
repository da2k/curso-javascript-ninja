...
*/
pessoa.nomeCompleto(); // "Olá! Meu nome é Luiza Martins"
...
// Agora, apresente-se ;)
pessoa.apresentacao(); // "Olá, eu sou a Luiza Martins, tenho 18 anos, 1.6, meu peso é 50 e, só hoje, eu já caminhei 27 metros!"
```
