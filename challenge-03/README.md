...
*/
pessoa.nomeCompleto(); //Olá! Meu nome é angelilton epifanio!
...
pessoa.apresentacao = function () {
  ...
  if (pessoa.caminhouQuantosMetros === 1) {
    resposta += `eu já caminhei ${pessoa.caminhouQuantosMetros} metro!`
  } else {
    resposta += `eu já caminhei ${pessoa.caminhouQuantosMetros} metros!`
  }
  return resposta;
}
