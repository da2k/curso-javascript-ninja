...
*/
pessoa.nomeCompleto(); //'Olá! Meu nome é Wanderlyn Duarte!'
...
inline ao lado da instrução para mostrar qual foi a resposta retornada)
*/
pessoa.mostrarPeso(); //'Olá! Eu peso 84 Kg.'

/*
Qual a altura da pessoa? (Use a instrução para responder e comentários
inline ao lado da instrução para mostrar qual foi a resposta retornada)
*/
pessoa.mostrarAltura(); //'Minha altura 1.67 m.'
...
*/
pessoa.caminhouQuantosMetros; //55
...
// Agora, apresente-se ;)
pessoa.apresentacao(); //'Olá, eu sou o Wanderlyn Duarte, tenho 39 anos, 1.67, meu peso é 84 e, só hoje, eu já caminhei 0 metros!'
```
