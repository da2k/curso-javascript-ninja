...
pessoa.apresentacao = function() {
	...
	return 'Olá, ' + souX + ' ' + this.nome + ' ' + this.sobrenome + ', tenho ' + this.idade + ' ' + anoX + ', ' + this.altura + ', meu peso é ' + this.peso + ' e, só hoje, eu já caminhei ' + this.caminhouQuantosMetros + ' ' + metroX + '!';
}

// Agora, apresente-se ;)
> pessoa.apresentacao() //'Olá, eu sou o Rafael Gomes, tenho 45 anos, 1.77, meu peso é 88 e, só hoje, eu já caminhei 12 metros!'
```
