...
*/
var pessoa = {nome: 'Gustavo', sobrenome: 'de Paula', sexo: 'masculino', idade: 34, altura: 1.78, peso: 78, andando: false, caminhouQuantosMetros: 0}
...
*/
pessoa.nomeCompleto();//Olá  meu nome é Gustavo de Paula!
...
/*
Faça a `pessoa` fazer 3 aniversários. // Minha altura é 1.78m.
*/
...
pessoa.apresentacao(); // Olá eu sou o Gustavo de Paula, tenho 37 anos, 1.78, meu peso é 77 e, só hoje eu caminhei 350 metros!
```
