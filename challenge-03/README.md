...
*/
pessoa.nomeCompleto();//'Olá! Meu nome é Halissa Franco!' 
...
*/
pessoa.caminhouQuantosMetros;//51
...
var pessoa = {
    ...
    apresentacao(){
        ...
        return `Olá, eu sou ${pronome} ${this.nome} ${this.sobrenome}, tenho ${this.idade} ${anoOuAnos}, ${this.altura}, meu peso é ${this.peso} e, só hoje, eu já caminhei ${this.caminhouQuantosMetros} ${metroOuMetros}!`    
    }
};
