...
*/
var pessoa = { nome: 'tissiana', sobrenome: 'mendes', sexo: 'feminino', idade: 29, altura: 1.69, peso: 60, andando: false, caminhouQuantosMetros: 0 }
...
*/
pessoa.nomeCompleto(); // 'Olá! Meu nome é tissiana mendes!'
...
// Agora, apresente-se ;)
pessoa.apresentacao(); // "Olá, eu sou a tissiana mendes, tenho 32 anos, 1.69, meu peso é 60 e, só hoje, eu já caminhei 65 metros"
