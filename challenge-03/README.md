...
var pessoa = {nome:'giselle',sobrenome:'povoa',idade:42,altura:1.60,peso:60,andando:'false',caminhouQuantosMetros:0};
...
pessoa.nomeCompleto ();//'Olá! Meu nome é giselle povoa!'
...
*/
pessoa.apresentacao = function () {var sexo = 'o';
var idadeAnos = 'anos'; 
...
// Agora, apresente-se ;)
pessoa.apresentacao () // 'Olá, eu sou o giselle povoa, tenho 47 anos, 1.6, meu peso é 60 e, só hoje, eu já caminhei 20 metros!'
```
