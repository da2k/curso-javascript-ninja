...
*/
pessoa.andar = function(metroCaminhado){
    pessoa.caminhouQuantosMetros += metroCaminhado;
    pessoa.andando = true;
}
...
*/
pessoa.nomeCompleto(); //'Olá! Meu nome é Felipe Bossolani!'
...
*/
pessoa.caminhouQuantosMetro; //80
