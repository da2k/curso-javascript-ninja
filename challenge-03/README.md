...
*/
pessoa.parar = funtion() { pessoa.andando = false; }
...
*/
pessoa.apresentacao = function() { return `Olá, eu sou o ${pessoa.nome} ${pessoa.sobrenome}, tenho ${pessoa.idade} anos, ${pessoa.altura}, meu peso é ${pessoa.peso} Kg. e, só hoje, eu já caminhei ${pessoa.idade} metros!`}
