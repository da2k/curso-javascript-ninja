...
*/
pessoa.andar = function(caminhado){
...
*/
pessoa.nomeCompleto();//"Olá meu nome é Vladimir Costa"
...
// Agora, apresente-se ;)
pessoa.apresentacao(); //"Olá, eu sou o Vladimir Costa, tenho 27anos, 1.65, meu peso é 62kg e, só hoje, eu já caminhei 37 metros!"
```
