...
*/
pessoa.nomeCompleto() // 'Olá! Meu nome é Lucas Floriani'
...
pessoa.apresentacao = function() {
  ...
  return 'Olá, eu sou ' + sexo + ' ' + this.nome + ' ' + this.sobrenome + ', tenho ' + this.idade + ' ' + idade + ', ' + this.altura + ', meu peso é ' + this.peso + ' e, só hoje, eu já caminhei ' + this.caminhouQuantosMetros + ' ' + distancia + '!';
}
