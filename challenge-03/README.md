...
*/
  pessoa.andar = function(quantidadeMetrosCaminhados){
		...
		/*observações importantes: nan + inteiro = nan / undefined + inteiro = undefined */
...
*/
  pessoa.nomeCompleto(); // 'Olá! Meu nome é Felipe Santos'
...
*/
  pessoa.apresentacao = function() {
		...
		if (pessoa.quantidadeMetrosCaminhados === 1){ metro = "metro";}
...
// Agora, apresente-se ;)
  pessoa.apresentacao(); /*'Olá, eu sou o Felipe Santos, tenho 28 anos, 1.71, meu peso é 81 e, só hoje, eu já caminhei 50 metros!'  */
```
