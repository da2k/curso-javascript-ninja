...
*/
pessoa.nomeCompleto(); //Olá! Meu nome é Anderson Manhães!
...
pessoa.apresentacao = function() {
  ...
  retorn 'Olá, eu sou ' + genero + ' ' + pessoa.nome + ' ' + pessoa.sobrenome + ', tenho ' + pessoa.idade + ' ' + singPlural + ', ' + pessoa.altura + ', meu peso é ' + pessoa.peso + ' e, só hoje, eu já caminhei ' + pessoa.caminhouQuantosMetros + ' ' + distancia + '!'
}
