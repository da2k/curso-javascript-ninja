...
*/
 pessoa.nomeCompleto(); // "Olá! Meu nome é Dara Medeiros"
...
// Agora, apresente-se ;)
pessoa.aprensetacao() ; // "Olá, eu sou o Dara Medeiros, tenho 26 anos 1.75, meu peso é 75 e, só hoje, eu já caminhei 9 metros!"
```
