...
*/
let pessoa = { nome:'Wilson', sobreNome:'Junior', sexo: 'Masculino', idade: 32, altura: 1.77, peso: 77, andando: false, caminhouQuantosMetros: 0};
...
*/
pessoa.andar = function(n) { pessoa.caminhouQuantosMetros += n;
pessoa.andando = true }
...
*/
pessoa.nomeCompleto() //'Olá! Meu nome é Wilson Junior!'
...
*/
pessoa.caminhouQuantosMetros(); //950
