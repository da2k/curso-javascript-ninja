...
Pessoa.nomeCompleto = function(){
  return 'Ola! Meu nomo e:' + pessoa.nome + '' + pessoa.sobrenome + '!';
};
...
*/
pessoa.nomeCompleto(); // Ola! meu nome e Maria Silva!
...
inline ao lado da instrução para mostrar qual foi a resposta retornada)
*/
pessoa.mostrarAltura(); // Minha altura e 1.64 m.
...
retornada)
*/
pessoa.mostrarIdade(); // Ola, eu tenho 28 anos!
