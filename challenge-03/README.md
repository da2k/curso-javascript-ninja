...
for chamado.
*/
pessoa.fazerAniversario = function() { this.idade += 1 }
...
pessoa.apresentacao = function() {
    ...
    var genero = this.sexo == 'masculino' ? 'o' : 'a';
    var anos = this.idade > 1 ? 'anos' : 'ano';
    var distancia = this.caminhouQuantosMetros > 1 ? 'metros' : 'metro';

    return "Olá, eu sou " + genero + " " + this.nome + " " + this.sobrenome + ", tenho " +
        this.idade + " " + anos + ", minha altura é " + this.altura +
        ", eu peso " + this.peso + "Kg e, só hoje, eu já caminhei " +
