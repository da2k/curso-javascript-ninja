...
*/
pessoa.nomeCompleto(); //'Olá! Meu nome é Luiz Campedelli!'
...
pessoa.apresentacao = function(){
	...
	return "Olá, eu sou " 
			...
			+ pessoa.nome + " " 
			+ pessoa.sobrenome 
			+ ", tenho " + pessoa.idade + " " + qtdAnos + ", " 
			+ pessoa.altura 
			+ ", meu peso é " + pessoa.peso 
			+ " e, só hoje, eu já caminhei " + pessoa.caminhouQuantosMetros + " " + andado;
}
