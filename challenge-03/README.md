...
*/
pessoa.nomeCompleto(); //"Olá! Meu nome é Adonias Dantas!"
/*
...
pessoa.apresentacao = function () {
  ...
  if (pessoa.sexo === 'Feminino') {
    sexo += ("Olá, eu sou a " + pessoa.nome + " " + pessoa.sobrenome + ", tenho ");
  } else {
    sexo += ("Olá, eu sou o " + pessoa.nome + " " + pessoa.sobrenome + ", tenho ");
  }
  ...
  if (pessoa.caminhouQuantosMetros === 1) {
    ...
    caminhou += (pessoa.caminhouQuantosMetros + " metros!");
  }
