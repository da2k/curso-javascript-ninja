...
*/
var pessoa = {nome: 'Romario', sobrenome: 'Coimbra', sexo: 'Masculino', idade: 27, altura: 1.70, peso: 80, andando: false, caminhouQuantosMetros: 0};
...
*/
pessoa.nomeCompleto(); // 'Olá meu nome completo é Romario Coimbra!'

/*
Qual a idade da pessoa? (Use a instrução para responder e comentários
inline ao lado da instrução para mostrar qual foi a resposta retornada)
*/
pessoa.mostrarIdade(); // 'Olá tenho 27 anos!'
...
var sexo = 'o', idade = 'anos', distancia = 'metros';
