...
*/
pessoa.nomeCompleto(); // Olá, Meu nome é Lucas Lopes!
...
*/
pessoa.caminhouQuantosMetros; // 776
...
pessoa.apresentacao();
/*
Olá, eu sou o Lucas Lopes, tenho 26 anos, 1.8, meu peso é 98 e, só hoje, eu já caminhei 776 metros!
*/
```
