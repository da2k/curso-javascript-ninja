...
*/
var pessoa = {nome: 'Samuel', sobrenome: 'Ramos', sexo: 'Masculino', idade: 27, altura: 1.69, peso: 65, andando: false, caminhouQuantosMetros: 0 };
...
*/
pessoa.nomeCompleto(); //Olá! Meu nome é Samuel Ramos!
