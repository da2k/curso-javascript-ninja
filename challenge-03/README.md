...
*/
pessoa.nomeCompleto(); //Olá! Meu nome é Wesley Xavier!
...
return 'Olá, eu sou '+tSexo+' ' +pessoa.nome+' '+pessoa.sobrenome+', tenho '+ pessoa.idade+' '+tIdade+', '+ pessoa.altura +', meu peso é '+ pessoa.peso+' e, só hoje, eu já caminhei '+pessoa.caminhouQuantosMetros+' '+tMetro+'!';

}

// Agora, apresente-se ;)
//Olá, eu sou o Wesley Xavier, tenho 31 anos, 1.85, meu peso é 87 e, só hoje, eu já caminhei 6 metros!
```
