...
*/
pessoa = { nome: "Chico", sobrenome: "Silva", sexo: "masculino", idade: 25, altura: 1.80, peso: 85.5, andando: false, caminhouQuantosMetros: 0}
...
*/
pessoa.andar = function(x){return pessoa.caminhouQuantosMetros += x, pessoa.andando = true; }
...
*/
pessoa.nomeCompleto();//"Olá! Meu nome é Chico Silva!"
...
inline ao lado da instrução para mostrar qual foi a resposta retornada)
*/
pessoa.mostrarPeso();//"Eu peso 85.5Kg."
