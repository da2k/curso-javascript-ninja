...
*/
? var pessoa = { nome: "Thiago", sobrenome: "Machado", sexo: "Masculino", idade: 33, altura: 1.77, peso: 80, andando: false, caminhouQuantosMetros: 0 }
...
*/
? pessoa.mostrarIdade = function(){ "Olá! eu tenho " + pessoa.idade  + " anos!"; }
...
*/
? pessoa.nomeCompleto() // 'Olá! Meu nome é Thiago Machado'
...
? pessoa.apresentacao = function(){
	...
	return "Olá, "+ sx + pessoa.nome + " " + pessoa.sobrenome + ", tenho "+ pessoa.idade + id + " " + pessoa.altura + ", meu peso é " + pessoa.peso + "Kg e, só hoje, eu já caminhei " + pessoa.caminhouQuantosMetros  + mt;
}
