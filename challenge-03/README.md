...
*/
pessoa.nomeCompleto(); // "Olá! Meu nome é: William Oliveira"
...
*/
pessoa.andar(2); // undefined
pessoa.andar(3); // undefined
pessoa.andar(2); // undefined
...
// Agora, apresente-se ;)
pessoa.apresentacao(); // "Olá, eu sou o William Oliveira, tenho 27 anos, 1.75, meu peso é 60 e, só hoje, eu já caminhei 7 metros!"
```
