...
*/
pessoa.nomeCompleto(); // "Olá! Meu nome é Natalia Luiza da Silva!"
...
retornada)
*/
pessoa.mostrarIdade()ç // "Olá, eu tenho 27 anos!"
...
*/
pessoa.apresentacao = () => {
  const sexo = pessoa.sexo === 'Feminino' ? 'a' : 'o';
  const idade = pessoa.idade === 1 ? 'ano' : 'anos';
...
// Agora, apresente-se ;)
pessoa.apresentacao() // "Olá, eu sou a Natalia Luiza da Silva, tenho 27 anos, 1.65, meu peso é 90 e, só hoje, eu já caminhei 350 metros!"
```
