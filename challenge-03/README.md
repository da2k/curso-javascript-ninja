...
*/
pessoa.nomeCompleto(); // 'Olá! Meu nome é Eric Cristhiano!'
...
pessoa.apresentacao = function() {
  ...
  return 'Olá, eu sou ' + inicio + ' ' + pessoa.nome + ' ' + pessoa.sobrenome + ', tenho ' + pessoa.idade + ' ' + ano + ', ' + pessoa.altura + ', meu peso é ' + pessoa.peso + ' e, só hoje, eu já caminhei ' + pessoa.caminhouQuantosMetros + ' ' + metro + '!';
}
