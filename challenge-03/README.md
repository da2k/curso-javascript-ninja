...
*/
pessoa.nomeCompleto(); // 'Olá! Meu nome é Jonathan Ramos!'
...
// Agora, apresente-se ;)
pessoa.apresentacao(); //'Olá, eu sou o Jonathan Ramos, tenho 27 anos, 1.85, meu peso é 83 e, só hoje, eu já caminhei 350 metros!'
```
