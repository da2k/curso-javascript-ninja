...
*/
pessoa.nomeCompleto(); // "Olá! Meu nome é Paulo Alexandre!"
...
pessoa.apresentacao = function() {
	...
	return "Olá, eu sou " + sexo + " " + this.nome + " " + this.sobrenome + ", tenho " + this.idade + " " + idadeAnos + ", " + this.altura + " , meu peso é " + this.peso + " e, só hoje, eu já caminhei " + this.caminhouQuantosMetros + " " + metrosCaminhados + "!";
}
