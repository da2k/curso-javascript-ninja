...
*/
var pessoa = {nome: 'Matheus', sobrenome: 'Barbosa', sexo: 'Masculino', idade: 19, altura: 1.72, peso: 80, andando: false, caminhouQuantosMetros: 0};
...
*/
pessoa.nomeCompleto(); //'Olá! Meu nome é Matheus Barbosa'
...
pessoa.apresentacao = function(){
  ...
  if(pessoa.caminhouQuantosMetros === 1){
    var m = 'metro.';
    return 'Olá, eu sou o ' + pessoa.nomeCompleto + ', tenho ' + pessoa.idade + ' anos, ' + pessoa.altura + ', meu peso é ' + pessoa.peso + ' e, só hoje, eu já caminhei '+ pessoa.caminhouQuantosMetros + m;
  }
...
// Agora, apresente-se ;)
'Olá, eu sou o Matheus Barbosa, tenho 22 anos, 1.72, meu peso é 80 e, só hoje, eu já caminhei 300 metros!'
```
