...
*/
pessoa.nomeCompleto(); // 'Olá! Meu nome é Ben-hur Guimarães!'
...
inline ao lado da instrução para mostrar qual foi a resposta retornada)
*/
pessoa.mostrarAltura(); // 'Eu peso 86Kg.'
...
pessoa.apresentacao = function (){
    ...
    return 'Olá, eu sou ' + artigo + ' ' + this.nome + ' ' + pessoa.sobrenome +
           ', tenho ' + this.idade + ' '+  ano + ', ' + this.altura + ', meu peso é '+ this.peso + ' e, só hoje, eu já caminhei '+ this.caminhouQuantosMetros + ' ' + metro + '!'
};
