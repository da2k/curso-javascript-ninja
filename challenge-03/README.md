...
pessoa.fazerAniversario = function(){ //Possibilidade 1
	pessoa.idade++;
};

pessoa.fazerAniversario = function(){ //Possibilidade 2
	pessoa.idade += 1;
};

pessoa.fazerAniversario = function(){ //Possibilidade 3
...
*/
pessoa.nomeCompleto(); //'Olá! Meu nome é John Mello!'
...
// esse de cima é inconcebivel de ser feito



pessoa.apresentacao1 = function() {
	var sexo = 'o';
	var idadeAnos = 'anos';
...
pessoa.apresentacao() //'Olá, eu sou o John Mello, tenho 36 anos, 1.85, meu peso é 80 e, só hoje, eu já caminhei 180 metros!'