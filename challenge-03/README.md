...
pessoa.mostrarAltura = function() {
    ...
    return 'eu tenho'+ pessoa.altura + 'cm';
...
*/
pessoa.nomeCompleto();
//'ola! meu nome é jefferson candido!'
...
// Agora, apresente-se ;)
pessoa.apresentacao()
//'Olá, eu sou o jefferson candido, tenho 29 anos, 1.87, meu peso é 130 e, só hoje, eu já caminhei270 metros!'
```
