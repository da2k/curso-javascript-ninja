...
*/
pessoa.andar = function(valor) { pessoa.caminhouQuantosMetros += valor, pessoa.andando = true };
...
*/
pessoa.nomeCompleto(); // "Olá! Meu nome é Renato Siqueira!"
...
*/
pessoa.caminhouQuantosMetros; // 158
...
pessoa.apresentacao = function() {
  ...
  if( pessoa.sexo === 'Feminino' ) { intro = 'a' }
	if( pessoa.idade === 1 ) { idade = 'ano' }
	if( pessoa.caminhouQuantosMetros === 1 ) { metro = 'metro' }

    return "Olá, eu sou " + intro + " " + pessoa.nome + " " + pessoa.sobrenome + ", tenho " + pessoa.idade + " " + idade + ", " + pessoa.altura + ", meu peso é " + pessoa.peso + " e, só hoje, eu já caminhei " + pessoa.caminhouQuantosMetros + " " + metro + "!"
};

// Agora, apresente-se ;)
pessoa.apresentacao();
// "Olá, eu sou o Renato Siqueira, tenho 40 anos, 1.82, meu peso é 80 e, só hoje, eu já caminhei 158 metros!"
```
