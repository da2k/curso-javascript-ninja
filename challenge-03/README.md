...
*/
pessoa.nomeCompleto(); // 'Olá! Meu nome é Saulo Santos!'
...
// Agora, apresente-se ;)
pessoa.apresentacao(); // 'Olá, eu sou o Saulo Santos, tenho 30 anos, 1.74m., meu peso é 90Kg. e, só hoje, eu já caminhei 30 metros!'
```
