...
*/
pessoa.nomeCompleto(); // Diego Costa
...
pessoa.apresentacao = function() {
    ...
    var metragem = (pessoa.caminhouQuantosMetros === 1) ? 'metro' : 'metros'; 

    return "Olá, eu sou " + sexo + " " + pessoa.nome + " " + pessoa.sobrenome + ", tenho " + pessoa.idade + " " + idade + ", " + pessoa.altura + ", meu peso é " + pessoa.peso + " e, só hoje, eu já caminhei " + pessoa.caminhouQuantosMetros + " " + metragem + "!";
};
