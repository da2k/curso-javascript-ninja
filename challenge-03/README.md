...
*/
var pessoa {nome: 'Rios',sobrenome:'Santos',sexo: 'M', idade: '30', altura: 1.7, peso: 47, andando: false, caminhouQuantosMetros: 0};
...
*/
pessoa.nomeCompleto() // 'Olá! Meu nome é Rios Santos'

/*
Qual a idade da pessoa? (Use a instrução para responder e comentários
inline ao lado da instrução para mostrar qual foi a resposta retornada)
*/
pessoa.mostrarIdade() // 'Olá, tenho 30 anos!'

/*
Qual o peso da pessoa? (Use a instrução para responder e comentários
inline ao lado da instrução para mostrar qual foi a resposta retornada)
*/
pessoa.mostrarPeso() // 'Eu peso 47Kg'
