...
*/
pessoa.nomeCompleto(); //"Olá! Meu nome é Eduardo Teixeira!"
...
pessoa.apresentacao = 
    function() {
        ...
        if (pessoa.idade === 1)
            tempo = ' ano';
        tempo = pessoa.idade + tempo;

        var distancia = ' metros';
        if (pessoa.caminhouQuantosMetros === 1)
            distancia = ' metro';
        distancia = pessoa.caminhouQuantosMetros + distancia;

        return 'Olá, eu sou' + nome +', tenho ' + tempo + ', ' + pessoa.altura + 'm, meu peso é ' + pessoa.peso + 'Kg e, só hoje, eu já caminhei ' + distancia + '!';
    }

// Agora, apresente-se ;)
pessoa.apresentacao(); /* "Olá, eu sou o Eduardo Teixeira, tenho 40 anos, 1.75m, meu peso é 77Kg e, só hoje, eu já caminhei 200 metros!" */
```
