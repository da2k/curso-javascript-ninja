...
*/
pessoa.mostrarAultura = function(){
...
*/
pessoa.nomeCompleto(); // Olá! meu nome é Douglas Lambertinny
...
pessoa.apresentacao = function(){
    ...
    if (pessoa.sexo === 'Masculino'){
        message += "o " + pessoa.nomeCompleto(); + ", "
    }else {
        message += "a " + pessoa.nomeCompleto(); + ", "
    };
    if (pessoa.idade === 1){
        message += "tenho" + pessoa.idade + "ano,"
    }else {
        message += "tenho" + pessoa.idade + "anos,"
    };
    message += + pessoa.altura + "," + "meu peso é " + pessoa.peso "e, "
    if (pessoa.caminhouQuantosMetros == 1){
        message += "só hoje, eu já caminhei " + pessoa.caminhouQuantosMetros + "metro!"
    }else {
        message += "só hoje, eu já caminhei " + pessoa.caminhouQuantosMetros + "metros!"
    };
    return message
};
