...
*/
pessoa.nomeCompleto(); // "Paulo Pamplona"
...
pessoa.apresentacao = function(){
    ...
    if (pessoa.caminhouQuantosMetros > 1){
        grammarMetros = 'metros';
    } else {
        grammarMetros = 'metro';
    }
                                 
    return "Olá, eu sou " + grammarArtigo + " " + pessoa.nomeCompleto() + ", tenho " + pessoa.idade + " " + grammarAnos + ", " + pessoa.altura + ", meu peso é " + pessoa.peso + " e, só hoje, eu já caminhei " + pessoa.caminhouQuantosMetros + " " + grammarMetros + "!";
};

// Agora, apresente-se ;)
pessoa.apresentacao();
// "Olá, eu sou o Paulo Pamplona, tenho 42 anos, 1.8, meu peso é 75 e, só hoje, eu já caminhei 17 metros!"
