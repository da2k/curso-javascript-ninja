...
pessoa.apresentacao = function() {
  return "Olá, eu sou o"+pessoa.nome+" "+pessoa.sobrenome+", tenho"+pessoa.idade+" anos,"+pessoa.altura+", meu peso é "+pessoa.peso+" e, só hoje, eu já caminhei"+caminhouQuantosMetros+" metros!";
}
