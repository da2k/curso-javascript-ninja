...
*/
 var pessoa= { nome: 'Lucas', sobrenome: 'Guiral', sexo: 'masculino', idade: 27, altura: 1.85, peso: '85' , andando: false , caminhouQuantosMetros: 0}
...
*/
pessoa.nomeCompleto(); //'Olá! Meu nome é Lucas Guiral!'
