...
pessoa.mostrarPeso =function(){
    return console.log("Eu pesso " + pessoa.peso + "Kg.")
}
...
pessoa.minhaAltura = function(){
    return console.log("Minha altura é " + pessoa.altura.toFixed(2)+ "m.")
}
...
*/
pessoa.nomeCompleto() // Olá! Meu nome é Pablo Binotto!

/*
Qual a idade da pessoa? (Use a instrução para responder e comentários
inline ao lado da instrução para mostrar qual foi a resposta retornada)
*/
pessoa.motrarIdade() // Ola, eu tenho 44 anos!
...
inline ao lado da instrução para mostrar qual foi a resposta retornada)
*/
pessoa.minhaAltura() // Minha altura é 1.70m.
...
retornada)
*/
pessoa.motrarIdade() // Ola, eu tenho 46 anos!
