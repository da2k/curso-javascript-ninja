...
*/
pessoa.andar = function(pMetros){ 
        pessoa.caminhouQuantosMetros += pMetros; 
        pessoa.andando  = true;
        };
...
*/
pessoa.nomeCompleto();//"Olá! Meu nome é Fabricio Beneduzi!"
...
pessoa.apresentacao = function(){
  ...
  return inicio                        + ' ' + pessoa.nomeCompleto     + ',' + ' ' + 
         'tenho'                       + ' ' + pessoa.idade                  + ' ' + 
         idade + ','                   + ' ' + pessoa.altura + ','           + ' ' +  
...
// Agora, apresente-se ;)
// "Olá, eu sou o Fabricio Beneduzi, tenho 33 anos, 1.80, meu peso é 89 e, só hoje, eu já caminhei 6 metros!"
