...
*/
pessoa.nomeCompleto(); //"Olá! Meu nome é Cinthia Campos"
...
pessoa.apresentacao = function () {
	var retorno = "Olá, eu sou";
	if(pessoa.sexo === "Feminino")
		retorno += " a ";
	else
		retorno += " o ";
	retorno += pessoa.nome + " " + pessoa.sobrenome;
	retorno += ", tenho " + pessoa.idade;
	if(pessoa.idade === 1)
		retorno += " ano, ";
	else
		retorno += " anos, ";
	retorno += pessoa.altura;
	retorno += ", meu peso é " + pessoa.peso;
	retorno += " e, só hoje, eu já caminhei " + pessoa.caminhouQuantosMetros;
...
// Agora, apresente-se ;)
pessoa.apresentacao(); /* "Olá, eu sou a Cinthia Campos, tenho 28 anos, 1.6, meu peso é 78 e, só hoje, eu já caminhei 23 metros!" */
```
