...
*/
pessoa.nomeCompleto(); // "Olá, meu nome é Flávia Guterres!"
...
*/
pessoa.caminhouQuantosMetros; // 301
...
// Agora, apresente-se ;)
pessoa.apresentacao(); // "Olá, eu sou a Flávia Guterres, tenho 39 anos, 1.67, meu peso é 60 e, só hoje, eu já caminhei 301 metros!"
```
