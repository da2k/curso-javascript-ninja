...
function calculator(param) {
  return function(a, b) {
    ...
    return 'Resultado da operação: ' + a + ' ' + param + ' ' + b + ' = ' + resultado;
  };
}
...
*/
sum(9, 3); //Resultado da operação: 9+6 = 1
...
var mod = calculator("%");
var qualquercoisa = calculator('z');
...
qualquercoisa(20,8); //'Operação inválida.'
