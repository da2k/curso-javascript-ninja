...
//A função showName retorna weverton couy.
/*
...
function calculator(operacao){
    ...
    return function (numero1, numero2){ 
       ...
       return 'Resultado da operação: ' + numero1 + ' ' + operacao + ' ' + numero2 + ' = ' + resultado + '.';
    };       
}              
