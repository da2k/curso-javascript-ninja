...
no console.
*/
console.log(subtraction(30,15)); //Resultado da operação: 30 - 15 = 15.
console.log(multiplication(2,15)); //Resultado da operação: 2 * 15 = 30.
console.log(division(50,2)); //Resultado da operação: 50 / 2 = 25.
console.log(mod(45,25)); //Resultado da operação: 45 % 25 = 20.
