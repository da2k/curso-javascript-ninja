...
function showName() { return 'Davi Rocha'; }
...
//console.log(sum(87,134)); //Resultado da operação 87 + 134 = 221
...
console.log(subtraction(874, 424));
console.log(multiplication(9,8));
console.log(division(140, 7));
console.log(mod(987,655));
