...
function calculator(op){
    return function(op1, op2){
        ...
        return 'Resultado da operação: ' + op1 + ' ' + op + ' ' + op2 + ' = ' + resultado;
    }
}
...
*/
console.log(sum(10, 10)); //Resultado da operação: 10 + 10 = 20
...
console.log(multiplication(9, 9)); //Resultado da operação: 9 * 9 = 81
