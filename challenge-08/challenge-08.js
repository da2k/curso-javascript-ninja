...
function calculator( operador ){
    return function ( x, y ){
        ...
        return 'Resultado da operação: '+ x +' '+ operador +' '+ x +' = '+ resultado +'';
    };
};
...
no console.
*/
console.log( subtraction( 500, 120 ) );
console.log( multiplication( 12, 5 ) );
console.log( division( 50, 12 ) );
console.log( mod( 5, 50 ) );
