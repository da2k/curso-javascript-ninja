...
*/
sum(1, 7) // Resultado da operação: 1 + 7 = 8
...
no console.
*/
subtraction(7, 5) // Resultado da operação: 7 - 5 = 2
multiplication(10, 10) // Resultado da operação: 10 * 10 = 100
division(5, 2) // Resultado da operação: 5 / 2 = 2.5
mod(127, 30) // Resultado da operação: 127 % 30 = 7
