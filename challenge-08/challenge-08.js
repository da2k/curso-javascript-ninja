...
*/
console.log('O nome da funcao é ' +sum.name +'.');
...
*/
console.log('A funcao ' +showName.name +' retorna ' + varShowName() +'.')
...
function calculator (op) {
    return function (valor1, valor2) {
        ...
        console.log( 'Resultado da operação: ' +valor1 +' ' +op +' ' +valor2 +' = ' +result +'.');
    };
