...
function calculator(operador){
 return function(x,y){
    ...
    var retorno = 'Resultado da operação: ' + x + ' ' + operador + ' ' + y + ' = ' + result;
    return retorno;
  }
}
...
*/
console.log(sum(10,40));//Resultado da operação: 10 + 40 = 50
...
no console.
*/
console.log(subtraction(10,9));//Resultado da operação: 10 - 9 = 1
console.log(multiplication(10,20));//Resultado da operação: 10 * 20 = 200
console.log(division(100,2));//Resultado da operação: 100 / 2 = 50
console.log(mod(10,2));//Resultado da operação: 10 % 2 = 0
console.log(sum(10,100));//Resultado da operação: 10 + 100 = 110
