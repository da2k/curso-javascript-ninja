...
console.log('A função ' + showName.name + ' retorna ' +
    varShowName);
...
function calculator(operacao) {
    return function (operando_1, operando_2) {
        var resultado;
        switch (operacao) {
            case '+':
        ...
        return 'Resultado da operação: ' + operando_1 + operacao + operando_2 + ' = ' + resultado;
    }
}
