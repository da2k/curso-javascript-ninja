...
console.log('A soma de ' + val1 + ' e ' + val2 + ' é igual a ' + sum(val1, val2) + '.'); // A soma de 2 e 2 é igual a 4.
...
*/
console.log('A função ' + varShowName.name + ' retorna ' + varShowName() + '.'); // A função showName retorna William.
