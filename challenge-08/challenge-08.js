...
*/
console.log(`A função ${showName.name} retorna ${showName()}`) // A função showName retorna Henrique Araújo
...
no console.
*/
console.log(subtraction(50, 10))  // Resultado da operação: 50 - 10 = 40.
