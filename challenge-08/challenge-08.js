...
//    if(mathOperator === '+'){
//      
//      return 'Resultado da operação: ' + x + mathOperator + y + ' = ' + (x + y) + '.'
//      
...
function calculator(mathOperator) {
  ...
  return function (number1, number2){
    ...
    return 'Resultado da operação: ' + number1 + ' ' + mathOperator + ' ' + number2 + ' = ' + result + '.';
