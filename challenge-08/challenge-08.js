...
no console.*/
console.log(substraction(4,5));// Resultado da operação: 4-5 = -1.
console.log(multiplication(25,80));//Resultado da operação: 25*80 = 2000.
console.log(division(900,600));//Resultado da operação: 900/600 = 1.5.
console.log(mod(1,2));//Resultado da operação: 1%2 = 1.
