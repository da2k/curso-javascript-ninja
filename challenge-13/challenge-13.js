(function() {
  ...
  */
  var nordeste = [ 'Ceará', 'Alagoas', 'Bahia', 'Maranhão', 'Paraíba', 'Piauí', 'Pernambuco', 'Rio Grande do Norte', 'Sergipe' ];
  ...
  */
  ...
  var qtdLetters = brasil.every(function( item ) {
     return item.length > 7;
  });
  console.log( qtdLetters ? 'Sim, todos os estados tem mais de 7 letras!' : 'Nem todos os estados tem mais de 7 letras!');
  /*
