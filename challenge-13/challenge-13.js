(function(){
    ...
    */
    ...
    brasil.unshift('Acre', 'Roraima', 'Amapá');
    console.log( brasil );
    ...
    */
    ...
    chamada `newSudeste`.
    */
    var newSudeste = brasil.splice( 5, 6);
    ...
    */
    ...
    var hasSevenLetter = brasil.every(function( item ){        
    ...
    */
    ...
    var map = newBrasil.map(function( item ){
        otherBrasil.push({id: item.id + 1,  estado: item.estado + ' pertence ao Brasil.'});
    });
