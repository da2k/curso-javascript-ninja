(function () {
    ...
    */
    var sul = ['Parana', 'Rio Grande do Sil', 'Santa Catarina'];
    ...
    */
    var nordeste = ['Alagoas', 'Bahia', 'Ceará', 'Maranhão'];
    ...
    */
    ...
    var hasMaisSeteDigitos = brasil.every(function (item) {
        return item.length > 7;
    });

    hasMaisSeteDigitos ? console.log('Sim, todos os estados tem mais de 7 letras!') : console.log('Nem todos os estados tem mais de 7 letras!');
    ...
    */
    ...
    hasCeara ? console.log('Ceará está incluído!') : console.log('Ceará não foi incluído');
    ...
    */
    ...
    var filter = newBrasil.filter(function (item, indice) {
        return item.id % 2 === 0;
    });
