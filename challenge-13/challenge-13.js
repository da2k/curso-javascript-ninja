(function(){
  ...
  */
  ...
  var sudeste = ['Minas Gerais', 'Rio de Janeiro', 'Espírito Santo', 'São Paulo']
  ...
  */
  var nordeste = ['Pernambuco', 'Paraíba', 'Rio Grande do Norte', 'Ceará', 'Maranhão', 'Piauí', 'Alagoas', 'Sergipe', 'Bahia']
  ...
  */
  ...
  brasil.forEach(function(item, index){
    newBrasil = brasil.map(function(item, index, array){
