(function(){
    ...
    */
    var newArray = [];
    newArray.push('Lucas','José','Teresinha','Paula');
    ...
    */
    ...
    var sul = [];
    var sudeste = [];
    sul.push('Rio Grande do Sul','Paraná','Santa Catarina');
    sudeste.push('São Paulo','Minas Gerais','Rio de Janeiro','Espirito Santo');
    /*
    ...
    */
    // ?
        ...
        brasil.forEach(function(estado){
            if(estado == 'Rio Grande do Sul'|| estado == 'Paraná'|| estado == 'Santa Catarina'){
                newSul.push(estado);
            }
        });
    /**
    ...
    */
    // ?
        var nordeste = [];
        nordeste.push('Alagoas','Bahia','Ceará','Maranhão','Paraíba','Pernambuco','Piauí', 'Rio Grande do Norte' ,'Sergipe');
    ...
    */
    ...
    // ?
    var containsCeara = brasil.some(function(estado){
        return estado === 'Ceará';
    })? "Ceará está incluído!" : "Ceará não foi incluído :(";
    console.log(containsCeara)
