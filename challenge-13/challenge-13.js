(function() {
	...
	*/
	...
	var hasSevenLetter;
	hasSevenLetter = brasil.every( function( item ) {
		return item.length > 7;
	});
	console.log( hasSevenLetter ? 'Sim, todos os estados tem mais de 7 letras!' : 'Nem todos os estados tem mais de 7 letras!' );
