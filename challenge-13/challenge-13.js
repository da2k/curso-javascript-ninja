...
(function(){
    ...
    */
    var nordeste = [ 'Rio Grande do Norte', 'Paraíba', 'Sergipe', 'Bahia', 'Pernambuco', 'Maranhão', 'Piauí', 'Ceará', 'Alagoas' ];
    ...
    */
    ...
    var verificacao = brasil.every( function(item) {
        return item.length > 7; 
    });
   
    verificacao ? console.log('Sim, todos os estados tem mais de 7 letras!') : console.log('Nem todos os estados tem mais de 7 letras!');
    ...
    */
    ...
    var verificacao = brasil.some(function(item){
        return item === 'Ceará';
    });
    
    verificacao ? console.log('Ceará está incluído!') : console.log('Ceará não foi incluído :(');
