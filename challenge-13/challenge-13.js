(function() {
	...
	*/
	...
	var myArray = ['Adams', 1, function(){}, { force: 100, agility: 90 }, true];
	...
	*/
	...
	brasil.unshift( 'Amanzonas', 'Pará', 'Acre' );
	console.log( brasil );
	...
	*/
	var nordeste = [ 'Rio Grande do Norte', 'Paraíba', 'Pernambuco', 'Alagoas', 'Sergipe', 'Bahia', 'Ceará', 'Piauí', 'Maranhão' ];
