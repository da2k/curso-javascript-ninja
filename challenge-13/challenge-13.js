(() => {
    ...
    */
    ...
    var moreSeven = brasil.every((item) => {
        return item.length > 7;
    });
    console.log(moreSeven ? 'Sim, todos os estados tem mais de 7 letras!' : 'Nem todos os estados tem mais de 7 letras!');
    ...
    */
    ...
    var cearaInner = brasil.some(item => {
        return item === 'Ceará';
    });
    console.log(cearaInner ? 'Ceará está incluído!' : 'Ceará não foi incluído :(');
