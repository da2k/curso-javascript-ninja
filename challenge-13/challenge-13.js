...
var sudeste = ['Sao Paulo', 'Rio De Janeiro', 'Espirito Do Santo', 'Minas Gerais'];
...
console.log(some ? 'Ceara esta incluido' : 'Ceara nao foi incluido');
...
var map = newBrasil.map(function(item, index) {
    ...
    // item.id++;
    // item.edtado += ' pertence ao Brasil';
    // return item;
});
