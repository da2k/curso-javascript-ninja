...
var arrSudeste = ['São Paulo', 'Rio de Janeiro', 'Espírito Santo', 'Minas Gerais'];
...
*/
var brasilEvery = brasil.every(function(item, index, array){
    return item.length > 7;
});
console.log(brasilEvery ? "Sim, todos os estados tem mais de 7 letras!"
                         : "Nem todos os estados tem mais de 7 letras!");
console.log( '\nTodos os estados de `brasil` tem mais de 7 letras?', brasilEvery );
// ?
