(function() { /*
    ...
    */
    ...
    chamada `newSudeste`.
    */
    var newSudeste =  brasil.splice(5,4) // esse index 4 é a qtd que vamos remover
    ...
    */
    ...
    var mapFilter = map.map(function(item) {
        return item;
    }).filter(function(item) {
        return item.id % 2 === 0;
    });

    // var mapFilter = map.filter(function(item, index) {
    //     return item.id % 2 === 0;
    // })
