(function() {
  ...
  */
  var sul = ['Rio Grande do Sul', 'Paraná', 'Santa Catarina']/*.join(', ')
  Tornou-se desnecessário! */;

  // var sulSpace = sul.join(', ');

  var sudeste = ['São Paulo', 'Rio de Janeiro', 'Espírito Santo', 'Minas Gerais']/*.join(', ')
  Tornou-se desnecessário! */;

  // var sudesteSpace = sudeste.join(', ');
  ...
  */
  ...
  // var norte = ['Amazonas', 'Pará', 'Roraima'].join(', ');
  // brasil += [', ' + norte]; 
 ...
 // console.log(brasil);
  // console.log(brasil.concat(sul, sudeste).unshift([norte]));
  ...
  */
  /* var newSul = brasil.concat(sudeste,sul).slice(3,8); // O Slice no concat retira o sudeste, considerando o norte apenas na contagem! */
  ...
  */
  var somar = newBrasil.map(function (item, index) {
      return {
        id: item.id + 1,
  ...
  */
    var filtro = somar.filter(function (item, index) {
    return item.id % 2 === 0;
  });
