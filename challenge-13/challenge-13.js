(function() {
    ...
    */
    ...
    var moreOfSevenLetters = brasil.every(function(item) {
        return item.length > 7;
    });

    console.log(moreOfSevenLetters ? 'Sim, todos os estados tem mais de 7 letras!' : 'Nem todos os estados tem mais de 7 letras!');
    ...
    */
    ...
    var search = brasil.some(function(item) {
        return item === "Ceará";
    });

    console.log(search ? 'Ceará está incluído!' : 'Ceará não está incluído!');
