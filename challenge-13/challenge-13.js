(function(){
	...
	*/
	...
	var answer = brasil.every(function(item){
		return item.length > 7;
	});
	msg = answer ? "Sim, todos os estados tem mais de 7 letras!" : "Nem todos os estados tem mais de 7 letras!";
	console.log(msg);
	/*
	...
	*/
	var cearaExists = false;
	brasil.forEach(function(item){
		if(item === 'Ceará')
			cearaExists = true;
	});
	console.log( '\nCeará está incluído em `brasil`?' );
	var msg = cearaExists ? "Ceará está incluído!" : "Ceará não foi incluído :(";
	console.log(msg);
