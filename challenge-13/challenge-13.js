(function(){
  ...
  */
  var nordeste = ['Ceará', 'Bahia', 'Sergipe', 'Pernambuco', 'Rio Grande do Norte', 'Piaui', 'Maranhão', 'Paraíba', 'Alagoas'];
  ...
  */
  ...
  var sevenStates = brasil.every(function(item) {
  ...
  */
  ...
  console.log(
    cearaExists ? 'Ceará está incluído!' : 'Ceará não foi incluído :(');
