(function() {
	...
	*/
	...
	var brasilItensLetters = brasil.every( function( item ) {
		return item.length > 7;
	});

	brasilItensLetters ? console.log( 'Sim, todos os estados tem mais de 7 letras!' ) : console.log( 'Nem todos os estados tem mais de 7 letras!' );
	...
	*/
	...
	var brasilHasItem = brasil.some( function( item ) {
		return item === 'Ceará';
	});

	brasilHasItem ? console.log( 'Ceará está incluído!' ) : console.log( 'Ceará não foi incluído :(' );
