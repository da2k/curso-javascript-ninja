(function(){
    ...
    */
    ...
    //
    let moreThanSevenLetters = brasil.every(item=>{
        return item.length > 7;
    });

    function message(){
        return moreThanSevenLetters ? 'Sim, todos os estados tem mais de 7 letras!' : 'Nem todos os estados tem mais de 7 letras!';
    }
    ...
    */
    ...
    //
    let cearaExists = brasil.includes('Ceará');
    function message2(){
        return cearaExists ? "Ceará está incluído!" : "Ceará não foi incluído :(";
    }
