(function() {
  ...
  */
  var nordeste = ['Bahia', 'Pernambuco', 'Alagoas', 'Sergipe', 'Rio Grande do Norte',
  ...
  */
  ...
  var maiorQueSeteLetras = brasil.every(function(estado){
    return estado.length > 7;
  });
  console.log(maiorQueSeteLetras ?
    'Sim, todos os estados tem mais de 7 letras!' :
    'Nem todos os estados tem mais de 7 letras!');
  ...
  */
  ...
  var contemEstadoCeara = brasil.some(function(estado){
    return estado === 'Ceará';
  });
  console.log(contemEstadoCeara ?
    'Ceará está incluído!' :
    'Ceará não foi incluído :(');
