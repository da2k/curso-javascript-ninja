...
var brasil = sul.concat(sudeste.concat());
...
*/
var nordeste = ['Maranhão', 'Piauí', 'Bahia', 'Alagoas', 'Ceará', 'Sergipe', 'Pernambuco', 'Paraíba', 'Rio Grande do Norte'];
