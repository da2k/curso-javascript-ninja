(function () {
    ...
    */
    var nordeste = ['Bahia', 'Pernambuco', 'Ceará'];
    ...
    */
    var newBrasil = [];
    brasil.forEach(function(obj, index) {
        newBrasil.push({id: index, estado: obj});
    });
    ...
    */
    ...
    var isCearaExists = brasil.some(function(item) {
        return item === 'Ceará';
    });

    console.log(isCearaExists ? 'Ceará está incluído!' : "Ceará não foi incluído :(");
    ...
    */
    var map = newBrasil.map(function (obj, index) {
        return {
            id: obj.id + 1,
    ...
    */
    var filter = map.filter(function (obj) {
        return obj.id % 2 === 0;
    });
