(function(){
    ...
    */
    var nordeste = ['Alagoas', 'Bahia', 'Ceara', 'Maranhao', 'Paraiba', 'Pernanbuco', 'Piaui', 'Rio Grande do Norde', 'Sergipe'];
    ...
    */
    ...
    temMaisSeteLetras ? console.log('Sim, todos os estados tem mais de 7 letras!') : console.log('Nem todos os estados tem mais de 7 letras!');
