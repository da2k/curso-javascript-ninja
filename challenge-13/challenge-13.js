...
(function() {
    ...
    */
    ...
    var moreThanSevenLetters = brasil.every(function(item) {
        return item.length >= 7;
    });
    moreThanSevenLetters === true ? console.log('Sim, todos os estados tem mais de 7 letras!') : console.log('Nem todos os estados tem mais de 7 letras!');
    ...
    */
    var isCearaIn = brasil.some(function(item) {
        return item === 'Ceará';
    })
    console.log('\nCeará está incluído em `brasil`?');
    console.log(isCearaIn ? 'Ceará está incluído!' : 'Ceará não foi incluído :(');
