(function(){
    ...
    */
    var arrSul = ['Rio Grande do Sul', 'Santa Catarina', 'Paraná']
    var arrSudeste = ['Minas Gerais', 'Espirito Santo', 'São Paulo', 'Rio de Janeiro']
    ...
    */
    var arrNordeste = ['Maranhão', 'Piaui', 'Ceará', 'Rio Grande do Norte', 'Paraíba', 'Pernambuco', 'Alagoas', 'Sergipe', 'Bahia']
    ...
    */
    ...
    sevenLetters ? 'Sim, todos os estados tem mais de 7 letras' : 'Nem todos os estados tem mais de 7 letras' );
    ...
    */
    var hasCeara = brasil.filter(function(item) {
        return item ==='Ceará'
    })
