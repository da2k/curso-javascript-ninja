(function(){
    ...
    */
    var nordeste = ['Maranhão', 'Piauí', 'Ceará', 'Rio Grande do Norte', 'Paraíba', 'Alagoas', 'Pernambuco', 'Sergipe', 'Bahia'];
  ...
  //   var filter;
  //   function estadoExiste ( arr, estado ){
  //       filter = arr.filter(function(item){
  //           return item === estado;
  //       });
  //       if (filter[0] === 'Ceará') {
  //           return estado + ' está incluído!';
  //       }
  //       return estado + ' não está incluído!';
  //   }
  //   console.log(estadoExiste( brasil, 'Ceará'));
