(function() {
  ...
  */
  ...
  var estadoSul = ['Paraná', 'Santa Catarina', 'Rio Grande Do Sul'];
  var estadoSudeste = ['Minas Gerais', 'São Paulo', 'Rio De Janeiro', 'Espírito Santo'];
  ...
  */
  ...
  var brasil = estadoSul.concat(estadoSudeste);
  console.log( '\nAlguns Estados do Brasil:' ,brasil);
  
  /*
  Adicione 3 novos estados da região Norte no início do array e mostre no console.
  */
  brasil.unshift('Bahia', 'amapa', 'maranhao');
