(function(){
    ...
    */
    ...
    var arr = ['Bruno', 'Yuri', 'JS', 'Ninja', {developer : 'Ninja'}];
    ...
    */
    ...
    brasil.unshift('Pará', 'Amazonas', 'Rondônia');
    console.log(brasil);
    ...
    */
    var nordeste = ['Maranhão', 'Paraíba', 'Pernambuco', 'Piaui'];
    ...
    */
    ...
    var temMaisSeteLetras = brasil.every(function (item) {
      return item.length > 7;
    });

    if (temMaisSeteLetras){
    ...
    */
    ...
    var isCearaIncluido = brasil.some(function (item){
        return item === 'Ceará';
    });
    ...
    */
    var brasilOther = newBrasil.map(function (item, index, array){
    ...
    */
    ...
    console.log(brasilOther);

    /*
    Filtre o array criado acima, retornando somente os estados que tiverem
    ID par. Atribua o valor à uma variável chamada `filter`.
    */
    var filter = brasilOther.filter(function (item){
      return item.id % 2 === 0;
    });
