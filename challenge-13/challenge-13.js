(function () {/*
    ...
    */
    var nordeste = ['Alagoas','Bahia','Ceará','Maranhão','Paraíba','Pernambuco',
    ...
    */
    var map = [];
    newBrasil.map(function (estado, index) {
        map.push({
            [Number(index) + 1]: Object.values(estado) + ' pertence ao Brasil.'
        })
    });
