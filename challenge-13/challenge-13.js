(function(){
    ...
    */
    ...
    //brasil.splice(0, 0, 'Amazonas', 'Amapá', 'Acre');
    ...
    */
    console.log( '\nEstado removido:' );
    console.log(brasil.shift()/*brasil.splice(0, 1)*/);
    ...
    */
    var nordeste = ['Bahia', 'Sergipe', 'Alagoas', 'Pernambuco', 'Paraíba', 'Rio Grande do Norte', 'Ceará', 'Piauí', 'Maranhão'];
    ...
    */
    ...
    console.log(verifica ? 'Sim, todos os estados tem mais de 7 letras!' : 'Nem todos os estados tem mais de 7 letras!');
