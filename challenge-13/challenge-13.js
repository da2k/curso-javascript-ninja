...
*/
var nordeste = ['CE', 'MA', 'PI', 'AL', 'SE', 'PB', 'RN', 'BA', 'PE'];
...
var hasSevenLetters = newBrasil.every(function(item) {
	return item.estado.lengh > 7;
});
...
var hasCeara = newBrasil.some(function(item) {
	return item.estado === 'CE';
});
