(function () {
    ...
    */
    ...
    var sudeste = [ 'São Paulo', 'Espírito Santo', 'Minas Gerais', 'Rio de Janeiro' ]; 
    ...
    */
    ...
    brasil = brasil.concat(nordeste); //Atribui a concatenação ao array brasil, para que modifique o array original
