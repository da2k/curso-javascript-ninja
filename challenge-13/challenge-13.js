...
*/
var nordeste = ['Alagoas', 'Bahia', 'Ceará', 'Maranhão', 'Paraíba', 'Pernambuco', 'Piaué', 'Rio Grande do Norte', 'Sergipe'];
...
console.log('NewSudoeste: ', newSudeste.toString());
...
brasil.map(function(item, index){
...
const ceara = brasil.some(function(item){
    return item === 'Ceará';
})
...
Atribua o no
vo array a uma variável chamada `map`.
*/
