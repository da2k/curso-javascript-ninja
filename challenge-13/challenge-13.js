(function(){
	...
	*/
	...
	var addEstado = brasil.unshift('Ceará', 'Bahia', 'Pernambuco');
	...
	*/
	...
	chamada `newSudeste`.
	*/
	var newSudeste = console.log(brasil.pop( sudeste ));

	/*
	Adicione os estados do `nordeste` ao array `brasil`. Esses estados devem
	ficar no mesmo nível que os estados já existentes, não em um array separado.
	*/
	var addNordeste = brasil.concat( nordeste );
