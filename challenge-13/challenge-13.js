(function() {
    ...
    */
    ...
    brasil.unshift('Amazonas');  //brasil.unshift('Acre', 'Amapá', 'Amazonas');
    console.log(brasil);
    ...
    */
    ...
    chamada `newSudeste`.
    */
    var newSudeste = brasil.slice(2, 6);
    ...
    */
    ...
    var stateLength = brasil.every(function (item) {
        return item.length > 7;
    });
    console.log(stateLength === true ? 'Sim, todos os estados tem mais de 7 letras!' : 'Nem todos os estados tem mais de 7 letras!');
