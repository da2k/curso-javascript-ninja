(function() {
  ...
  */
  ...
  chamada `newSudeste`.
  */
  //var newSudeste = brasil.splice(-4); ou
  ...
  */
  ...
  var estadoMaior7 = brasil.every(function(item) {
    return item.length > 7;
  });
  console.log(estadoMaior7 ? 'Sim, todos os estados tem mais de 7 letras' : 'Nem todos os estados tem mais de 7 letras');
