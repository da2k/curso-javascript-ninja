...
*/
  ...
  var myArray = [1, "a", [1, 2, 3], { name: "Rodrigo" }, 5];
...
*/
  nordeste.reverse().forEach(function(estado) {
...
*/
  ...
  var temMaisDe7 = brasil.every(function(item) {
...
*/
  var myNewArray = newBrasil.map(function(item) {
    return {
      id: item.id + 1,
...
*/
  var filter = myNewArray.filter(function(item) {
    return item.id % 2 === 0;
  });
