(function () {
    ...
    */
    ...
    var myArray = [1, 3, 4, true, false, null];
    ...
    */
    ...
    var show = brasil.every( function ( item ) {
        return item.length > 7;
    });

    console.log( show ? 'Sim, todos os estados tem mais de 7 letras!' : 'Nem todos os estados tem mais de 7 letras!' );
    ...
    */
    ...
    var included = brasil.some( function ( item ) {
        return item === 'Ceará';
    });
    console.log( included ? 'Ceará está incluído!' : 'Ceará não foi incluído :(');
    /*
