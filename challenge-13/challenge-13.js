(function (){
  ...
  */
  ...
  brasil.unshift('Acre', 'Amazonas', 'Pará', 'Rondônia', 'Roraima', 'Tocantins');
  console.log(brasil);
  ...
  */
  ...
  var moreThanSevenLetters = true;
  for ( var i=0; i < brasil.length; i++ ){
    if( brasil[i].length < 7 ){
      moreThanSevenLetters = false;
      break;
    }
  }
  ...
  */
  ...
  var cearaIndex = brasil.indexOf('Ceará');
  if ( cearaIndex > 0 ) {
  ...
  */
  var filtred = map.filter( function (item) {
    return item.id % 2 === 0;
  });
