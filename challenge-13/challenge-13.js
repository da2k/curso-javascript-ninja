(function() {
    ...
    */
    ...
    brasil.unshift('Acre', 'Amapá', 'Amazonas', 'Pará', 'Rondônia', 'Roraima', 'Tocatins' );
    ...
    */
    ...
    var sevenStr = brasil.every(function(estado) {
        return estado.length > 7;
    });

    if (sevenStr) console.log('Sim, todos os estados tem mais de 7 letras');
    ...
    */
    ...
    var existCeara = brasil.some(function(estado) {
        return estado === 'Ceará';
    });

    if (existCeara) console.log("Ceará está incluído!");
