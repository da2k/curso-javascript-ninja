(function(){
	...
	*/
	...
	var series = [ 'How I Met Your Mother', 'Suits', 'The Big Bang Theory', 'Chuck' ];
	...
	*/
	var nordeste = [ 'Bahia', 'Piauí', 'Ceará', 'Pernambuco', 'Paraíba', 'Rio Grande do Norte', 'Alagoas', 'Maranhão', 'Sergipe' ];
