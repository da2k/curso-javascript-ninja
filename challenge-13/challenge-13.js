(function(){
    ...
    */
    ...
    var sudeste = ["Minas", "Sao paulo", "Rio de janeiro"];
    ...
    */
    ...
    brasil.unshift("Pará", "Ácre", "Amazônia");
    console.log(brasil);
    ...
    */
    var nordeste = ["Maranhão","Ceará","Piauí"];
    ...
    */
    ...
    brasil.every(function(item){
        return item.length > 7 ? consol.log("Sim, todos os estados tem mais de 7 letras!") : console.log("Nem todos os estados tem mais de 7 letras!");
    });
