...
// OU == var newSudeste = brasil.splice( 5 ); // remove o restante dos itens do array a partir do indice
...
// var estadosMaiorQueSeteLetras = 0;
// brasil.every( function( item ) {
//     if ( item.length > 7) {
//         estadosMaiorQueSeteLetras += 1;
//     }
// });

// if (brasil.length === estadosMaiorQueSeteLetras) {
...
// var existe = false;
// var existeEstado = brasil.some( function( item )  {
//     if (item === 'Ceará') {
//         existe = true;
//     }
// });
...
// */
var map = newBrasil.map( somarUmId );

function somarUmId( item, index ) {
