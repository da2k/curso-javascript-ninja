(function() {
  ...
  */
  ...
  var nomeEstadoLength = brasil.every(function(item) {
    return item.length > 7;
  });
  
  console.log(nomeEstadoLength ? 'Sim, todos os estados tem mais de 7 letras!' : 'Nem todos os estados tem mais de 7 letras!');
  ...
  */
  ...
  var cearaEstaIncluso = brasil.some(function(item) {
    return item === 'Ceará';
  });
  
  console.log(cearaEstaIncluso ? 'Ceará está incluído!' : 'Ceará não foi incluído :(');
