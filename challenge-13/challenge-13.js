(function () {
    ...
    */
    ...
    var sudeste = ['São Paulo', 'Espírito Santo', 'Rio de Janeiro', 'Minas Gerais'];
    ...
    */
    ...
    brasil.unshift('Amazonas', 'Rondônia', 'Amapá');
    console.log(brasil);
    ...
    */
    var nordeste = ['Bahia', 'Paraíba', 'Piauí', 'Sergipe', 'Maranhão', 'Ceará', 'Alagoas'];
    ...
    */
    ...
    var maisDeSeteLetras = brasil.every(function(item) {
        return item.length > 7
    });

    console.log(maisDeSeteLetras ? 'Sim, todos os estados tem mais de 7 letras!' : 'Nem todos os estados tem mais de 7 letras!');
