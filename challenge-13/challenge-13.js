...
*/
var arr = [1, 2, 3, 4];
console.log( 'O array em formato de string é:', arr.toString(arr));
// ?
...
// Alguns Estados do Brasil: Rio Grande do Sul, Santa Catarina, Paraná, Espírito Santo, Minas Gerais, Rio de Janeiro, São Paulo
...
// Mais estados adicionados: ["Acre", "Amapá", "Amazonas", "Rio Grande do Sul", " Santa Catarina", " Paraná", "Espírito Santo", " Minas Gerais", " Rio de Janeiro", " São Paulo"]

/*
Remova o primeiro estado do array `brasil` e mostre-o no console.
*/
var removeEstado = brasil.shift()
console.log( '\nEstado removido:', removeEstado );
// Estado removido: Acre
...
*/
var tamEstado = brasil.every(function(item){
...
console.log( '\nTodos os estados de `brasil` tem mais de 7 letras?', tamEstado);
// Nem todos os estados tem mais de 7 letras!
...
*/
var cearaIn = brasil.some(function(item){
    return item === 'Ceará';
});
    if(cearaIn){
...
console.log( '\nCeará está incluído em `brasil`?', cearaIn);
// 'Ceará está incluído em `brasil`? false'
