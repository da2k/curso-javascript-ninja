...
*/
  ...
  */
  ...
  var teams = ['Palmeiras', 'Corinthians', 'Santos', 'São Paulo'];
  ...
  */
  var nordeste = ['BA', 'PE', 'AL', 'PI', 'SE', 'PA', 'MA', 'CE', 'RN'];
  ...
  */
  ...
  var test = brasil.every(function (item) {
  ...
  */
  ...
  test = brasil.some(function (item) {
    return item == 'CE';
  });
  console.log(test);
  /*
  ...
  */
  var map = newBrasil.map(function (item) {
    return { id: item.id + 1, estado: item.estado };
  });
