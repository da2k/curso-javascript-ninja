(function(){
    ...
    */
    ...
    var letras = brasil.every(function(value){
        return value.length > 7;
    });
    letras ? console.log('Sim, todos os estados tem mais de 7 letras!') : console.log('Nem todos os estados tem mais de 7 letras!');
    ...
    */
    ...
    var busca = brasil.some(function(value){
        return value === 'Ceará';
    });
    busca ? console.log('Ceará está incluído!') : console.log('Ceará não foi incluído :(');
