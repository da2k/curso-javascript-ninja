(function(){
	...
	*/
	...
	var hasBrasil7Letters = brasil.every(function(item){
		return item.length > 7;
	});

	console.log(hasBrasil7Letters ? 'Sim, todos os estados tem mais de 7 letras!': 'Nem todos os estados tem mais de 7 letras');
	/*
