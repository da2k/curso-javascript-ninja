...
(function(){
	...
	*/
	...
	var hasMaisDeSeteLetras = brasil.every(function(item){
		return item.length > 7;
	});
	console.log(hasMaisDeSeteLetras ? 'Sim, todos os estados tem mais de sete letras!' : "Nem todos os estados tem mais de 7 letras!");
	...
	*/
	var map = newBrasil.map(function(item, i){
	...
	*/
	var filter = map.filter(function(item, i){
		return item.id % 2 === 0;
	});
