(function() {
    ...
    */
    ...
    var hasSevenLetters = brasil.every( function( item ) {
        return item.length > 7;
    } );
    console.log( hasSevenLetters ? 'Sim, todos os estados tem mais de 7 letras!' : 'Nem todos os estados tem mais de 7 letras!');
