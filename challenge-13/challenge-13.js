(function () {
  ...
  */
  ...
  var isSeven = newBrasil.every(function (item, index, array) {
                  return item.estado > 7 
                })
  isSeven ? console.log('Sim, todos os estados tem mais de 7 letras!') : console.log('Nem todos os estados tem mais de 7 letras!');
  ...
  */
  ...
  var isCeara = newBrasil.some(function (item, index, array) {
    return item.estado === 'Ceará';
  })
