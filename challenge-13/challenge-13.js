...
var sudeste = ['Espirito santo', 'Rio de janeira', 'Sao paulo', 'Minas gerais'];
...
*/
var nordeste = ['Paraiba', 'Maranhao', 'Pernambuco', 'Ceara', 'Rio grande do norte', 'Sergipe', 'Piaui', 'Bahia', 'Alagoas'];
