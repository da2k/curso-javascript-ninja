(function () {
   ...
   */
  /*
   TODO  minas gerais e são paulo não entram na condição...
   TODO esta implementação deve estar errada...
   */
  var newSudeste = brasil.filter(function (item, index, array) {
  ...
  result ? console.log('Sim, todos os estados tem mais de 7 letras!')
  ...
  result = brasil.some(function (item) {
    return item === 'Ceará';
  });

  result ? console.log('Ceará está incluído!')
