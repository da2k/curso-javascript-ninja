(function() {
  ...
  */
  var nordeste = ['Maranhão', 'Ceará', 'Rio Grande do Norte', 'Pernambuco', 'Alagoas', 'Sergipe', 'Bahia', 'Piauí', 'Alagoas']
  ...
  */
  var map = newBrasil.map(function(index){
    index.id++
    index.estado = index.estado + ' pertence ao Brasil.'
    return index
  })
  ...
  */
  var filter = map.filter(function(index){
    return index.id % 2 === 0
  })
