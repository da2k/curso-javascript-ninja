(function(){
	...
	*/
	var lengthWords = brasil.every(function( letras ){
	...
	*/
	var includeState = brasil.some(function( estado ){
		return 'Ceará' === estado;
	});
	...
	*/
	var map = newBrasil.map(function(soma){
		return { id: soma.id + 1, estado: soma.estado + ' pertence ao Brasil.' }; 
	});
	...
	*/
	var filter = map.filter(function(soma){
		return soma.id % 2 === 0;
	});
