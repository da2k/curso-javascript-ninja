(function () {
    ...
    */
    ...
    var arrayString = [1, 3, 4, 56, 'array', 'string'];
    ...
    */
    ...
    var sudeste = ['São Paulo', 'Rio de Janeiro', 'Espiríto Santo', 'Minas Gerais'];
    ...
    */
    var nordeste = ['Bahia', 'Alagoas', 'Ceará', 'Maranhão', 'Paraíba', 'Pernanbuco', 'Piauí', 'Rio Grande do Norte', 'Sergipe'];
    ...
    */
    ...
    /*
        ** SOLUÇAO QUE HAVIA ENCONTRADO 
        nordeste.forEach(function (item) {
            brasil.splice(brasil.length, 1, item);
        });
    */
    ...
    */
    ...
    console.log(
        every ? "Sim, todos os estados tem mais de 7 letras!" : "Nem todos os estados tem mais de 7 letras!"
    );
