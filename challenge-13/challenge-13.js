(function() {
  ...
  */
  ...
  console.log([ 't', 'o', 's', 't', 'r', 'i', 'n', 'g' ].toString());
  ...
  */
  ...
  console.log(brasil = brasil.concat(sudeste, sul));
  ...
  */
  ...
  console.log(
    brasil.every(function(item) { return item.length > 7; }) ?
      'Sim, todos os estados tem mais de 7 letras!' :
      'Nem todos os estados tem mais de 7 letras!'
  );
  ...
  */
  ...
  console.log(
    brasil.some(function(item) { return item === 'Ceará'; }) ?
      'Ceará está incluído!' :
      'Ceará não foi incluído :('
  );
