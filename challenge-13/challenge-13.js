(function () {
	...
	*/
	...
	var hasMoreSevenLetters = brasil.every(function (estado) {
	...
	*/
	var map = newBrasil.map(function (objEstado) {
		return {
			'id': objEstado.id + 1,
			'estado': objEstado.estado + ' pertence ao Brasil.'
		}
	});
	...
	*/
	var filter = map.filter(function (objEstado) {
		return objEstado.id % 2 === 0;
	});
