(function() {
	...
	*/
	...
	var sudeste = ['Minas Gerais', 'São Paulo', 'Espírito Santo', 'Rio de Janeiro'];
	...
	*/
	...
	brasil.unshift('Pará', 'Tocantins', 'Roraima');
	console.log(brasil);
	...
	*/
	var nordeste = [ 'Piauí', 'Maranhão', 'Ceará', 'Bahia', 'Paraíba', 'Pernambuco', 'Sergipe' ];
	...
	*/
	...
	var test = brasil.every(function(item) { return item.length > 7 });
	if(test)
	...
	*/
	...
	var test = brasil.some(function(item) { return item === 'Ceará' });
	if(test)
	...
	*/
	...
	var map = [];
	newBrasil.map(function(item) {
		map.push( { id: ++item.id, estado: item.estado + ' pertence ao Brasil.' })
	});
