(function(){
    ...
    */
    ...
    brasil.unshift('Para','Amazonas','Roraima');
    console.log(brasil);
    ...
    */
    var nordeste = ['Bahia','Maranhão','Piauí','Ceará','Pernambuco','Rio Grande do Norte','Paraíba','Sergipe','Alagoas'];
...
;
    ...
    */
    ...
    var result;
    result = brasil.every(function(item){
    ...
    */
    ...
    result = brasil.some(function(item,index,brasil){
        return item === 'Ceará';
    }); 
    console.log(result ? 'Ceará está incluido' : 'Ceara não foi incluido');
    /*
    ...
    */
    var map = newBrasil.map(function(item,index,newBrasil){
