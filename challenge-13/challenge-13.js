...
*/
console.log( '\nEstado removido:' );
console.log(brasil.reverse().pop());
...
*/
/*
Estado do AL	AL  Alagoas	Maceió
Estado do BA	BA	Bahia	Salvador
Estado do CE	CE	Ceará	Fortaleza
Estado do MA	MA	Maranhão	São Luís
Estado do PB	PB	Paraíba	João Pessoa
Estado do PE	PE	Pernambuco	Recife
Estado do PI	PI	Piauí	Teresina
Estado do RN	RN	Rio Grande do Norte	Natal
Estado do SE	SE	Sergipe
*/
...
var verifica = brasil.every(function (item) {
