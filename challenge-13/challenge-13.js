(function() {
    ...
    */
    ...
    var arr = ['Jesus', 'Família', 'Fé', 'Salvação'];
    ...
    */
    ...
    brasil.unshift('Amazonas', 'Acre', 'Amapá', 'Rondônia');
    console.log(brasil);
    ...
    */
    ...
    var letras = brasil.every(function(item) {
        return item > 7;
    });

    console.log(letras ? 'Sim, todos os estados tem mais de 7 letras!' :
            'Nem todos os estados tem mais de 7 letras!');
    ...
    */
    ...
    var cearaVerify = brasil.some(function(item) {
        return item === 'Ceará'
    });

    console.log(cearaVerify ? 'Ceará está incluído!' : 'Ceará não foi incluído :(');
