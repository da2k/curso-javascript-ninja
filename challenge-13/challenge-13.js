...
*/
var nordeste = ['alagoas','pernambuco','rio grande do norte'];
...
var every = brasil.every(function(){
...
var some = brasil.some(function(){
    return item === 'ceará';
});
  console.log(filter ? 'Ceará está incluído!' : 'Ceará, não foi incluído!');
