(function () {
  ...
  */
  ...
  var southEast = ['São Paulo', 'Rio de Janeiro', 'Espírito Santo', 'Minas Gerais'];
  ...
  */
  var northEast = ['Alagoas', 'Bahia', 'Ceará', 'Maranhão', 'Paraíba', 'Pernambuco', 'Piauí', 'Rio Grande do Norte', 'Sergipe'];
  ...
  */
  ...
  chamada `newSudeste`.
  */
  var newSudeste = brazil.splice(5, 4);
