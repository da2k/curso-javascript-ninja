(function() {
  ...
  */
  ...
  chamada `newSudeste`.
  */
  var newSudeste = brasil.slice(brasil.length - 4);
  ...
  */
  ...
  var soMaiorQSete = brasil.every(function(item) {
    return item.length > 7;
  });
  var message = soMaiorQSete ? "Sim, todos os estados tem mais de 7 letras!" : "Nem todos os estados tem mais de 7 letras";
  console.log(message);
  ...
  */
  ...
  var cearaNoBrasil = brasil.some(function(item) {
    return item === "Ceará";
  });
  var msg = cearaNoBrasil ? "Ceará está incluído!" : "Ceará não foi incluído :(";
  console.log(msg);
