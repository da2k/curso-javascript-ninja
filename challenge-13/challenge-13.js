(function () {
    ...
    */
    ...
    var hasSeteLetras = brasil.every(function (item) { return item.length > 7; });
    ...
    */
    ...
    var hasCeara = brasil.some(function (item) { return item === 'Ceará'; });
    ...
    */
    var mapBrasil = newBrasil.map(function (item) {
    ...
    */
    var filterBrasil = mapBrasil.filter( (item) => item.id % 2 === 0 );
