(function(){
    ...
    */
    var nordeste = ['Bahia', 'Maranhão', 'Piauí', 'Ceará', 'Rio Grande do Norte', 'Pernambuco', 'Paraíba', 'Alagoas', 'Sergipe'];
    ...
    */
    ...
    var tem = brasil.every(function(value){
        value.length > 7
    });
    ...
    */
    ...
    var hasCeara = brasil.some(function(value){
        return value === 'Ceará';
    });
    ...
    */
    var map = newBrasil.map(function(value, index){
        return {id: index+1, estado: value.estado + ' pertence ao Brasil'};
    })
