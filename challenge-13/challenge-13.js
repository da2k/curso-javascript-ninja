...
*/
  ...
  const numbers = [2, 3, 90, 45, 70, 34];

  console.log(`O array em formato de string é: ${numbers.toString()}`);
...
*/
  ...
  let moreThanSeven = brasil.every(function (item) {
...
*/
  ...
  let cearaIncludes = brasil.some(function (item) {
    return item === "Ceará";
  });
  console.log("\nCeará está incluído em `brasil`?");
  console.log(cearaIncludes ? "Ceará está incluso" : "Ceará nãi inclído");
...
*/
  let createNewArray = newBrasil.map(function (item) {
    item.id++;
...
*/
  ...
  let filter = createNewArray.filter(function (item) {
    return item.id % 2 === 0;
  });
