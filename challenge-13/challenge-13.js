(function () {
    ...
    */
     const regiaoSul = [ 'Paraná', 'Santa Catarina', 'Rio Grande do Sul' ];
     const regiaoSudeste = [ 'São Paulo', 'Rio de Janeiro', 'Espírito Santo', 'Minas Gerais'];

    /*
    Crie uma variável chamada `brasil`, que irá receber as duas regiões
    concatenadas. Mostre o `brasil` no console.
    */
    const brasil = regiaoSul.concat(regiaoSudeste);
    ...
    */
    const regiaoNordeste = [ 'Alagoas', 'Bahia', 'Ceará', 'Maranhão', 'Paraíba', 'Pernambuco', 'Piauí', 'Rio Grande do Norte', 'Sergipe']
   ...
   const brasil = brasil.concat(regiaoNordeste);
