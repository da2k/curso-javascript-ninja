...
var suldeste = ['Minas Gerais', 'São Paulo', 'Rio de Janeiro', 'Espirito Santo'];
...
console.log(brasil.unshift("Amazonas", 'Roraima', 'Pará'));
console.log(brasil);
/*
...
*/
var nordeste =['Alagoas',"Bhaia",'Ceará',"Maranhão",'Paraiba','Pernanbuco',"Piaui","Riogrande Grande do Norte","Sergipe"];
