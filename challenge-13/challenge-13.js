(function() {
	...
	*/
	var nordeste = [ 'Alagoas', 'Bahia', 'Ceará', 'Maranhão', 'Paraíba', 'Pernambuco', 'Rio Grande do Norte', 'Piauí', 'Sergipe' ];
	...
	*/
	...
	brasil.forEach(function( item, index ) {
		newBrasil.push( { estado: item, id: index } );
	});
	...
	*/
	...
	var map = brasil.every(function( item, index ) {

		return item.lenght > 7
	});

	console.log( ( map ) ? "Sim, todos os estados tem mais de 7 letras!" : "Nem todos os estados tem mais de 7 letras!" );
