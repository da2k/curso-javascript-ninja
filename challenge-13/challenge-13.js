(function() {
  ...
  */
  var nordeste = [ 'Bahia', 'Paraíba', 'Ceará', 'Pernambuco', 'Alagoas', 'Maranhão' ];
  ...
  */
  function addNordesteToBrazil(item, index, array) {
    brasil.push(item);  
  }  
  nordeste.forEach(addNordesteToBrazil);
  ...
  */
  var newBrasil = [];
  function addToNewBrasil(item, index, array) {
    newBrasil.push( { id: index, estado: item } );
  }
  brasil.forEach(addToNewBrasil);
