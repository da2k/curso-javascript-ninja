...
brasil.unshift('Acre','Amapá','Amazonia');
console.log(brasil);
...
*/
var nordeste = ['Pernambuco','Paraiba', 'Natal', 'Salvador', 'Alagoas'];

/*
Mostre no console os estados do nordeste.
*/
console.log( '\nEstados do Nordeste:' );
console.log(nordeste.sort());
...
*/
var map = newBrasil.forEach(function(item,index){
    return{
      id: item.id + 1,
