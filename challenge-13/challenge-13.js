(function() {
    ...
    */
    ...
    var isOverSeven = brasil.every(function(item) {
        return item.length > 7;
    });
    console.log(isOverSeven ? 'Sim, todos os estados tem mais de 7 letras!' : 'Nem todos os estados tem mais de 7 letras!');
    ...
    */
    ...
    var isCearaIncluded = brasil.some(function(item) {
        return item === 'Ceará';
    }); 
