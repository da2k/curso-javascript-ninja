(function(){
    ...
    */
    var nordeste = ['Maranhão', 'Piauí', 'Ceará', 'Bahia', 'Rio Grande do Norte', 'Paraiba', 'Pernambuco', 'Alagoas', 'Sergipe'];
    ...
    */
    var map = newBrasil.map(function(item, index) {
      return { 'id': index + 1, 'estado': ' - ' + item.estado + ' percente ao Brasil.' };
    });
