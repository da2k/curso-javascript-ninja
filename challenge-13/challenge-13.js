...
(function (){
	...
	*/
	// ?
	var nordeste = ['Recife','Sergipe','Alagoas', 'Pernambuco', 'Paraíba', 'Rio Grande do Norte', 'Bahia', 'Piauí'];
	...
	*/
	...
	var letrasdosestados = brasil.every(function(item){
	...
	*/
	var percorrendoBrasil = newBrasil.map(function(item){
		item.id += 1;
	...
	*/
	console.log( '\nnewBrasil agora com mais informações:' +  percorrendoBrasil');
	// ?
	...
	*/
	...
	var filtre = map.filter(function(item){
		return item.id % 2 === 0;
	});
