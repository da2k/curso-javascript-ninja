(function() {
	...
	*/
	var ufRemovido = brasil.shift();
	console.log( '\nEstado removido:', ufRemovido );
	...
	*/
	...
	var allGtSeven = brasil.every(function(item) {
		return item.length > 7;
	});

	allGtSeven ? console.log( '\nSim, todos os estados tem mais de 7 letras!')
			   : console.log( '\nNem todos os estados tem mais de 7 letras!');
	/*
