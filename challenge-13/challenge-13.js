(function() {
  ...
  */
  ...
  brasil.unshift('Amazonas', 'Amapá', 'Roraima');
  console.log(brasil);
  ...
  */
  var nordeste = ['Bahia', 'Pernambuco', 'Ceará', 'Paraíba', 'Alagoas', 'Maranhão', 'Rio Grande do Norte', 'Sergipe'];
  ...
  */
  ...
  var cearaFound = brasil.some(function(item) {
    return item === 'Ceará';
  });
  console.log(cearaFound ? 'Ceará está incluído!' : 'Ceará não foi incluído :(');
