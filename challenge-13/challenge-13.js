(function(){
	...
	*/
	...
	var norte = ['Acre', 'Pará', 'Tocantins'];
	nbrasil = brasil.unshift(norte);
	console.log( nbrasil );
	...
	*/
	var nordeste = ['Alagoas', 'Bahia', 'Ceará', 'Piauí'];
	...
	*/
	...
	var words = brasil.every(function(item){
		return item.length > 7;
	});
	words ? console.log( 'Sim, todos os estados tem mais de 7 letras!' ) : console.log( 'Nem todos os estados tem mais de 7 letras!' );
	...
	*/
	...
	ceara ? console.log( 'Ceará está incluído!' ) : console.log( 'Ceará não foi incluído :(' );
