(function () {
  ...
  */
  ...
  brasil.unshift('Amapa', 'Acre', 'Amazonas');
  console.log(brasil);
  ...
  */
  var nordeste = ['Alagoas', 'Bahia', 'Ceara', 'Maranhao', 'Paraiba', 'Piaui', 'Pernambuco', 'Rio Grande do Norte', 'Sergipe'];
  ...
  */
  ...
  var estadoComMaisde7Letras = brasil.every(function (item) {
    return item.length > 7;
  });

  console.log(
    estadoComMaisde7Letras
      ? 'Sim, todos os estados tem mais de 7 letras!'
      : 'Nem todos os estados tem mais de 7 letras!'
  );
