(function() {
    ...
    */
    ...
    var hasMoreThan7Chars = brasil.every(function(item) {
        return item.length > 7;
    });
    console.log(hasMoreThan7Chars ? 'Sim, todos os estados tem mais de 7 letras!' : 'Nem todos os estados tem mais de 7 letras!');
