...
console.log( 'O array em formato de string é: ' + array );
...
var arraySul = ['Paraná','Santa Catarina','Rio Grande do Sul'];
var arraySudeste = ['Espírito Santo','Minas Gerais','Rio de Janeiro','São Paulo'];
...
*/
brasil.unshift('Acre','Amapá' ,'Pará');
...
var nordeste = ['Alagoas','Bahia' ,'Ceará', 'Maranhão', 'Paraíba', 'Pernanbuco','Piaui', 'Rio Grande do Norte', 'Sergipe'];
...
console.log(verificar ? 'Ceará está incluído!' : 'Ceará não foi incluído :(');
