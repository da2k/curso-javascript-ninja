(function(){
	...
	*/
	...
	var filterSevenLetters = brasil.every( function ( item ) {
		return item.length > 7
	});
	console.log( filterSevenLetters ? 'Sim, todos os estados tem mais de 7 letras!' : 'Nem todos os estados tem mais de 7 letras!' );
	...
	*/
	var addingToNewBrasil = newBrasil.map( function ( item, index ) {
		return {
			id: item.id + 1,
	...
	*/
	...
	console.log( addingToNewBrasil );

	/*
	Filtre o array criado acima, retornando somente os estados que tiverem
	ID par. Atribua o valor à uma variável chamada `filter`.
	*/
	var filter = addingToNewBrasil.filter( function ( item ){
		return item.id % 2 === 0;
	});
