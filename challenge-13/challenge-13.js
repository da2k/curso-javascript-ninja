...
var maisde7 = true;
maisde7 = brasil.every(function (item,index){
   return item.length > 7;
});
  
maisde7 == true ? console.log('Sim, todos os estados tem mais de 7 letras!') : console.log('Nem todos os estados tem mais de 7 letras!')   
...
ceara = brasil.some(function (item){
  return item === 'Ceará';
});

ceara == true ? console.log('Ceará está incluído!') : console.log('Ceará não foi incluído :(')
/*
...
*/
var filter = map.map(function(item,index,array) {
  if (index % 2==0){
  return index;
  }
});
