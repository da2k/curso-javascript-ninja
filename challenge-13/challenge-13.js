(function () {
  ...
  */
  var sul = ['Santa Cararina', 'Paraná', 'Rio Grande do Sul'];
  ...
  */
  var estadoRemovido = brasil.shift(0);
  console.log('\nEstado removido:');
  ...
  */
  var nordeste = ['Maranhão', 'Sergipe', 'Pernambuco', 'Ceará', 'Paraíba',
    'Alagoas', 'Rio Grande do Norte', 'Piauí', 'Bahia'
  ];
