(function(win,doc){
    ...
    */
    $button.addEventListener('click', function(evt){
        ...
        var isEmailEmpty = $inputEmail.value === '' ;
        var isMessageEmpty = $message.value === '';
        var isEmailnotValid = !isValidEmail($inputEmail.value);
        if (isNameEmpty || isEmailEmpty || isMessageEmpty || isEmailnotValid){
            if (isNameEmpty) {
    ...
    */
    function isValidEmail(email) {
        var regex = /^[\w.+]+@\w+\.[A-Za-z]{2,}(?:\.[A-Za-z]{2})?$/;
