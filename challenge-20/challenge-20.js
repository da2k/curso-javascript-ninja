(function(window, document){
    ...
    */
    var $email = prompt('Qual o seu e-mail?(campo obrigatório)');

    //validando um e-mail usando regex
    // while($email == null){
    //     alert('valor digitado incorreto!');
    //     var $email = prompt('Qual o seu e-mail?(campo obrigatório)');
    // }
    // var $regex = $email.match(^(([a-z0-9_+.]){1,})@([a-z0-9_]){1,}\.(\w{2,})((\.(\w){2,2})?)$/g);
    // while($regex == undefined || $regex == null){
    ...
    */
    ...
    var $inputUsername = $inputs[0]; // $inputUsername = document.querySelector('input[type="text"]')
    ...
    */
    ...
    $button.addEventListener('click', function(event){
        ...
        while(val === false){// loop para verificacao dos campos
