(function (win, doc) {
    ...
    Anotações -- 
    ações do window.
    alert() - caixa de diálogo na tela
    prompt() - faz uma pergunta e pode-se salvar em uma viável (var name = prompt('qual seu nome'))
    confirm() - faz uma pergunta na tela com ok e cancela, se der ok, retorna true, se der calncel, retorna false
    Document() - é o html (documento em formato de objeto javaScript é o 'DOM')
    formas de pegar elementos:
    Sào todos mutaveis...
    document.getElementById() - pega pelo id
    document.getElementsByClassName() - pega pelo nome da classe
    document.getElementsByName() - pega pelo Nome (name)
    document.getElementsByTagName() - pega pela tag <a> <div>
    
    com estes não existe a chance de acontecer efeito colateral: 
    São estáticos - 
    document.querySelector() - Seleciona o primeiro
    document.querySelectorAll() - Seleciona todos - parâmetro deve ser passado como CSS
    
    document.addEventListener('click', function (event){
    event.precentDefault(); --  nao envia mais o formulario
    console.log('clicando no botao....')
    }, false) - 
    pode-se adcionar evento em qualquer lugar do documento até nos imputs
