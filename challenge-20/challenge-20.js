...
(function(){
    ...
    if(username)
    console.log(alert('Bem vindo '+ username));
    else
    console.log(username = 'Desconhecido');
...
`$inputUsername`.
*/
 var $inputUsername = doc.querySelectorAll('input[type=text]');
...
`$message`.
*/
var $messagem = doc.querySelectorAll('textarea');
