...
/*
^[\w+.] - inicio, pode conter qualquer caractere alfanumérico, quantos forem necessários, ou sinal de mais(+) ou ponto(.);
+@ - seguido de arroba(@);
\w+ - pode conter qualquer caractere alfanumérico, quantos forem necessários;
\. - barra invertida para escapar o ponto;
\w{2,} - seguindo por pelo menos dois caracteres ou mais;
(?:\. w{2})? - o final é opcional e por isso estar entre parenteses, seguido  de interrogação, se existir deve ser precidd por um ponto e seguido por no máximo dois caracteres, 
usando o interrogação e os dois pontos no inicio para não fazer a captura, fazendo somente o agrupamento;
$ - fim  da regex;
/gm - global e multilinha
*/
})(window, document);