(function(win, doc){
    ...
    */
    var questionName = win.prompt('Qual o seu nome?');
    var username;
    if(questionName)
    ...
    */
    var questionEmail = win.prompt('Qual seu email?');
    var email;
    if(questionEmail)
        email = questionEmail;
    ...
    */
    $button.addEventListener('click', function(event){
        ...
        if($inputUsername.value === 'undefined') {
        ...
        if(isValidEmail($inputEmail.value) === false) {
            win.alert('Entre com um email válido!');
            send = false;
        }
