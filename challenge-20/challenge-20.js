(function(window, document){
  ...
  */
     ...
     let nameUser = window.prompt('Qual o seu nome?');
     nameUser !== true ? 'Desconhecido': '';
  ...
  */
    const email = window.prompt('Qual o seu e-mail?');
    email !== true ? 'Desconhecido': '';
    console.log(email);
  ...
  */
  $button.addEventListener('click', (e) => {
    e.preventDefault();
    if(!$inputUsername.value) return window.alert("Preencha o nome do usuário!");
    if(!isValidEmail($inputEmail.value)) return window.alert("Preencha o nome do Email!");
    if(!$message.value) return window.alert("Preencha o nome do mensagem!");
