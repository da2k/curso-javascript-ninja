(function(win, doc){
    ...
    */
    ...
    !username ? username = 'Desconhecido' : null
    ...
    */
    $button.addEventListener('click', function(){
        ...
        !$inputUsername.value ? alert('Preencha o nome do usuário!') : false
        !$inputEmail.value ? alert('Preencha o e-mail!') : false
        !$message.value ? alert('Preencha a mensagem!') : false
        !isValidEmail($inputEmail.value) ? alert('Entre com um e-mail válido!') : false
        ...
        if( $inputUsername.value &&
            ...
            var submitQuestion = confirm('Tem certeza que deseja enviar o formulário?')
            submitQuestion ? alert('Enviado com sucesso!') : alert('Não enviado.')
    ...
    */
    ...
    function isValidEmail(email) {
        return /[\w\d+._]+@[\w_]+\.[\w]{2,}(.?\w{2})?/g.test(email)
   }
