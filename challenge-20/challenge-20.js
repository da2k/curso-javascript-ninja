(function(window, document) {
    ...
    */
    $button.addEventListener('click', function(event) {
        ...
        if(!isValidEmail($inputEmail.value)) alert("Entre com um e-mail válido!")
    ...
    */
    function isValidEmail(email) {
        var regex = new RegExp('^[\\w_+.]+@[\\w_]+\\.\\w{2,}(?:\\.\\w{1,2})?$', 'gi')
        console.log(regex)
        return regex.test(email)
    }

    // var emails = ["meu.email+categoria@gmail.com", "juca_malandro@bol.com.br", "pedrobala@hotmail.uy", "sandro@culinaria.dahora", "walter-da-silva@maraca.br", "rita-marica@titica.a.b", "agua_@evida.br.com"]
