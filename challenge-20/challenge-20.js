(function(window, document) {
  ...
  */
  $button.addEventListener('click',function(event) {
    ...
    if (hasValue($inputUsername) && hasValue($inputEmail) && isValidEmail($inputEmail.value) && hasValue($message))
  ...
  function hasValue(field) {
    var fieldMessage = {
      ...
      'textarea': 'Preencha a mensagem!',
    };

    if (!field.value || field.value === 'Desconhecido')
      alert(fieldMessage[field.type]);
