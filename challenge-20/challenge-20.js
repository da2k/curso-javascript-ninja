...
alert(username==''?'Bem vindo Desconhecido!':'Bem vindo '+username);
...
$button.addEventListener('click',function(event){
   ...
   // alert(inputUsername);
    ...
    if ( $inputUsername.value && $inputEmail.value && $message.value )
        return alert(window.confirm('Tem certeza que deseja enviar o formulário?')?'Enviado com sucesso!':'Não enviado.');
