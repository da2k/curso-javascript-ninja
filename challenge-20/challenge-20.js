;(function ( win, doc ) {
  ...
  */
  $button.addEventListener( 'click', function( event ) {
    ...
    if ( $inputUsername.value.length === 0 ) // ( !$inputUsername.value )
      return alert('Preencha o nome do usuário!');
    if ( $inputEmail.value.length === 0 ) // ( !$inputEmail.value )
      return alert('Preencha o e-mail!');
    if ( isValidEmail($inputEmail.value) === false ) // !isValidEmail( $inputEmail.value )
 ...
 function isValidEmail( email ) {
  ...
  console.log(isValidEmail("juca_malandro@bol.com.br"));
  console.log(isValidEmail("pedrobala@hotmail.uy"));
  console.log(isValidEmail("sandro@culinaria.dahora"));

  //false
  console.log(isValidEmail("walter-da-silva@maraca.br"));
  console.log(isValidEmail("rita-marica@titica.a.b"));
  console.log(isValidEmail("agua_@evida.br.com"));
})( window, document );
