(function (win, doc) {
    ...
    */
    $button.addEventListener('click', function (e) {
        ...
        if ($inputUsername.value
            ...
            var confirmed = confirm('Tem certeza que deseja enviar o formulário?');
            return alert(confirmed ? 'Enviado com sucesso!' : 'Não enviado.');
        }
    ...
    */
    ...
    function isValidEmail(email) {
        var regex = RegExp('^[\\w+\\.]+@[\\w]+\\.[A-Za-z0-9]{2,}(?:\\.[A-Za-z0-9]{1,2})?$');
