(function(doc){
    ...
    */
    //
    let checkName = prompt('Qual o seu nome?');
    let username;
    if(checkName){
        username = checkName;
    ...
    */
    //
    let checkEmail = prompt("Qual o seu e-mail?");
    let email;
    email = checkEmail ? checkEmail : 'Desconhecido';
    ...
    */
    ...
    function isValidEmail(email){
        let regexEmail = new RegExp('^[\\w+.]*\\w+[^_]@\\w+[.]\\w+[.]?\\w*$','gm');
