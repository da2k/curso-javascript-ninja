...
*/
  ...
  */
  ...
  email = (email == '') ? 'Email Desconhecido' : email
  alert("Bem vindo!, seu email é " + email + "!")
  ...
  */
  ...
  /*3. Se tudo estiver OK, pergunte ao usuário:
    -"Tem certeza que deseja enviar o formulário?"
  Se
  for confirmado, mostre um alerta com a mensagem:
    -"Enviado com sucesso!"
  Caso contrário, mostre um alerta com a mensagem:
    -"Não enviado." *
    /
  ...
  */
  ...
  $button.addEventListener('click', function (event) {
    ...
    let validate
    validate = isValidInput($inputUsername)
    validate = isValidInput($inputEmail)
    validate = isValidInput($message)
    ...
    let send = confirm('Tem certeza que deseja enviar o formulário?')
