(function(win, doc){
	...
	*/
	...
	// var username = prompt('Qual seu nome?') || 'Desconhecido'; // Resultado com: curto circuito, no caso elimina o if
	...
	*/
	...
	$button.addEventListener('click', function(event){
		event.preventDefault(); //Preveni a ação padrão do botão
	...
	*/
	function isValidEmail(email){
		return /^[\w+.]+@\w{2,}(?:\.\w{2})?$/gm.test(email);
	};
