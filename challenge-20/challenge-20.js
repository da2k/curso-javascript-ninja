(function(window, document){
    ...
    */
    ...
    window.confirm('Tem certeza que deseja enviar o formulário?')
    ...
    Alguns e-mails inválidos:
        ...
        - "agua_@evida.br.com"
    */
    function isValidEmail(verEmail){
        const parseEmail = /^[\w+.]+@\w+\.\w{2,}(?:\.\w{2})?$/;
        return parseEmail.test(String(verEmail).toLowerCase());
    }
