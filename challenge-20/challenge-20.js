(function(win, doc) {
    ...
    */
    $button.addEventListener('click', function(event) {
        ...
        If they're not, shows an alert for each one
        */
        var formFields = {
            'o nome do usuário': $inputUsername,
            'o e-mail': $inputEmail,
            'a mensagem': $message,
        };
        ...
        // Check if everythin is ok
        if (formHasErrors)
            return ;

        // Submit confirmation (or not)
        var confirmationMessage = 'Não enviado.';
