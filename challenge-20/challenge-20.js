(function(win, doc) {
    ...
    */
    ...
    // outra opcão com curto circuito:
    var username = prompt('Qual o seu nome?') || 'Desconhecido';
    alert( 'Bem vindo ' + username + '!' );
    // se o prompt for true, tiver valor, username recebe esse valor. mas se o prompt for false, n tiver valor, username recebe 'desconhecido'.
    ...
    */
    ...
    function isValidEmail( email ) {
        var regex = new RegExp('^[\\w+.]+@\\w+\\.\\w{2,}(?:\\.\\w{2})?$', 'gm');
