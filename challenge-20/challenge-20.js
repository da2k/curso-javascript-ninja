(function (w, d) {
  ...
  */
  var email = prompt('Qual o seu e-mail?') || 'Sem email :(';
  ...
  `$inputUsername`.
  */
  var $inputUsername = d.querySelector('input[type="text"]');

  /*
  - Selecione o input de "Email", atribuindo-o à uma variável chamada
  `$inputEmail`.
  */
  var $inputEmail = d.querySelector('input[type="email"]');

  /*
  - Selecione o campo de "Mensagem", atribuindo-o à uma variável chamada
  `$message`.
  */
  var $message = d.querySelector('textarea');

  /*
  - Selecione o botão de envio do formulário, atribuindo-o à uma variável
  chamada `$button`.
  */
  var $button = d.querySelector('button[type="submit"]');
