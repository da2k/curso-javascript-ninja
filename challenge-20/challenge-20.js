...
'use strict';
  ...
  */
  ...
  /*
  Ao carregar a página, pergunte ao usuário "Qual o seu
  nome?". Atribua o
  resultado à uma variável chamada `username`. Se o
  usuário não digitar um
  nome, `username` deve receber "Desconhecido".
  Com a resposta, mostre um alert com a mensagem "Bem
  vindo [USERNAME]!"
  */
  ...
  /*
  Agora, pergunte ao usuário "Qual o seu e-mail?",
  atribuindo o resultado à
  ...
  */
  ...
  /*
  - Selecione o input de "Nome", atribuindo-o à uma
  variável chamada
  `$inputUsername`.
  */
  ...
  /*
  - Selecione o input de "Email", atribuindo-o à uma
  variável chamada
  `$inputEmail`.
  */
  ...
  /*
  - Selecione o campo de "Mensagem", atribuindo-o à uma
  variável chamada
  `$message`.
  */
  ...
  /*
  - Selecione o botão de envio do formulário, atribuindo
  o à uma variável
  chamada `$button`.
  */
  ...
  /*
  Preencha os campos de "Nome" e "Email" que estão no
  documento com os valores
  ...
  */
  ...
  /*
  Adicione um listener de evento de click ao botão que
  faça o seguinte:
  ...
  - Se o campo de "Email" não estiver preenchido, mostrar:
      - "Preencha o e-mail!"
  - Se o campo de "Mensagem" não estiver preenchido,
  mostrar:
      - "Preencha a mensagem!"
  ...
  `isValidEmail`, passando
  o e-mail que foi entrado no campo de "Email" por
  parâmetro. (A função
  ...
  */
  ...
  /*
  Crie uma função chamada `isValidEmail`, que será usada
  na validação do
  envio do formulário.
  Essa função deve receber o e-mail por parâmetro e
  verificar se é um e-mail
  válido.
  As regras para validação são:
      - O nome do usuário (antes do arroba), pode ser
      qualquer caractere
      alfanumérico, incluindo o underscore, sinal de "+"
      e o ponto;
      - Após o arroba, o domínio pode conter somente
      caracteres alfanuméricos
      e o underscore;
      - Para a extensão, o domínio deve vir seguido de um
      ponto, e no mínimo
      2 caracteres alfanuméricos;
      - O final do domínio é opcional, mas se existir,
      deve começar com um
      ponto, seguido de no máximo 2 caracteres
      alfanuméricos.
