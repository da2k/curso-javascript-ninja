(function(win, doc){
  ...
  */
  ...
  //OPÇÃO 3
  const username = win.prompt( 'Qual o seu nome?' )
  ...
  /*
	...
	*/
  const email = win.prompt( 'Qual o seu email?' )
  
	if( email )
		console.log('respondeu email');
	else
		console.log('não respondeu email');
	/*
	- Selecione o input de "Nome", atribuindo-o à uma variável chamada
	`$inputUsername`.	
	!!=== Para selecionar atributos de tags html, usa o [] ===!!
	*/
	const $inputUsername = doc.querySelector('[type="text"]');
	...
	`$inputEmail`.
	*/
	const $inputEmail = doc.querySelector('[type="email"]');
  ...
  /*
	...
	`$message`.
	*/
	const $message = doc.getElementsByTagName('textarea');
	//let $message = doc.querrySelector('textarea');
	//console.log( $message )
  ...
  /*
	...
	*/
	...
	//let $message = doc.querrySelector('button');
	//console.log( $button )
