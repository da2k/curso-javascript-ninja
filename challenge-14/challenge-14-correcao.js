...
*/
console.log( '\nInversed Name:' );
var inversedName = name.reduceRight(function (valuetotal, itemtotal){
 return valuetotal + itemtotal;
})
...
// ?
console.log( Array.isArray(justMod2Or3) === true ? justMod2Or3.toString() : 'Não é um array');
