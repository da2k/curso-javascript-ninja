(function () {
    ...
    */
    ...
    for (var i = 0; i < numberObjects.length; i++) {
        for (var prop in numberObjects[i]) {
            console.log(prop + ': ' + numberObjects[i][prop]);
        }
    }
    ...
    */
    ...
    for (var i = 0; i < justNumbers.length; i++) {
        if (justNumbers[i] % 2 === 0 || justNumbers[i] % 3 === 0) {
            justMod2Or3.push(justNumbers[i]);
        }
    }
    ...
    */
    console.log('\nInversed Name:');
    var inversedName = pName.reduceRight(function (acumulado, atual) {
    ...
    */
    ...
    if (numberObjects.lastIndexOf({ number: 2 }, 0) > -1) {
        console.log('Existe um objeto { number: 2 } em numberObjects!');
    } else {
        console.log('Não existe um objeto { number: 2 } em numberObjects :(');
    }
