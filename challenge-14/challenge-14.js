(function(){
    ...
    */
    ...
    var myName = [ 'Ve', 're', 'na' ];
    var pLanguage = myName.reduce(function(acumulado, atual){
        return acumulado + 'p' + atual;
    }, '');
    console.log( pLanguage );
    // Eu tive que trocar o nome da variável pq no console do navegador, que é onde eu testo, ele dá TypeError: name.reduce is not a function
