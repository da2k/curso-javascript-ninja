(function(){
    ...
    */
    ...
    console.log('Aqui teria que dar um valor para a variável do objeto desejado, sé não na comparação iria comparar dois objetos de instancias diferente');
    
    numberObjects.indexOf(obj) > -1? console.log('Existe um objeto { number: 2 } em numberObjects!'):console.log('Não existe um objeto { number: 2 } em numberObjects :(');
    ...
    */
    ...
    numberObjects.lastIndexOf(obj,2) >-1? console.log('Existe um objeto { number: 2 } em numberObjects!'):console.log('Não existe um objeto { number: 2 } em numberObjects :(');
