(function() {
  ...
  */
  console.log( '\nOperation:' );
  var operation = justMod2Or3.reduce(function(accumulator, current) {
  ...
  */
  console.log( '\nOperation 2:' );
  var operation2 = justMod2Or3.reduceRight(function(accumulator, current) {
    return ++accumulator * current
  });
  ...
  */
  ...
  var name = ['Fi', 'li', 'pe'];
  var reduceName = name.reduce(function(accumulator, current) {
  ...
  */
  ...
  console.log('\nA função indexOf() retornou que o objeto não existe pois o objeto comparado possui endereço de memória diferente do que está presente no array.');
