(function() {
  ...
  */
  ...
  var name = ['Bru', 'no', 'Gio', 'va', 'ni'];
  var reducedName = name.reduce(function(acc, atual) {
  	return acc + 'P' + atual;
  }, '');
  ...
  */
  ...
  var index = numberObjects.indexOf({number: 2}) > -1 ? "Existe um { number: 2 } em numberObjects?" : "Não existe um objeto { number: 2 } em numberObjects :(";
  console.log(index);
  ...
  */
  ...
  var index = numberObjects.lastIndexOf({number: 2}, 2) > -1 ? "Existe um { number: 2 } em numberObjects?" : "Não existe um objeto { number: 2 } em numberObjects :(";
  console.log(index);
