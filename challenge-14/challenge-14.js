(function() {
    ...
    */
    console.log( '\nOperation:' );
    var operation = justMod2Or3.reduce(function(v1, v2){
        return ( v1 + 1 ) * v2
    }, 0);
    ...
    */
    console.log( '\nOperation 2:' );
    var operation2 = justMod2Or3.reduceRight(function(v1, v2){
        return ( v1 + 1 ) * v2
    }, 0);
    ...
    */
    console.log( '\nInversed Name:' );
    var inversedName = name.reduceRight(function(v1, v2){
        return v1 + v2;
    });
    ...
    */
    ...
    console.log( 
        ...
        'verificando pelos seus índices, o item especificado via parâmetro'
    );
    ...
    */
    ...
    var isItAnArray = Array.isArray(justMod2Or3);
    if( justMod2Or3 ) {
