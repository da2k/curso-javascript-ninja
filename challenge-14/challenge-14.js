(function(){
    ...
    */
    console.log( '\nOperation 2:' );
    var operation2 = justMod2Or3.reduce(function(acumulado, item ){
        return (acumulado + 1) * item;
    }, 0);
    ...
    */
    ...
    var mensagem = 
        numberObjects.map(function(item){ return item.number; }).indexOf(2) > -1
            ? 'Existe um objeto { number: 2 } em numberObjects!'
            : 'Não existe um objeto { number: 2 } em numberObjects :('
        ;
    ...
    */
    ...
    mensagem = 
        numberObjects.map(function(item){ return item.number; }).indexOf(2, numberObjects.length - 1) > -1
            ? 'Existe um objeto { number: 2 } em numberObjects!'
            : 'Não existe um objeto { number: 2 } em numberObjects :('
        ;
    console.log(mensagem);
