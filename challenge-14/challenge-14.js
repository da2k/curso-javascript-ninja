...
console.log( '\nOperation:' );
    ...
    var operation = justMod2Or3.reduceRight(function(acumulado, atual, indice){
       return (justMod2Or3[indice]+1)*atual
...
var operation2 = justMod2Or3.reduce(function(acumulado, atual, indice){
    return (justMod2Or3[indice]+1)*atual
...
console.log( '\nSeu nome na língua do "P":' );
 ...
 var name = ['Pen', 'Pi', 'Pue']
//  var name = name.reduce(function(acumulador, atual, indice){
...
var inversedName = name.reduceRight(function(acumulador, atual, indice){
        return acumulador+atual
})
