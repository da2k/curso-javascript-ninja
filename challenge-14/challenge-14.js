( function () {
  ...
  */
  console.log( '\nOperation 2:' );
  var operation = justMod2Or3.reduceRight(function(acumulado, item){
    acumulado += 1;
    acumulado *= item;
    return acumulado;
  }, 0);
  ...
  */
  ...
  var name = ['Fer','nan','do'];
  var nameReduce = name.reduce(function(acumulado, item, index){
  ...
  */
  ...
  console.log('\nAo passar o objeto por parametro, estamos criando um novo objeto.');
  console.log('Por mais que os atributos do objeto são os mesmos, trata-se de um novo');
  console.log('objeto, com outra referecia de memoria, logo ele retornará -1!');
  ...
  */
  ...
  indexOf = numberObjects.lastIndexOf({ number:2 }, 2);
  console.log(
    indexOf >= 0
    ? 'Existe um objeto { number: 2 } em numberObjects!'
    : 'Não existe um objeto { number: 2 } em numberObjects :('
