(function() {
    ...
    */
    console.log( '\nOperation:' );
    let operation = justMod2Or3.reduce(function(previous, current, index) {
    ...
    */
    console.log( '\nOperation 2:' );
    let operation2 = justMod2Or3.reduceRight(function(previous, current, index) {
        return (previous + 1) * current
    }, 0);
    ...
    */
    ...
    let name = ['Le', 'an', 'dro'].reduce(function(previous, current, index) {
    ...
    */
    console.log( '\nInversed Name:' );
    let inversedName = ['Le', 'an', 'dro'].reduceRight(function(previous, current, index) {
