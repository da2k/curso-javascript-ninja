...
(function () {
    ...
    */
    ...
    var name = ['Chris', 'ti', 'an'];
    reducedName = name.reduce(function (acumulado, atual) {
    ...
    */
    console.log('\nInversed Name:');
    var inversedName = name.reverse().reduce(function (acumulado, atual) {
    ...
    */
    ...
    console.log('Aqui temos um problema com a referência de objetos. '
        + 'O objeto da minha comparação é um novo objeto e faz referência a outro trecho da memório'
        + 'Ou seja, eles não são iguais.');
