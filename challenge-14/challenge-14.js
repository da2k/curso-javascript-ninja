( function() {
  ...
  */
  console.log( '\nOperation:' );
  var operation = justMod2Or3.reduce( function( total, valor ) {
    return ++total * valor;
  }, 0 );
  ...
  */
  console.log( '\nOperation 2:' );
  var operation2 = justMod2Or3.reduceRight( function( total, valor ) {
    return ++total * valor;
  }, 0 );
  ...
  */
  ...
  var name = [ 'an', 'dre' ];
  // panpdre
  var name_in_p_language = name.reduce( function( total, item ) {
    return total + 'p' + item;
  }, '' );
  console.log( 'name:', name_in_p_language );
  ...
  */
  ...
  console.log( 'O resultado é false porque a referência do objeto na memoria é diferente' );
  ...
  */
  ...
  console.log(
    numberObjects.indexOf( { number: 2 }, 2 )
    ? 'Existe um objeto { number: 2 } em numberObjects!'
    : 'Não existe um objeto { number: 2 } em numberObjects :('
  );
