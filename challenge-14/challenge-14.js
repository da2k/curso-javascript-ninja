...
var name = ['Jor','ge'].reduce(function(acumulado,atual,index,array){
...
*/
console.log( '\nInversed Name:' );
var inversedName = ['Jor','ge'].reduceRight(function(acumulado,atual,index,array){
...
console.log(Array.isArray(justMod2Or3)?justMod2Or3:'');
