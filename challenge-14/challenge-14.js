(function(){
    ...
    */
    ...
    var forEach = arr.forEach(function(item){
        return numberObjects.push({number : item });
    }) 
    ...
    */
    ...
    operation2 = justMod2Or3.reduceRight(function(acum, atual, index, array){
        return (acum + 1) * atual;
    },0);
    ...
    */
    ...
    var linguaDoP = name.reduce(function(acum, atual){
        return acum +  'p' + atual;
    }, '');
    /*
    ...
    */
    ...
    some ? "Existe um objeto { number: 2 } em numberObjects!" : "Não existe um objeto { number: 2 } em numberObjects :(";
