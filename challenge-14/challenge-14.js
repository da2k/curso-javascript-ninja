(function(){
  ...
  */
  ...
  var operation = justMod2Or3.reduce(function(acumulator, item, index, array){
  ...
  */
  ...
  var operation2 = justMod2Or3.reduceRight(function(acumulator, item){
    return ( acumulator + 1 ) * item;
  }, 0)
  ...
  */
  ...
  console.log(name.map(function(item){
    return 'P' + item;
  }).reduce(function(acumulator, item){
  ...
  */
  ...
  var inversedName = name.reduceRight(function(acumulator, item){
    return acumulator + item;
  })
