(() => {
  ...
  */
  console.log( '\nOperation:' );
  const operation = justMod2Or3.reduce((total, atual) => {
  ...
  */
  console.log( '\nOperation 2:' );
  const operation2 = justMod2Or3.reduceRight((total, atual) => {
    return ( total + 1 ) * atual;
  });
  ...
  */
  ...
  const name = ['I', 'zan', 'der', 'son'];
  const nameP = name.reduce((total, item) => {
    return total + 'P' + item;
  }, '');
  console.log(nameP);
  ...
  */
  console.log( '\nInversed Name:' );
  const inversedName = name.reduceRight((total, item) => {
    return total + item;
  });
