(function () {
  ...
  */
  console.log("\nOperation:");
  let operation = justMod2Or3.reduce(function (acc, current) {
    acc++;
    return acc * current;
  }, 0);
  ...
  */
  console.log("\nOperation 2:");
  let operation2 = justMod2Or3.reduceRight(function (acc, current) {
    acc++;
    return acc * current;
  }, 0);
  ...
  */
  ...
  let p = name.reduce(function (acc, current) {
  ...
  */
  console.log("\nInversed Name:");
  let inversedName = name.reduceRight(function (acc, current) {
    return acc + current;
  });
