...
var justNumbers = numberObjects.map(function(item){ // pega so os numeros
  return item.number;
});
...
var justMod2Or3 = justNumbers.filter(function(item){ // filtra so os que sao divisiveis
