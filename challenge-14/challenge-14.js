(function() {
	...
	*/
	...
	var name = [ 'MA', 'THE', 'US' ];
	var pLanguage = name.reduce( function ( accumulated, total ) {
		return accumulated + 'P' + total; 
	}, '' );
	...
	*/
	console.log( '\nInversed Name:' );
	var inversedName = name.reduceRight( function ( accumulated, total ) {
	...
	*/
	...
	console.log( 'No console mostra que não existe um objeto. Confesso que não entendi muito bem...' )
