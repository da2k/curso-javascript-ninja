(function envolveTudoGeral(){
	...
	*/
	console.log( '\nInversed Name:' );
	var inversedName = nameP.reduceRight(function(acumulado, atual){
	...
	*/
	...
	if( numberObjects.indexOf(numberObjects[1], 2) > -1 ) {
		console.log('Existe');
	} else {
	...
	*/
	console.log( '\nE buscando a partir do último índice, o { number: 2 } existe?' );
		var obj = numberObjects[1];
	if( numberObjects.lastIndexOf(obj, 2) > 2 ) {
		console.log('Existe');
	} else {
		console.log('Não existe')
	}
