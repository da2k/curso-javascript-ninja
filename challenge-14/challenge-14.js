(function(){
    ...
    */
    ...
    console.log(name.reduce(function(acumulated, actual){
        return acumulated + 'P' + actual;
    }, ''));
    ...
    */
    console.log( '\nInversed Name:' );
    var inversedName = name.reduceRight(function(acumulated, actual) {
    ...
    */
    ...
    var verifyObj = numberObjects.map(function(item) {
        return JSON.stringify(item);
    }).indexOf('{"number":2}');

    console.log(verifyObj !== -1 ? 'Existe um objeto { number: 2 } em numberObjects!' :
                    'Não existe um objeto { number: 2 } em numberObjects :(');
    ...
    */
    ...
    var verifyReverse = numberObjects.map(function(item) {
        return JSON.stringify(item);
    }).lastIndexOf('{"number":2}', 2);

    console.log(verifyReverse !== -1 ? 'Existe um objeto { number: 2 } em numberObjects!' :
                    'Não existe um objeto { number: 2 } em numberObjects :(');
