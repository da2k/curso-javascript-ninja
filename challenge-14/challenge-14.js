;(function(){
    ...
    */
    ...
    console.log('Acredito que por passar um objeto para o indexOf ele comparará o endereço de memória do objeto e não o conteúdo do mesmo, deste modo o resultado será -1, ou seja, não encontrará.');
