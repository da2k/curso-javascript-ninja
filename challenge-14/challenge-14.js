(function(){
	...
	*/
	console.log( '\nOperation:' );
	var operation = justMod2Or3.reduce(function(resultado,atual,index,array){
		return (resultado+1)*atual;
	},0);
	...
	*/
	console.log( '\nOperation 2:' );
	var operation2 = justMod2Or3.reduceRight(function(resultado,atual,index,array){
		return (resultado+1)*atual;
	},0);
	...
	*/
	...
	var name = ['Re','na','to'];
	var nameP = name.reduce(function(resultado,atual){
		return resultado+'P'+atual;
	},'');
	console.log(nameP);
	...
	*/
	console.log( '\nInversed Name:' );
	var inversedName = name.reduceRight(function(resultado,atual,index,array){
