(function() {
    ...
    */
    ...
    var inversedName = name.reduceRight(function(total, current) {
    ...
    */
    ...
    console.log('\nA função indexOf() retornou que o objeto não existe pois o objeto passado no parâmetro possui endereço de memória diferente do que está presente no array.');
    ...
    */
    ...
    console.log(numberObjects.lastIndexOf({number: 2}, 2) > -1
        ? 'Existe um objeto { number: 2 } em numberObjects!'
        : 'Não existe um objeto { number: 2 } em numberObjects :('
    );
