(function(){
	...
	*/
	...
	var mapArr = numberObjects.map( function( item ){
		return item;
	} );
	...
	*/
	var justNumbers = mapArr.map( function( item, index, array ){
	...
	*/
	var operation = justMod2Or3.reduce( function( acumulado, atual ){
		var valorAtual = atual + 1;
		return valorAtual * atual;
	}, 0 );
	...
	*/
	...
	numberObjects.indexOf( { number: 2 } ) ? console.log( "Existe um objeto { number: 2 } em numberObjects!" ) : console.log( "Não existe um objeto { number: 2 } em numberObjects :(" );

	/*
	Fazendo o mesmo do exercício acima, mas começando a buscar do último índice,
	será que obtemos um resultado diferente? Faça a busca a partir do índice 2.
	*/
	console.log( numberObjects.indexOf( { number: 2 }, 9 ) );
	...
	*/
	...
	var reducejustMod2Or3 = justMod2Or3.reduce( function( acumulado, atual ){
		return acumulado + atual;
	} );

	console.log( reducejustMod2Or3 );                                                                                                               
