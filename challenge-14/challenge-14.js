(function () {
    ...
    */
    console.log( '\nOperation:' );
    var operation = justMod2Or3.reduce(function (result, item) {
        result++;
        result *= item;
        return result; 
    ...
    */
    console.log( '\nOperation 2:' );
    var operation2 = justMod2Or3.reduceRight(function (result, item) {
        result++;
        result *= item;
        return result; 
        // return (result + 1) * item;
    ...
    */
    ...
    var name = ['Mo', 'ni', 'ca'];
    var linguaDoP = name.reduce(function (result, item) {
        return result + 'P' + item;
    }, '');
    ...
    */
    ...
    // var temNumber2 = numberObjects.some(function (item) {
    ...
    //         ? 'Existe um objeto { number: 2 } em numberObjects!'
    //         : 'Não existe um objeto { number: 2 } em numberObjects :('
    // , 'Falso, pois objetos se comparam por referência.');
    ...
    console.log('Falso, pois objetos se comparam por referência.');
