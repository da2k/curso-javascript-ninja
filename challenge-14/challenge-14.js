(function(){
	...
	*/
	console.log( '\nOperation:' );
	var operation = justMod2Or3.reduce(function(itemAnterior, itemAtual, index, array){
	...
	*/
	console.log( '\nInversed Name:' );
	var inversedName = name.reduceRight(function(itemAnterior, itemAtual){
	...
	*/
	...
	var search2 = numberObjects.lastIndexOf({ number: 2 }, 2);
	search2 > 0 
	? console.log('Existe um objeto { number: 2 } em numberObjects!')
	: console.log('Não existe um objeto { number: 2 } em numberObjects :(');
