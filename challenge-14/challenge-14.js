(function() {
    ...
    */
    ...
    var operation = justMod2Or3.reduce(function(acumulate, item, index) {
    ...
    console.
    */
    var operation2 = justMod2Or3.reduceRight(function(acumulate, item, index) {
      return (acumulate + 1) * item;
    }, 0);
    ...
    */
    var name = ['Ren', 'nan']
    var newName = name.reduce(function(acum, item) {
      return acum + 'P' + item;
    }, '');
    ...
    */
    var inversedName = name.reduce(function(acum, item) {
      return item + acum
    }, '');
    ...
    */
    ...
    o que acontece ;)
    */
    var mensagem = numberObjects.indexOf({ number: 2 }) > 0
      ? 'Existe um objeto { number: 2 } em numberObjects!'
      : 'Não existe um objeto { number: 2 } em numberObjects :(';

    console.log( '\nExiste um { number: 2 } em numberObjects?', mensagem );

    /*
    Fazendo o mesmo do exercício acima, mas começando a buscar do último índice,
    será que obtemos um resultado diferente? Faça a busca a partir do índice 2.
    */
    var mensagem2 = numberObjects.lastIndexOf({ number: 2 }) > 0
    ? 'Existe um objeto { number: 2 } em numberObjects!'
    : 'Não existe um objeto { number: 2 } em numberObjects :(';

    console.log( '\nE buscando a partir do último índice, o { number: 2 } existe?', mensagem2 );
