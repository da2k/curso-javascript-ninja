(function(){
	...
	*/
	console.log( '\nOperation:' );
	var operation = justMod2or3.reduce(function(accumulator, cur){
		return (accumulator + 1) * cur;
	}, 0);
	...
	*/
	console.log( '\nOperation 2:' );
	var operation2 = justMod2or3.reduceRight(function(accumulator, cur){
		return (accumulator + 1) * cur;
	}, 0);
	...
	*/
	...
	var name = ['Isa', 'ac']
	var linguaP = name.reduce(function(acc, cur){
		return acc + 'P' + cur;
	}, '');
	console.log( linguaP );
