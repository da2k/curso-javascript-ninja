...
var name = [ 'Di', 'e', 'go'];
var reduzido = name.reduce(function(acumulado, atual){
...
*/
console.log( '\nInversed Name:' );
var invertido = name.reduceRight(function(acumulado, atual){
...
var num2 = numberObjects[1];
if(numberObjects.indexOf(num2) > -1){
...
if(numberObjects.lastIndexOf(num2) > -1){
	console.log( "Existe um objeto { number: 2 } em numberObjects!" );
} else console.log( "Não existe um objeto { number: 2 } em numberObjects :(" );
