;(function() {
    ...
    */
    ...
    var operation = justMod2Or3.reduce(function (acumulated, atual) {
      return (acumulated + 1) * atual;
    }, 0);
    ...
    */
    ...
    var operation2 = justMod2Or3.reduceRight(function (acumulated, atual) {
      return (acumulated + 1) * atual;
    }, 0);
    ...
    */
    ...
    var reduced = name.reduce(function (acumulated, atual) {
      return acumulated + 'P' + atual;
    });
    ...
    */
    ...
    console.log(
      ...
      'Existe um objeto { number: 2 } em numberObjects!' :
      'Não existe um objeto { number: 2 } em numberObjects :( \n Os objetos em JS só são iguais se criado um novo objeto atribuindo o primeiro.'
    );
