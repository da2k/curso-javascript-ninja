(function () {
   ...
   */
  console.log('\nOperation:');
  var operation = justMod2Or3.reduceRight(function (accumulator, item) {
  ...
  console.log('\nNão faz a busca por um objeto com o método indexOf...');
