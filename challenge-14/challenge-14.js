...
(function() {
    ...
    */
    ...
    var pname = name.reduce(function(acc, cur, index, array) {
    ...
    */
    ...
    var isItThere = numberObjects.indexOf({ number: 2 }) >= 0;
    console.log(numberObjects.indexOf(2));
    console.log(isItThere === true ? 'Existe um objeto { number: 2 } em numberObjects!' : 'Não existe um objeto { number: 2 } em numberObjects :(');
    ...
    */
    ...
    var isItThere = numberObjects.lastIndexOf({ number: 2 }) >= 0;
