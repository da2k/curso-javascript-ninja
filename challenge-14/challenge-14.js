(function () {
    ...
    */
    console.log( '\nOperation:' );
    var operation = justMod2Or3.reduce( function( accum, curr ) {
        return ++accum * curr;
    }, 0 );
    ...
    */
    console.log( '\nOperation 2:' );
    var operation2 = justMod2Or3.reduceRight( function( accum, curr ) {
        return ++accum * curr;
    }, 0 );
    ...
    */
    console.log( '\nInversed Name:' );
    var inversedName = name.reduceRight( function( accum, curr ) {
        return accum + curr;
    }, '' );
    ...
    */
    ...
    var hasTwo = numberObjects.map( function( e ) {
        return e.number;
    } ).indexOf( 2 ) >= 0; 
    if ( hasTwo ) {
    ...
    */
    ...
    hasTwo = numberObjects.map( function( e ) {
        return e.number;
    } ).lastIndexOf( 2, 2 ) >= 0; 
    if ( hasTwo ) {
        console.log( 'Existe um objeto { number: 2 } em numberObjects!' );
