(function() {
    ...
    */
    ...
    var reducedName = name.reduce(function(acumulado, atual) {
    ...
    */
    ...
    Neste caso, eu estou comparando se o index de um objeto é igual ao
    índice de um novo objeto criado, e não a algum índice do próprio objeto.
    Portanto, ao tentar comparar duas referências diferentes, não há como
    o resultado ser true, pois cada um é um objeto diferente.
    Com a sintaxe atual do if, um novo objeto está sendo criado na memória.
