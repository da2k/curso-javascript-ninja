(function () {
  ...
  */
  ...
  var langP = name.reduce(function ( acc, cur ) {
    return acc + 'p' +cur;
  ...
  */
  ...
  /* Minha solução:
  var strNumberObjects = JSON.stringify( numberObjects );

  var checkObj = ( strNumberObjects.indexOf( '{"number":2}' ) > -1 )
    ? "Existe um objeto { number: 2 } em numberObjects!"
    : "Não existe um objeto { number: 2 } em numberObjects :("
  ...
  */
  ...
  var obj = numberObjects[ 1 ]; // criar uma var que aponte direto(na memória!) para o índice do numberObj
  ...
  */
  ...
  Mas o correto seria testar pelo { number: 2 }, mesmo que retorne erro, porque tem que ficar
  fixado essa situação do ponteiro da memória etc.
  */
