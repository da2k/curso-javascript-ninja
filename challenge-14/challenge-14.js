...
console.log(
  ...
  "Existe um objeto { number: 2 } em numberObjects!" : "Não existe um objeto { number: 2 } em numberObjects :(" );
...
console.log(Array.isArray(justMod2Or3) ? justMod2Or3.toString() : Array.isArray(justMod2Or3))
