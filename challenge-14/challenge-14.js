(function() {
    ...
    */
    ...
    var i = numberObjects.indexOf({ number: 2 });
    console.log(
        i > -1
        ? 'Existe um objeto { number: 2 } em numberObjects!'
        : 'Não existe um objeto { number: 2 } em numberObjects :('
    ...
    /*
        Sempre vai retornar que nao existe, pois a comparacao e feita
        por referencia. Para retornar que existe, o indice do array
        deveria ter a referencia para o mesmo objeto de comparacao.
    */
    ...
    */
    ...
    i = numberObjects.lastIndexOf({ number: 2 }, 2);
    console.log(
        i > -1
        ? 'Existe um objeto { number: 2 } em numberObjects!'
        : 'Não existe um objeto { number: 2 } em numberObjects :('
