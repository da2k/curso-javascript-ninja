(function() {
  ...
  */
  console.log( '\nJust Numbers:' );
  // var justNumbers = [];
  // numberObjects.reduce( function( acumulado, atual ) {
  //   return justNumbers.push( atual.number );
  // }, 0);
  ...
  */
  ...
  var justMod2Or3 = justNumbers.filter( function( element, index ) {
  ...
  */
  ...
  if( Array.isArray( justMod2Or3 ) ) {
    console.log( justMod2Or3.toString(), JSON.stringify(justMod2Or3) );
  }
})();