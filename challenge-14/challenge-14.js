...
*/
console.log( '\nInversed Name:' );
inversedName.reduceRight(function(acumulado, atual){
...
if (numberObjects.indexOft( {number: 2}) > -1) {
  console.log('exite um objeto                                      
              '{ number: 2}'' em numberObject'}
              else{ console.log('não exite um objeto                            
              '{ number: 2}'' em numberObject')});
...
console.log( '\nExiste um { number: 2 } em numberObjects?' );
if (numberObjects.lastindexOft( {number: 2}, 2) > -1) {
  console.log('exite um objeto                                      
              '{ number: 2}'' em numberObject'}
              else{ console.log('não exite um objeto                            
              '{ number: 2}'' em numberObject')});
