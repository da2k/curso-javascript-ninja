    ...
    */
    ...
    var justNumbers = numberObjects.map (function (item){  // passa por todo array e retorna um novo array
        return item.number;
    });
    ...
    */
    ...
    var justMod20r3 = numberObjects.filter (function (item) {
    ...
    */
    ...
    if (numberObjects.indexOf ({obj} ) > -1 ) {
        console.log ('Existe um objeto { number: 2 } em numberObjects!') } else {
