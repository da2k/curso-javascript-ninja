(function() {
	...
	*/
	...
	justMod2Or3 = justNumbers.filter(function( item, index, array ) {
	...
	*/
	...
	inversedName = name.reduceRight(function( acumulado, valorCorrente, index, array ) {
	...
	*/
	...
	console.log( numberObjects.indexOf( {number: 2 } ) > -1 ? numberObjects[ numberObjects.indexOf( {number: 2 } ) ]  : "Não existe um objeto { number: 2 } em numberObjects :(" );
	...
	*/
	...
	console.log( numberObjects.lastIndexOf( {number: 2 } ) > -1 ? numberObjects[ numberObjects.lastIndexOf( {number: 2 } ) ]  : "Não existe um objeto { number: 2 } em numberObjects :(" );
