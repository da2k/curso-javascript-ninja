(function() {
    ...
    */
    console.log( '\nInversed Name:' );
    var reduceRight = name.reduceRight(function(acumulado, item) {
    ...
    */
    ...
    var copyNumberObjects = numberObjects[1];
    if( numberObjects.indexOf( copyNumberObjects ) > -1 ) {
    ...
    */
    ...
    if( numberObjects.lastIndexOf( copyNumberObjects ) > -1 ) {
        console.log( 'Existe um objeto { number: 2 } em numberObjects!' );
    } else {
        console.log( 'Não existe um objeto { number: 2 } em numberObjects :(' );
    }
