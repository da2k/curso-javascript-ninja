(function (){
    ...
    */
    ...
    var nameReduzido = name.reduce(function(acumulado, atual){
    ...
    */
    ...
    var result = numberObjects.some(function (item){
        return item.number === 2;
    })

    console.log(result ? "Existe um objeto { number: 2 } em numberObjects!" : "Não existe um objeto { number: 2 } em numberObjects" );
    ...
    */
    ...
    let number = numberObjects[1];
    if (numberObjects.lastIndexOf(number) > -1){
