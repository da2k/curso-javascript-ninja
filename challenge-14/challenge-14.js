...
*/
console.log( '\nOperation:' );
var operation = justMod2Or3.reduce(function (valorAcomulado, valorAtual) {
...
*/
console.log( '\nOperation 2:' );
var operation2 = justMod2Or3.reduceRight(function (valorAcomulado, valorAtual) {
  return (valorAcomulado + 1) * valorAtual;
});
...
console.log('a responta é não tem porque cada objeto tem uma referencia diferente na memoria então são diferentes');
