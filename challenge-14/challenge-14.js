(function () {
    ...
    */
    ...
    var nameP = name.reduce(function(acumulado, item, index) {
    ...
    */
    ...
    //Retorna false porque cada objeto criado possui seu único endereço na memória, assim, nenhum objeto criado é igual ao outro, ao menos que seja atribuída uma referência a ele.

    //var obj = numberObjects[1];
    //console.log(numberObjects.indexOf(obj) >= 0 ? "Existe um objeto { number: 2 } em numberObjects!" : "Não existe um objeto { number: 2 } em numberObjects :(");
    //Retorna true porque atribui o objeto do índice 1 à variável obj, criando uma referencia ao objeto do índice 1, assim, eles são iguais.
    ...
    */
    ...
    console.log(numberObjects.indexOf({ number: 2 }, 2) > -1 ? "Existe um objeto { number: 2 } em numberObjects!" : "Não existe um objeto { number: 2 } em numberObjects :(");
