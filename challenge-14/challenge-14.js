(function () {
    ...
    */
    console.log('\nInversed Name:');
    inversedName = name.reduce( function ( acumulado, atual ) {
    ...
    */
    ...
    console.log('Em JS cada objeto ao ser criado tem uma referência (ponteiro de memória) única.\n'+
                'Ao passar { number: 2 } para a função estou criando um novo objeto que terá uma nova referência.');
