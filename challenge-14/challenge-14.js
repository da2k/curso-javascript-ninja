(function() {
  ...
  */
  var operation = justMod20r3.reduce(function(acc, current) {
  ...
  console.
  */
  var operation2 = justMod20r3.reduceRight(function(acc, current) {
    return (acc + 1) * current;
  }, 0);
  ...
  */
  var name = ['e', 'i', 'o'];
  var nameP = name.reduce(function (acc, current) {
    return acc + (acc !== 'p' ? 'p' : '') + current;
  }, 'p');
  ...
  */
  var inversedName = name.reduceRight(function (acc, current) {
    return acc + current;
  });
  ...
  */
  ...
  o que acontece ;)
  */
  function searchNumberTwo(arr) {
    arr.some(function ({ number }) { return number === 2 })
      ? console.log(`Existe um objeto { number: 2 } em numberObjects!`)
      : console.log(`Não existe um objeto { number: 2 } em numberObjects :(`);
  }

  console.log( '\nExiste um { number: 2 } em numberObjects?' );
  searchNumberTwo(numberObjects);
  ...
  */
  ...
  searchNumberTwo(numberObjects.slice(2));
