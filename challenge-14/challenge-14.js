(function(){
  ...
  */
  ...
  // Object.keys(numberObjects).forEach(function(item) {
  //   justNumbers.push(numberObjects[item].number);
  // });
  ...
  */
  console.log( '\nOperation:' );
  var operation = justMod2Or3.reduce(function(acumulate, actual) {
  ...
  */
  console.log( '\nOperation 2:' );
  var operation2 = justMod2Or3.reduceRight(function(acumulate, actual) {
    return (acumulate + 1) * actual;
  }, 0);
  ...
  */
  ...
  var reduceP = name.reduce(function(acumulate, actual) {
