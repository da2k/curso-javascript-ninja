(function(){
	...
	*/
	...
	var name = [ 'l', 'e', 'a', 'n', 'd', 'r', 'o'];
	var linguaP = name.reduce(function( x, y ){
		return ( x + y + 'p' );
	}, '');
	console.log( linguaP );
	...
	*/
	...
	console.log('Pelo que entendi está dando que não existe por conta que o objeto é criado em um espaço de memoria unico');
	/*
