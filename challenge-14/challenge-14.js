(function() {
  ...
  */
  ...
  //   }
  // });
  // console.log(justMod2Or3.filter(Boolean));
  ...
  */
  ...
  /* retorna false pois cada valor do array ocupa um lugar na memória, ou seja,
  são diferentes.
  */

  var obj = numberObjects[1]; // posição {number: 2} no array
  ...
  /* retorna true pois o valor de obj é a referência do valor {number: 2} dentro
  do array numberObjects. eles apontam pro mesmo lugar na memória.
  */

  // var obj = numberObjects[1]; // posição {number: 2} no array
  // var some = numberObjects.some(function(index) {
  //   return index === obj;
  // });
