(function() {
	...
	*/
	...
	var indexEncontrado = numberObjects.indexOf(numberObjects[1]);
	console.log( indexEncontrado > -1 ? 'Existe um objeto { number: 2 } em numberObjects!' : 'Não existe um objeto { number: 2 } em numberObjects :(' );
	...
	*/
	...
	var novoIndexEncontrado = numberObjects.lastIndexOf(numberObjects[1], 2);
	console.log( novoIndexEncontrado > -1 ? 'Existe um objeto { number: 2 } em numberObjects!' : 'Não existe um objeto { number: 2 } em numberObjects :(' );
