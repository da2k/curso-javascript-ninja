(function() {
  ...
  */
  console.log( '\nInversed Name:' );
  var inversedName = name.reduceRight(function(acumuldado, atual) {
  ...
  */
  ...
  //console.log(numberObjects.indexOf(numberObjects[1], 2) > -1 ? 'Existe um objeto { number: 2 } em numberObjects!' : 'Não existe um objeto { number: 2 } em numberObjects :(');
