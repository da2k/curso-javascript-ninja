(function(){
    ...
    */
    console.log( '\nJust Numbers:' );
    var justNumbers = numberObjects.map(function(value, index){
        return value.number;
    });
    ...
    */
    console.log( '\nOperation:' );
    var operation = justMod2Or3.reduce(function(acc, current){
    ...
    */
    console.log( '\nOperation 2:' );
    var operation2 = justMod2Or3.reduceRight(function(acc, current){
        return (acc + 1) * current;
    }, 0);
    ...
    */
    ...
    var name = ['Me', 'nan', 'dro'];
    var namePLanguage = name.reduce(function(acc, current){
        return acc + 'P' + current;
    }, '');
    console.log(namePLanguage);
