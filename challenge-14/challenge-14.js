...
var nome = [ 'He', 'ri', 'ck' ];
var nomeReduzido = nome.reduce(function( acumulado, atual, index, array ){
    return acumulado + 'P' + atual;
}, '')

console.log(nomeReduzido);
...
*/
console.log( '\nInversed Name:' );
var inverseName = nome.reduceRight(function( acumulado, atual, index, array) {
