...
*/
carro.oberMarcaModelo = function() {
  return console.log(
    "Esse carro é um " + this.obterMarca() + " " + this.obterModelo()
  );
};
...
carro.adicionarPessoas = function(numeroPessoas) {
  ...
  return console.log(
    "Já temos " + this.quantidadePessoas + " pessoas no carro!"
  );
};
...
carro.oberMarcaModelo(); // Esse carro é um Ford Ka
