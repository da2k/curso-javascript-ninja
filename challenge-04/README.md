...
para o contrário.
*/
var isTruthy = function(arg1) { return arg1 ? true : false };
...
*/
var carro = { marca: 'renault', modelo: 'kwid', placa: 'QHD-3733', ano: 2015, cor: 'Preta', quantasPortas: 2, assentos: 5, quantidadePessoas: 0 };
...
*/
carro.addPessoas = function(pessoa) { 
	if( carro.quantidadePessoas >= carro.assentos ) {
		return "O carro já está lotado!";
    }
	if( carro.quantidadePessoas+pessoa > carro.assentos ) {
		var assentosRestantes = carro.assentos - carro.quantidadePessoas;
		assentosRestantes += (assentosRestantes > 1 )? " pessoas!" : " pessoa.";
		return "Só cabem mais " + assentosRestantes;
    }
