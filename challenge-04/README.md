...
carro.adicionaPessoas = function(numeroPessoas) {
    var pessoasNoCarro = carro.quantidadePessoas + numeroPessoas;
    var lugaresVagos = carro.assentos - carro.quantidadePessoas;
    var pessoa = lugaresVagos === 1 ? 'pessoa' : 'pessoas';
    var cabe = lugaresVagos === 1 ? 'cabe' : 'cabem';
    var tem = pessoasNoCarro === 1 ? 'tem' : 'temos';
    var pessoa2 = pessoasNoCarro === 1 ? 'pessoa' : 'pessoas';
    ...
    return 'Já ' + tem + ' ' + pessoasNoCarro + ' ' + pessoa2 + ' no carro!'; 
};
...
// Faça o carro encher.
carro.adicionaPessoas(3); // 'Já temos 4 pessoas no carro!'

// Tire 4 pessoas do carro.
carro.adicionaPessoas(-4); // 'Já tem 1 pessoa no carro!'
