...
carro.addPessoasCarro = function(numPessoas){
    ...
    var pessoas = this.quantidadePessoas + numPessoas;
    
    if(this.quantidadePessoas === this.assentos){
        return `O carro já está lotado!`;
    }
    if(pessoas > this.assentos || numPessoas > this.assentos){
...
carro.obterMarcaModelo(); // 'Esse carro é um Audi R8'

// Adicione 2 pessoas no carro.
carro.addPessoasCarro(2); // 'Já temos 2 no carro!'

// Adicione mais 4 pessoas no carro.
carro.addPessoasCarro(4); // 'Só cabem mais 3 pessoas'

// Faça o carro encher.
carro.addPessoasCarro(3); // 'Já temos 5 no carro!' 
