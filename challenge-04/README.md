...
carro.addPessoas = function(qtdPessoas){
	if(carro.assentos == carro.quantidadePessoas){
		...
		var qtdCabemCarro = carro.assentos - carro.quantidadePessoas;
		return 'Só cabem mais ' +  qtdCabemCarro+ ' pessoas!'
	}else if(carro.assentos - (carro.quantidadePessoa+ qtdPessoas) == 1){
