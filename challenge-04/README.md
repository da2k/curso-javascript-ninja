...
*/
var adicionarPessoas = function(numero) {
  if (carro.quantidadePessoas >= carro.assentos) {
    return 'O carro já está lotado!';
  }

  if ((carro.quantidadePessoas + numero) > carro.assentos) {
    return 'Só cabem mais ' + ( carro.assentos - carro.quantidadePessoas ) + '
    ' + ( ( ( carro.assentos - carro.quantidadePessoas ) === 1 ) ? 'pessoa!' : 'pessoas!' );
  }
...
carro.obterMarcaModelo(); // Esse carro é um Volkwagem Voyage
