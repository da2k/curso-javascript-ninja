...
para o contrário.
*/
var isTruthy = function( a ) { return !!a === true ? true : false; };
...
carro.addPessoas = function ( pessoas ) {
    ...
    } else if ( carro.assentos >= 1 && pessoas > carro.assentos ) {
        return carro.assentos === 1 ? 'Só cabem mais ' + carro.assentos + ' pessoa!' : 'Só cabem mais ' + carro.assentos + ' pessoas!';
    } else {
...
carro.obterMarcaModelo(); //'Esse carro é um Palio Verde Musgo'
