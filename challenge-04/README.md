...
carro.addPessoas = function(x) {
	...
	var assentosVagos = 0;
	if ( x > 0 && carro.quantidadePessoas >= carro.assentos ) {
		return 'O carro já está lotado!';
	}
	if ( totalPessoas > carro.assentos ) { 
		assentosVagos = carro.assentos - carro.quantidadePessoas;
		if ( assentosVagos === 1 ) {
			return 'Só cabe mais ' + assentosVagos + ' pessoa!';
		}
...
// Faça o carro encher.
carro.addPessoas(1) //'Já temos 3 pessoas no carro!'
carro.addPessoas(2) //'Já temos 5 pessoas no carro!'
carro.addPessoas(0) //'Já temos 5 pessoas no carro!'
