...
carro.adicionarPessoas = function(pessoas){
    ...
    if (pessoas <= 0){
        return "ERRO: Entrar com um número de pessoas válido!";
    }

    if ((this.assentos - this.quantidadePessoas) == 0){
        return "O carro já está lotado!";
    } else if ((this.assentos - (this.quantidadePessoas + pessoas)) < 0){
        var plural = (this.assentos - this.quantidadePessoas) == 1 ? '' : 's';
        return "Só cabem mais "+ (this.assentos - this.quantidadePessoas) +  " pessoa"+plural+"!";
    }
