...
carro.adicionarPessoasNoCarro = function (qtdPessoas) {
  if(carro.quantidadeDePessoas < carro.assentos) {
      if(qtdPessoas <= (carro.assentos - carro.quantidadeDePessoas)) {
        carro.quantidadeDePessoas += qtdPessoas;
        return "Já temos " + carro.quantidadeDePessoas + " pessoas no carro!"
      } else {
        return 'Só cabem mais ' + ((carro.assentos - carro.quantidadeDePessoas)) + (carro.quantidadeDePessoas === 4 ? ' pessoa!' : ' pessoas!');
      }
  } else if (carro.quantidadeDePessoas === carro.assentos) {
