...
para o contrário.
*/
var isTruthy = function (verdadeiro) {
  return !!verdadeiro;
};
...
carro.addPessoas = function(numPessoas){
  var totalPassageiros = carro.quantidadePessoas + numPessoas;
  ...
  if(totalPassageiros > carro.assentos){
    ...
    var pluralSingular = quantosCabem === 1 ? ' pessoa' : ' pessoas';
    return "Só cabem mais " + quantosCabem + pluralSingular + " no carro!";
  }
...
carro.addPessoas(10); // Só cabem mais 3 pessoas no carro!
