...
carro.adicionarPessoas = function(numPessoas) {
    ...
    if (totalPessoas > carro.assentos) {
        var tem =  carro.assentos - carro.quantidadePessoas;
        totalPessoas = totalPessoas + numPessoas;
        var singPluPessoa = tem === 1 ? ", pessoa!": ", pessoas!";
        return "Só cabem mais " +tem + singPluPessoa;
    }
...
carro.obterMarcaModelo(); // 'Esse carro é um Volkswagen Nivus'
