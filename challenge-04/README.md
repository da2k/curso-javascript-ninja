...
*/
var carro = { marca: 'chevrolet', modelo: 'celta', placa: 'OJS9779', ano: 2012, cor: 'branco', quantasPortas: 4, assentos: 5, quantidadePessoas: 0 };
...
carro.adicionarPessoas = function(numeroPessoas) {
	...
	if( (numeroPessoas + carro.quantidadePessoas) === 4) {
		carro.quantidadePessoas = carro.quantidadePessoas + numeroPessoas;
		pluralPessoa = 'pessoa';
		return "Só cabem mais " + 1 + " " + pluralPessoa + "!";
	} 
}
