...
carro.adicionarPessoas = 
    function(numPessoas) { 
        if (carro.assentos === carro.quantidadePessoas) 
            ...
            var mensagemPessoas = (carro.assentos - carro.quantidadePessoas) === 1 ? ' pessoa!' : ' pessoas!';
            return 'Só cabem mais ' + (carro.assentos - carro.quantidadePessoas) + mensagemPessoas;
        }
