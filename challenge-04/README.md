...
*/
 ...
 carro.addPessoas = function(Npessoas) {
     var totalPessoas = Npessoas;
     var assentosLivres = carro.assentos - carro.quantidadesPessoas;
     var maisQueUma = assentosLivres === 1? 'pessoa' : 'pessoas';
     ...
     if(totalPessoas > carro.assentos){
        return 'Só cabem ' + assentosLivres +  maisQueUma + '!';
     }

     carro.quantidadesPessoas += totalPessoas;
