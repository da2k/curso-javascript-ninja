...
para o contrário.
*/
var isTruthy = function isTrue(args){ return args ? true : false; }
...
*/
carro.mudarCor = function(novaCor){ return carro.cor = novaCor; }
...
*/
carro.obterMarcaModelo = function() { return 'Esse carro é um ' + carro.obterMarca() + ' ' + carro.obter.Modelo(); }
...
carro.addPessoas = function(x) {  
  var qtdPessoas = carro.quantidadePessoas + x;    
  ...
  if ( qtdPessoas > carro.assentos ){
    pessoa = vagas === 1 ? 'pessoa' : 'pessoas';   
    return 'Só cabem mais ' + vagas + ' ' + pessoa + ' no carro!';
  }
