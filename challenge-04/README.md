...
carro.adicionaPessoas = function(qtd){
    ...
    if((carro.quantidadePessoas + qtd) > carro.assentos){
        ...
        return 'Só cabem mais '+ (carro.assentos - carro.quantidadePessoas) + regra1 + '!';
    }   
    ...
    return 'Já temos ' + carro.quantidadePessoas + regra2 + ' no carro!'
...
carro.adicionaPessoas(10); //'Só cabem mais 3 pessoas'
