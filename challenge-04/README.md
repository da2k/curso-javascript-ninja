...
*/
carro.oculpantes = function(numPessoas) {
  var pessoasNoCarro = carro.quantidadePessoas + numPessoas;
  var cambemPessoas = carro.assentos - carro.quantidadePessoas;
  var pluralOuSingular = cambemPessoas === 1 ? ' pessoa' : ' pessoas';
  ...
  if (pessoasNoCarro > carro.assentos) {
    return 'Só cabem mais ' + cambemPessoas + pluralOuSingular;
  }
...
carro.oculpantes(2); //Já temos 2 pessoas no carro

// Adicione mais 4 pessoas no carro.
carro.oculpantes(4); //só cabem mais 3 pessoas

// Faça o carro encher.
carro.oculpantes(3); //já temos 5 pessoas no carro

// Tire 4 pessoas do carro.
carro.oculpantes(-4); //já temos  pessoa no carro

// Adicione 10 pessoas no carro.
carro.oculpantes(10); //So cambem mais 4 pessoas
