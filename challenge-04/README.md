...
carro.addPessoas = function(numPessoas){
	if (carro.quantidadePessoas < carro.assentos && (carro.quantidadePessoas + numPessoas) > carro.assentos){
		var quantidade = (carro.assentos - carro.quantidadePessoas) === 1 ? 'pessoa' : 'pessoas';	
		return 'Só cabem mais ' + (carro.assentos - carro.quantidadePessoas) + ' ' + quantidade + '!';
	}

	if ((carro.quantidadePessoas + numPessoas) === carro.assentos || (carro.quantidadePessoas + numPessoas) >= carro.assentos){
