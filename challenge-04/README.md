...
carro.addPessoas = function(nPessoas){
    ...
    var nVagas = carro.assentos - carro.quantidadePessoas;
    var pluSing = nVagas === 1 ? ['cabe', 'pessoa'] : ['cabem', 'pessoas']; //concordância verbal
...
carro.mudaCor('Hot Pink');

// E agora, qual a cor do carro?
carro.obterCor();                       //Hot Pink
...
carro.addPessoas();                     //Já temos 1 pessoa no carro!
```
