...
carro.adicionaPessoas = function (addPessoas) {
	var vagas = 0;	
	if(addPessoas <= carro.assentos && (addPessoas + carro.quantidadePessoas) <= carro.assentos) {
		carro.quantidadePessoas = carro.quantidadePessoas + addPessoas;
		return "Já temos "+carro.quantidadePessoas+" pessoas no carro!";

	}else if (carro.quantidadePessoas < carro.assentos && addPessoas + carro.quantidadePessoas > carro.assentos){
		vagas = carro.assentos - carro.quantidadePessoas;
		if ((carro.quantidadePessoas - carro.assentos) === 1) {
			return "Só cabe mais "+vagas+" pessoa!";
