...
carro.adicionarPessoas = function(pessoas) {
	...
	var ultimaPessoa = lugaresDisponiveis === 1 ? 'pessoa' : 'pessoas';

	if(carro.quantidadePessoas <= carro.assentos && pessoas <= lugaresDisponiveis) {
		carro.quantidadePessoas += pessoas;	
		return "Já temos " + carro.quantidadePessoas + " pessoas no carro!";	
	}

	if(lugaresDisponiveis > 0) {
		return "Só cabem mais " + lugaresDisponiveis + " " + ultimaPessoa + "!";		
	}
