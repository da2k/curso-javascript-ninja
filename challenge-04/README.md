...
*/
carro.mudarCor = function(color) { carro.cor = color; };
...
carro.adicionarPessoas = function(pessoas) {
    ...
    if (assentosLivres === 0) {
        ...
        var singular = assentosLivres === 1 ? "pessoa" : "pessoas";
        var singular2 = assentosLivres === 1 ? "cabe" : "cabem";
        return "Só " + singular2 + " mais " + assentosLivres + " " + singular + "!";
    } 
    
    else {
        carro.quantidadePessoas += pessoas;
        var singular3 = carro.quantidadePessoas === 1 ? "pessoa" : "pessoas";
        return "Já temos " + carro.quantidadePessoas + " "+  singular3 + " no carro!"
    }
}
