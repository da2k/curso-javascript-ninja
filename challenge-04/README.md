...
carro.adicionarPessoas = function(qtdPessoas) {
    let totalPessoas = carro.quantidadePessoas + qtdPessoas;
    ...
    if(totalPessoas > carro.assentos) {
        ...
        let pluOuSin = quantasPessoasCabem === 1 ? ' pessoa' : ' pessoas';
        return `Só cabem mais ${quantasPessoasCabem}${pluOuSin}!`
    }
...
carro.obterMarcaModelo() // "Esse carro é um Tesla Model X"
