...
carro.adicionarPessoas = function(numeroPessoas) {
    var totalPessoasNoCarro = this.quantidadePessoas + numeroPessoas;

    if(this.quantidadePessoas === this.assentos && totalPessoasNoCarro >= this.assentos) {
        return "O carro já está lotado";
    }

    if(totalPessoasNoCarro > this.assentos) {
        var quantidadePessoasCabemNoCarro = this.assentos - this.quantidadePessoas;
        var pluralOuSingular = quantidadePessoasCabemNoCarro === 1 ? ' pessoa!' : ' pessoas!';
        return  "Só cabem mais " + quantidadePessoasCabemNoCarro + pluralOuSingular;
    }
