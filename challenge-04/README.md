...
*/
carro.adicionarPessoa = function(numNovasPessoas) {
	var assentosVagos = carro.assentos - carro.quantidadePessoas;
	
	if (assentosVagos === 0 && numNovasPessoas > 0) {
		return "O carro já está lotado";
	} else if (numNovasPessoas > assentosVagos) {
		return "Só " + (assentosVagos > 1 ? "cabem" : "cabe") + " mais " + assentosVagos + (assentosVagos > 1 ? " pessoas!" : " pessoa!");
	}
	carro.quantidadePessoas += numNovasPessoas;
