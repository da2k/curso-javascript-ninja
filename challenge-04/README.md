...
isTruthy('0'); //true
isTruthy(158); //true
isTruthy("ninja-javascript"); //true
isTruthy({}); //true
isTruthy([1,2,3]); //true
isTruthy({nome: 'Alberto', sobrenome: 'Veloso'}); //true
isTruthy(1); //true
isTruthy(1.5); //true
...
carro.adicionarPessoas = function(qtdPessoas){
	...
	var assentosRestantes;
	var singularPlural = 'pessoas';
	...
	if(totalPessoas > carro.assentos ){
		...
		{
			var singularPlural = 'pessoa';
		}

		return 'Só cabe mais ' + assentosRestantes + ' ' + singularPlural + '!';
	}
...
// E agora, qual a cor do carro?
carro.obterCor(0); //'verde musgo'

// Qual a marca e modelo do carro?
carro.obterMarcaModelo(); // Este carro é um Ford Silverado
