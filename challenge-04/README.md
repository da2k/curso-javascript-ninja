...
para o contrário.
*/
isTruthy = function(param){ return !!param; }

// Invoque a função criada acima, passando todos os tipos de valores `falsy`.
isTruthy(-0); isTruthy(0); isTruthy(''); isTruthy(undefined); 
isTruthy(null); isTruthy(false); isTruthy(NaN);

/*
Invoque a função criada acima passando como parâmetro 5 valores `truthy`.
*/
- isTruthy(' '); isTruthy({}); isTruthy([]); isTruthy(function() {});
...
carro.adicionarPessoasCarro = function (pessoas){ 
    ...
    var quantidadePessoasRestantes = carro.assentos - carro.quantidadePessoas;
    var frase = quantidadePessoasRestantes === 1 ? "pessoa" : "pessoas";
    return "Só cabem mais " + quantidadePessoasRestantes + " " + frase + "!";
} 
