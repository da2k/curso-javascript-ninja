...
carro.obterMarcaModelo(); // "Este carro é um Toyota Matrix Xr!"
...
carro.diminuirPessoas = function(z) {

    var pessoas = 'pessoas';
    carro.quantidadesPessoas -= z;

    if (carro.quantidadesPessoas === 1) { 
        pessoas = 'pessoa';
    }
console.log(pessoas)
    return 'Tem' + ' ' + carro.quantidadesPessoas + ' ' + pessoas + ' ' + 'no carro!'
}


carro.diminuirPessoas(4) // "Tem 1 pessoa no carro!"
