...
*/
var carro = {marca: "Fiat", modelo: "Palio", placa: "HGX9845", ano: 2002, cor: "cinza", quantasPortas: 4, assentos: 5, quantidadedePessoas: 0};
...
carro.adicionaPessoa = function(pessoas){
    var lugaresRestantes = carro.assentos - pessoas;
    carro.quantidadedePessoas += pessoas;
    var pessoa = "pessoas";
    if(carro.quantidadedePessoas >= carro.assentos){
        return "O carro já está lotado!";
    }if(pessoas > carro.assentos && lugaresRestantes !== carro.assentos){
        return "Só cabem mais " + lugaresRestantes + " " + pessoa + "!";
...
carro.adicionaPessoa(4);//'O carro já está lotado'

// Faça o carro encher.
carro.adicionaPessoa(0);//'O carro já está lotado'

// Tire 4 pessoas do carro.
carro.adicionaPessoa(4);//"Já temos 2 pessoas no carro."

// Adicione 10 pessoas no carro.
carro.adicionaPessoa(10);//'O carro já está lotado'
