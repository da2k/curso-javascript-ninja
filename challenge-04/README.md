...
*/
carro.adicionaPassageiros = function (passageiros) {
    var totalPassageiros = carro.quantidadePessoas + passageiros;
    ...
    if (totalPassageiros > carro.assentos) {
        ...
        var texto = (lugaresVagos === 1 ? ' pessoa' : ' pessoas');
        return 'Só cabem mais ' + lugaresVagos + texto +'!';
    }
...
carro.adicionaPassageiros(2); //'Já temos 2 pessoas no carro!'

// Adicione mais 4 pessoas no carro.
carro.adicionaPassageiros(4); //'Só cabem mais 3 pessoas!'

// Faça o carro encher.
carro.adicionaPassageiros(3); //'Já temos 5 pessoas no carro!'

// Tire 4 pessoas do carro.
carro.adicionaPassageiros(-4); //'Já temos 1 pessoa no carro';
