...
*/
var carro = { marca: 'Ford', modelo: 'Focus', placa: 'PSX-0000', ano: 2018, cor: 'Branco', quantasPortas: 4, assentos: 5, quantidadePessoas: 0 };
...
carro.adicionarPessoas = function( numeroPessoas) {
	...
	var verifica =  lugares === 1 ? 'pessoa' : 'pessoas';
	var verifica2 = lugares === 1 ? 'cabe' : 'cabem';

	if(carro.quantidadePessoas === carro.assentos && totalPessoas >= carro.assentos){	return 'O carro já está lotado';	}
	if(totalPessoas > carro.assentos) {	return 'Só ' + verifica2 + ' mais ' + lugares + ' ' + verifica + ' no carro!';	}
