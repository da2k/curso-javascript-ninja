...
*/
carro.adicionaPessoas = function(quantidadePessoas) {  
  ...
  if( carro.quantidadePessoas < carro.assentos && quantidadePessoas > assentosLivres){
...
carro.obterMarcaModelo(); // Esse carro é um Toyota Ecos
