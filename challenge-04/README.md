...
carro.mudaCor = function(corMudar) {
  carro.cor = corMudar;
}; 
...
carro.addPessoaNoCarro = function( qtdPessoas ){
...
carro.obterMarcaModelo(); // Gm Onix

// Adicione 2 pessoas no carro.

carro.addPessoaNoCarro(2);

// Adicione mais 4 pessoas no carro.

carro.addPessoaNoCarro(4); // Só cabem mais 3 pessoas!

// Faça o carro encher.

//'Já temos 5 pessoa no carro!'


carro.addPessoaNoCarro(3); // Tire 4 pessoas do carro.
