...
para o contrário.
*/
var isTruthy = function(p){return !!p;};
...
*/
var carro = {marca: 'BMW', modelo: 'gol', placa: 'GAC-1020', ano: 1950, cor: 'azul', quantasPortas: 4, assentos: 5, quantasPessoas: 0};
...
*/
  ...
  carro.addPessoas = function(p){
    var totalPessoas = carro.quantidadePessoas + p;
    var qtsCabem = carro.assentos - carro.quantidadePessoas;
    var pluralOuSingular = qtsCabem ===1?'pessoa':'pessoas';
    ...
    if(totalPessoas>carro.assentos){
      return 'Só cabem mais ' + qtsCabem + pluralOuSingular +'!';
    }
...
carro.obterMarcaModelo();// Esse carro é um BMW gol
