...
carro.addPeople = function (people) {
	var faltam = this.assentos - this.quantidadePessoas;
	var retorno = "";
	if(faltam > 0 || people < 0) 
		test = faltam - people;
	else 
		return "O carro já está lotado";
	
	if(test >= 0) 
		this.quantidadePessoas += people;
	 else 
		return "Só cabem mais " + faltam + ((faltam > 1) ? " pessoas!" : " pessoa!");
...
// Faça o carro encher.
carro.addPeople(3); //"Já temos 5 no carro!"

// Tire 4 pessoas do carro.
carro.addPeople(-4); //"Já temos 1 no carro!"
