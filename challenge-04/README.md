...
para o contrário.
*/
var isTruthy = function (valor){return !!valor};
...
*/
carro.obterMarcaModelo = function(){return "Esse carro é um " + obterMarca() + " " + obterModelo()}
...
carro.addPessoas = function(quantidade){
    ...
    }else if(quantidade > (carro.assentos - carro.quantidadePessoas)){
