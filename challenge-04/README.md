...
*/
carro.adicionarPessoasNoCarro = function (numeroDePessoas) {
  var totalDePessoas  = carro.quantidadePessoas + numeroDePessoas;
  if ( carro.assentos === carro.quantidadePessoas && totalDePessoas >= carro.assentos ) {
    return 'O carro ja esta lotado!';
  }
  if ( totalDePessoas > carro.assentos ) {
    var quantasPessoasAindaCabem = carro.assentos - carro.quantidadePessoas;
    var pluralOuSingular = quantasPessoasAindaCabem === 1 ? ' pessoa' : ' pessoas';
    return 'So cabem mais ' + quantasPessoasAindaCabem + pluralOuSingular + '!';
  }
...
//"Esse carro é um volks, modelo gol"
