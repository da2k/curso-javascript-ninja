...
carro.adicionaPessoas = function(numPessoas) {
    ...
    } else if (carro.assentos === 1 && numPessoas > 1) {
       return 'Só cabe mais ' + carro.assentos + ' pessoa!';
    } else if (carro.assentos < numPessoas) {
       numPessoas = 0;
...
carro.removePessoas(4); //"Temos 1 pessoas no carro!"
