...
carro.obterMarca = function () {
  return 'A marca do carro selecionado é ' + carro.marca + '!.'
}
...
carro.adicionarPessoas = function (pessoas) {
    ...
    var pessoa = carro.quantidadePessoas == 4 || carro.quantidadePessoas == 1 ? ' pessoa':' pessoas'
    if(carro.quantidadePessoas < carro.assentos ) {
        return 'Já temos ' + pessoas + pessoa + ' no carro!'
    } else if (pessoas > carro.assentos) { 
        carro.quantidadePessoas = 5
        return 'O carro só cabe ' + carro.assentos + pessoa + '!'
