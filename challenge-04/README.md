...
isTruthy([]);
isTruthy([1, 2, 3, 4]);
isTruthy({ text : 'Minions ipsum poulet tikka masala la bodaaa me want bananaaa'});
...
carro.obterMarcaModelo(); // "Este carro é um: Subaru Impreza"
...
carro.addPassageiro(-4); // Já temos 1 pessoas no carro!
