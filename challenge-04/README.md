...
carro.adicionarPessoas = function(entraraoCarro) {
    var totalPessoas = carro.quantidadePessoas + entraraoCarro;
    var quantasPessoasCabem = carro.assentos - carro.quantidadePessoas;
    var cabeOuCabem = quantasPessoasCabem === 1 ? 'cabe' : 'cabem';
    var pessoaOuPessoas = quantasPessoasCabem === 1 ? ' pessoa.' : ' pessoas.';
...
carro.adicionarPessoas(10) // Só cabem mais 4 pessoa.
