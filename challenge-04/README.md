...
carro.adicionarPessoas = function(numPessoas) {
 ...
 var pluralOuSingular = (carro.assentos - carro.quantidadePessoas) === 1 ? ' pessoa!' : ' pessoas!';
 return 'Só cabem mais ' + (carro.assentos - carro.quantidadePessoas) + pluralOuSingular;
 }
 else
 {
