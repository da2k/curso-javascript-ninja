...
*/
isTruthy(1); //true
isTruthy('Marcus'); //true
isTruthy('0'); //true
isTruthy(true); //true
isTruthy('JS Ninja'); //true
isTruthy(10); //true
isTruthy(100); //true
isTruthy(!false); //true
isTruthy(1.73); //true
isTruthy('10 valores verdadeiros'); //true
...
carro.addPessoas = function (numPessoas) {
 ...
        return 'O carro já está lotado!';
    ...
    if(totalPessoas > carro.assentos) {
        var localVago = carro.assentos - carro.quantidadePessoas;
        var plural = localVago === 1 ? 'pessoa' : 'pessoas';
        return 'Só cabem mais ' + localVago + plural + '!';
    }
...
carro.obterMarcaModelo(); //'Esse carro é um Chevrollet Classic'
