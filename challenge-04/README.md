...
carro.obterMarcaModelo = function(){
  return 'Esse carro é um ' + carro.obterMarca() + ' ' + carro.obterModelodelo();
}
...
*/
carro.adicionarPassageiros = function(numPassageiros){
  var totalPassageiros = carro.quantidadePessoas + numPassageiros;
  ...
  if(totalPassageiros > carro.assentos){
    var singularOuPlural = totalAssentosLivres === 1 ? ' pessoa' : ' pessoas';
    var totalAssentosLivres = carro.assentos - carro.quantidadePessoas;
    return 'Só cabem mais '+ totalAssentosLivres + singularOuPlural +  '!';
  }
  carro.quantidadePessoas += numPassageiros;
