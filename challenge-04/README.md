...
para o contrário.
*/
var isTruthy = function oneFunction(x) {
    return !!x;
};
...
carro.adicionarPessoas = function(num) {
    var pluralOuSingular = quantascCabem === 1 ? 'pessoa' : 'pessoas';
    ...
    if(totalPessoas > carro.assentos) {
        ...
        return 'Só cabem mais ' + quantasCabem + ' ' + pluralOuSingular;
    }
...
carro.obterMarcaModelo(); // "Esse carro é um Ford Cruze"
