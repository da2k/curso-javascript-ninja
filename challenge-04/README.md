...
carro.adicionarPessoas = function(n) {
  ...
  var lugaresVagos = carro.assentos - carro.quantidadePessoas,
      flexaoGramaticalPessoa = lugaresVagos === 1 ? 'pessoa' : 'pessoas';

  if(lugaresVagos > 0 && n > lugaresVagos) return 'Só cabem mais ' + lugaresVagos + ' ' + flexaoGramaticalPessoa + '!';
...
carro.obterMarcaModelo(); // Esse carro é um Ford 4x4
