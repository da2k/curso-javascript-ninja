...
carro.addPessoas = function(nPessoas) {
  ...
  var capacidadePessoas = carro.assentos - carro.quantidadePessoas;
  var pluralPessoas = capacidadePessoas === 1 ? 'pessoa' : 'pessoas';
  ...
  if( totalPessoas > carro.assentos ) {
    return 'Só cabem mais ' + capacidadePessoas + ' ' + pluralPessoas + '!';
  }
...
carro.obterMarcaModelo() //"Esse carro é um Volkswagen Polo Sedan"
