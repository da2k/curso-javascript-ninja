...
carro.addPessoas = function(numeroPessoas){
    ...
    if(totalPessoas > carro.assentos){
        ...
        var pluralSing = quantasPessoasCabem === 1 ? ' pessoa' : ' pessoas';
        return 'Só cabem mais  '+ quantasPessoasCabem + pluralSing + '!';
    }
...
carro.quantidadePessoas//Temos 1 pesoas no carro.
