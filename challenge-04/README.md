...
console.log(isTruthy("nodeJs"));
console.log(isTruthy(true));
console.log(isTruthy(9));
console.log(isTruthy({}));
console.log(isTruthy([]));
console.log(isTruthy(1 === 1));
console.log(isTruthy("Udemy"));
console.log(isTruthy('0'));
console.log(isTruthy('Ninja'));
...
carro.adicionarPassageiros = function(numPassageiros) {
    var pluralPessoas = (carro.assentos - carro.quantidadePessoas === 1) ? 'pessoa' : 'pessoas';

    if (carro.quantidadePessoas === carro.assentos) {
        return "O carro já está lotado!";
    }
    else if ((carro.assentos - carro.quantidadePessoas) < numPassageiros) {
        return "Só cabem mais " + (carro.assentos - carro.quantidadePessoas) + " " + pluralPessoas + "!";
    }
