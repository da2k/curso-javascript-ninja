...
carro.adicionarPessoas = function(pessoas) {
  ...
  if(pessoasAdicionadas >= carro.assentos) {
    ...
    return "Só " + caber + " mais " + assentosRestantes + " " + pessoa + "!";; 
  	...
  	return "Já temos " + pessoasAdicionadas + " no carro!";
  }
...
// Faça o carro encher.
carro.adicionarPessoas(carro.assentos); 
//Nesta hora o carro já está cheio pois as duas invocações anteriores ultrapassam o limite de assentos
