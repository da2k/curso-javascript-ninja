...
carro.adicionarPessoas = function(numeroPessoas) {
  ...
  totalPessoas = carro.quantidadePessoas + numeroPessoas;
  ...
  if(totalPessoas > carro.assentos) {
    var pessoa = carro.assentos - carro.quantidadePessoas === 1 ? 'pessoa' : 'pessoas';
    var cabe = carro.assentos - carro.quantidadePessoas === 1 ? 'cabe' : 'cabem';
...
carro.obterMarca() + carro.obterModelo(); // Peugeot307 Presence 1.6 Sedan
...
// Faça o carro encher.
adicionarPessoas(1); // Já temos 5 pessoas no carro.
