...
isTruthy([]);
isTruthy({});
isTruthy('String mais longa que a outra');
isTruthy((10+10)*2);
isTruthy([ 1, 3 ]);
isTruthy({ cor: azul, tamanho: m });
...
carro.adicionaPessoas = function(numeroPessoas) {
  ...
  var singularOuPlural = quantasPessoasCabem === 1 ? ' pessoa' : ' pessoas';
  ...
  return 'Já temos ' + totalPessoas + singularOuPlural + ' no carro!';
...
carro.obterMarcaModelo(); // 'Esse carro é um Mitsubishi Lancer.'
