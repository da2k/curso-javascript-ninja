...
carro.adicionarPessoas = function (quantidadePessoas) {
    ...
    var mensagemQuantidadeAtual = function () { 
        return "Já temos " + carro.quantidadePessoas + " pessoas no carro!";
    };
    var carroCheio = carro.quantidadePessoas === carro.assentos;
    if ( carroCheio && quantidadePessoas ) {
        return mensagemQuantidadeAtual() + "\n O carro já está lotado!";
    } else {
        var assentosRestantes = carro.assentos - carro.quantidadePessoas;
        if ( quantidadePessoas > assentosRestantes ) {        
            var nomePessoas = assentosRestantes > 1 ? "pessoas" : "pessoa";    
            return  mensagemQuantidadeAtual() + "\n Só cabem mais " + assentosRestantes + " " + nomePessoas + "!";
        } else {
