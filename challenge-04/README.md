...
*/
carro.adicionarPessoasCarro = function(numPessoas){
    var total = carro.quantidadePessoas + numPessoas,
        qtdPessoasCabem = carro.assentos - carro.quantidadePessoas,
        verPessoa = (qtdPessoasCabem === 1)? 'pessoa':'pessoas';
    ...
    if(total > carro.assentos){
       return 'Só cabem mais '+ qtdPessoasCabem + ' '+ verPessoa + '!';
    }
...
carro.adicionarPessoasCarro(1); //"O carro já está lotado!"
