...
*/
newFunction(1, "a", 111, true, "verdadeiro", 'vrai', 10, 'juro', "serio", 123);
...
carro.removerPessoas = function(numPessoas) {
    numPessoas >= carro.quantidadePessoas ? carro.quantidadePessoas = 0 : carro.quantidadePessoas -= numPessoas;
}
