...
carro.adicionarPessoas = function(qtdePessoas){
  ...
  var pluralOuSingular = quantidadeVagasDiponiveis === 1 ? 'pessoa' : 'pessoas';
  var totalPessoas = carro.quantidadePessoas + qtdePessoas;
  ...
  if (totalPessoas > carro.assentos) {
    return "Só cabem mais " + quantidadeVagasDiponiveis +" " + pluralOuSingular + "!";
  }
