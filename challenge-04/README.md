...
carro.adicionarPessoas = function(quantidade){
	...
	if(total > carro.assentos){
		var x = carro.assentos - carro.quantidadePessoas;
		if( x === 1){
		return 'Só cabe mais '+ x +' pessoa!';
        }
		return 'Só cabem mais '+ x +' pessoas!';
	}
...
carro.obterMarcaModelo(); // "Esse carro é um Peugeot 206"
