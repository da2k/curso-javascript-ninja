...
isTruthy({}); //true
isTruthy(12345); //true
isTruthy("Petherson"); //true
isTruthy('Monteiro'); //true
isTruthy([ 1, 'dois', 3 ]); //true
isTruthy({ nome: 'Petherson', idade: 24 }); //true
...
carro.addPessoas = function(qnt){
  ...
  if(vagas === 0){
    ...
    return vagas === 1 ? 'Só cabe mais 1 pessoa!' : 'Só cabem mais ' + vagas + ' pessoas!';
  }

  carro.quantidadePessoas += qnt;
