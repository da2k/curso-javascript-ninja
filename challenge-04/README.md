...
*/
carro.adicionarPessoa = function (novasPessoas) {
if((carro.assentos > carro.quantidadePessoas) && novasPessoas > (carro.assentos - carro.quantidadePessoas)){   
...
}else if ((carro.quantidadePessoas + novasPessoas) < 0){
    carro.quantidadePessoas -= novasPessoas;
...
// Faça o carro encher.
carro.adicionarPessoa(3); // O carro está cheio
