...
var isTruthy = function(param) {
  return !!param  //retorna o valor em boolean do parametro
};
...
carro.obterMarcaModelo = function(){
  return 'Este carro é um '+carro.obterMarca()+' '+carro.obeterModelo();
};
...
carro.adicionarPessoas = function(numeroPessoas){
  ...
  var totaPessoas = carro.quantidadePessoas + numeroPessoas;
  ...
  if(totalPessoas > carros.assentos){
    ...
    var pluralOuSingural = quantasPessoasCabem === 1 ? ' pessoa' : ' pessoas';
