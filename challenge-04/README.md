...
*/
var carro = {marca: 'Honda', modelo: 'HRV', placa: 'JSI2233', ano: 2010, cor: 'Prata', quantasPortas: 4, assentos: 5, quantidadePessoas: 0};
...
carro.addPessoas = function(qtdPessoas){
  ...
  if( carro.assentos >= ( carro.quantidadePessoas + qtdPessoas) ){//adiciona pessoas caso tenha lugar.
