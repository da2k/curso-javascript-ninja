...
carro.adicionarPessoas = function(numeroPessoas){
	...
	pluralSingular = carro.quantidadePessoas===1? 'pessoa' : 'pessoas';
...
carro.adicionarPesoas(2);//Já temos 2 pessoas no carro!

// Adicione mais 4 pessoas no carro.

carro.adicionarPesoas(2);//Só cabem mais 3 pessoas!

// Faça o carro encher.

carro.adicionarPesoas(3);//Já temos 5 pessoas no carro!

// Tire 4 pessoas do carro.

carro.adicionarPesoas(-4);//"Já temos 1 pessoas no carro!"
