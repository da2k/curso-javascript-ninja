...
carro.adicionarPessoas = function(nPessoas){
    ...
    var regraGramatical = lugaresLivres === 1 ? 'pessoa' : 'pessoas';
    ...
    if(totalPessoas > carro.assentos){
        return 'Só cabem mais ' + lugaresLivres + ' ' + regraGramatical + '!';
    }
...
/*carro.adicionarPessoas = function(nPessoas){
    ...
    if(carro.quantidadePessoas < carro.assentos && (carro.quantidadePessoas + nPessoas) > carro.assentos){
