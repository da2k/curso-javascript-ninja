...
carro.obterMarcaModelo(); // 'Esse carro é um corolla X-RE'

// Adicione 2 pessoas no carro.
carro.adicionarPessoas(2); // 'Ja témos 2 Pessoas no carro!'

// Adicione mais 4 pessoas no carro.
carro.adicionarPessoas(4); // 'So cabem mais 3 pessoas!'

// Faça o carro encher.
carro.adicionarPessoas(3); // 'Ja témos 5 pessoas no carro!'

// Tire 4 pessoas do carro.
carro.adicionarPessoas(-4); // 'Ja témos 1 pessoas no carro!'
