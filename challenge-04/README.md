...
carro.adicionarPessoa = function(quantidadePessoas){
  ...
  if (quantidadePessoas > carro.assento) {
    var pessoas = carro.assento - carro.quantidadePessoas;
    var palavraPessoa = pessoas === 1 ? 'pessoa!' : 'pessoas!';
    return 'Só cabem mais ' + pessoas + ' ' + palavraPessoa;
  }
