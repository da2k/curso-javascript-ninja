...
carro.adicionarPessoas = function(quantidade) {
    var quatidadePessoas = carro.quantidadePessoas + quantidade;
    if (carro.quantidadePessoas === carro.assentos && quatidadePessoas >= carro.assentos){
        return "O carro ja está lotado!";
    };
    if(quantidadePessoas > carros.assentos){
        var sobram = carros.assentos - carro.quantidadePessoas;
        var plural = sobram === 1 ? 'pessoa' : 'pessoas';
        return "Só cabem mais " + sobram + " " + plural + "!";
    };
