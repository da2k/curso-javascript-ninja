...
*/
carrro.mudarCor = function ( novaCor ) {
	carro.cor = novaCor;
}
...
*/
carro.adicionarPessoasCarro = function ( numeroPessoas ) {
...
// Faça o carro encher.
carro.adicionarPessoasCarro( 5 ); // Já temos 5 pessoas no carro!

// Tire 4 pessoas do carro.
carro.adicionarPessoasCarro( -4 ); // Já temos 1 pessoa no carro!
