...
*/
  carro.addPessoas = function(qtdPessoas){
   ...
   var qtdNoCarro = carro.quantidadePessoas;
   var qtdDisponivel = carro.assentos - qtdNoCarro;

   if(qtdNoCarro === carro.assentos && (qtdNoCarro + qtdPessoas) >= carro.assentos){
     return 'O Carro já está lotado';
   }
   if (qtdPessoas > qtdDisponivel && qtdNoCarro < 5){
    var pessoa =  qtdDisponivel === 1 ? 'pessoa' : 'pessoas';
...
carro.obterMarcaModelo() // "Esse carro é um Gol GTI"
