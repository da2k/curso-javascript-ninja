...
carro.mudarCor = function(cor){
  this.cor = cor;
  return "A cor do carro foi alterada para " + cor;
}
...
carro.addPessoas = function(qtd){
  ...
  if(this.quantidadePessoas === this.assentos && this.quantidadePessoas + qtd >= this.assentos){ // se o carro estiver cheio
    return "O carro já está lotado!";
  } 
  
  if (qtd > this.assentos || this.quantidadePessoas + qtd > this.assentos){ // capacidade insuficiente
    var resto = this.assentos - this.quantidadePessoas;
    var pessoas = resto === 1 ? " pessoa!" : " pessoas!";
...
carro.mudarCor('Vermelho'); // 'A cor do carro foi alterada para Vermelho'

// E agora, qual a cor do carro?
carro.obterCor(); // 'A cor do carro é: Vermelho'

// Mude a cor do carro para verde musgo.
carro.mudarCor('Verde Musgo'); // 'A cor do carro foi alterada para Verde Musgo'

// E agora, qual a cor do carro?
carro.obterCor(); // 'A cor do carro é: Verde Musgo'

// Qual a marca e modelo do carro?
carro.obterMarcaModelo(); // 'Esse carro é um Chevrolet Corsa Wind'
