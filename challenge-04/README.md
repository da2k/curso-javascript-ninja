...
carro.adicionarPessoas = function(numPessoas) {
 var totalPessoas = carro.quantidadedePessoas + numPessoas;
  ...
  if(totalPessoas > carro.assentos) {
    ...
    var pluralOuSingular = qtsPessoasCabem === 1 ? ' pessoa' : ' pessoas';

    return 'Só cabem mais ' + qtsPessoasCabem + pluralOuSingular + '.';
  }  
...
carro.obterMarcaModelo() // 'Esse carro é um GM Celta.'
...
carro.adcionarPessoas(-4) // Temos 1 pessoa no carro

// Adicione 10 pessoas no carro.
carro.adiconarPessoas(10) // o carro já esta lotado
