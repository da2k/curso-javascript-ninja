...
*/
carro.adicionarPessoas = (quantidadeNovasPessoas) => {
  let {quantidadePessoas, acentos} = carro;
  var totalPessoas = quantidadePessoas + quantidadeNovasPessoas;
  
  if (totalPessoas === acentos){
    return "O carro já está lotado!";
  }
  
  if (totalPessoas > acentos) {
    let cabem = acentos - quantidadePessoas;
...
carro.obterMarcaModelo() // 'Esse carro é um Chevrolet Opala'
