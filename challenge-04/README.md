...
*/
carro.mudarCor = function(corRecebida){

    carro.cor = corRecebida;
    return "A cor do carro é: " + corRecebida;
...
carro.obterMarcaModelo = function(){
    ...
    return "Esse carro é um é da marca "+ carro.marca +", o seu modelo "+ carro.modelo + ".";
...
// E agora, qual a cor do carro?
"A cor do carro é: verde musgo"

// Qual a marca e modelo do carro?
carro.obterModelo();//"A marca do carro é: Fox"

// Adicione 2 pessoas no carro.
carro.adicionarPessoas(2);//"Já temos 2 pessoas no carro!"

// Adicione mais 4 pessoas no carro.
carro.adicionarPessoas(4);//"Só  pessoas mais 3  pessoas!"
...
carro.adicionarPessoas(10);//"Só  pessoas mais 4  pessoas!"
