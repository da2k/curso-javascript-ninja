...
carro.addPessoas = function(numPessoas){
	var pessoaOuPessoas = (carro.assentos - carro.quantidadePessoas === 1) ? ' pessoa' : ' pessoas';

	if( numPessoas <= carro.assentos && ((numPessoas + carro.quantidadePessoas) <= 5) ) {
	...
	if( (carro.quantidadePessoas < 5) && ((numPessoas + carro.quantidadePessoas) > 5) ) {
