...
carro.entrar = function(pessoas) {
    if (carro.assentos < (carro.quantidadePessoas + pessoas)) {
        var trat = carro.assentos - carro.quantidadePessoas === 1 ? ' pessoa' : ' pessoas';
        return 'Só cabem mais ' + (carro.assentos - carro.quantidadePessoas) + trat;
    } else {
...
// Faça o carro encher.
carro.entrar(3); //O carro já está lotado!
