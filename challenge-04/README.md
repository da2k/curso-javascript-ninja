...
carro.adicionarPessoa = function(pessoas) {
    ...
    if (totalPessoas > carro.assentos) {
        var espaço = carro.assentos - carro.quantidadePessoas
        var plural = espaço === 1 ? '' : 's'
        return 'Só cabem mais ' + espaço + ' pessoa' + plural + '!'
    }
...
carro.obterMarcaModelo() // "Esse carro é um BMW X6"
