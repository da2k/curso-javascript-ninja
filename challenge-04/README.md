...
carro.adicionarPessoas = function(numeroDePessoas) {
	...
	var textoPessoa = (vagasRestantes > 1 ? "pessoas" : "pessoa");
	var textoCabe = (vagasRestantes > 1 ? "cabem" : "cabe");

	if(carro.assentos === carro.quantidadePessoas) {
		return "O carro já está lotado!";
    } else if (numeroDePessoas > vagasRestantes) { 
		return "Só " + textoCabe + " mais " + vagasRestantes + " " + textoPessoa + "!"
    } else {
