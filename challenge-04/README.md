...
carro.adicionarPessoas = function(numPessoas) {
  ...
  if(totalPessoas > carro.assentos ) {
    ...
    var singularPlural = quantosCabem === 1 ? 'pessoa' : 'pessoas';
    return `Só cabem mais ${quantosCabem} ${singularPlural}!`;
  }
...
carro.obterMarcaModelo() // 'Esse carro é um Mercedes Classe A Limousine'
